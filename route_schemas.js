...
// allergySkinPrickInterpretation
const allergySkinPrickInterpretation = { patientId: { type: 'string', required: true } };

// allergyIgeLevelInterpretation
const allergyIgeLevelInterpretation = { patientId: { type: 'string', required: true } };

// allergyAnaphylaxisSeverity
const allergyAnaphylaxisSeverity = { patientId: { type: 'string', required: true } };

// allergyFoodAllergyScore
const allergyFoodAllergyScore = { patientId: { type: 'string', required: true } };

// allergyAsthmaAllergic
const allergyAsthmaAllergic = { patientId: { type: 'string', required: true } };

// anesthesiaAsaPhysicalStatus
const anesthesiaAsaPhysicalStatus = { patientId: { type: 'string', required: true } };

// anesthesiaMallampatiScore
const anesthesiaMallampatiScore = { patientId: { type: 'string', required: true } };

// anesthesiaAirwayDifficultPrediction
const anesthesiaAirwayDifficultPrediction = { patientId: { type: 'string', required: true } };

// anesthesiaMalignantHyperthermiaRisk
const anesthesiaMalignantHyperthermiaRisk = { patientId: { type: 'string', required: true } };

// anesthesiaPonvRisk
const anesthesiaPonvRisk = { patientId: { type: 'string', required: true } };

// audiologyPureToneAverage
const audiologyPureToneAverage = { patientId: { type: 'string', required: true } };

// audiologySpeechReceptionThreshold
const audiologySpeechReceptionThreshold = { patientId: { type: 'string', required: true } };

// audiologyTympanometryType
const audiologyTympanometryType = { patientId: { type: 'string', required: true } };

// audiologyOtoacousticEmissions
const audiologyOtoacousticEmissions = { patientId: { type: 'string', required: true } };

// audiologyAuditoryBrainstem
const audiologyAuditoryBrainstem = { patientId: { type: 'string', required: true } };

// burn_unitParklandFormula
const burn_unitParklandFormula = { patientId: { type: 'string', required: true } };

// burn_unitAbsiScore
const burn_unitAbsiScore = { patientId: { type: 'string', required: true } };

// burn_unitBurnDepthClassification
const burn_unitBurnDepthClassification = { patientId: { type: 'string', required: true } };

// burn_unitInhalationInjuryRisk
const burn_unitInhalationInjuryRisk = { patientId: { type: 'string', required: true } };

// burn_unitFluidResuscitationRate
const burn_unitFluidResuscitationRate = { patientId: { type: 'string', required: true } };

// cardiac_rehabMetsCapacity
const cardiac_rehabMetsCapacity = { patientId: { type: 'string', required: true } };

// cardiac_rehabFunctionalCapacity
const cardiac_rehabFunctionalCapacity = { patientId: { type: 'string', required: true } };

// cardiac_rehabExercisePrescription
const cardiac_rehabExercisePrescription = { patientId: { type: 'string', required: true } };

// cardiac_rehabRiskStratification
const cardiac_rehabRiskStratification = { patientId: { type: 'string', required: true } };

// cardiac_rehabProgramAdherence
const cardiac_rehabProgramAdherence = { patientId: { type: 'string', required: true } };

// ccuKillipClass
const ccuKillipClass = { patientId: { type: 'string', required: true } };

// ccuGraceScore
const ccuGraceScore = { patientId: { type: 'string', required: true } };

// ccuCardiacArrestPrognosis
const ccuCardiacArrestPrognosis = { patientId: { type: 'string', required: true } };

// ccuCardiogenicShockScore
const ccuCardiogenicShockScore = { patientId: { type: 'string', required: true } };

// ccuPostPCIComplication
const ccuPostPCIComplication = { patientId: { type: 'string', required: true } };

// chaplaincySpiritualAssessment
const chaplaincySpiritualAssessment = { patientId: { type: 'string', required: true } };

// chaplaincyReligiousNeeds
const chaplaincyReligiousNeeds = { patientId: { type: 'string', required: true } };

// chaplaincyEndOfLifeSpiritualCare
const chaplaincyEndOfLifeSpiritualCare = { patientId: { type: 'string', required: true } };

// chaplaincyGriefStage
const chaplaincyGriefStage = { patientId: { type: 'string', required: true } };

// chaplaincyFaithCommunitySupport
const chaplaincyFaithCommunitySupport = { patientId: { type: 'string', required: true } };

// cicuStsRiskScore
const cicuStsRiskScore = { patientId: { type: 'string', required: true } };

// cicuCabgMortalityRisk
const cicuCabgMortalityRisk = { patientId: { type: 'string', required: true } };

// cicuValveReplacementRisk
const cicuValveReplacementRisk = { patientId: { type: 'string', required: true } };

// cicuPostOpAfibRisk
const cicuPostOpAfibRisk = { patientId: { type: 'string', required: true } };

// cicuIcuLengthOfStay
const cicuIcuLengthOfStay = { patientId: { type: 'string', required: true } };

// ctuCopdExacerbation
const ctuCopdExacerbation = { patientId: { type: 'string', required: true } };

// ctuAsthmaControl
const ctuAsthmaControl = { patientId: { type: 'string', required: true } };

// ctuArdsSeverity
const ctuArdsSeverity = { patientId: { type: 'string', required: true } };

// ctuWeaningSuccessProbability
const ctuWeaningSuccessProbability = { patientId: { type: 'string', required: true } };

// ctuLongTermOxygenNeed
const ctuLongTermOxygenNeed = { patientId: { type: 'string', required: true } };

// dermatologyPasoriasisSeverity
const dermatologyPasoriasisSeverity = { patientId: { type: 'string', required: true } };

// dermatologyMelanomaBreslow
const dermatologyMelanomaBreslow = { patientId: { type: 'string', required: true } };

// dermatologyDermatitisSeverity
const dermatologyDermatitisSeverity = { patientId: { type: 'string', required: true } };

// dermatologyScoradScore
const dermatologyScoradScore = { patientId: { type: 'string', required: true } };

// dermatologyDrugReactionSeverity
const dermatologyDrugReactionSeverity = { patientId: { type: 'string', required: true } };

// dialysisKtvRatio
const dialysisKtvRatio = { patientId: { type: 'string', required: true } };

// dialysisUrrAdequacy
const dialysisUrrAdequacy = { patientId: { type: 'string', required: true } };

// dialysisVascularAccessPatency
const dialysisVascularAccessPatency = { patientId: { type: 'string', required: true } };

// dialysisDryWeightEstimate
const dialysisDryWeightEstimate = { patientId: { type: 'string', required: true } };

// dialysisDialysisAdequacyScore
const dialysisDialysisAdequacyScore = { patientId: { type: 'string', required: true } };

// epilepsyEngelOutcomeClass
const epilepsyEngelOutcomeClass = { patientId: { type: 'string', required: true } };

// epilepsyIlaeOutcomeClass
const epilepsyIlaeOutcomeClass = { patientId: { type: 'string', required: true } };

// epilepsySeizureFrequency
const epilepsySeizureFrequency = { patientId: { type: 'string', required: true } };

// epilepsyAedSerumLevel
const epilepsyAedSerumLevel = { patientId: { type: 'string', required: true } };

// epilepsySudepRisk
const epilepsySudepRisk = { patientId: { type: 'string', required: true } };

// fetal_medicineFirstTrimesterScreen
const fetal_medicineFirstTrimesterScreen = { patientId: { type: 'string', required: true } };

// fetal_medicineCfDNAInterpretation
const fetal_medicineCfDNAInterpretation = { patientId: { type: 'string', required: true } };

// fetal_medicineFetalGrowthCentile
const fetal_medicineFetalGrowthCentile = { patientId: { type: 'string', required: true } };

// fetal_medicineUmbilicalDoppler
const fetal_medicineUmbilicalDoppler = { patientId: { type: 'string', required: true } };

// fetal_medicineFetalAnomalyScore
const fetal_medicineFetalAnomalyScore = { patientId: { type: 'string', required: true } };

// geneticsBreastCancerBRCA
const geneticsBreastCancerBRCA = { patientId: { type: 'string', required: true } };

// geneticsLynchSyndromeRisk
const geneticsLynchSyndromeRisk = { patientId: { type: 'string', required: true } };

// geneticsCysticFibrosisCarrier
const geneticsCysticFibrosisCarrier = { patientId: { type: 'string', required: true } };

// geneticsSickleCellCarrier
const geneticsSickleCellCarrier = { patientId: { type: 'string', required: true } };

// geneticsPharmacogenomicCYP
const geneticsPharmacogenomicCYP = { patientId: { type: 'string', required: true } };

// headacheMidasScore
const headacheMidasScore = { patientId: { type: 'string', required: true } };

// headacheHit6Score
const headacheHit6Score = { patientId: { type: 'string', required: true } };

// headacheChronicDailyHeadache
const headacheChronicDailyHeadache = { patientId: { type: 'string', required: true } };

// headacheMedicationOveruse
const headacheMedicationOveruse = { patientId: { type: 'string', required: true } };

// headacheTemporalPattern
const headacheTemporalPattern = { patientId: { type: 'string', required: true } };

// hematologyAnemiaClassification
const hematologyAnemiaClassification = { patientId: { type: 'string', required: true } };

// hematologyCoagulopathyWorkup
const hematologyCoagulopathyWorkup = { patientId: { type: 'string', required: true } };

// hematologyThrombocytopeniaCause
const hematologyThrombocytopeniaCause = { patientId: { type: 'string', required: true } };

// hematologyLeukemiaRiskScore
const hematologyLeukemiaRiskScore = { patientId: { type: 'string', required: true } };

// hematologyLymphomaStaging
const hematologyLymphomaStaging = { patientId: { type: 'string', required: true } };

// icuSofaScore
const icuSofaScore = { patientId: { type: 'string', required: true } };

// icuApacheII
const icuApacheII = { patientId: { type: 'string', required: true } };

// icuSapsII
const icuSapsII = { patientId: { type: 'string', required: true } };

// icuLodsScore
const icuLodsScore = { patientId: { type: 'string', required: true } };

// icuQSOFA
const icuQSOFA = { patientId: { type: 'string', required: true } };

// immunologyAutoimmuneRisk
const immunologyAutoimmuneRisk = { patientId: { type: 'string', required: true } };

// immunologyImmunosuppressionLevel
const immunologyImmunosuppressionLevel = { patientId: { type: 'string', required: true } };

// immunologyVaccineResponsePredict
const immunologyVaccineResponsePredict = { patientId: { type: 'string', required: true } };

// immunologyIgaDeficiency
const immunologyIgaDeficiency = { patientId: { type: 'string', required: true } };

// immunologyComplementDeficiency
const immunologyComplementDeficiency = { patientId: { type: 'string', required: true } };

// infection_controlMrsaRisk
const infection_controlMrsaRisk = { patientId: { type: 'string', required: true } };

// infection_controlCdiffRisk
const infection_controlCdiffRisk = { patientId: { type: 'string', required: true } };

// infection_controlVREColonization
const infection_controlVREColonization = { patientId: { type: 'string', required: true } };

// infection_controlIsolationPrecaution
const infection_controlIsolationPrecaution = { patientId: { type: 'string', required: true } };

// infection_controlOutbreakInvestigation
const infection_controlOutbreakInvestigation = { patientId: { type: 'string', required: true } };

// infectious_diseaseSepsisSeverity
const infectious_diseaseSepsisSeverity = { patientId: { type: 'string', required: true } };

// infectious_diseaseMdrOrganismRisk
const infectious_diseaseMdrOrganismRisk = { patientId: { type: 'string', required: true } };

// infectious_diseaseTbRiskAssessment
const infectious_diseaseTbRiskAssessment = { patientId: { type: 'string', required: true } };

// infectious_diseaseHivStaging
const infectious_diseaseHivStaging = { patientId: { type: 'string', required: true } };

// infectious_diseaseMalariaSeverity
const infectious_diseaseMalariaSeverity = { patientId: { type: 'string', required: true } };

// ivfOvarianReserveAMH
const ivfOvarianReserveAMH = { patientId: { type: 'string', required: true } };

// ivfIvfSuccessProbability
const ivfIvfSuccessProbability = { patientId: { type: 'string', required: true } };

// ivfEndometrialReceptivity
const ivfEndometrialReceptivity = { patientId: { type: 'string', required: true } };

// ivfEmbryoQualityGrade
const ivfEmbryoQualityGrade = { patientId: { type: 'string', required: true } };

// ivfMiscarriageRisk
const ivfMiscarriageRisk = { patientId: { type: 'string', required: true } };

// maternal_fetalPreeclampsiaRisk
const maternal_fetalPreeclampsiaRisk = { patientId: { type: 'string', required: true } };

// maternal_fetalGdmRiskScore
const maternal_fetalGdmRiskScore = { patientId: { type: 'string', required: true } };

// maternal_fetalPretermBirthRisk
const maternal_fetalPretermBirthRisk = { patientId: { type: 'string', required: true } };

// maternal_fetalPlacentaPreviaSeverity
const maternal_fetalPlacentaPreviaSeverity = { patientId: { type: 'string', required: true } };

// maternal_fetalIugrClassification
const maternal_fetalIugrClassification = { patientId: { type: 'string', required: true } };

// memory_clinicMmseScore
const memory_clinicMmseScore = { patientId: { type: 'string', required: true } };

// memory_clinicMoCA
const memory_clinicMoCA = { patientId: { type: 'string', required: true } };

// memory_clinicCdrScore
const memory_clinicCdrScore = { patientId: { type: 'string', required: true } };

// memory_clinicAlzheimerStage
const memory_clinicAlzheimerStage = { patientId: { type: 'string', required: true } };

// memory_clinicVascularDementiaScore
const memory_clinicVascularDementiaScore = { patientId: { type: 'string', required: true } };

// movement_disordersUpdrsScore
const movement_disordersUpdrsScore = { patientId: { type: 'string', required: true } };

// movement_disordersHoehnYahrStage
const movement_disordersHoehnYahrStage = { patientId: { type: 'string', required: true } };

// movement_disordersDyskinesiaRating
const movement_disordersDyskinesiaRating = { patientId: { type: 'string', required: true } };

// movement_disordersTremorSeverity
const movement_disordersTremorSeverity = { patientId: { type: 'string', required: true } };

// movement_disordersResponseToLevodopa
const movement_disordersResponseToLevodopa = { patientId: { type: 'string', required: true } };

// movementTremorAmplitude
const movementTremorAmplitude = { patientId: { type: 'string', required: true } };

// movementBradykinesiaScore
const movementBradykinesiaScore = { patientId: { type: 'string', required: true } };

// movementRigidityRating
const movementRigidityRating = { patientId: { type: 'string', required: true } };

// movementPosturalInstability
const movementPosturalInstability = { patientId: { type: 'string', required: true } };

// movementGaitFreezing
const movementGaitFreezing = { patientId: { type: 'string', required: true } };

// multiple_sclerosisEdssScore
const multiple_sclerosisEdssScore = { patientId: { type: 'string', required: true } };

// multiple_sclerosisMsFunctionalComposite
const multiple_sclerosisMsFunctionalComposite = { patientId: { type: 'string', required: true } };

// multiple_sclerosisRelapseRate
const multiple_sclerosisRelapseRate = { patientId: { type: 'string', required: true } };

// multiple_sclerosisMriLesionCount
const multiple_sclerosisMriLesionCount = { patientId: { type: 'string', required: true } };

// multiple_sclerosisDiseaseProgression
const multiple_sclerosisDiseaseProgression = { patientId: { type: 'string', required: true } };

// neonatologyApgarScore
const neonatologyApgarScore = { patientId: { type: 'string', required: true } };

// neonatologySilvermanScore
const neonatologySilvermanScore = { patientId: { type: 'string', required: true } };

// neonatologyBallardScore
const neonatologyBallardScore = { patientId: { type: 'string', required: true } };

// neonatologyNeonatalSepsisRisk
const neonatologyNeonatalSepsisRisk = { patientId: { type: 'string', required: true } };

// neonatologyBronchopulmonaryDysplasia
const neonatologyBronchopulmonaryDysplasia = { patientId: { type: 'string', required: true } };

// neurosurgeryTbiSeverity
const neurosurgeryTbiSeverity = { patientId: { type: 'string', required: true } };

// neurosurgeryGlioblastomaPrognosis
const neurosurgeryGlioblastomaPrognosis = { patientId: { type: 'string', required: true } };

// neurosurgerySpinalCordInjury
const neurosurgerySpinalCordInjury = { patientId: { type: 'string', required: true } };

// neurosurgeryHydrocephalusSeverity
const neurosurgeryHydrocephalusSeverity = { patientId: { type: 'string', required: true } };

// neurosurgeryIntracranialPressure
const neurosurgeryIntracranialPressure = { patientId: { type: 'string', required: true } };

// neuro_oncologyKpsScore
const neuro_oncologyKpsScore = { patientId: { type: 'string', required: true } };

// neuro_oncologyGlioblastomaMGMT
const neuro_oncologyGlioblastomaMGMT = { patientId: { type: 'string', required: true } };

// neuro_oncologyMetastasisNumber
const neuro_oncologyMetastasisNumber = { patientId: { type: 'string', required: true } };

// neuro_oncologyRecursivePartitioning
const neuro_oncologyRecursivePartitioning = { patientId: { type: 'string', required: true } };

// neuro_oncologyPrognosisEstimate
const neuro_oncologyPrognosisEstimate = { patientId: { type: 'string', required: true } };

// nicuSnappeII
const nicuSnappeII = { patientId: { type: 'string', required: true } };

// nicuNeonatalMortality
const nicuNeonatalMortality = { patientId: { type: 'string', required: true } };

// nicuVentilationDays
const nicuVentilationDays = { patientId: { type: 'string', required: true } };

// nicuNeonatalPainScore
const nicuNeonatalPainScore = { patientId: { type: 'string', required: true } };

// nicuParenteralNutrition
const nicuParenteralNutrition = { patientId: { type: 'string', required: true } };

// nuclear_medicinePetAvidLesion
const nuclear_medicinePetAvidLesion = { patientId: { type: 'string', required: true } };

// nuclear_medicineThyroidUptake
const nuclear_medicineThyroidUptake = { patientId: { type: 'string', required: true } };

// nuclear_medicineBoneScanHotSpot
const nuclear_medicineBoneScanHotSpot = { patientId: { type: 'string', required: true } };

// nuclear_medicineMyocardialPerfusionDefect
const nuclear_medicineMyocardialPerfusionDefect = { patientId: { type: 'string', required: true } };

// nuclear_medicineRenogramPattern
const nuclear_medicineRenogramPattern = { patientId: { type: 'string', required: true } };

// nutritionBmiCategory
const nutritionBmiCategory = { patientId: { type: 'string', required: true } };

// nutritionMalnutritionSGA
const nutritionMalnutritionSGA = { patientId: { type: 'string', required: true } };

// nutritionCaloricRequirement
const nutritionCaloricRequirement = { patientId: { type: 'string', required: true } };

// nutritionProteinRequirement
const nutritionProteinRequirement = { patientId: { type: 'string', required: true } };

// nutritionMicronutrientDeficiency
const nutritionMicronutrientDeficiency = { patientId: { type: 'string', required: true } };

// occupational_therapyAdlScore
const occupational_therapyAdlScore = { patientId: { type: 'string', required: true } };

// occupational_therapyCognitiveAssessment
const occupational_therapyCognitiveAssessment = { patientId: { type: 'string', required: true } };

// occupational_therapySensoryProfile
const occupational_therapySensoryProfile = { patientId: { type: 'string', required: true } };

// occupational_therapyWorkCapacityEval
const occupational_therapyWorkCapacityEval = { patientId: { type: 'string', required: true } };

// occupational_therapyHandFunctionDexterity
const occupational_therapyHandFunctionDexterity = { patientId: { type: 'string', required: true } };

// pain_managementPainLadder
const pain_managementPainLadder = { patientId: { type: 'string', required: true } };

// pain_managementOpioidRiskScore
const pain_managementOpioidRiskScore = { patientId: { type: 'string', required: true } };

// pain_managementNeuropathicPainScore
const pain_managementNeuropathicPainScore = { patientId: { type: 'string', required: true } };

// pain_managementChronicPainImpact
const pain_managementChronicPainImpact = { patientId: { type: 'string', required: true } };

// pain_managementFibromyalgiaScore
const pain_managementFibromyalgiaScore = { patientId: { type: 'string', required: true } };

// palliative_carePpsScore
const palliative_carePpsScore = { patientId: { type: 'string', required: true } };

// palliative_careEcogPerformance
const palliative_careEcogPerformance = { patientId: { type: 'string', required: true } };

// palliative_careSymptomBurden
const palliative_careSymptomBurden = { patientId: { type: 'string', required: true } };

// palliative_carePrognosisEstimate
const palliative_carePrognosisEstimate = { patientId: { type: 'string', required: true } };

// palliative_careSpiritualDistress
const palliative_careSpiritualDistress = { patientId: { type: 'string', required: true } };

// pathologyTumorGrade
const pathologyTumorGrade = { patientId: { type: 'string', required: true } };

// pathologyMarginsStatus
const pathologyMarginsStatus = { patientId: { type: 'string', required: true } };

// pathologyKi67Index
const pathologyKi67Index = { patientId: { type: 'string', required: true } };

// pathologyHer2Status
const pathologyHer2Status = { patientId: { type: 'string', required: true } };

// pathologyLymphNodeInvolvement
const pathologyLymphNodeInvolvement = { patientId: { type: 'string', required: true } };

// physiotherapyRangeOfMotion
const physiotherapyRangeOfMotion = { patientId: { type: 'string', required: true } };

// physiotherapyMuscleStrengthMRC
const physiotherapyMuscleStrengthMRC = { patientId: { type: 'string', required: true } };

// physiotherapyFlexibilityTest
const physiotherapyFlexibilityTest = { patientId: { type: 'string', required: true } };

// physiotherapyEnduranceTest
const physiotherapyEnduranceTest = { patientId: { type: 'string', required: true } };

// physiotherapyPainOnMovement
const physiotherapyPainOnMovement = { patientId: { type: 'string', required: true } };

// picuPelodScore
const picuPelodScore = { patientId: { type: 'string', required: true } };

// picuPrismScore
const picuPrismScore = { patientId: { type: 'string', required: true } };

// picuPediatricSepsis
const picuPediatricSepsis = { patientId: { type: 'string', required: true } };

// picuVasoactiveScore
const picuVasoactiveScore = { patientId: { type: 'string', required: true } };

// picuMechanicalVentilationDays
const picuMechanicalVentilationDays = { patientId: { type: 'string', required: true } };

// plastic_surgeryBurnSeverity
const plastic_surgeryBurnSeverity = { patientId: { type: 'string', required: true } };

// plastic_surgeryReconstructionFlapScore
const plastic_surgeryReconstructionFlapScore = { patientId: { type: 'string', required: true } };

// plastic_surgeryCosmeticRiskScore
const plastic_surgeryCosmeticRiskScore = { patientId: { type: 'string', required: true } };

// plastic_surgeryScarringRisk
const plastic_surgeryScarringRisk = { patientId: { type: 'string', required: true } };

// plastic_surgeryTissueViabilityIndex
const plastic_surgeryTissueViabilityIndex = { patientId: { type: 'string', required: true } };

// psychiatryPhq9Score
const psychiatryPhq9Score = { patientId: { type: 'string', required: true } };

// psychiatryGad7Score
const psychiatryGad7Score = { patientId: { type: 'string', required: true } };

// psychiatryPssScore
const psychiatryPssScore = { patientId: { type: 'string', required: true } };

// psychiatryMmseScore
const psychiatryMmseScore = { patientId: { type: 'string', required: true } };

// psychiatryYBOCS
const psychiatryYBOCS = { patientId: { type: 'string', required: true } };

// pulmonary_rehabSixMinuteWalk
const pulmonary_rehabSixMinuteWalk = { patientId: { type: 'string', required: true } };

// pulmonary_rehabDyspneaScale
const pulmonary_rehabDyspneaScale = { patientId: { type: 'string', required: true } };

// pulmonary_rehabExerciseTolerance
const pulmonary_rehabExerciseTolerance = { patientId: { type: 'string', required: true } };

// pulmonary_rehabQualityOfLifeScore
const pulmonary_rehabQualityOfLifeScore = { patientId: { type: 'string', required: true } };

// pulmonary_rehabProgramCompletion
const pulmonary_rehabProgramCompletion = { patientId: { type: 'string', required: true } };

// radiologyLungRadsCategory
const radiologyLungRadsCategory = { patientId: { type: 'string', required: true } };

// radiologyBiRadsCategory
const radiologyBiRadsCategory = { patientId: { type: 'string', required: true } };

// radiologyTiRadsCategory
const radiologyTiRadsCategory = { patientId: { type: 'string', required: true } };

// radiologyLiRadsCategory
const radiologyLiRadsCategory = { patientId: { type: 'string', required: true } };

// radiologyPiRadsCategory
const radiologyPiRadsCategory = { patientId: { type: 'string', required: true } };

// rehabilitationFunctionalIndependence
const rehabilitationFunctionalIndependence = { patientId: { type: 'string', required: true } };

// rehabilitationBergBalance
const rehabilitationBergBalance = { patientId: { type: 'string', required: true } };

// rehabilitationGaitSpeed
const rehabilitationGaitSpeed = { patientId: { type: 'string', required: true } };

// rehabilitationStrokeRecoveryFuglMeyer
const rehabilitationStrokeRecoveryFuglMeyer = { patientId: { type: 'string', required: true } };

// rehabilitationAmputationKLevel
const rehabilitationAmputationKLevel = { patientId: { type: 'string', required: true } };

// sleep_medicineEpworthSleepiness
const sleep_medicineEpworthSleepiness = { patientId: { type: 'string', required: true } };

// sleep_medicineBerlinQuestionnaire
const sleep_medicineBerlinQuestionnaire = { patientId: { type: 'string', required: true } };

// sleep_medicinePsqiScore
const sleep_medicinePsqiScore = { patientId: { type: 'string', required: true } };

// sleep_medicineStopBangScore
const sleep_medicineStopBangScore = { patientId: { type: 'string', required: true } };

// sleep_medicineInsomniaSeverity
const sleep_medicineInsomniaSeverity = { patientId: { type: 'string', required: true } };

// social_workPsychosocialAssessment
const social_workPsychosocialAssessment = { patientId: { type: 'string', required: true } };

// social_workFinancialAssistanceLevel
const social_workFinancialAssistanceLevel = { patientId: { type: 'string', required: true } };

// social_workFamilySupportIndex
const social_workFamilySupportIndex = { patientId: { type: 'string', required: true } };

// social_workHousingStability
const social_workHousingStability = { patientId: { type: 'string', required: true } };

// social_workCaregiverBurden
const social_workCaregiverBurden = { patientId: { type: 'string', required: true } };

// speech_therapyDysphagiaSeverity
const speech_therapyDysphagiaSeverity = { patientId: { type: 'string', required: true } };

// speech_therapyAphasiaType
const speech_therapyAphasiaType = { patientId: { type: 'string', required: true } };

// speech_therapyApraxiaScore
const speech_therapyApraxiaScore = { patientId: { type: 'string', required: true } };

// speech_therapyDysarthriaSeverity
const speech_therapyDysarthriaSeverity = { patientId: { type: 'string', required: true } };

// speech_therapyVoiceDisorderIndex
const speech_therapyVoiceDisorderIndex = { patientId: { type: 'string', required: true } };

// stroke_unitNihssScore
const stroke_unitNihssScore = { patientId: { type: 'string', required: true } };

// stroke_unitModifiedRankinScale
const stroke_unitModifiedRankinScale = { patientId: { type: 'string', required: true } };

// stroke_unitBarthelIndex
const stroke_unitBarthelIndex = { patientId: { type: 'string', required: true } };

// stroke_unitAshworthSpasticity
const stroke_unitAshworthSpasticity = { patientId: { type: 'string', required: true } };

// stroke_unitStrokeRecoveryStage
const stroke_unitStrokeRecoveryStage = { patientId: { type: 'string', required: true } };

// thoracic_surgeryLungCancerStage
const thoracic_surgeryLungCancerStage = { patientId: { type: 'string', required: true } };

// thoracic_surgeryEsophagusCancerStage
const thoracic_surgeryEsophagusCancerStage = { patientId: { type: 'string', required: true } };

// thoracic_surgeryMediastinalMassRisk
const thoracic_surgeryMediastinalMassRisk = { patientId: { type: 'string', required: true } };

// thoracic_surgerySurgicalRiskPulmonary
const thoracic_surgerySurgicalRiskPulmonary = { patientId: { type: 'string', required: true } };

// thoracic_surgeryCabgRiskScore
const thoracic_surgeryCabgRiskScore = { patientId: { type: 'string', required: true } };

// transplantMeldScore
const transplantMeldScore = { patientId: { type: 'string', required: true } };

// transplantKepaDonorMatch
const transplantKepaDonorMatch = { patientId: { type: 'string', required: true } };

// transplantRejectionRisk
const transplantRejectionRisk = { patientId: { type: 'string', required: true } };

// transplantImmunosuppressionLevel
const transplantImmunosuppressionLevel = { patientId: { type: 'string', required: true } };

// transplantGraftSurvivalProbability
const transplantGraftSurvivalProbability = { patientId: { type: 'string', required: true } };

// trauma_surgeryIssScore
const trauma_surgeryIssScore = { patientId: { type: 'string', required: true } };

// trauma_surgeryTrissProbability
const trauma_surgeryTrissProbability = { patientId: { type: 'string', required: true } };

// trauma_surgeryRtsScore
const trauma_surgeryRtsScore = { patientId: { type: 'string', required: true } };

// trauma_surgeryGcsScore
const trauma_surgeryGcsScore = { patientId: { type: 'string', required: true } };

// trauma_surgeryTraumaActivation
const trauma_surgeryTraumaActivation = { patientId: { type: 'string', required: true } };

// urologyIpssScore
const urologyIpssScore = { patientId: { type: 'string', required: true } };

// urologyPsaRiskScore
const urologyPsaRiskScore = { patientId: { type: 'string', required: true } };

// urologyStoneSizeClassification
const urologyStoneSizeClassification = { patientId: { type: 'string', required: true } };

// urologyUroflowmetryScore
const urologyUroflowmetryScore = { patientId: { type: 'string', required: true } };

// urologyRenalFailureRisk
const urologyRenalFailureRisk = { patientId: { type: 'string', required: true } };

// vascular_surgeryAbIAAneurysmRisk
const vascular_surgeryAbIAAneurysmRisk = { patientId: { type: 'string', required: true } };

// vascular_surgeryCarotidStenosisSeverity
const vascular_surgeryCarotidStenosisSeverity = { patientId: { type: 'string', required: true } };

// vascular_surgeryClaudicationSeverity
const vascular_surgeryClaudicationSeverity = { patientId: { type: 'string', required: true } };

// vascular_surgeryLimbIschemiaStage
const vascular_surgeryLimbIschemiaStage = { patientId: { type: 'string', required: true } };

// vascular_surgeryAaaDiameterRisk
const vascular_surgeryAaaDiameterRisk = { patientId: { type: 'string', required: true } };

// wound_careWagnerUlcerGrade
const wound_careWagnerUlcerGrade = { patientId: { type: 'string', required: true } };

// wound_carePressureUlcerStage
const wound_carePressureUlcerStage = { patientId: { type: 'string', required: true } };

// wound_careWoundHealingPhase
const wound_careWoundHealingPhase = { patientId: { type: 'string', required: true } };

// wound_careDfuClassification
const wound_careDfuClassification = { patientId: { type: 'string', required: true } };

// wound_careBurnSurfaceArea
const wound_careBurnSurfaceArea = { patientId: { type: 'string', required: true } };
