...
const staticChecks = [
    ...
    { pattern: "app.get('/api/icu/patients', requireAuth, requireTenantScope", label: "ICU Patients List: GET /api/icu/patients محمي بـ requireTenantScope" },
    { pattern: "app.post('/api/icu/monitoring', requireAuth, requireTenantScope", label: "ICU Monitoring Insert: POST /api/icu/monitoring محمي بـ requireTenantScope" },
    { pattern: "app.get('/api/icu/monitoring/:admissionId', requireAuth, requireTenantScope", label: "ICU Monitoring Detail: GET /api/icu/monitoring/:admissionId محمي بـ requireTenantScope" },
    { pattern: "app.post('/api/icu/ventilator', requireAuth, requireTenantScope", label: "ICU Ventilator Insert: POST /api/icu/ventilator محمي بـ requireTenantScope" },
    { pattern: "app.get('/api/icu/ventilator/:admissionId', requireAuth, requireTenantScope", label: "ICU Ventilator Detail: GET /api/icu/ventilator/:admissionId محمي بـ requireTenantScope" },
    { pattern: "app.post('/api/icu/scores', requireAuth, requireTenantScope", label: "ICU Scores Insert: POST /api/icu/scores محمي بـ requireTenantScope" },
