# سيناريو التدريب - Executive

## المشهد 1: مقدمة (0:00 - 0:30)
**الصوت (Voiceover):** "مرحباً بكم في دليل استخدام نظام Nama Medical ERP الخاص بقسم Executive. سنتعلم اليوم كيفية إدارة الطلبات الطبية وقراءة النتائج بشكل آمن."
**الشاشة:** عرض لوحة تحكم Executive مع التركيز على الشريط الجانبي.
...
**الشاشة:** تسجيل شاشة تفاعلي يوضح اختيار مريض من القاعدة وإرسال طلب `POST /api/v1/executive/orders`.
