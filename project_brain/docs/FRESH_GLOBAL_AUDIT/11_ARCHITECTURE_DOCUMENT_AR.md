...
توصيف فعلي: Node/Express monolith (server.js 7054 سطر) + SPA (app.js 11469 سطر) + PostgreSQL 16 + Redis + PM2 على صندوق win32 واحد، خلف دومين jumanasoft.com (health 200).
...
- **Nginx/domain**: jumanasoft.com (HTTPS).
