"""
Add 9 new schemas (ped vitals/fluid/croup/pews + surgery asa/risk/timeout/caprini + pharmacy interactions/renal/pregnancy).
"""
...
# Insert only NEW schemas into exports (skip the 3 pre-existing ones)
...
# Only the 9 NEW schemas — exclude pediatricsApgarCreate, pediatricsVitalsCreate, surgeryAsaCreate
...
print("OK - 9 new schemas added (pediatricsFluid, pediatricsCroup, pediatricsPews, surgeryRisk, surgeryTimeout, surgeryCaprini, pharmacyInteractions, pharmacyRenalDose, pharmacyPregnancy)")
