...
const engineSrc = fs.readFileSync(path.join(__dirname, 'internal_medicine_wave1_engine_batch2.js'), 'utf8');
const serverSrc = fs.readFileSync(path.join(__dirname, 'server.js'), 'utf8');

const ROUTES = [
  {
    "path": "/hepatology/liver-failure-alert",
    "fn": "checkLiverFailureAlert"
  },
  {
    "path": "/gastro/pancreatitis-alert",
    "fn": "checkAcutePancreatitisAlert"
  },
  {
    "path": "/transplant/rejection-risk",
    "fn": "checkTransplantRejectionRisk"
  },
  {
    "path": "/heme-onc/chemo-safety-lock",
    "fn": "checkChemoSafetyLock"
  },
  {
    "path": "/heme-onc/hyperleukocytosis",
    "fn": "checkHyperleukocytosisAlert"
  },
  {
    "path": "/heme/transfusion-reversal",
    "fn": "checkTransfusionReversalAlert"
  },
  {
    "path": "/heme-onc/febrile-neutropenia",
    "fn": "checkFebrileNeutropeniaProtocol"
  }
];
...
function runTests() {
    for (const r of ROUTES) {
        assert.ok(
            ...
            'internal_medicine_wave1_engine_batch2.js must export ' + r.fn
        );
    }
    assert.ok(
    ...
    console.log('internal_medicine_wave1_engine_batch2_routes_static_test: all ' + ROUTES.length + ' routes verified');
}
