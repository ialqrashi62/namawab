...
module.exports = function makeConsentFormsRouter({ addVAT, calcVAT, getRequestTenantContext, logAudit, pool, requireAuth, requireRole, requireTenantScope, RS, validateBody }) {
    const router = express.Router();
router.get('/api/consent-forms', requireAuth, requireTenantScope, async (req, res) => {
    try {
...
router.post('/api/consent-forms', requireAuth, requireTenantScope, async (req, res) => {
    try {
...
router.get('/api/consent-forms/:id', requireAuth, requireTenantScope, async (req, res) => {
    try {
        const { tenantId } = getRequestTenantContext(req);
...
router.put('/api/consent-forms/:id/sign', requireAuth, requireTenantScope, async (req, res) => {
    try {
        const { tenantId } = getRequestTenantContext(req);
...
router.get('/api/consent-forms/templates/list', requireAuth, requireTenantScope, async (req, res) => {
    try {
        res.json([
...
router.get('/api/consent-forms/render/:type', requireAuth, requireTenantScope, async (req, res) => {
    try {
        const { tenantId } = getRequestTenantContext(req);
