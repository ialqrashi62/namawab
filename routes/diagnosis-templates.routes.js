...
module.exports = function makeDiagnosisTemplatesRouter({ pool, requireAuth, requireRole, requireTenantScope, validateBody, RS, getRequestTenantContext, calcVAT, addVAT, logAudit }) {
    ...
    try {
        ...
        const templates = {
            ...
            'Cardiology / القلب': [
                ...
                { name: 'Atrial Fibrillation', name_ar: 'رجفان أذيني', icd: 'I48.9', symptoms: 'Irregular palpitations, fatigue, dyspnea, dizziness, irregularly irregular pulse, absent P waves on ECG', treatment: 'Rate control: Bisoprolol/Metoprolol/Diltiazem, CHA2DS2-VASc score, Rivaroxaban/Warfarin if ≥2, cardioversion if acute, echo' },
