#!/usr/bin/env python3
"""P3-AL generator: SQL + routes + integration for audiology, neuropsych, speech_lang."""
import os, textwrap

MODULES = [
    ('audiology', 'audiology_engine', [
        'PureToneAudiometry', 'AsymmetricHearingLoss', 'TinnitusSeverity', 'ABRThreshold',
        'OtoacousticEmissions', 'WordRecognitionScore', 'CochlearImplantCandidate',
        'Hyperacusis', 'VestibularAssessment', 'PresbycusisProgression'
    ]),
    ('neuropsych', 'neuropsych_engine', [
        'MoCAScore', 'MMSEFolstein', 'ACE3Addenbrokes', 'BeckDepressionInventory',
        'HamiltonAnxietyScale', 'TrailMakingTestA', 'TrailMakingTestB',
        'ConfusionAssessmentMethod', 'FABFrontal', 'WAISFSIQEstimate'
    ]),
    ('speech_lang', 'speech_lang_engine', [
        'AphasiaTypeAssessment', 'DysarthriaAssessment', 'DysphagiaFEES', 'StutteringSeverity',
        'VoiceDisorderGRBAS', 'AphasiaSeverityAQ', 'AACNeed', 'ChildLanguageDisorder',
        'DysphagiaOralCareCognitive', 'CognitiveCommunicationDisorder'
    ])
]
...
print('P3-AL generation complete.')
