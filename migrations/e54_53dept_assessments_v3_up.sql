-- filepath: namaweb/migrations/e54_53dept_assessments_v3_up.sql
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER allergy_set_updated_at BEFORE UPDATE ON allergy_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger allergy_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER anesthesia_set_updated_at BEFORE UPDATE ON anesthesia_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger anesthesia_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER audiology_set_updated_at BEFORE UPDATE ON audiology_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger audiology_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER burn_unit_set_updated_at BEFORE UPDATE ON burn_unit_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger burn_unit_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER cardiac_rehab_set_updated_at BEFORE UPDATE ON cardiac_rehab_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger cardiac_rehab_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER ccu_set_updated_at BEFORE UPDATE ON ccu_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger ccu_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER chaplaincy_set_updated_at BEFORE UPDATE ON chaplaincy_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger chaplaincy_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER cicu_set_updated_at BEFORE UPDATE ON cicu_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger cicu_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER ctu_set_updated_at BEFORE UPDATE ON ctu_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger ctu_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER dermatology_set_updated_at BEFORE UPDATE ON dermatology_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger dermatology_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER dialysis_set_updated_at BEFORE UPDATE ON dialysis_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger dialysis_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER epilepsy_set_updated_at BEFORE UPDATE ON epilepsy_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger epilepsy_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER fetal_medicine_set_updated_at BEFORE UPDATE ON fetal_medicine_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger fetal_medicine_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER genetics_set_updated_at BEFORE UPDATE ON genetics_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger genetics_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER headache_set_updated_at BEFORE UPDATE ON headache_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger headache_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER hematology_set_updated_at BEFORE UPDATE ON hematology_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger hematology_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER icu_set_updated_at BEFORE UPDATE ON icu_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger icu_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER immunology_set_updated_at BEFORE UPDATE ON immunology_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger immunology_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER infection_control_set_updated_at BEFORE UPDATE ON infection_control_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger infection_control_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER infectious_disease_set_updated_at BEFORE UPDATE ON infectious_disease_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger infectious_disease_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER ivf_set_updated_at BEFORE UPDATE ON ivf_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger ivf_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER maternal_fetal_set_updated_at BEFORE UPDATE ON maternal_fetal_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger maternal_fetal_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER memory_clinic_set_updated_at BEFORE UPDATE ON memory_clinic_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger memory_clinic_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER movement_disorders_set_updated_at BEFORE UPDATE ON movement_disorders_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger movement_disorders_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER movement_set_updated_at BEFORE UPDATE ON movement_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger movement_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER multiple_sclerosis_set_updated_at BEFORE UPDATE ON multiple_sclerosis_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger multiple_sclerosis_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER neonatology_set_updated_at BEFORE UPDATE ON neonatology_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger neonatology_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER neurosurgery_set_updated_at BEFORE UPDATE ON neurosurgery_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger neurosurgery_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER neuro_oncology_set_updated_at BEFORE UPDATE ON neuro_oncology_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger neuro_oncology_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER nicu_set_updated_at BEFORE UPDATE ON nicu_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger nicu_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER nuclear_medicine_set_updated_at BEFORE UPDATE ON nuclear_medicine_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger nuclear_medicine_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER nutrition_set_updated_at BEFORE UPDATE ON nutrition_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger nutrition_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER occupational_therapy_set_updated_at BEFORE UPDATE ON occupational_therapy_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger occupational_therapy_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER pain_management_set_updated_at BEFORE UPDATE ON pain_management_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger pain_management_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER palliative_care_set_updated_at BEFORE UPDATE ON palliative_care_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger palliative_care_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER pathology_set_updated_at BEFORE UPDATE ON pathology_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger pathology_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER physiotherapy_set_updated_at BEFORE UPDATE ON physiotherapy_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger physiotherapy_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER picu_set_updated_at BEFORE UPDATE ON picu_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger picu_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER plastic_surgery_set_updated_at BEFORE UPDATE ON plastic_surgery_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger plastic_surgery_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER psychiatry_set_updated_at BEFORE UPDATE ON psychiatry_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger psychiatry_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER pulmonary_rehab_set_updated_at BEFORE UPDATE ON pulmonary_rehab_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger pulmonary_rehab_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER radiology_set_updated_at BEFORE UPDATE ON radiology_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger radiology_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER rehabilitation_set_updated_at BEFORE UPDATE ON rehabilitation_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger rehabilitation_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER sleep_medicine_set_updated_at BEFORE UPDATE ON sleep_medicine_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger sleep_medicine_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER social_work_set_updated_at BEFORE UPDATE ON social_work_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger social_work_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER speech_therapy_set_updated_at BEFORE UPDATE ON speech_therapy_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger speech_therapy_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER stroke_unit_set_updated_at BEFORE UPDATE ON stroke_unit_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger stroke_unit_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER thoracic_surgery_set_updated_at BEFORE UPDATE ON thoracic_surgery_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger thoracic_surgery_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER transplant_set_updated_at BEFORE UPDATE ON transplant_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger transplant_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER trauma_surgery_set_updated_at BEFORE UPDATE ON trauma_surgery_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger trauma_surgery_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER urology_set_updated_at BEFORE UPDATE ON urology_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger urology_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER vascular_surgery_set_updated_at BEFORE UPDATE ON vascular_surgery_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger vascular_surgery_set_updated_at already exists, skipping';
    END;
END $$;
...
BEGIN
    BEGIN
        EXECUTE 'CREATE TRIGGER wound_care_set_updated_at BEFORE UPDATE ON wound_care_assessments FOR EACH ROW EXECUTE FUNCTION trg_set_updated_at()';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE 'Trigger wound_care_set_updated_at already exists, skipping';
    END;
END $$;
