...
-- Add Foreign Key constraints for tenant_id and patient_id
...
ALTER TABLE obgyn_pregnancies DROP CONSTRAINT IF EXISTS fk_obgyn_pregnancies_patient;
ALTER TABLE obgyn_pregnancies ADD CONSTRAINT fk_obgyn_pregnancies_patient FOREIGN KEY (patient_id) REFERENCES patients(id) ON DELETE CASCADE;
