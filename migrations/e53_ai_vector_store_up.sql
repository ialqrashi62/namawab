// filepath: namaweb/migrations/e53_ai_vector_store_up.sql
// AI Vector Store + prompt log + cost log
...
-- ============================================================
-- ai_document_chunks — RAG vector store with HNSW
-- ============================================================
...
CREATE INDEX IF NOT EXISTS idx_ai_chunks_kind
    ON ai_document_chunks (tenant_id, doc_kind);

CREATE INDEX IF NOT EXISTS idx_ai_chunks_fts
    ON ai_document_chunks USING gin (to_tsvector('simple', text));
