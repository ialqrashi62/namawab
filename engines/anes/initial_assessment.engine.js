...
/**
 * ANES-001 Initial Assessment Engine
...
class ANESInitialAssessment extends Engine {
  constructor(deps = {}) {
    super(Object.assign({
      redact: new Redactor(),
    ...
    this.id = 'ANES-001:initial_assessment';
    this.version = '1.0.0';
    this.deptId = 'ANES';
  ...
  async run(input, ctx) {
    ...
    if (this.deps.rag) {
      try {
        chunks = await this.deps.rag.retrieve({
          ...
          corpus: ['cba','sfda','nphies','who','anes-guidelines'],
          topK: 8,
          tenantId,
        });
    ...
    const llmReq = {
      promptId: 'PROMPT:ANES-001:initial_assessment',
      vars: {
        dept_name: 'Anesthesiology',
...
module.exports = { ANESInitialAssessment };
