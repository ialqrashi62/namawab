...
/**
 * ONC-001 Initial Assessment Engine
...
class ONCInitialAssessment extends Engine {
  constructor(deps = {}) {
    super(Object.assign({
      redact: new Redactor(),
    ...
    this.id = 'ONC-001:initial_assessment';
    this.version = '1.0.0';
    this.deptId = 'ONC';
  ...
  async run(input, ctx) {
    ...
    if (this.deps.rag) {
      try {
        chunks = await this.deps.rag.retrieve({
          ...
          corpus: ['cba','sfda','nphies','who','onc-guidelines'],
          topK: 8,
          tenantId,
        });
    ...
    const llmReq = {
      promptId: 'PROMPT:ONC-001:initial_assessment',
      vars: {
        dept_name: 'Hematology & Medical Oncology',
...
module.exports = { ONCInitialAssessment };
