...
// AUTO-GEN T2 — cytogenetics/initial_assessment.engine.js
...
class CytogeneticsAssessment extends Engine {
  constructor() {
    super({
      dept: 'cytogenetics',
      redFlags: RED_FLAGS,
  ...
  async run(input, ctx) {
    ...
    const chunks = await this.rag.search(ctx, text || input.condition || 'cytogenetics');

    const promptText = [
      this.registry.compose('SYSTEM_PROMPT_BASE'),
      '\nDepartment: cytogenetics (Tier-2)',
...
module.exports = CytogeneticsAssessment;
