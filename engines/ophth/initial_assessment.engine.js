...
/**
 * OPHTH-001 Initial Assessment Engine
...
class OPHTHInitialAssessment extends Engine {
  constructor(deps = {}) {
    super(Object.assign({
      redact: new Redactor(),
    ...
    this.id = 'OPHTH-001:initial_assessment';
    this.version = '1.0.0';
    this.deptId = 'OPHTH';
  ...
  async run(input, ctx) {
    ...
    if (this.deps.rag) {
      try {
        chunks = await this.deps.rag.retrieve({
          ...
          corpus: ['cba','sfda','nphies','who','ophth-guidelines'],
          topK: 8,
          tenantId,
        });
    ...
    const llmReq = {
      promptId: 'PROMPT:OPHTH-001:initial_assessment',
      vars: {
...
module.exports = { OPHTHInitialAssessment };
