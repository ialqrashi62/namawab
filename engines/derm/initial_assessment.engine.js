...
/**
 * DERM-001 Initial Assessment Engine
...
class DERMInitialAssessment extends Engine {
  constructor(deps = {}) {
    super(Object.assign({
      redact: new Redactor(),
    ...
    this.id = 'DERM-001:initial_assessment';
    this.version = '1.0.0';
    this.deptId = 'DERM';
  ...
  async run(input, ctx) {
    ...
    if (this.deps.rag) {
      try {
        chunks = await this.deps.rag.retrieve({
          ...
          corpus: ['cba','sfda','nphies','who','derm-guidelines'],
          topK: 8,
          tenantId,
        });
    ...
    const llmReq = {
      promptId: 'PROMPT:DERM-001:initial_assessment',
      vars: {
...
module.exports = { DERMInitialAssessment };
