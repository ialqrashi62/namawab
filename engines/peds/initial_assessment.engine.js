...
/**
 * PEDS-001 Initial Assessment Engine
...
class PEDSInitialAssessment extends Engine {
  constructor(deps = {}) {
    super(Object.assign({
      redact: new Redactor(),
    ...
    this.id = 'PEDS-001:initial_assessment';
    this.version = '1.0.0';
    this.deptId = 'PEDS';
  ...
  async run(input, ctx) {
    ...
    if (this.deps.rag) {
      try {
        chunks = await this.deps.rag.retrieve({
          ...
          corpus: ['cba','sfda','nphies','who','peds-guidelines'],
          topK: 8,
          tenantId,
        });
    ...
    const llmReq = {
      promptId: 'PROMPT:PEDS-001:initial_assessment',
      vars: {
...
module.exports = { PEDSInitialAssessment };
