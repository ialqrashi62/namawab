...
/**
 * ORTHO-001 Initial Assessment Engine
...
class ORTHOInitialAssessment extends Engine {
  constructor(deps = {}) {
    super(Object.assign({
      redact: new Redactor(),
    ...
    this.id = 'ORTHO-001:initial_assessment';
    this.version = '1.0.0';
    this.deptId = 'ORTHO';
  ...
  async run(input, ctx) {
    ...
    if (this.deps.rag) {
      try {
        chunks = await this.deps.rag.retrieve({
          ...
          corpus: ['cba','sfda','nphies','who','ortho-guidelines'],
          topK: 8,
          tenantId,
        });
    ...
    const llmReq = {
      promptId: 'PROMPT:ORTHO-001:initial_assessment',
      vars: {
...
module.exports = { ORTHOInitialAssessment };
