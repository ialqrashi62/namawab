...
/**
 * NEURO-001 Initial Assessment Engine
...
class NEUROInitialAssessment extends Engine {
  constructor(deps = {}) {
    super(Object.assign({
      redact: new Redactor(),
    ...
    this.id = 'NEURO-001:initial_assessment';
    this.version = '1.0.0';
    this.deptId = 'NEURO';
  ...
  async run(input, ctx) {
    ...
    if (this.deps.rag) {
      try {
        chunks = await this.deps.rag.retrieve({
          ...
          corpus: ['cba','sfda','nphies','who','neuro-guidelines'],
          topK: 8,
          tenantId,
        });
    ...
    const llmReq = {
      promptId: 'PROMPT:NEURO-001:initial_assessment',
      vars: {
        dept_name: 'Neurology',
...
module.exports = { NEUROInitialAssessment };
