...
/**
 * ICU-001 Initial Assessment Engine
...
class ICUInitialAssessment extends Engine {
  constructor(deps = {}) {
    super(Object.assign({
      redact: new Redactor(),
    ...
    this.id = 'ICU-001:initial_assessment';
    this.version = '1.0.0';
    this.deptId = 'ICU';
  ...
  async run(input, ctx) {
    ...
    if (this.deps.rag) {
      try {
        chunks = await this.deps.rag.retrieve({
          ...
          corpus: ['cba','sfda','nphies','who','icu-guidelines'],
          topK: 8,
          tenantId,
        });
    ...
    const llmReq = {
      promptId: 'PROMPT:ICU-001:initial_assessment',
      vars: {
...
module.exports = { ICUInitialAssessment };
