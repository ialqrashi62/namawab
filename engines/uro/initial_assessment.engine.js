...
/**
 * URO-001 Initial Assessment Engine
...
class UROInitialAssessment extends Engine {
  constructor(deps = {}) {
    super(Object.assign({
      redact: new Redactor(),
    ...
    this.id = 'URO-001:initial_assessment';
    this.version = '1.0.0';
    this.deptId = 'URO';
  ...
  async run(input, ctx) {
    ...
    if (this.deps.rag) {
      try {
        chunks = await this.deps.rag.retrieve({
          ...
          corpus: ['cba','sfda','nphies','who','uro-guidelines'],
          topK: 8,
          tenantId,
        });
    ...
    const llmReq = {
      promptId: 'PROMPT:URO-001:initial_assessment',
      vars: {
        dept_name: 'Urology',
...
module.exports = { UROInitialAssessment };
