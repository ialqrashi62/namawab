...
/**
 * ENDO-001 Initial Assessment Engine
...
class ENDOInitialAssessment extends Engine {
  constructor(deps = {}) {
    super(Object.assign({
      redact: new Redactor(),
    ...
    this.id = 'ENDO-001:initial_assessment';
    this.version = '1.0.0';
    this.deptId = 'ENDO';
  ...
  async run(input, ctx) {
    ...
    if (this.deps.rag) {
      try {
        chunks = await this.deps.rag.retrieve({
          ...
          corpus: ['cba','sfda','nphies','who','endo-guidelines'],
          topK: 8,
          tenantId,
        });
    ...
    const llmReq = {
      promptId: 'PROMPT:ENDO-001:initial_assessment',
      vars: {
...
module.exports = { ENDOInitialAssessment };
