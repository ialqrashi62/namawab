...
/**
 * NEPH-001 Initial Assessment Engine
...
class NEPHInitialAssessment extends Engine {
  constructor(deps = {}) {
    super(Object.assign({
      redact: new Redactor(),
    ...
    this.id = 'NEPH-001:initial_assessment';
    this.version = '1.0.0';
    this.deptId = 'NEPH';
  ...
  async run(input, ctx) {
    ...
    if (this.deps.rag) {
      try {
        chunks = await this.deps.rag.retrieve({
          ...
          corpus: ['cba','sfda','nphies','who','neph-guidelines'],
          topK: 8,
          tenantId,
        });
    ...
    const llmReq = {
      promptId: 'PROMPT:NEPH-001:initial_assessment',
      vars: {
...
module.exports = { NEPHInitialAssessment };
