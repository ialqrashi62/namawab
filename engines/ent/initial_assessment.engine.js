...
/**
 * ENT-001 Initial Assessment Engine
...
class ENTInitialAssessment extends Engine {
  constructor(deps = {}) {
    super(Object.assign({
      redact: new Redactor(),
    ...
    this.id = 'ENT-001:initial_assessment';
    this.version = '1.0.0';
    this.deptId = 'ENT';
  ...
  async run(input, ctx) {
    ...
    if (this.deps.rag) {
      try {
        chunks = await this.deps.rag.retrieve({
          ...
          corpus: ['cba','sfda','nphies','who','ent-guidelines'],
          topK: 8,
          tenantId,
        });
    ...
    const llmReq = {
      promptId: 'PROMPT:ENT-001:initial_assessment',
      vars: {
...
module.exports = { ENTInitialAssessment };
