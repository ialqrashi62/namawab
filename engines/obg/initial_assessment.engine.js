...
/**
 * OBG-001 Initial Assessment Engine
...
class OBGInitialAssessment extends Engine {
  constructor(deps = {}) {
    super(Object.assign({
      redact: new Redactor(),
    ...
    this.id = 'OBG-001:initial_assessment';
    this.version = '1.0.0';
    this.deptId = 'OBG';
  ...
  async run(input, ctx) {
    ...
    if (this.deps.rag) {
      try {
        chunks = await this.deps.rag.retrieve({
          ...
          corpus: ['cba','sfda','nphies','who','obg-guidelines'],
          topK: 8,
          tenantId,
        });
    ...
    const llmReq = {
      promptId: 'PROMPT:OBG-001:initial_assessment',
      vars: {
...
module.exports = { OBGInitialAssessment };
