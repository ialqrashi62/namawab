...
/**
 * RHEUM-001 Initial Assessment Engine
...
class RHEUMInitialAssessment extends Engine {
  constructor(deps = {}) {
    super(Object.assign({
      redact: new Redactor(),
    ...
    this.id = 'RHEUM-001:initial_assessment';
    this.version = '1.0.0';
    this.deptId = 'RHEUM';
  ...
  async run(input, ctx) {
    ...
    if (this.deps.rag) {
      try {
        chunks = await this.deps.rag.retrieve({
          ...
          corpus: ['cba','sfda','nphies','who','rheum-guidelines'],
          topK: 8,
          tenantId,
        });
    ...
    const llmReq = {
      promptId: 'PROMPT:RHEUM-001:initial_assessment',
      vars: {
...
module.exports = { RHEUMInitialAssessment };
