...
/**
 * PSYC-001 Initial Assessment Engine
...
class PSYCInitialAssessment extends Engine {
  constructor(deps = {}) {
    super(Object.assign({
      redact: new Redactor(),
    ...
    this.id = 'PSYC-001:initial_assessment';
    this.version = '1.0.0';
    this.deptId = 'PSYC';
  ...
  async run(input, ctx) {
    ...
    if (this.deps.rag) {
      try {
        chunks = await this.deps.rag.retrieve({
          ...
          corpus: ['cba','sfda','nphies','who','psyc-guidelines'],
          topK: 8,
          tenantId,
        });
    ...
    const llmReq = {
      promptId: 'PROMPT:PSYC-001:initial_assessment',
      vars: {
...
module.exports = { PSYCInitialAssessment };
