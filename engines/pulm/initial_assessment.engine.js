...
/**
 * PULM-001 Initial Assessment Engine
...
class PULMInitialAssessment extends Engine {
  constructor(deps = {}) {
    super(Object.assign({
      redact: new Redactor(),
    ...
    this.id = 'PULM-001:initial_assessment';
    this.version = '1.0.0';
    this.deptId = 'PULM';
  ...
  async run(input, ctx) {
    ...
    if (this.deps.rag) {
      try {
        chunks = await this.deps.rag.retrieve({
          ...
          corpus: ['cba','sfda','nphies','who','pulm-guidelines'],
          topK: 8,
          tenantId,
        });
    ...
    const llmReq = {
      promptId: 'PROMPT:PULM-001:initial_assessment',
      vars: {
...
module.exports = { PULMInitialAssessment };
