...
const out = ssh("pm2 logs nama-medical-erp --lines 200 --nostream --raw 2>&1 | grep -E 'pgx|voice|dr|throw|TypeError' | tail -30");
fs.writeFileSync(path.resolve(__dirname, 'err500.txt'), out);
