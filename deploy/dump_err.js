...
const out = ssh("pm2 logs nama-medical-erp --lines 500 --nostream --raw 2>&1 | grep -E 'engine-registry|Cannot find module|throw|EACCES|EROFS' | head -50");
fs.writeFileSync(path.resolve(__dirname, 'err_dump.txt'), out);
