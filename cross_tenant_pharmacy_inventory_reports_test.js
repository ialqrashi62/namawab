...
const targetedRoutes = [
    ...
    { route: "app.get('/api/inventory/items', requireAuth, requireTenantScope", label: "GET /api/inventory/items (requireTenantScope)" },
    { route: "app.post('/api/inventory/items', requireAuth, requireTenantScope", label: "POST /api/inventory/items (requireTenantScope)" },
