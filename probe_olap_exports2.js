// filepath: probe_olap_exports2.js
const { spawnSync } = require('child_process');
// Heredoc approach: write the inline node script to a temp file on remote, then run it.
const inline = `
...
const r = spawnSync('ssh', [
  ...
  'root@204.168.144.74',
  `bash -lc 'cat > /tmp/probe_olap.js <<'\\''PROBE_EOF'\\''
${inline}
PROBE_EOF
cd /var/www/namaweb && node /tmp/probe_olap.js 2>&1 | head -80'`
]);
