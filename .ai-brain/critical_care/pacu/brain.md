...
## Cognitive Core: Ultra-Specialized Recovery Precision
...
- **Context Window Management:** Current PACU admission + anesthesia record + surgery type + baseline vitals + discharge criteria.
...
- **Stitch Tokens:** `AldreteScorePanel`, `PACUFlowsheet`, `DischargeGate`, `PainNauseaTracker`.
