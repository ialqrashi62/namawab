...
```ts
// namaweb/tests/unit/obg_001/initial_assessment.test.ts
import { OBG_001_Engine } from '../../../engines/obg_001/initial_assessment.engine';

describe('OBG-001 initial assessment engine', () => {
