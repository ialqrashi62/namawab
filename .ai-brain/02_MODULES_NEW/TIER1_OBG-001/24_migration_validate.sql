...
DECLARE
  ...
  v_expected text[] := ARRAY[
    'obg_001_visits', 'obg_001_orders', 'obg_001_results',
    'obg_001_tasks_v2', 'obg_001_ai_assessments'
  ];
BEGIN
  ...
  ELSE
    RAISE NOTICE 'OBG-001 migration validation: PASS';
  END IF;
END $$;
