...
```dbml
Project nama_obg_001 {
  database_type: 'PostgreSQL'
  Note: 'Obstetrics & Gynecology ERD — Tier-1 dept.'
}

Table obg_001_visits {
  id bigserial [pk]
...
Table obg_001_orders {
  id bigserial [pk]
  tenant_id uuid [not null]
  visit_id bigint [ref: > obg_001_visits.id]
  orders jsonb
