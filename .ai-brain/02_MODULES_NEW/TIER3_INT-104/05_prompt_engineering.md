# INT-104 — Prompt Engineering

```yaml
- id: PROMPT:INT-104:main_assessment
  version: 1.0.0
  status: draft
  owner: CMO
  dept: INT-104
  ...
  input_schema_ref: SCHEMA:int_104_input
  output_schema_ref: SCHEMA:int_104_output
  guardrail_set_id: GRD:INT-104:v1
...
Examples tailored to Art Therapy.
