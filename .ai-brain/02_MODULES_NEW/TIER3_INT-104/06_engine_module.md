...
export class int_104_Engine implements Engine<int_104_Input, int_104_Output> {
  ...
  async execute(input: int_104_Input, ctx: ExecutionContext): Promise<int_104_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:INT-104:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('INT-104'), tenantId });
