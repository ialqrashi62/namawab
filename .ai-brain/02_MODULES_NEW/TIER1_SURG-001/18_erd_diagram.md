...
```dbml
Project nama_surg_001 {
  database_type: 'PostgreSQL'
  Note: 'General Surgery ERD — Tier-1 dept.'
}

Table surg_001_visits {
  id bigserial [pk]
...
Table surg_001_orders {
  id bigserial [pk]
  tenant_id uuid [not null]
  visit_id bigint [ref: > surg_001_visits.id]
  orders jsonb
