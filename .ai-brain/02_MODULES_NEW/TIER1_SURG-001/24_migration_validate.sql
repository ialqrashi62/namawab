...
DECLARE
  ...
  v_expected text[] := ARRAY[
    'surg_001_visits', 'surg_001_orders', 'surg_001_results',
    'surg_001_tasks_v2', 'surg_001_ai_assessments'
  ];
BEGIN
  ...
  ELSE
    RAISE NOTICE 'SURG-001 migration validation: PASS';
  END IF;
END $$;
