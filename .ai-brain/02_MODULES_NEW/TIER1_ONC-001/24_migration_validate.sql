...
DECLARE
  ...
  v_expected text[] := ARRAY[
    'onc_001_visits', 'onc_001_orders', 'onc_001_results',
    'onc_001_tasks_v2', 'onc_001_ai_assessments'
  ];
BEGIN
  ...
  ELSE
    RAISE NOTICE 'ONC-001 migration validation: PASS';
  END IF;
END $$;
