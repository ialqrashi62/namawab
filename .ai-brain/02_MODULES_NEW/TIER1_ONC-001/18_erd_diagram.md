...
```dbml
Project nama_onc_001 {
  database_type: 'PostgreSQL'
  Note: 'Hematology & Medical Oncology ERD — Tier-1 dept.'
}

Table onc_001_visits {
  id bigserial [pk]
...
Table onc_001_orders {
  id bigserial [pk]
  tenant_id uuid [not null]
  visit_id bigint [ref: > onc_001_visits.id]
  orders jsonb
