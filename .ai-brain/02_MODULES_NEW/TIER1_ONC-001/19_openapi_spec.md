# ONC-001 — OpenAPI Spec (machine-readable YAML produced for runtime)

```yaml
openapi: 3.1.0
info:
  title: NamaMedical Hematology & Medical Oncology API
  version: 1.0.0
servers:
  - url: https://jumanasoft.com/api/v4/onc_001
security:
  - BearerAuth: []
