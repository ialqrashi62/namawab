...
```dbml
Project nama_endo_001 {
  database_type: 'PostgreSQL'
  Note: 'Endocrinology ERD — Tier-1 dept.'
}

Table endo_001_visits {
  id bigserial [pk]
...
Table endo_001_orders {
  id bigserial [pk]
  tenant_id uuid [not null]
  visit_id bigint [ref: > endo_001_visits.id]
  orders jsonb
