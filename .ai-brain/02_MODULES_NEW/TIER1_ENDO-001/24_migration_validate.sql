...
DECLARE
  ...
  v_expected text[] := ARRAY[
    'endo_001_visits', 'endo_001_orders', 'endo_001_results',
    'endo_001_tasks_v2', 'endo_001_ai_assessments'
  ];
BEGIN
  ...
  ELSE
    RAISE NOTICE 'ENDO-001 migration validation: PASS';
  END IF;
END $$;
