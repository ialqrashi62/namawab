...
export class sup_103_Engine implements Engine<sup_103_Input, sup_103_Output> {
  ...
  async execute(input: sup_103_Input, ctx: ExecutionContext): Promise<sup_103_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:SUP-103:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('SUP-103'), tenantId });
