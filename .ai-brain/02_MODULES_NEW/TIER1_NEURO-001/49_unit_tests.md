# NEURO-001 — Unit Tests

```ts
// namaweb/tests/unit/neuro_001/initial_assessment.test.ts
import { NEURO_001_Engine } from '../../../engines/neuro_001/initial_assessment.engine';

describe('NEURO-001 initial assessment engine', () => {
