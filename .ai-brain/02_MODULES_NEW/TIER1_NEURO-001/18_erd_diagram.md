...
```dbml
Project nama_neuro_001 {
  database_type: 'PostgreSQL'
  Note: 'Neurology ERD — Tier-1 dept.'
}

Table neuro_001_visits {
  id bigserial [pk]
...
Table neuro_001_orders {
  id bigserial [pk]
  tenant_id uuid [not null]
  visit_id bigint [ref: > neuro_001_visits.id]
  orders jsonb
...
Table neuro_001_ai_assessments {
  id bigserial [pk]
  tenant_id uuid [not null]
