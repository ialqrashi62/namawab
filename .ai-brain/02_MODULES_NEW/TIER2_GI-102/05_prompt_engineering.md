# GI-102 — Prompt Engineering

```yaml
- id: PROMPT:GI-102:main_assessment
  version: 1.0.0
  status: draft
  owner: CMO
  dept: GI-102
  ...
  input_schema_ref: SCHEMA:gi_102_input
  output_schema_ref: SCHEMA:gi_102_output
  guardrail_set_id: GRD:GI-102:v1
...
Examples tailored to Hepatology.
