...
export class gi_102_Engine implements Engine<gi_102_Input, gi_102_Output> {
  ...
  async execute(input: gi_102_Input, ctx: ExecutionContext): Promise<gi_102_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:GI-102:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('GI-102'), tenantId });
