# ICU-103 — Prompt Engineering

```yaml
- id: PROMPT:ICU-103:main_assessment
  version: 1.0.0
  status: draft
  owner: CMO
  dept: ICU-103
  ...
  input_schema_ref: SCHEMA:icu_103_input
  output_schema_ref: SCHEMA:icu_103_output
  guardrail_set_id: GRD:ICU-103:v1
...
Examples tailored to Pediatric ICU.
