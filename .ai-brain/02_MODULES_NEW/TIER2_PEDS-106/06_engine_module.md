...
export class peds_106_Engine implements Engine<peds_106_Input, peds_106_Output> {
  ...
  async execute(input: peds_106_Input, ctx: ExecutionContext): Promise<peds_106_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:PEDS-106:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('PEDS-106'), tenantId });
