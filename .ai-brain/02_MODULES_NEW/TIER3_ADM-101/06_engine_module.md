...
export class adm_101_Engine implements Engine<adm_101_Input, adm_101_Output> {
  ...
  async execute(input: adm_101_Input, ctx: ExecutionContext): Promise<adm_101_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:ADM-101:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('ADM-101'), tenantId });
