# ADM-108 — Prompt Engineering

```yaml
- id: PROMPT:ADM-108:main_assessment
  version: 1.0.0
  status: draft
  owner: CMO
  dept: ADM-108
  ...
  input_schema_ref: SCHEMA:adm_108_input
  output_schema_ref: SCHEMA:adm_108_output
  guardrail_set_id: GRD:ADM-108:v1
...
Examples tailored to Marketing & PR.
