...
```yaml
- id: PROMPT:LAB-101:main_assessment
  version: 1.0.0
  status: draft
  owner: CMO
  dept: LAB-101
  ...
  input_schema_ref: SCHEMA:lab_101_input
  output_schema_ref: SCHEMA:lab_101_output
  guardrail_set_id: GRD:LAB-101:v1
...
Examples tailored to Microbiology.
