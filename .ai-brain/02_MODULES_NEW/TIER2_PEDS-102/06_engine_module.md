...
export class peds_102_Engine implements Engine<peds_102_Input, peds_102_Output> {
  ...
  async execute(input: peds_102_Input, ctx: ExecutionContext): Promise<peds_102_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:PEDS-102:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('PEDS-102'), tenantId });
