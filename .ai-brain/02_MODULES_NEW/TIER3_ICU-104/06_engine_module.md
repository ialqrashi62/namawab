...
export class icu_104_Engine implements Engine<icu_104_Input, icu_104_Output> {
  ...
  async execute(input: icu_104_Input, ctx: ExecutionContext): Promise<icu_104_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:ICU-104:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('ICU-104'), tenantId });
