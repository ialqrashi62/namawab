# ICU-104 — Prompt Engineering

```yaml
- id: PROMPT:ICU-104:main_assessment
  version: 1.0.0
  status: draft
  owner: CMO
  dept: ICU-104
  ...
  input_schema_ref: SCHEMA:icu_104_input
  output_schema_ref: SCHEMA:icu_104_output
  guardrail_set_id: GRD:ICU-104:v1
...
Examples tailored to Neonatal ICU.
