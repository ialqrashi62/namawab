...
export class rare_110_Engine implements Engine<rare_110_Input, rare_110_Output> {
  ...
  async execute(input: rare_110_Input, ctx: ExecutionContext): Promise<rare_110_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:RARE-110:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('RARE-110'), tenantId });
