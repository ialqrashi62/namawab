...
export class surg_101_Engine implements Engine<surg_101_Input, surg_101_Output> {
  ...
  async execute(input: surg_101_Input, ctx: ExecutionContext): Promise<surg_101_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:SURG-101:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('SURG-101'), tenantId });
