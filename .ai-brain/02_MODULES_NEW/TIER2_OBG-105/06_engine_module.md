...
export class obg_105_Engine implements Engine<obg_105_Input, obg_105_Output> {
  ...
  async execute(input: obg_105_Input, ctx: ExecutionContext): Promise<obg_105_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:OBG-105:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('OBG-105'), tenantId });
