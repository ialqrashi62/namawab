...
export class rare_107_Engine implements Engine<rare_107_Input, rare_107_Output> {
  ...
  async execute(input: rare_107_Input, ctx: ExecutionContext): Promise<rare_107_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:RARE-107:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('RARE-107'), tenantId });
