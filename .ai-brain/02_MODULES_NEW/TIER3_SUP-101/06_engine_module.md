...
export class sup_101_Engine implements Engine<sup_101_Input, sup_101_Output> {
  ...
  async execute(input: sup_101_Input, ctx: ExecutionContext): Promise<sup_101_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:SUP-101:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('SUP-101'), tenantId });
