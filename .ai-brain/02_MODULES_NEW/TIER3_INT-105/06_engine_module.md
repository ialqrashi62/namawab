...
export class int_105_Engine implements Engine<int_105_Input, int_105_Output> {
  ...
  async execute(input: int_105_Input, ctx: ExecutionContext): Promise<int_105_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:INT-105:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('INT-105'), tenantId });
