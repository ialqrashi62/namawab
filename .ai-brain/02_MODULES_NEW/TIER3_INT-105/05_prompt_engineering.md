# INT-105 — Prompt Engineering

```yaml
- id: PROMPT:INT-105:main_assessment
  version: 1.0.0
  status: draft
  owner: CMO
  dept: INT-105
  ...
  input_schema_ref: SCHEMA:int_105_input
  output_schema_ref: SCHEMA:int_105_output
  guardrail_set_id: GRD:INT-105:v1
...
Examples tailored to Massage Therapy.
