...
export class pulm_102_Engine implements Engine<pulm_102_Input, pulm_102_Output> {
  ...
  async execute(input: pulm_102_Input, ctx: ExecutionContext): Promise<pulm_102_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:PULM-102:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('PULM-102'), tenantId });
