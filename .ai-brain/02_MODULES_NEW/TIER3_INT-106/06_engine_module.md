...
export class int_106_Engine implements Engine<int_106_Input, int_106_Output> {
  ...
  async execute(input: int_106_Input, ctx: ExecutionContext): Promise<int_106_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:INT-106:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('INT-106'), tenantId });
