# INT-106 — Prompt Engineering

```yaml
- id: PROMPT:INT-106:main_assessment
  version: 1.0.0
  status: draft
  owner: CMO
  dept: INT-106
  ...
  input_schema_ref: SCHEMA:int_106_input
  output_schema_ref: SCHEMA:int_106_output
  guardrail_set_id: GRD:INT-106:v1
...
Examples tailored to Pet Therapy.
