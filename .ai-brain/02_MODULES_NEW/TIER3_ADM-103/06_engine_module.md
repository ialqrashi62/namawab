...
export class adm_103_Engine implements Engine<adm_103_Input, adm_103_Output> {
  ...
  async execute(input: adm_103_Input, ctx: ExecutionContext): Promise<adm_103_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:ADM-103:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('ADM-103'), tenantId });
