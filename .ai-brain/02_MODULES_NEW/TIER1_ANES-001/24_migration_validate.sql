...
DECLARE
  ...
  v_expected text[] := ARRAY[
    'anes_001_visits', 'anes_001_orders', 'anes_001_results',
    'anes_001_tasks_v2', 'anes_001_ai_assessments'
  ];
BEGIN
  ...
  ELSE
    RAISE NOTICE 'ANES-001 migration validation: PASS';
  END IF;
END $$;
