...
```dbml
Project nama_anes_001 {
  database_type: 'PostgreSQL'
  Note: 'Anesthesiology ERD — Tier-1 dept.'
}

Table anes_001_visits {
  id bigserial [pk]
...
Table anes_001_orders {
  id bigserial [pk]
  tenant_id uuid [not null]
  visit_id bigint [ref: > anes_001_visits.id]
  orders jsonb
