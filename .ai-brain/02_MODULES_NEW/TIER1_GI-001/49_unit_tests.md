...
```ts
// namaweb/tests/unit/gi_001/initial_assessment.test.ts
import { GI_001_Engine } from '../../../engines/gi_001/initial_assessment.engine';

describe('GI-001 initial assessment engine', () => {
