...
export class adm_104_Engine implements Engine<adm_104_Input, adm_104_Output> {
  ...
  async execute(input: adm_104_Input, ctx: ExecutionContext): Promise<adm_104_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:ADM-104:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('ADM-104'), tenantId });
