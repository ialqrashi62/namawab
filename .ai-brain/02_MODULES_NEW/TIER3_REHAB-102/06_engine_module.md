...
export class rehab_102_Engine implements Engine<rehab_102_Input, rehab_102_Output> {
  ...
  async execute(input: rehab_102_Input, ctx: ExecutionContext): Promise<rehab_102_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:REHAB-102:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('REHAB-102'), tenantId });
