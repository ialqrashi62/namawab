...
export class sup_104_Engine implements Engine<sup_104_Input, sup_104_Output> {
  ...
  async execute(input: sup_104_Input, ctx: ExecutionContext): Promise<sup_104_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:SUP-104:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('SUP-104'), tenantId });
