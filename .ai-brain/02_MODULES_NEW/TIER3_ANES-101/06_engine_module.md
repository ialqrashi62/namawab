...
export class anes_101_Engine implements Engine<anes_101_Input, anes_101_Output> {
  ...
  async execute(input: anes_101_Input, ctx: ExecutionContext): Promise<anes_101_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:ANES-101:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('ANES-101'), tenantId });
