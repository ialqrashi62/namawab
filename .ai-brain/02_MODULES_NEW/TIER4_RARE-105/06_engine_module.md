...
export class rare_105_Engine implements Engine<rare_105_Input, rare_105_Output> {
  ...
  async execute(input: rare_105_Input, ctx: ExecutionContext): Promise<rare_105_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:RARE-105:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('RARE-105'), tenantId });
