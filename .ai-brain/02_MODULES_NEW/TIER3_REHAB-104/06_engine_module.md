...
export class rehab_104_Engine implements Engine<rehab_104_Input, rehab_104_Output> {
  ...
  async execute(input: rehab_104_Input, ctx: ExecutionContext): Promise<rehab_104_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:REHAB-104:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('REHAB-104'), tenantId });
