...
export class card_102_Engine implements Engine<card_102_Input, card_102_Output> {
  ...
  async execute(input: card_102_Input, ctx: ExecutionContext): Promise<card_102_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:CARD-102:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('CARD-102'), tenantId });
