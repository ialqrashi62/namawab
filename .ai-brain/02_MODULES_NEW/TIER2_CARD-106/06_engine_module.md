...
export class card_106_Engine implements Engine<card_106_Input, card_106_Output> {
  ...
  async execute(input: card_106_Input, ctx: ExecutionContext): Promise<card_106_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:CARD-106:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('CARD-106'), tenantId });
