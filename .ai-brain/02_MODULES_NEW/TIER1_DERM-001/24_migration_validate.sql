...
DECLARE
  ...
  v_expected text[] := ARRAY[
    'derm_001_visits', 'derm_001_orders', 'derm_001_results',
    'derm_001_tasks_v2', 'derm_001_ai_assessments'
  ];
BEGIN
  ...
  ELSE
    RAISE NOTICE 'DERM-001 migration validation: PASS';
  END IF;
END $$;
