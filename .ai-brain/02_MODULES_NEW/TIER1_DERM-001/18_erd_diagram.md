...
```dbml
Project nama_derm_001 {
  database_type: 'PostgreSQL'
  Note: 'Dermatology ERD — Tier-1 dept.'
}

Table derm_001_visits {
  id bigserial [pk]
...
Table derm_001_orders {
  id bigserial [pk]
  tenant_id uuid [not null]
  visit_id bigint [ref: > derm_001_visits.id]
  orders jsonb
