# ADM-107 — Prompt Engineering

```yaml
- id: PROMPT:ADM-107:main_assessment
  version: 1.0.0
  status: draft
  owner: CMO
  dept: ADM-107
  ...
  input_schema_ref: SCHEMA:adm_107_input
  output_schema_ref: SCHEMA:adm_107_output
  guardrail_set_id: GRD:ADM-107:v1
...
Examples tailored to Procurement.
