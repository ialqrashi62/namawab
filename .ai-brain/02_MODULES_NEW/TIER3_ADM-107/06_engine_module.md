...
export class adm_107_Engine implements Engine<adm_107_Input, adm_107_Output> {
  ...
  async execute(input: adm_107_Input, ctx: ExecutionContext): Promise<adm_107_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:ADM-107:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('ADM-107'), tenantId });
