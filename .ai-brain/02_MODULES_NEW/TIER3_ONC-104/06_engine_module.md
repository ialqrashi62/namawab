...
export class onc_104_Engine implements Engine<onc_104_Input, onc_104_Output> {
  ...
  async execute(input: onc_104_Input, ctx: ExecutionContext): Promise<onc_104_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:ONC-104:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('ONC-104'), tenantId });
