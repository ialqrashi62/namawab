...
export class peds_103_Engine implements Engine<peds_103_Input, peds_103_Output> {
  ...
  async execute(input: peds_103_Input, ctx: ExecutionContext): Promise<peds_103_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:PEDS-103:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('PEDS-103'), tenantId });
