...
export class rare_102_Engine implements Engine<rare_102_Input, rare_102_Output> {
  ...
  async execute(input: rare_102_Input, ctx: ExecutionContext): Promise<rare_102_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:RARE-102:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('RARE-102'), tenantId });
