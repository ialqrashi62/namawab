...
```dbml
Project nama_peds_001 {
  database_type: 'PostgreSQL'
  Note: 'Pediatrics ERD — Tier-1 dept.'
}

Table peds_001_visits {
  id bigserial [pk]
...
Table peds_001_orders {
  id bigserial [pk]
  tenant_id uuid [not null]
  visit_id bigint [ref: > peds_001_visits.id]
  orders jsonb
