...
DECLARE
  ...
  v_expected text[] := ARRAY[
    'peds_001_visits', 'peds_001_orders', 'peds_001_results',
    'peds_001_tasks_v2', 'peds_001_ai_assessments'
  ];
BEGIN
  ...
  ELSE
    RAISE NOTICE 'PEDS-001 migration validation: PASS';
  END IF;
END $$;
