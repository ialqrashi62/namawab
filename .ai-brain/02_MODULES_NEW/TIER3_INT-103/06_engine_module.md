...
export class int_103_Engine implements Engine<int_103_Input, int_103_Output> {
  ...
  async execute(input: int_103_Input, ctx: ExecutionContext): Promise<int_103_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:INT-103:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('INT-103'), tenantId });
