# INT-103 — Prompt Engineering

```yaml
- id: PROMPT:INT-103:main_assessment
  version: 1.0.0
  status: draft
  owner: CMO
  dept: INT-103
  ...
  input_schema_ref: SCHEMA:int_103_input
  output_schema_ref: SCHEMA:int_103_output
  guardrail_set_id: GRD:INT-103:v1
...
Examples tailored to Music Therapy.
