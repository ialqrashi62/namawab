...
export class card_103_Engine implements Engine<card_103_Input, card_103_Output> {
  ...
  async execute(input: card_103_Input, ctx: ExecutionContext): Promise<card_103_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:CARD-103:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('CARD-103'), tenantId });
