# OBG-103 — Prompt Engineering

```yaml
- id: PROMPT:OBG-103:main_assessment
  version: 1.0.0
  status: draft
  owner: CMO
  dept: OBG-103
  ...
  input_schema_ref: SCHEMA:obg_103_input
  output_schema_ref: SCHEMA:obg_103_output
  guardrail_set_id: GRD:OBG-103:v1
...
Examples tailored to Urogynecology.
