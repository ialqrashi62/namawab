...
DECLARE
  ...
  v_expected text[] := ARRAY[
    'ortho_001_visits', 'ortho_001_orders', 'ortho_001_results',
    'ortho_001_tasks_v2', 'ortho_001_ai_assessments'
  ];
BEGIN
  ...
  ELSE
    RAISE NOTICE 'ORTHO-001 migration validation: PASS';
  END IF;
END $$;
