...
```dbml
Project nama_ortho_001 {
  database_type: 'PostgreSQL'
  Note: 'Orthopedics ERD — Tier-1 dept.'
}

Table ortho_001_visits {
  id bigserial [pk]
...
Table ortho_001_orders {
  id bigserial [pk]
  tenant_id uuid [not null]
  visit_id bigint [ref: > ortho_001_visits.id]
  orders jsonb
...
Table ortho_001_ai_assessments {
  id bigserial [pk]
  tenant_id uuid [not null]
