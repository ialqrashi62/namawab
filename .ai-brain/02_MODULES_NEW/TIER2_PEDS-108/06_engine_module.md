...
export class peds_108_Engine implements Engine<peds_108_Input, peds_108_Output> {
  ...
  async execute(input: peds_108_Input, ctx: ExecutionContext): Promise<peds_108_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:PEDS-108:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('PEDS-108'), tenantId });
