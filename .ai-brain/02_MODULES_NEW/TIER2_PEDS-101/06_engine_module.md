...
export class peds_101_Engine implements Engine<peds_101_Input, peds_101_Output> {
  ...
  async execute(input: peds_101_Input, ctx: ExecutionContext): Promise<peds_101_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:PEDS-101:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('PEDS-101'), tenantId });
