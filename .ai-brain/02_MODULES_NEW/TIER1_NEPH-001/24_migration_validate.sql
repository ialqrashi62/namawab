...
DECLARE
  ...
  v_expected text[] := ARRAY[
    'neph_001_visits', 'neph_001_orders', 'neph_001_results',
    'neph_001_tasks_v2', 'neph_001_ai_assessments'
  ];
BEGIN
  ...
  ELSE
    RAISE NOTICE 'NEPH-001 migration validation: PASS';
  END IF;
END $$;
