...
```dbml
Project nama_neph_001 {
  database_type: 'PostgreSQL'
  Note: 'Nephrology ERD — Tier-1 dept.'
}

Table neph_001_visits {
  id bigserial [pk]
...
Table neph_001_orders {
  id bigserial [pk]
  tenant_id uuid [not null]
  visit_id bigint [ref: > neph_001_visits.id]
  orders jsonb
