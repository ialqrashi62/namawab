...
export class coe_102_Engine implements Engine<coe_102_Input, coe_102_Output> {
  ...
  async execute(input: coe_102_Input, ctx: ExecutionContext): Promise<coe_102_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:COE-102:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('COE-102'), tenantId });
