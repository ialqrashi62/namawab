...
export class rare_104_Engine implements Engine<rare_104_Input, rare_104_Output> {
  ...
  async execute(input: rare_104_Input, ctx: ExecutionContext): Promise<rare_104_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:RARE-104:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('RARE-104'), tenantId });
