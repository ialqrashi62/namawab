...
export class peds_104_Engine implements Engine<peds_104_Input, peds_104_Output> {
  ...
  async execute(input: peds_104_Input, ctx: ExecutionContext): Promise<peds_104_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:PEDS-104:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('PEDS-104'), tenantId });
