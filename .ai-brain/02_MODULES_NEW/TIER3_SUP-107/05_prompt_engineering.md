# SUP-107 — Prompt Engineering

```yaml
- id: PROMPT:SUP-107:main_assessment
  version: 1.0.0
  status: draft
  owner: CMO
  dept: SUP-107
  ...
  input_schema_ref: SCHEMA:sup_107_input
  output_schema_ref: SCHEMA:sup_107_output
  guardrail_set_id: GRD:SUP-107:v1
...
Examples tailored to Safety / Security.
