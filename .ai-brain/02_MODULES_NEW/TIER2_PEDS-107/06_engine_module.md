...
export class peds_107_Engine implements Engine<peds_107_Input, peds_107_Output> {
  ...
  async execute(input: peds_107_Input, ctx: ExecutionContext): Promise<peds_107_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:PEDS-107:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('PEDS-107'), tenantId });
