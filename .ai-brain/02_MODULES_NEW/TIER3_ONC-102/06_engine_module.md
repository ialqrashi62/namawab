...
export class onc_102_Engine implements Engine<onc_102_Input, onc_102_Output> {
  ...
  async execute(input: onc_102_Input, ctx: ExecutionContext): Promise<onc_102_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:ONC-102:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('ONC-102'), tenantId });
