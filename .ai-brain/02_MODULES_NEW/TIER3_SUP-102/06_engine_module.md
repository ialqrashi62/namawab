...
export class sup_102_Engine implements Engine<sup_102_Input, sup_102_Output> {
  ...
  async execute(input: sup_102_Input, ctx: ExecutionContext): Promise<sup_102_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:SUP-102:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('SUP-102'), tenantId });
