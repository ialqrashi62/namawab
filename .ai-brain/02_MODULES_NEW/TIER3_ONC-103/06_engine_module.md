...
export class onc_103_Engine implements Engine<onc_103_Input, onc_103_Output> {
  ...
  async execute(input: onc_103_Input, ctx: ExecutionContext): Promise<onc_103_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:ONC-103:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('ONC-103'), tenantId });
