...
export class lab_102_Engine implements Engine<lab_102_Input, lab_102_Output> {
  ...
  async execute(input: lab_102_Input, ctx: ExecutionContext): Promise<lab_102_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:LAB-102:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('LAB-102'), tenantId });
