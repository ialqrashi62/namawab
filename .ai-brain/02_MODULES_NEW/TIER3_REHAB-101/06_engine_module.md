...
export class rehab_101_Engine implements Engine<rehab_101_Input, rehab_101_Output> {
  ...
  async execute(input: rehab_101_Input, ctx: ExecutionContext): Promise<rehab_101_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:REHAB-101:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('REHAB-101'), tenantId });
