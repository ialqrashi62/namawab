...
export class coe_107_Engine implements Engine<coe_107_Input, coe_107_Output> {
  ...
  async execute(input: coe_107_Input, ctx: ExecutionContext): Promise<coe_107_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:COE-107:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('COE-107'), tenantId });
