...
export class surg_103_Engine implements Engine<surg_103_Input, surg_103_Output> {
  ...
  async execute(input: surg_103_Input, ctx: ExecutionContext): Promise<surg_103_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:SURG-103:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('SURG-103'), tenantId });
