...
export class int_101_Engine implements Engine<int_101_Input, int_101_Output> {
  ...
  async execute(input: int_101_Input, ctx: ExecutionContext): Promise<int_101_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:INT-101:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('INT-101'), tenantId });
