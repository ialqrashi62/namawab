# INT-102 — Prompt Engineering

```yaml
- id: PROMPT:INT-102:main_assessment
  version: 1.0.0
  status: draft
  owner: CMO
  dept: INT-102
  ...
  input_schema_ref: SCHEMA:int_102_input
  output_schema_ref: SCHEMA:int_102_output
  guardrail_set_id: GRD:INT-102:v1
...
Examples tailored to Aromatherapy.
