...
export class coe_108_Engine implements Engine<coe_108_Input, coe_108_Output> {
  ...
  async execute(input: coe_108_Input, ctx: ExecutionContext): Promise<coe_108_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:COE-108:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('COE-108'), tenantId });
