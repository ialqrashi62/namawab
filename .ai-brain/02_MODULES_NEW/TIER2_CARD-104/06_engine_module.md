...
export class card_104_Engine implements Engine<card_104_Input, card_104_Output> {
  ...
  async execute(input: card_104_Input, ctx: ExecutionContext): Promise<card_104_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:CARD-104:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('CARD-104'), tenantId });
