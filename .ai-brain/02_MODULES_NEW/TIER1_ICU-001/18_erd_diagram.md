...
```dbml
Project nama_icu_001 {
  database_type: 'PostgreSQL'
  Note: 'Intensive Care Unit ERD — Tier-1 dept.'
}

Table icu_001_visits {
  id bigserial [pk]
...
Table icu_001_orders {
  id bigserial [pk]
  tenant_id uuid [not null]
  visit_id bigint [ref: > icu_001_visits.id]
  orders jsonb
