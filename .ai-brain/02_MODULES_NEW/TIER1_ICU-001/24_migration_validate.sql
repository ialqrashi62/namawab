...
DECLARE
  ...
  v_expected text[] := ARRAY[
    'icu_001_visits', 'icu_001_orders', 'icu_001_results',
    'icu_001_tasks_v2', 'icu_001_ai_assessments'
  ];
BEGIN
  ...
  ELSE
    RAISE NOTICE 'ICU-001 migration validation: PASS';
  END IF;
END $$;
