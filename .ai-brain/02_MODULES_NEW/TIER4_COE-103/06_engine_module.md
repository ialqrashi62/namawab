...
export class coe_103_Engine implements Engine<coe_103_Input, coe_103_Output> {
  ...
  async execute(input: coe_103_Input, ctx: ExecutionContext): Promise<coe_103_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:COE-103:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('COE-103'), tenantId });
