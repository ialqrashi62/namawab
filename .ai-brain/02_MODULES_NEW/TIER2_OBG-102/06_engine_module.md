...
export class obg_102_Engine implements Engine<obg_102_Input, obg_102_Output> {
  ...
  async execute(input: obg_102_Input, ctx: ExecutionContext): Promise<obg_102_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:OBG-102:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('OBG-102'), tenantId });
