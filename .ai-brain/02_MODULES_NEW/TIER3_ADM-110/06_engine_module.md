...
export class adm_110_Engine implements Engine<adm_110_Input, adm_110_Output> {
  ...
  async execute(input: adm_110_Input, ctx: ExecutionContext): Promise<adm_110_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:ADM-110:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('ADM-110'), tenantId });
