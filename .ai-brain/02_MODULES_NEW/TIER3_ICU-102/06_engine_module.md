...
export class icu_102_Engine implements Engine<icu_102_Input, icu_102_Output> {
  ...
  async execute(input: icu_102_Input, ctx: ExecutionContext): Promise<icu_102_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:ICU-102:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('ICU-102'), tenantId });
