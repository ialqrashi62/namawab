...
export class rad_101_Engine implements Engine<rad_101_Input, rad_101_Output> {
  ...
  async execute(input: rad_101_Input, ctx: ExecutionContext): Promise<rad_101_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:RAD-101:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('RAD-101'), tenantId });
