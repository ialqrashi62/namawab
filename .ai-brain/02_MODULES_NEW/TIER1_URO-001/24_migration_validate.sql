...
DECLARE
  ...
  v_expected text[] := ARRAY[
    'uro_001_visits', 'uro_001_orders', 'uro_001_results',
    'uro_001_tasks_v2', 'uro_001_ai_assessments'
  ];
BEGIN
  ...
  ELSE
    RAISE NOTICE 'URO-001 migration validation: PASS';
  END IF;
END $$;
