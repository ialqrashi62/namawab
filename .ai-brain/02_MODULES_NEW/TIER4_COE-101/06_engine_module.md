...
export class coe_101_Engine implements Engine<coe_101_Input, coe_101_Output> {
  ...
  async execute(input: coe_101_Input, ctx: ExecutionContext): Promise<coe_101_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:COE-101:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('COE-101'), tenantId });
