...
export class anes_102_Engine implements Engine<anes_102_Input, anes_102_Output> {
  ...
  async execute(input: anes_102_Input, ctx: ExecutionContext): Promise<anes_102_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:ANES-102:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('ANES-102'), tenantId });
