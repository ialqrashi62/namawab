...
export class obg_104_Engine implements Engine<obg_104_Input, obg_104_Output> {
  ...
  async execute(input: obg_104_Input, ctx: ExecutionContext): Promise<obg_104_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:OBG-104:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('OBG-104'), tenantId });
