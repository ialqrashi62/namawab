...
export class obg_101_Engine implements Engine<obg_101_Input, obg_101_Output> {
  ...
  async execute(input: obg_101_Input, ctx: ExecutionContext): Promise<obg_101_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:OBG-101:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('OBG-101'), tenantId });
