...
export class rare_101_Engine implements Engine<rare_101_Input, rare_101_Output> {
  ...
  async execute(input: rare_101_Input, ctx: ExecutionContext): Promise<rare_101_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:RARE-101:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('RARE-101'), tenantId });
