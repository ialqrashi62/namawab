...
export class coe_105_Engine implements Engine<coe_105_Input, coe_105_Output> {
  ...
  async execute(input: coe_105_Input, ctx: ExecutionContext): Promise<coe_105_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:COE-105:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('COE-105'), tenantId });
