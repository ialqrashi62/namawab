# COE-105 — Prompt Engineering

```yaml
- id: PROMPT:COE-105:main_assessment
  version: 1.0.0
  status: draft
  owner: CMO
  dept: COE-105
  ...
  input_schema_ref: SCHEMA:coe_105_input
  output_schema_ref: SCHEMA:coe_105_output
  guardrail_set_id: GRD:COE-105:v1
...
Examples tailored to Trauma Center.
