...
```dbml
Project nama_psyc_001 {
  database_type: 'PostgreSQL'
  Note: 'Psychiatry ERD — Tier-1 dept.'
}

Table psyc_001_visits {
  id bigserial [pk]
...
Table psyc_001_orders {
  id bigserial [pk]
  tenant_id uuid [not null]
  visit_id bigint [ref: > psyc_001_visits.id]
  orders jsonb
