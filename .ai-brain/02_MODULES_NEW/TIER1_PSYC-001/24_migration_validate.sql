...
DECLARE
  ...
  v_expected text[] := ARRAY[
    'psyc_001_visits', 'psyc_001_orders', 'psyc_001_results',
    'psyc_001_tasks_v2', 'psyc_001_ai_assessments'
  ];
BEGIN
  ...
  ELSE
    RAISE NOTICE 'PSYC-001 migration validation: PASS';
  END IF;
END $$;
