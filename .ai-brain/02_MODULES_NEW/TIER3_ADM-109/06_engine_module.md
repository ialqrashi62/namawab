...
export class adm_109_Engine implements Engine<adm_109_Input, adm_109_Output> {
  ...
  async execute(input: adm_109_Input, ctx: ExecutionContext): Promise<adm_109_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:ADM-109:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('ADM-109'), tenantId });
