...
DECLARE
  ...
  v_expected text[] := ARRAY[
    'ent_001_visits', 'ent_001_orders', 'ent_001_results',
    'ent_001_tasks_v2', 'ent_001_ai_assessments'
  ];
BEGIN
  ...
  ELSE
    RAISE NOTICE 'ENT-001 migration validation: PASS';
  END IF;
END $$;
