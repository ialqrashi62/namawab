...
```dbml
Project nama_ent_001 {
  database_type: 'PostgreSQL'
  Note: 'Otolaryngology ERD — Tier-1 dept.'
}

Table ent_001_visits {
  id bigserial [pk]
...
Table ent_001_orders {
  id bigserial [pk]
  tenant_id uuid [not null]
  visit_id bigint [ref: > ent_001_visits.id]
  orders jsonb
