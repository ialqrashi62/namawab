# ICU-101 — Prompt Engineering

```yaml
- id: PROMPT:ICU-101:main_assessment
  version: 1.0.0
  status: draft
  owner: CMO
  dept: ICU-101
  ...
  input_schema_ref: SCHEMA:icu_101_input
  output_schema_ref: SCHEMA:icu_101_output
  guardrail_set_id: GRD:ICU-101:v1
...
Examples tailored to Cardiac ICU.
