...
export class icu_101_Engine implements Engine<icu_101_Input, icu_101_Output> {
  ...
  async execute(input: icu_101_Input, ctx: ExecutionContext): Promise<icu_101_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:ICU-101:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('ICU-101'), tenantId });
