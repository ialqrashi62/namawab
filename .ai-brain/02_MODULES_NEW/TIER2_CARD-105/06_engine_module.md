...
export class card_105_Engine implements Engine<card_105_Input, card_105_Output> {
  ...
  async execute(input: card_105_Input, ctx: ExecutionContext): Promise<card_105_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:CARD-105:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('CARD-105'), tenantId });
