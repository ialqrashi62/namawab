...
DECLARE
  ...
  v_expected text[] := ARRAY[
    'ophth_001_visits', 'ophth_001_orders', 'ophth_001_results',
    'ophth_001_tasks_v2', 'ophth_001_ai_assessments'
  ];
BEGIN
  ...
  ELSE
    RAISE NOTICE 'OPHTH-001 migration validation: PASS';
  END IF;
END $$;
