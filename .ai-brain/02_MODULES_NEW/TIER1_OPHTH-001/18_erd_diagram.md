...
```dbml
Project nama_ophth_001 {
  database_type: 'PostgreSQL'
  Note: 'Ophthalmology ERD — Tier-1 dept.'
}

Table ophth_001_visits {
  id bigserial [pk]
...
Table ophth_001_orders {
  id bigserial [pk]
  tenant_id uuid [not null]
  visit_id bigint [ref: > ophth_001_visits.id]
  orders jsonb
...
Table ophth_001_ai_assessments {
  id bigserial [pk]
  tenant_id uuid [not null]
