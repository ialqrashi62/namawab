# OPHTH-001 — Unit Tests

```ts
// namaweb/tests/unit/ophth_001/initial_assessment.test.ts
import { OPHTH_001_Engine } from '../../../engines/ophth_001/initial_assessment.engine';

describe('OPHTH-001 initial assessment engine', () => {
