...
export class neuro_102_Engine implements Engine<neuro_102_Input, neuro_102_Output> {
  ...
  async execute(input: neuro_102_Input, ctx: ExecutionContext): Promise<neuro_102_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:NEURO-102:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('NEURO-102'), tenantId });
