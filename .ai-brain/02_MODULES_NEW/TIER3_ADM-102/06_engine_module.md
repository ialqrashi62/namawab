...
export class adm_102_Engine implements Engine<adm_102_Input, adm_102_Output> {
  ...
  async execute(input: adm_102_Input, ctx: ExecutionContext): Promise<adm_102_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:ADM-102:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('ADM-102'), tenantId });
