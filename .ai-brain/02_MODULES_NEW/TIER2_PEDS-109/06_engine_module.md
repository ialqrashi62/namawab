...
export class peds_109_Engine implements Engine<peds_109_Input, peds_109_Output> {
  ...
  async execute(input: peds_109_Input, ctx: ExecutionContext): Promise<peds_109_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:PEDS-109:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('PEDS-109'), tenantId });
