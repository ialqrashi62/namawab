...
```dbml
Project nama_rheum_001 {
  database_type: 'PostgreSQL'
  Note: 'Rheumatology ERD — Tier-1 dept.'
}

Table rheum_001_visits {
  id bigserial [pk]
...
Table rheum_001_orders {
  id bigserial [pk]
  tenant_id uuid [not null]
  visit_id bigint [ref: > rheum_001_visits.id]
  orders jsonb
...
Table rheum_001_ai_assessments {
  id bigserial [pk]
  tenant_id uuid [not null]
