...
DECLARE
  ...
  v_expected text[] := ARRAY[
    'rheum_001_visits', 'rheum_001_orders', 'rheum_001_results',
    'rheum_001_tasks_v2', 'rheum_001_ai_assessments'
  ];
BEGIN
  ...
  ELSE
    RAISE NOTICE 'RHEUM-001 migration validation: PASS';
  END IF;
END $$;
