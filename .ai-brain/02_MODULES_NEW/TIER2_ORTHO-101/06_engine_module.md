...
export class ortho_101_Engine implements Engine<ortho_101_Input, ortho_101_Output> {
  ...
  async execute(input: ortho_101_Input, ctx: ExecutionContext): Promise<ortho_101_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:ORTHO-101:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('ORTHO-101'), tenantId });
