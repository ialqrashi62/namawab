...
export class peds_110_Engine implements Engine<peds_110_Input, peds_110_Output> {
  ...
  async execute(input: peds_110_Input, ctx: ExecutionContext): Promise<peds_110_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:PEDS-110:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('PEDS-110'), tenantId });
