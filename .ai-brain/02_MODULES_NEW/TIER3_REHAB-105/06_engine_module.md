...
export class rehab_105_Engine implements Engine<rehab_105_Input, rehab_105_Output> {
  ...
  async execute(input: rehab_105_Input, ctx: ExecutionContext): Promise<rehab_105_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:REHAB-105:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('REHAB-105'), tenantId });
