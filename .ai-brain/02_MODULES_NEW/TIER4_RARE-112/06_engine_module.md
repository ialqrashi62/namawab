...
export class rare_112_Engine implements Engine<rare_112_Input, rare_112_Output> {
  ...
  async execute(input: rare_112_Input, ctx: ExecutionContext): Promise<rare_112_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:RARE-112:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('RARE-112'), tenantId });
