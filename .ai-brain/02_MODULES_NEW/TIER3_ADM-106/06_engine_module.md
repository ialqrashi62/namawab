...
export class adm_106_Engine implements Engine<adm_106_Input, adm_106_Output> {
  ...
  async execute(input: adm_106_Input, ctx: ExecutionContext): Promise<adm_106_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:ADM-106:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('ADM-106'), tenantId });
