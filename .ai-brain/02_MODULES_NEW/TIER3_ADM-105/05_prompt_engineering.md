# ADM-105 — Prompt Engineering

```yaml
- id: PROMPT:ADM-105:main_assessment
  version: 1.0.0
  status: draft
  owner: CMO
  dept: ADM-105
  ...
  input_schema_ref: SCHEMA:adm_105_input
  output_schema_ref: SCHEMA:adm_105_output
  guardrail_set_id: GRD:ADM-105:v1
...
Examples tailored to Human Resources.
