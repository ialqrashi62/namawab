...
export class sup_108_Engine implements Engine<sup_108_Input, sup_108_Output> {
  ...
  async execute(input: sup_108_Input, ctx: ExecutionContext): Promise<sup_108_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:SUP-108:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('SUP-108'), tenantId });
