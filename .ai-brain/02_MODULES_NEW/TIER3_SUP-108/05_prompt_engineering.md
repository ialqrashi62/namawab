# SUP-108 — Prompt Engineering

```yaml
- id: PROMPT:SUP-108:main_assessment
  version: 1.0.0
  status: draft
  owner: CMO
  dept: SUP-108
  ...
  input_schema_ref: SCHEMA:sup_108_input
  output_schema_ref: SCHEMA:sup_108_output
  guardrail_set_id: GRD:SUP-108:v1
...
Examples tailored to Housekeeping.
