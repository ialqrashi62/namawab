...
export class coe_104_Engine implements Engine<coe_104_Input, coe_104_Output> {
  ...
  async execute(input: coe_104_Input, ctx: ExecutionContext): Promise<coe_104_Output> {
    ...
    const llm = await this.langchain.build('PROMPT:COE-104:main_assessment', { input, ctxBundle, chunks, redFlags, availableCalcs: this.calc.listForDept('COE-104'), tenantId });
