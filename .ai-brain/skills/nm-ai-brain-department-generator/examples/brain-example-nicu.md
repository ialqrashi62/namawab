...
- **Context Window Management:** Current neonate + maternal history + delivery record + APGAR + prior NICU events.
...
- **Stitch Tokens:** `NICUBedsideMonitor`, `APGARPanel`, `GrowthChart`, `MotherBabyLink`.
...
- **Sample Data:** Seed NICU admissions, APGAR scores, growth logs.
