# DevOps Runbook — Geri-001 (GERI-001)
...
### Geri-001-specific runbook

- How to restart just the Geri-001 engine: `pm2 restart nama-medical-erp --name=geri_001`
- How to scale Geri-001: edit `pm2.config.js` → `geri_001: instances=4`
- How to clear Geri-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Geri-001 audit log: `node scripts/replay_audit.js --dept=GERI-001`
