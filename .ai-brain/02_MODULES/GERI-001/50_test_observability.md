# Test Observability — Geri-001 (GERI-001)
...
- Overall: > 80%
- Geri-001 engine: > 90%
- Geri-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
geri_001.<area>.<action>.<expectation>

e.g.
geri_001.create.valid_returns_201
geri_001.create.invalid_returns_400
geri_001.create.cross_tenant_returns_403
geri_001.update.locked_returns_409
```
