# User Analytics — Geri-001 (GERI-001)
...
| Event | Properties |
|---|---|
| `geri_001_create` | tenant_id, user_id, patient_id_hash |
| `geri_001_view` | tenant_id, user_id, duration_ms |
| `geri_001_update` | tenant_id, user_id, fields_changed |
| `geri_001_delete` | tenant_id, user_id, reason |
| `geri_001_print` | tenant_id, user_id, format |
| `geri_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Geri-001 primary workflow
- step 1: open Geri-001 page
