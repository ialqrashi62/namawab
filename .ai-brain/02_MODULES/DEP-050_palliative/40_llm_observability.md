# LLM Observability — Palliative (DEP-050)
**Last updated:** 2026-08-10

## LLM usage for Palliative

### Orchestrators

| Orchestrator | Model | Calls/day | Cost/day |
|---|---|---|---|
| Palliative AI orchestrator | gpt-4o | ? | ? |
| Palliative summary | gpt-4o-mini | ? | ? |
| Palliative RAG | gpt-4o | ? | ? |
