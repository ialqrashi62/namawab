# Test Observability — Palliative (DEP-050)
**Last updated:** 2026-08-10

## Tests for Palliative
...
- Overall: > 80%
- Palliative engine: > 90%
- Palliative critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_050.<area>.<action>.<expectation>

e.g.
dep_050.create.valid_returns_201
dep_050.create.invalid_returns_400
dep_050.create.cross_tenant_returns_403
dep_050.update.locked_returns_409
```
