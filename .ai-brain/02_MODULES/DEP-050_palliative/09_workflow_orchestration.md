# Workflow Orchestration — Palliative_Care (DEP-050)

## BPMN State Machine
```yaml
workflow:
  id: palliative_patient_flow
...
|---|---|
| triage | nurse |
| assessment | palliative_specialist |
| plan | palliative_specialist |
| intervention | palliative_specialist + nurse |
| discharge | palliative_specialist |
| followup | scheduler + palliative_specialist |