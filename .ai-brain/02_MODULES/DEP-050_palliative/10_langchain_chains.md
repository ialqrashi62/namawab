# LangChain Chains — Palliative_Care (DEP-050)
...
PROMPT = PromptTemplate(
  ...
  template="""أنت خبير في الرعاية التلطيفية. أجب بالعربية. اعتمد فقط على السياق.
السياق: {context}
السؤال: {question}
الإجابة:"""
)
...
## Tools
- palliative_guidelines_search
- palliative_drug_search
- icd10_search
- snomed_search