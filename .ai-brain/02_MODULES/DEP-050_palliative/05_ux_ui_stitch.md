# UX/UI Stitch Design — Palliative_Care (DEP-050)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الرعاية التلطيفية | Palliative_Care] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/palliative` — main (2-col)
2. `/station/palliative/orders` — full-width list
3. `/station/palliative/results` — 2-col with chart
4. `/station/palliative/notes` — editor + sign
