// filepath: 02_MODULES/DEP-050/23_frontend_components.tsx
// Stitch components for Palliative_Care (DEP-050)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.PalliativeAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('palliative');
