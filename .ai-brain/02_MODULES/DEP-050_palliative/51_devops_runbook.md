# DevOps Runbook — Palliative (DEP-050)
...
### Palliative-specific runbook

- How to restart just the Palliative engine: `pm2 restart nama-medical-erp --name=dep_050`
- How to scale Palliative: edit `pm2.config.js` → `dep_050: instances=4`
- How to clear Palliative cache: `redis-cli -n 1 FLUSHDB`
- How to replay Palliative audit log: `node scripts/replay_audit.js --dept=DEP-050`
