# LangChain Chains — Transplant_Surgery (DEP-020)
...
PROMPT = PromptTemplate(
  ...
  template="""أنت خبير في جراحة الزرع. أجب بالعربية. اعتمد فقط على السياق.
السياق: {context}
السؤال: {question}
الإجابة:"""
)
...
## Tools
- transplant_guidelines_search
- transplant_drug_search
- icd10_search
- snomed_search