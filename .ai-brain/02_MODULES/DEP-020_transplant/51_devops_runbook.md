# DevOps Runbook — Transplant (DEP-020)
...
### Transplant-specific runbook

- How to restart just the Transplant engine: `pm2 restart nama-medical-erp --name=dep_020`
- How to scale Transplant: edit `pm2.config.js` → `dep_020: instances=4`
- How to clear Transplant cache: `redis-cli -n 1 FLUSHDB`
- How to replay Transplant audit log: `node scripts/replay_audit.js --dept=DEP-020`
