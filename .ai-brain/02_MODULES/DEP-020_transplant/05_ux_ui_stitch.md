# UX/UI Stitch Design — Transplant_Surgery (DEP-020)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: جراحة الزرع | Transplant_Surgery] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/transplant` — main (2-col)
2. `/station/transplant/orders` — full-width list
3. `/station/transplant/results` — 2-col with chart
4. `/station/transplant/notes` — editor + sign
