# Test Observability — Transplant (DEP-020)
...
- Overall: > 80%
- Transplant engine: > 90%
- Transplant critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_020.<area>.<action>.<expectation>

e.g.
dep_020.create.valid_returns_201
dep_020.create.invalid_returns_400
dep_020.create.cross_tenant_returns_403
dep_020.update.locked_returns_409
```
