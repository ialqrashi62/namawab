# Workflow Orchestration — Transplant_Surgery (DEP-020)

## BPMN State Machine
```yaml
workflow:
  id: transplant_patient_flow
...
|---|---|
| triage | nurse |
| assessment | transplant_specialist |
| plan | transplant_specialist |
| intervention | transplant_specialist + nurse |
| discharge | transplant_specialist |
| followup | scheduler + transplant_specialist |