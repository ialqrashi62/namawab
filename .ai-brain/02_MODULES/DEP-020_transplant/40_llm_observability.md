# LLM Observability — Transplant (DEP-020)
**Last updated:** 2026-08-10

## LLM usage for Transplant

### Orchestrators

| Orchestrator | Model | Calls/day | Cost/day |
|---|---|---|---|
| Transplant AI orchestrator | gpt-4o | ? | ? |
| Transplant summary | gpt-4o-mini | ? | ? |
| Transplant RAG | gpt-4o | ? | ? |
