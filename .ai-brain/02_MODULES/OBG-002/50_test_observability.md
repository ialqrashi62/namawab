# Test Observability — Obg-002 (OBG-002)
...
- Overall: > 80%
- Obg-002 engine: > 90%
- Obg-002 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
obg_002.<area>.<action>.<expectation>

e.g.
obg_002.create.valid_returns_201
obg_002.create.invalid_returns_400
obg_002.create.cross_tenant_returns_403
obg_002.update.locked_returns_409
```
