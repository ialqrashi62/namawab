# DevOps Runbook — Obg-002 (OBG-002)
...
### Obg-002-specific runbook

- How to restart just the Obg-002 engine: `pm2 restart nama-medical-erp --name=obg_002`
- How to scale Obg-002: edit `pm2.config.js` → `obg_002: instances=4`
- How to clear Obg-002 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Obg-002 audit log: `node scripts/replay_audit.js --dept=OBG-002`
