# User Analytics — Obg-002 (OBG-002)
...
| Event | Properties |
|---|---|
| `obg_002_create` | tenant_id, user_id, patient_id_hash |
| `obg_002_view` | tenant_id, user_id, duration_ms |
| `obg_002_update` | tenant_id, user_id, fields_changed |
| `obg_002_delete` | tenant_id, user_id, reason |
| `obg_002_print` | tenant_id, user_id, format |
| `obg_002_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Obg-002 primary workflow
- step 1: open Obg-002 page
