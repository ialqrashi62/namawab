# UX/UI Stitch Design — Urogynecology (DEP-038)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: النسائية البولية | Urogynecology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/urogyn` — main (2-col)
2. `/station/urogyn/orders` — full-width list
3. `/station/urogyn/results` — 2-col with chart
4. `/station/urogyn/notes` — editor + sign
