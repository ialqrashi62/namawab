...
| Event | Properties |
|---|---|
| `dep_038_create` | tenant_id, user_id, patient_id_hash |
| `dep_038_view` | tenant_id, user_id, duration_ms |
| `dep_038_update` | tenant_id, user_id, fields_changed |
| `dep_038_delete` | tenant_id, user_id, reason |
| `dep_038_print` | tenant_id, user_id, format |
| `dep_038_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Urogyn primary workflow
- step 1: open Urogyn page
