# Test Observability — Urogyn (DEP-038)
...
- Overall: > 80%
- Urogyn engine: > 90%
- Urogyn critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_038.<area>.<action>.<expectation>

e.g.
dep_038.create.valid_returns_201
dep_038.create.invalid_returns_400
dep_038.create.cross_tenant_returns_403
dep_038.update.locked_returns_409
```
