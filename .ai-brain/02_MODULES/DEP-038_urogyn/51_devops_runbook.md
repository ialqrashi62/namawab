...
### Urogyn-specific runbook

- How to restart just the Urogyn engine: `pm2 restart nama-medical-erp --name=dep_038`
- How to scale Urogyn: edit `pm2.config.js` → `dep_038: instances=4`
- How to clear Urogyn cache: `redis-cli -n 1 FLUSHDB`
- How to replay Urogyn audit log: `node scripts/replay_audit.js --dept=DEP-038`
