# Workflow Orchestration — Urogynecology (DEP-038)

## BPMN State Machine
```yaml
workflow:
  id: urogyn_patient_flow
...
|---|---|
| triage | nurse |
| assessment | urogyn_specialist |
| plan | urogyn_specialist |
| intervention | urogyn_specialist + nurse |
| discharge | urogyn_specialist |
| followup | scheduler + urogyn_specialist |