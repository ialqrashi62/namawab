# DevOps Runbook — Sleep-001 (SLEEP-001)
...
### Sleep-001-specific runbook

- How to restart just the Sleep-001 engine: `pm2 restart nama-medical-erp --name=sleep_001`
- How to scale Sleep-001: edit `pm2.config.js` → `sleep_001: instances=4`
- How to clear Sleep-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Sleep-001 audit log: `node scripts/replay_audit.js --dept=SLEEP-001`
