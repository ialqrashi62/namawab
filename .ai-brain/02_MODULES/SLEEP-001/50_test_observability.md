# Test Observability — Sleep-001 (SLEEP-001)
...
- Overall: > 80%
- Sleep-001 engine: > 90%
- Sleep-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
sleep_001.<area>.<action>.<expectation>

e.g.
sleep_001.create.valid_returns_201
sleep_001.create.invalid_returns_400
sleep_001.create.cross_tenant_returns_403
sleep_001.update.locked_returns_409
```
