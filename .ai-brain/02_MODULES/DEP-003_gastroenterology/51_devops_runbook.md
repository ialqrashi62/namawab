# DevOps Runbook — Gastroenterology (DEP-003)
...
### Gastroenterology-specific runbook

- How to restart just the Gastroenterology engine: `pm2 restart nama-medical-erp --name=dep_003`
- How to scale Gastroenterology: edit `pm2.config.js` → `dep_003: instances=4`
- How to clear Gastroenterology cache: `redis-cli -n 1 FLUSHDB`
- How to replay Gastroenterology audit log: `node scripts/replay_audit.js --dept=DEP-003`
