// filepath: 02_MODULES/DEP-003/23_frontend_components.tsx
// Stitch components for Gastroenterology (DEP-003)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.GastroenterologyAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('gastroenterology');
