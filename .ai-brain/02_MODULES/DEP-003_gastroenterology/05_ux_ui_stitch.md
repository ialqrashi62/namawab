# UX/UI Stitch Design — Gastroenterology (DEP-003)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الجهاز الهضمي | Gastroenterology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/gastroenterology` — main (2-col)
2. `/station/gastroenterology/orders` — full-width list
3. `/station/gastroenterology/results` — 2-col with chart
4. `/station/gastroenterology/notes` — editor + sign
