# Test Observability — Gastroenterology (DEP-003)
**Last updated:** 2026-08-10

## Tests for Gastroenterology
...
- Overall: > 80%
- Gastroenterology engine: > 90%
- Gastroenterology critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_003.<area>.<action>.<expectation>

e.g.
dep_003.create.valid_returns_201
dep_003.create.invalid_returns_400
dep_003.create.cross_tenant_returns_403
dep_003.update.locked_returns_409
```
