# LLM Observability — Gastroenterology (DEP-003)
**Last updated:** 2026-08-10

## LLM usage for Gastroenterology

### Orchestrators

| Orchestrator | Model | Calls/day | Cost/day |
|---|---|---|---|
| Gastroenterology AI orchestrator | gpt-4o | ? | ? |
| Gastroenterology summary | gpt-4o-mini | ? | ? |
| Gastroenterology RAG | gpt-4o | ? | ? |
