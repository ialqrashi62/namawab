# Test Observability — Card-001 (CARD-001)
...
- Overall: > 80%
- Card-001 engine: > 90%
- Card-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
card_001.<area>.<action>.<expectation>

e.g.
card_001.create.valid_returns_201
card_001.create.invalid_returns_400
card_001.create.cross_tenant_returns_403
card_001.update.locked_returns_409
```
