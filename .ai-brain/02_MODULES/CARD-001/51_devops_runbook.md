# DevOps Runbook — Card-001 (CARD-001)
...
### Card-001-specific runbook

- How to restart just the Card-001 engine: `pm2 restart nama-medical-erp --name=card_001`
- How to scale Card-001: edit `pm2.config.js` → `card_001: instances=4`
- How to clear Card-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Card-001 audit log: `node scripts/replay_audit.js --dept=CARD-001`
