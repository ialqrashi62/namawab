# User Analytics — Card-001 (CARD-001)
...
| Event | Properties |
|---|---|
| `card_001_create` | tenant_id, user_id, patient_id_hash |
| `card_001_view` | tenant_id, user_id, duration_ms |
| `card_001_update` | tenant_id, user_id, fields_changed |
| `card_001_delete` | tenant_id, user_id, reason |
| `card_001_print` | tenant_id, user_id, format |
| `card_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Card-001 primary workflow
- step 1: open Card-001 page
