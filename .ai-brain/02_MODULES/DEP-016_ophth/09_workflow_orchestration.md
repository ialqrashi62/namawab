# Workflow Orchestration — Ophthalmology (DEP-016)

## BPMN State Machine
```yaml
workflow:
  id: ophth_patient_flow
...
|---|---|
| triage | nurse |
| assessment | ophth_specialist |
| plan | ophth_specialist |
| intervention | ophth_specialist + nurse |
| discharge | ophth_specialist |
| followup | scheduler + ophth_specialist |