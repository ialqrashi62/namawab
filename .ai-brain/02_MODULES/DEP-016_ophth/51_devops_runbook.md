...
### Ophth-specific runbook

- How to restart just the Ophth engine: `pm2 restart nama-medical-erp --name=dep_016`
- How to scale Ophth: edit `pm2.config.js` → `dep_016: instances=4`
- How to clear Ophth cache: `redis-cli -n 1 FLUSHDB`
- How to replay Ophth audit log: `node scripts/replay_audit.js --dept=DEP-016`
