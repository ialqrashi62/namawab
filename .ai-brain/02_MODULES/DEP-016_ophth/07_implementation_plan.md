# Implementation Plan — Ophthalmology (DEP-016)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh ophth
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-ophth-<timestamp>`
