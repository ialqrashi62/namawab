# Test Observability — Ophth (DEP-016)
...
- Overall: > 80%
- Ophth engine: > 90%
- Ophth critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_016.<area>.<action>.<expectation>

e.g.
dep_016.create.valid_returns_201
dep_016.create.invalid_returns_400
dep_016.create.cross_tenant_returns_403
dep_016.update.locked_returns_409
```
