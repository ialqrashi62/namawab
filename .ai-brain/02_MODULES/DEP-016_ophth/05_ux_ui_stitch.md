# UX/UI Stitch Design — Ophthalmology (DEP-016)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: العيون | Ophthalmology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/ophth` — main (2-col)
2. `/station/ophth/orders` — full-width list
3. `/station/ophth/results` — 2-col with chart
4. `/station/ophth/notes` — editor + sign
