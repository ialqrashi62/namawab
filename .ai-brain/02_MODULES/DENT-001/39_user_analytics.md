# User Analytics — Dent-001 (DENT-001)
...
| Event | Properties |
|---|---|
| `dent_001_create` | tenant_id, user_id, patient_id_hash |
| `dent_001_view` | tenant_id, user_id, duration_ms |
| `dent_001_update` | tenant_id, user_id, fields_changed |
| `dent_001_delete` | tenant_id, user_id, reason |
| `dent_001_print` | tenant_id, user_id, format |
| `dent_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Dent-001 primary workflow
- step 1: open Dent-001 page
