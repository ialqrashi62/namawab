# DevOps Runbook — Dent-001 (DENT-001)
...
### Dent-001-specific runbook

- How to restart just the Dent-001 engine: `pm2 restart nama-medical-erp --name=dent_001`
- How to scale Dent-001: edit `pm2.config.js` → `dent_001: instances=4`
- How to clear Dent-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Dent-001 audit log: `node scripts/replay_audit.js --dept=DENT-001`
