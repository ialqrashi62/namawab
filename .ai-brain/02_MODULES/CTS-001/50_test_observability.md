# Test Observability — Cts-001 (CTS-001)
...
- Overall: > 80%
- Cts-001 engine: > 90%
- Cts-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
cts_001.<area>.<action>.<expectation>

e.g.
cts_001.create.valid_returns_201
cts_001.create.invalid_returns_400
cts_001.create.cross_tenant_returns_403
cts_001.update.locked_returns_409
```
