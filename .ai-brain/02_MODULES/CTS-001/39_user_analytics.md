# User Analytics — Cts-001 (CTS-001)
...
| Event | Properties |
|---|---|
| `cts_001_create` | tenant_id, user_id, patient_id_hash |
| `cts_001_view` | tenant_id, user_id, duration_ms |
| `cts_001_update` | tenant_id, user_id, fields_changed |
| `cts_001_delete` | tenant_id, user_id, reason |
| `cts_001_print` | tenant_id, user_id, format |
| `cts_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Cts-001 primary workflow
- step 1: open Cts-001 page
