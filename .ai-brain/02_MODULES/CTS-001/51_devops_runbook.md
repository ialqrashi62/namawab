# DevOps Runbook — Cts-001 (CTS-001)
...
### Cts-001-specific runbook

- How to restart just the Cts-001 engine: `pm2 restart nama-medical-erp --name=cts_001`
- How to scale Cts-001: edit `pm2.config.js` → `cts_001: instances=4`
- How to clear Cts-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Cts-001 audit log: `node scripts/replay_audit.js --dept=CTS-001`
