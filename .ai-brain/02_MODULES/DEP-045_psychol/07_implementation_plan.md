# Implementation Plan — Psychology (DEP-045)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh psychol
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-psychol-<timestamp>`
