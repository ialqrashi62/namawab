# User Analytics — Psychol (DEP-045)
...
| Event | Properties |
|---|---|
| `dep_045_create` | tenant_id, user_id, patient_id_hash |
| `dep_045_view` | tenant_id, user_id, duration_ms |
| `dep_045_update` | tenant_id, user_id, fields_changed |
| `dep_045_delete` | tenant_id, user_id, reason |
| `dep_045_print` | tenant_id, user_id, format |
| `dep_045_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Psychol primary workflow
- step 1: open Psychol page
