# DevOps Runbook — Psychol (DEP-045)
...
### Psychol-specific runbook

- How to restart just the Psychol engine: `pm2 restart nama-medical-erp --name=dep_045`
- How to scale Psychol: edit `pm2.config.js` → `dep_045: instances=4`
- How to clear Psychol cache: `redis-cli -n 1 FLUSHDB`
- How to replay Psychol audit log: `node scripts/replay_audit.js --dept=DEP-045`
