// filepath: 02_MODULES/DEP-045/23_frontend_components.tsx
// Stitch components for Psychology (DEP-045)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.PsycholAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('psychol');
