# UX/UI Stitch Design — Psychology (DEP-045)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: علم النفس | Psychology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/psychol` — main (2-col)
2. `/station/psychol/orders` — full-width list
3. `/station/psychol/results` — 2-col with chart
4. `/station/psychol/notes` — editor + sign
