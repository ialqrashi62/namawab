# Test Observability — Psychol (DEP-045)
...
- Overall: > 80%
- Psychol engine: > 90%
- Psychol critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_045.<area>.<action>.<expectation>

e.g.
dep_045.create.valid_returns_201
dep_045.create.invalid_returns_400
dep_045.create.cross_tenant_returns_403
dep_045.update.locked_returns_409
```
