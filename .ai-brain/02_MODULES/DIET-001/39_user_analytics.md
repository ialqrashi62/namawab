# User Analytics — Diet-001 (DIET-001)
...
| Event | Properties |
|---|---|
| `diet_001_create` | tenant_id, user_id, patient_id_hash |
| `diet_001_view` | tenant_id, user_id, duration_ms |
| `diet_001_update` | tenant_id, user_id, fields_changed |
| `diet_001_delete` | tenant_id, user_id, reason |
| `diet_001_print` | tenant_id, user_id, format |
| `diet_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Diet-001 primary workflow
- step 1: open Diet-001 page
