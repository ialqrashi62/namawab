# DevOps Runbook — Diet-001 (DIET-001)
...
### Diet-001-specific runbook

- How to restart just the Diet-001 engine: `pm2 restart nama-medical-erp --name=diet_001`
- How to scale Diet-001: edit `pm2.config.js` → `diet_001: instances=4`
- How to clear Diet-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Diet-001 audit log: `node scripts/replay_audit.js --dept=DIET-001`
