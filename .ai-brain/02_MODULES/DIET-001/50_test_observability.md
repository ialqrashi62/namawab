# Test Observability — Diet-001 (DIET-001)
...
- Overall: > 80%
- Diet-001 engine: > 90%
- Diet-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
diet_001.<area>.<action>.<expectation>

e.g.
diet_001.create.valid_returns_201
diet_001.create.invalid_returns_400
diet_001.create.cross_tenant_returns_403
diet_001.update.locked_returns_409
```
