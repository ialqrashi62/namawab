...
| Event | Properties |
|---|---|
| `dep_051_create` | tenant_id, user_id, patient_id_hash |
| `dep_051_view` | tenant_id, user_id, duration_ms |
| `dep_051_update` | tenant_id, user_id, fields_changed |
| `dep_051_delete` | tenant_id, user_id, reason |
| `dep_051_print` | tenant_id, user_id, format |
| `dep_051_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Anesth primary workflow
- step 1: open Anesth page
