# Training Video Script — Anesthesia (DEP-051)

> **Duration:** 15 minutes · **Generated:** 2026-08-08

## Scene 1: Introduction (2 min)
[Visual: Hospital logo + narrator]
Narrator: "Welcome to NamaMedical ERP. In this video, we cover Anesthesia workflow."

## Scene 2: Login & Navigation (2 min)
[Visual: Screen recording]
- Open https://jumanasoft.com
- Login as anesth_specialist
- Select Anesthesia from sidebar
