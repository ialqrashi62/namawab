# Workflow Orchestration — Anesthesia (DEP-051)

## BPMN State Machine
```yaml
workflow:
  id: anesth_patient_flow
...
|---|---|
| triage | nurse |
| assessment | anesth_specialist |
| plan | anesth_specialist |
| intervention | anesth_specialist + nurse |
| discharge | anesth_specialist |
| followup | scheduler + anesth_specialist |