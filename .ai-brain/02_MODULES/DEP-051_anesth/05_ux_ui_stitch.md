# UX/UI Stitch Design — Anesthesia (DEP-051)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: التخدير | Anesthesia] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/anesth` — main (2-col)
2. `/station/anesth/orders` — full-width list
3. `/station/anesth/results` — 2-col with chart
4. `/station/anesth/notes` — editor + sign
