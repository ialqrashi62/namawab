# Test Observability — Anesth (DEP-051)
...
- Overall: > 80%
- Anesth engine: > 90%
- Anesth critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_051.<area>.<action>.<expectation>

e.g.
dep_051.create.valid_returns_201
dep_051.create.invalid_returns_400
dep_051.create.cross_tenant_returns_403
dep_051.update.locked_returns_409
```
