# Implementation Plan — Anesthesia (DEP-051)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh anesth
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-anesth-<timestamp>`
