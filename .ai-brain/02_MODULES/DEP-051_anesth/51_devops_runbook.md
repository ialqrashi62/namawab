...
### Anesth-specific runbook

- How to restart just the Anesth engine: `pm2 restart nama-medical-erp --name=dep_051`
- How to scale Anesth: edit `pm2.config.js` → `dep_051: instances=4`
- How to clear Anesth cache: `redis-cli -n 1 FLUSHDB`
- How to replay Anesth audit log: `node scripts/replay_audit.js --dept=DEP-051`
