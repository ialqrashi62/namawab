...
- Overall: > 80%
- Micu engine: > 90%
- Micu critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
micu.<area>.<action>.<expectation>

e.g.
micu.create.valid_returns_201
micu.create.invalid_returns_400
micu.create.cross_tenant_returns_403
micu.update.locked_returns_409
```
