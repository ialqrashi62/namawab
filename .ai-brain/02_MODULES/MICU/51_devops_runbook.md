...
### Micu-specific runbook

- How to restart just the Micu engine: `pm2 restart nama-medical-erp --name=micu`
- How to scale Micu: edit `pm2.config.js` → `micu: instances=4`
- How to clear Micu cache: `redis-cli -n 1 FLUSHDB`
- How to replay Micu audit log: `node scripts/replay_audit.js --dept=MICU`
