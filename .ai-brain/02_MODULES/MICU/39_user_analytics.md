...
| Event | Properties |
|---|---|
| `micu_create` | tenant_id, user_id, patient_id_hash |
| `micu_view` | tenant_id, user_id, duration_ms |
| `micu_update` | tenant_id, user_id, fields_changed |
| `micu_delete` | tenant_id, user_id, reason |
| `micu_print` | tenant_id, user_id, format |
| `micu_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Micu primary workflow
- step 1: open Micu page
