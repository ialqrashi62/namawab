# DevOps Runbook — Onc-001 (ONC-001)
...
### Onc-001-specific runbook

- How to restart just the Onc-001 engine: `pm2 restart nama-medical-erp --name=onc_001`
- How to scale Onc-001: edit `pm2.config.js` → `onc_001: instances=4`
- How to clear Onc-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Onc-001 audit log: `node scripts/replay_audit.js --dept=ONC-001`
