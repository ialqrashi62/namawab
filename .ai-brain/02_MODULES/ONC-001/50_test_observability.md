# Test Observability — Onc-001 (ONC-001)
...
- Overall: > 80%
- Onc-001 engine: > 90%
- Onc-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
onc_001.<area>.<action>.<expectation>

e.g.
onc_001.create.valid_returns_201
onc_001.create.invalid_returns_400
onc_001.create.cross_tenant_returns_403
onc_001.update.locked_returns_409
```
