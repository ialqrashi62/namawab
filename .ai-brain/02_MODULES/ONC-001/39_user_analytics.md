# User Analytics — Onc-001 (ONC-001)
...
| Event | Properties |
|---|---|
| `onc_001_create` | tenant_id, user_id, patient_id_hash |
| `onc_001_view` | tenant_id, user_id, duration_ms |
| `onc_001_update` | tenant_id, user_id, fields_changed |
| `onc_001_delete` | tenant_id, user_id, reason |
| `onc_001_print` | tenant_id, user_id, format |
| `onc_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Onc-001 primary workflow
- step 1: open Onc-001 page
