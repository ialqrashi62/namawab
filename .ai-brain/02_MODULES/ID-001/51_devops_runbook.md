...
### Id-001-specific runbook

- How to restart just the Id-001 engine: `pm2 restart nama-medical-erp --name=id_001`
- How to scale Id-001: edit `pm2.config.js` → `id_001: instances=4`
- How to clear Id-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Id-001 audit log: `node scripts/replay_audit.js --dept=ID-001`
