# Test Observability — Id-001 (ID-001)
...
- Overall: > 80%
- Id-001 engine: > 90%
- Id-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
id_001.<area>.<action>.<expectation>

e.g.
id_001.create.valid_returns_201
id_001.create.invalid_returns_400
id_001.create.cross_tenant_returns_403
id_001.update.locked_returns_409
```
