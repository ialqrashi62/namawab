# User Analytics — Pulm-001 (PULM-001)
...
| Event | Properties |
|---|---|
| `pulm_001_create` | tenant_id, user_id, patient_id_hash |
| `pulm_001_view` | tenant_id, user_id, duration_ms |
| `pulm_001_update` | tenant_id, user_id, fields_changed |
| `pulm_001_delete` | tenant_id, user_id, reason |
| `pulm_001_print` | tenant_id, user_id, format |
| `pulm_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Pulm-001 primary workflow
- step 1: open Pulm-001 page
