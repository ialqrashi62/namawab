# DevOps Runbook — Pulm-001 (PULM-001)
...
### Pulm-001-specific runbook

- How to restart just the Pulm-001 engine: `pm2 restart nama-medical-erp --name=pulm_001`
- How to scale Pulm-001: edit `pm2.config.js` → `pulm_001: instances=4`
- How to clear Pulm-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Pulm-001 audit log: `node scripts/replay_audit.js --dept=PULM-001`
