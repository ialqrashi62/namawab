# Test Observability — Pulm-001 (PULM-001)
...
- Overall: > 80%
- Pulm-001 engine: > 90%
- Pulm-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
pulm_001.<area>.<action>.<expectation>

e.g.
pulm_001.create.valid_returns_201
pulm_001.create.invalid_returns_400
pulm_001.create.cross_tenant_returns_403
pulm_001.update.locked_returns_409
```
