# DevOps Runbook — Ortho-001 (ORTHO-001)
...
### Ortho-001-specific runbook

- How to restart just the Ortho-001 engine: `pm2 restart nama-medical-erp --name=ortho_001`
- How to scale Ortho-001: edit `pm2.config.js` → `ortho_001: instances=4`
- How to clear Ortho-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Ortho-001 audit log: `node scripts/replay_audit.js --dept=ORTHO-001`
