# Test Observability — Ortho-001 (ORTHO-001)
...
- Overall: > 80%
- Ortho-001 engine: > 90%
- Ortho-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
ortho_001.<area>.<action>.<expectation>

e.g.
ortho_001.create.valid_returns_201
ortho_001.create.invalid_returns_400
ortho_001.create.cross_tenant_returns_403
ortho_001.update.locked_returns_409
```
