# User Analytics — Ortho-001 (ORTHO-001)
...
| Event | Properties |
|---|---|
| `ortho_001_create` | tenant_id, user_id, patient_id_hash |
| `ortho_001_view` | tenant_id, user_id, duration_ms |
| `ortho_001_update` | tenant_id, user_id, fields_changed |
| `ortho_001_delete` | tenant_id, user_id, reason |
| `ortho_001_print` | tenant_id, user_id, format |
| `ortho_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Ortho-001 primary workflow
- step 1: open Ortho-001 page
