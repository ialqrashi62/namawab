# Workflow Orchestration — Nuclear_Medicine (DEP-042)

## BPMN State Machine
```yaml
workflow:
  id: nucmed_patient_flow
...
|---|---|
| triage | nurse |
| assessment | nucmed_specialist |
| plan | nucmed_specialist |
| intervention | nucmed_specialist + nurse |
| discharge | nucmed_specialist |
| followup | scheduler + nucmed_specialist |