# Test Observability — Nucmed (DEP-042)
...
- Overall: > 80%
- Nucmed engine: > 90%
- Nucmed critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_042.<area>.<action>.<expectation>

e.g.
dep_042.create.valid_returns_201
dep_042.create.invalid_returns_400
dep_042.create.cross_tenant_returns_403
dep_042.update.locked_returns_409
```
