...
| Event | Properties |
|---|---|
| `dep_042_create` | tenant_id, user_id, patient_id_hash |
| `dep_042_view` | tenant_id, user_id, duration_ms |
| `dep_042_update` | tenant_id, user_id, fields_changed |
| `dep_042_delete` | tenant_id, user_id, reason |
| `dep_042_print` | tenant_id, user_id, format |
| `dep_042_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Nucmed primary workflow
- step 1: open Nucmed page
