# UX/UI Stitch Design — Nuclear_Medicine (DEP-042)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الطب النووي | Nuclear_Medicine] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/nucmed` — main (2-col)
2. `/station/nucmed/orders` — full-width list
3. `/station/nucmed/results` — 2-col with chart
4. `/station/nucmed/notes` — editor + sign
