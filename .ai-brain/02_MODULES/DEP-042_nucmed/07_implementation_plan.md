# Implementation Plan — Nuclear_Medicine (DEP-042)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh nucmed
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-nucmed-<timestamp>`
