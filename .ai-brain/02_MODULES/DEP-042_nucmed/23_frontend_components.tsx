// filepath: 02_MODULES/DEP-042/23_frontend_components.tsx
// Stitch components for Nuclear_Medicine (DEP-042)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.NucmedAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('nucmed');
