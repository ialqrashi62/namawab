...
### Nucmed-specific runbook

- How to restart just the Nucmed engine: `pm2 restart nama-medical-erp --name=dep_042`
- How to scale Nucmed: edit `pm2.config.js` → `dep_042: instances=4`
- How to clear Nucmed cache: `redis-cli -n 1 FLUSHDB`
- How to replay Nucmed audit log: `node scripts/replay_audit.js --dept=DEP-042`
