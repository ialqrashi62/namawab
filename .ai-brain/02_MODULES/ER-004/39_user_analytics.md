...
| Event | Properties |
|---|---|
| `er_004_create` | tenant_id, user_id, patient_id_hash |
| `er_004_view` | tenant_id, user_id, duration_ms |
| `er_004_update` | tenant_id, user_id, fields_changed |
| `er_004_delete` | tenant_id, user_id, reason |
| `er_004_print` | tenant_id, user_id, format |
| `er_004_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Er-004 primary workflow
- step 1: open Er-004 page
