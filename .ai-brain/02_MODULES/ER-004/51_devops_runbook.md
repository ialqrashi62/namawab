...
### Er-004-specific runbook

- How to restart just the Er-004 engine: `pm2 restart nama-medical-erp --name=er_004`
- How to scale Er-004: edit `pm2.config.js` → `er_004: instances=4`
- How to clear Er-004 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Er-004 audit log: `node scripts/replay_audit.js --dept=ER-004`
