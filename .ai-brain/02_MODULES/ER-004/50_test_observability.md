# Test Observability — Er-004 (ER-004)
...
- Overall: > 80%
- Er-004 engine: > 90%
- Er-004 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
er_004.<area>.<action>.<expectation>

e.g.
er_004.create.valid_returns_201
er_004.create.invalid_returns_400
er_004.create.cross_tenant_returns_403
er_004.update.locked_returns_409
```
