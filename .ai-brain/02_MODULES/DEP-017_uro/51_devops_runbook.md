...
### Uro-specific runbook

- How to restart just the Uro engine: `pm2 restart nama-medical-erp --name=dep_017`
- How to scale Uro: edit `pm2.config.js` → `dep_017: instances=4`
- How to clear Uro cache: `redis-cli -n 1 FLUSHDB`
- How to replay Uro audit log: `node scripts/replay_audit.js --dept=DEP-017`
