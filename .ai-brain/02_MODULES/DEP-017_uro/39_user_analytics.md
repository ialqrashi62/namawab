...
| Event | Properties |
|---|---|
| `dep_017_create` | tenant_id, user_id, patient_id_hash |
| `dep_017_view` | tenant_id, user_id, duration_ms |
| `dep_017_update` | tenant_id, user_id, fields_changed |
| `dep_017_delete` | tenant_id, user_id, reason |
| `dep_017_print` | tenant_id, user_id, format |
| `dep_017_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Uro primary workflow
- step 1: open Uro page
