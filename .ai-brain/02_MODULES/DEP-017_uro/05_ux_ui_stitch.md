# UX/UI Stitch Design — Urology (DEP-017)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: المسالك البولية | Urology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/uro` — main (2-col)
2. `/station/uro/orders` — full-width list
3. `/station/uro/results` — 2-col with chart
4. `/station/uro/notes` — editor + sign
