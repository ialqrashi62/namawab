# Workflow Orchestration — Urology (DEP-017)
...
|---|---|
| triage | nurse |
| assessment | uro_specialist |
| plan | uro_specialist |
| intervention | uro_specialist + nurse |
| discharge | uro_specialist |
| followup | scheduler + uro_specialist |