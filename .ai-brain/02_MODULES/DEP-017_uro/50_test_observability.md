# Test Observability — Uro (DEP-017)
...
- Overall: > 80%
- Uro engine: > 90%
- Uro critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_017.<area>.<action>.<expectation>

e.g.
dep_017.create.valid_returns_201
dep_017.create.invalid_returns_400
dep_017.create.cross_tenant_returns_403
dep_017.update.locked_returns_409
```
