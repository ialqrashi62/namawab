// filepath: 02_MODULES/DEP-017/23_frontend_components.tsx
// Stitch components for Urology (DEP-017)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.UroAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('uro');
