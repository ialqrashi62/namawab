# User Analytics — Ent-001 (ENT-001)
...
| Event | Properties |
|---|---|
| `ent_001_create` | tenant_id, user_id, patient_id_hash |
| `ent_001_view` | tenant_id, user_id, duration_ms |
| `ent_001_update` | tenant_id, user_id, fields_changed |
| `ent_001_delete` | tenant_id, user_id, reason |
| `ent_001_print` | tenant_id, user_id, format |
| `ent_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Ent-001 primary workflow
- step 1: open Ent-001 page
