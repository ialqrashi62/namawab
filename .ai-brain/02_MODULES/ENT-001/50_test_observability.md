# Test Observability — Ent-001 (ENT-001)
...
- Overall: > 80%
- Ent-001 engine: > 90%
- Ent-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
ent_001.<area>.<action>.<expectation>

e.g.
ent_001.create.valid_returns_201
ent_001.create.invalid_returns_400
ent_001.create.cross_tenant_returns_403
ent_001.update.locked_returns_409
```
