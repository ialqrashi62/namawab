# DevOps Runbook — Ent-001 (ENT-001)
...
### Ent-001-specific runbook

- How to restart just the Ent-001 engine: `pm2 restart nama-medical-erp --name=ent_001`
- How to scale Ent-001: edit `pm2.config.js` → `ent_001: instances=4`
- How to clear Ent-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Ent-001 audit log: `node scripts/replay_audit.js --dept=ENT-001`
