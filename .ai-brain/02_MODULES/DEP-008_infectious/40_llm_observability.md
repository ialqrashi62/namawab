# LLM Observability — Infectious (DEP-008)
**Last updated:** 2026-08-10

## LLM usage for Infectious

### Orchestrators

| Orchestrator | Model | Calls/day | Cost/day |
|---|---|---|---|
| Infectious AI orchestrator | gpt-4o | ? | ? |
| Infectious summary | gpt-4o-mini | ? | ? |
| Infectious RAG | gpt-4o | ? | ? |
