# Test Observability — Infectious (DEP-008)
...
- Overall: > 80%
- Infectious engine: > 90%
- Infectious critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_008.<area>.<action>.<expectation>

e.g.
dep_008.create.valid_returns_201
dep_008.create.invalid_returns_400
dep_008.create.cross_tenant_returns_403
dep_008.update.locked_returns_409
```
