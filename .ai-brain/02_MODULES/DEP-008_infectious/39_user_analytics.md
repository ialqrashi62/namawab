# User Analytics — Infectious (DEP-008)
...
| Event | Properties |
|---|---|
| `dep_008_create` | tenant_id, user_id, patient_id_hash |
| `dep_008_view` | tenant_id, user_id, duration_ms |
| `dep_008_update` | tenant_id, user_id, fields_changed |
| `dep_008_delete` | tenant_id, user_id, reason |
| `dep_008_print` | tenant_id, user_id, format |
| `dep_008_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Infectious primary workflow
- step 1: open Infectious page
