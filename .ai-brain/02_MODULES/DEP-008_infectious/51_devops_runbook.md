# DevOps Runbook — Infectious (DEP-008)
...
### Infectious-specific runbook

- How to restart just the Infectious engine: `pm2 restart nama-medical-erp --name=dep_008`
- How to scale Infectious: edit `pm2.config.js` → `dep_008: instances=4`
- How to clear Infectious cache: `redis-cli -n 1 FLUSHDB`
- How to replay Infectious audit log: `node scripts/replay_audit.js --dept=DEP-008`
