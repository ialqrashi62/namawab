# UX/UI Stitch Design — Infectious_Diseases (DEP-008)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الأمراض المعدية | Infectious_Diseases] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/infectious` — main (2-col)
2. `/station/infectious/orders` — full-width list
3. `/station/infectious/results` — 2-col with chart
4. `/station/infectious/notes` — editor + sign
