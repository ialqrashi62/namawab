# Workflow Orchestration — Infectious_Diseases (DEP-008)

## BPMN State Machine
```yaml
workflow:
  id: infectious_patient_flow
...
|---|---|
| triage | nurse |
| assessment | infectious_specialist |
| plan | infectious_specialist |
| intervention | infectious_specialist + nurse |
| discharge | infectious_specialist |
| followup | scheduler + infectious_specialist |