# LangChain Chains — Infectious_Diseases (DEP-008)
...
PROMPT = PromptTemplate(
  ...
  template="""أنت خبير في الأمراض المعدية. أجب بالعربية. اعتمد فقط على السياق.
السياق: {context}
السؤال: {question}
الإجابة:"""
)
...
## Tools
- infectious_guidelines_search
- infectious_drug_search
- icd10_search
- snomed_search