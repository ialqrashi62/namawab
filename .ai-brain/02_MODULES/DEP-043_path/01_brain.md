# Pathology (DEP-043) — Brain Summary
...
1. cancer_diagnosis
2. lymphoma_classification
3. leukemia_diagnosis
4. melanoma_diagnosis
5. breast_cancer_diagnosis
6. GI_cancer_diagnosis
7. renal_disease_diagnosis
8. liver_disease_diagnosis
9. transplant_rejection_diagnosis
10. autoimmune_diagnosis


## Top 20 Procedures (SNOMED-CT)
1. histopathology_examination
2. immunohistochemistry
3. frozen_section
4. cytology_examination
5. FNAC
6. bone_marrow_biopsy_examination
7. molecular_testing_path
8. FISH_test
9. PCR_path
10. flow_cytometry
11. autopsy
12. frozen_section_intraop
13. special_stains_path
14. electron_microscopy
15. cytogenetics


## Red Flags
- ⚠️ malignancy_diagnosis
- ⚠️ unexpected_finding_intraop
- ⚠️ transplant_rejection_acute
- ⚠️ aggressive_lymphoma
- ⚠️ leukemia_acute
