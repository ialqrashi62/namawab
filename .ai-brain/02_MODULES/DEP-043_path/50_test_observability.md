# Test Observability — Path (DEP-043)
...
- Overall: > 80%
- Path engine: > 90%
- Path critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_043.<area>.<action>.<expectation>

e.g.
dep_043.create.valid_returns_201
dep_043.create.invalid_returns_400
dep_043.create.cross_tenant_returns_403
dep_043.update.locked_returns_409
```
