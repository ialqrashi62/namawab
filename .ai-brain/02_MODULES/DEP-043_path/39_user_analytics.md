...
| Event | Properties |
|---|---|
| `dep_043_create` | tenant_id, user_id, patient_id_hash |
| `dep_043_view` | tenant_id, user_id, duration_ms |
| `dep_043_update` | tenant_id, user_id, fields_changed |
| `dep_043_delete` | tenant_id, user_id, reason |
| `dep_043_print` | tenant_id, user_id, format |
| `dep_043_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Path primary workflow
- step 1: open Path page
