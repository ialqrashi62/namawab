-- Migration UP for Pathology (DEP-043)
...
CREATE POLICY path_enc_iso ON path_encounters
...
ALTER TABLE path_audit ENABLE ROW LEVEL SECURITY;
ALTER TABLE path_audit FORCE ROW LEVEL SECURITY;
CREATE POLICY path_audit_iso ON path_audit
  USING (tenant_id = current_setting('app.tenant_id', true)::BIGINT);
