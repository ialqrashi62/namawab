# UX/UI Stitch Design — Pathology (DEP-043)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: علم الأمراض | Pathology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/path` — main (2-col)
2. `/station/path/orders` — full-width list
3. `/station/path/results` — 2-col with chart
4. `/station/path/notes` — editor + sign
