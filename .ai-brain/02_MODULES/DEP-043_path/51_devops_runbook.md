...
### Path-specific runbook

- How to restart just the Path engine: `pm2 restart nama-medical-erp --name=dep_043`
- How to scale Path: edit `pm2.config.js` → `dep_043: instances=4`
- How to clear Path cache: `redis-cli -n 1 FLUSHDB`
- How to replay Path audit log: `node scripts/replay_audit.js --dept=DEP-043`
