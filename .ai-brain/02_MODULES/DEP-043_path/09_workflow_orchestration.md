# Workflow Orchestration — Pathology (DEP-043)

## BPMN State Machine
```yaml
workflow:
  id: path_patient_flow
...
|---|---|
| triage | nurse |
| assessment | path_specialist |
| plan | path_specialist |
| intervention | path_specialist + nurse |
| discharge | path_specialist |
| followup | scheduler + path_specialist |