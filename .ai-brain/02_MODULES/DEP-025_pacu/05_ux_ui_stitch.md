# UX/UI Stitch Design — PACU (DEP-025)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: إفاقة ما بعد التخدير | PACU] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/pacu` — main (2-col)
2. `/station/pacu/orders` — full-width list
3. `/station/pacu/results` — 2-col with chart
4. `/station/pacu/notes` — editor + sign
