// filepath: 02_MODULES/DEP-025/23_frontend_components.tsx
// Stitch components for PACU (DEP-025)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.PacuAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('pacu');
