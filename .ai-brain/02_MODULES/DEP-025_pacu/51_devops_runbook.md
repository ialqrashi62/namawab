...
### Pacu-specific runbook

- How to restart just the Pacu engine: `pm2 restart nama-medical-erp --name=dep_025`
- How to scale Pacu: edit `pm2.config.js` → `dep_025: instances=4`
- How to clear Pacu cache: `redis-cli -n 1 FLUSHDB`
- How to replay Pacu audit log: `node scripts/replay_audit.js --dept=DEP-025`
