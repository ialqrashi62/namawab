...
| Event | Properties |
|---|---|
| `dep_025_create` | tenant_id, user_id, patient_id_hash |
| `dep_025_view` | tenant_id, user_id, duration_ms |
| `dep_025_update` | tenant_id, user_id, fields_changed |
| `dep_025_delete` | tenant_id, user_id, reason |
| `dep_025_print` | tenant_id, user_id, format |
| `dep_025_export` | tenant_id, user_id, format, rows |
