# Test Observability — Pacu (DEP-025)
...
- Overall: > 80%
- Pacu engine: > 90%
- Pacu critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_025.<area>.<action>.<expectation>

e.g.
dep_025.create.valid_returns_201
dep_025.create.invalid_returns_400
dep_025.create.cross_tenant_returns_403
dep_025.update.locked_returns_409
```
