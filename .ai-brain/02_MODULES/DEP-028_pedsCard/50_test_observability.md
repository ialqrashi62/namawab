# Test Observability — Pedscard (DEP-028)
...
- Overall: > 80%
- Pedscard engine: > 90%
- Pedscard critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_028.<area>.<action>.<expectation>

e.g.
dep_028.create.valid_returns_201
dep_028.create.invalid_returns_400
dep_028.create.cross_tenant_returns_403
dep_028.update.locked_returns_409
```
