# User Analytics — Pedscard (DEP-028)
...
| Event | Properties |
|---|---|
| `dep_028_create` | tenant_id, user_id, patient_id_hash |
| `dep_028_view` | tenant_id, user_id, duration_ms |
| `dep_028_update` | tenant_id, user_id, fields_changed |
| `dep_028_delete` | tenant_id, user_id, reason |
| `dep_028_print` | tenant_id, user_id, format |
| `dep_028_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Pedscard primary workflow
- step 1: open Pedscard page
