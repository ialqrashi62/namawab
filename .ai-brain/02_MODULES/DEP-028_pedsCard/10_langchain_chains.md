# LangChain Chains — Pediatric_Cardiology (DEP-028)
...
PROMPT = PromptTemplate(
  ...
  template="""أنت خبير في قلب الأطفال. أجب بالعربية. اعتمد فقط على السياق.
السياق: {context}
السؤال: {question}
الإجابة:"""
)
...
## Tools
- pedsCard_guidelines_search
- pedsCard_drug_search
- icd10_search
- snomed_search