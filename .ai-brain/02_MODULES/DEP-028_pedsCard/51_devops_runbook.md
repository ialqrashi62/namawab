# DevOps Runbook — Pedscard (DEP-028)
...
### Pedscard-specific runbook

- How to restart just the Pedscard engine: `pm2 restart nama-medical-erp --name=dep_028`
- How to scale Pedscard: edit `pm2.config.js` → `dep_028: instances=4`
- How to clear Pedscard cache: `redis-cli -n 1 FLUSHDB`
- How to replay Pedscard audit log: `node scripts/replay_audit.js --dept=DEP-028`
