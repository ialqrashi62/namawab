// filepath: 02_MODULES/DEP-028/23_frontend_components.tsx
// Stitch components for Pediatric_Cardiology (DEP-028)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.PedscardAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('pedsCard');
