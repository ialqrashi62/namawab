# Implementation Plan — Pediatric_Cardiology (DEP-028)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh pedsCard
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-pedsCard-<timestamp>`
