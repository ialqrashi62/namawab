# Workflow Orchestration — Pediatric_Cardiology (DEP-028)

## BPMN State Machine
```yaml
workflow:
  id: pedsCard_patient_flow
...
|---|---|
| triage | nurse |
| assessment | pedsCard_specialist |
| plan | pedsCard_specialist |
| intervention | pedsCard_specialist + nurse |
| discharge | pedsCard_specialist |
| followup | scheduler + pedsCard_specialist |