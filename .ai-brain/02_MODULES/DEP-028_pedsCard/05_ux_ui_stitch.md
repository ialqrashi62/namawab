# UX/UI Stitch Design — Pediatric_Cardiology (DEP-028)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: قلب الأطفال | Pediatric_Cardiology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/pedsCard` — main (2-col)
2. `/station/pedsCard/orders` — full-width list
3. `/station/pedsCard/results` — 2-col with chart
4. `/station/pedsCard/notes` — editor + sign
