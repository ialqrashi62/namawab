# DevOps Runbook — Pharm-001 (PHARM-001)
...
### Pharm-001-specific runbook

- How to restart just the Pharm-001 engine: `pm2 restart nama-medical-erp --name=pharm_001`
- How to scale Pharm-001: edit `pm2.config.js` → `pharm_001: instances=4`
- How to clear Pharm-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Pharm-001 audit log: `node scripts/replay_audit.js --dept=PHARM-001`
