# User Analytics — Pharm-001 (PHARM-001)
...
| Event | Properties |
|---|---|
| `pharm_001_create` | tenant_id, user_id, patient_id_hash |
| `pharm_001_view` | tenant_id, user_id, duration_ms |
| `pharm_001_update` | tenant_id, user_id, fields_changed |
| `pharm_001_delete` | tenant_id, user_id, reason |
| `pharm_001_print` | tenant_id, user_id, format |
| `pharm_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Pharm-001 primary workflow
- step 1: open Pharm-001 page
