# Test Observability — Pharm-001 (PHARM-001)
...
- Overall: > 80%
- Pharm-001 engine: > 90%
- Pharm-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
pharm_001.<area>.<action>.<expectation>

e.g.
pharm_001.create.valid_returns_201
pharm_001.create.invalid_returns_400
pharm_001.create.cross_tenant_returns_403
pharm_001.update.locked_returns_409
```
