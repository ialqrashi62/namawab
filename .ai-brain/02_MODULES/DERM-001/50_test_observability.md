# Test Observability — Derm-001 (DERM-001)
...
- Overall: > 80%
- Derm-001 engine: > 90%
- Derm-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
derm_001.<area>.<action>.<expectation>

e.g.
derm_001.create.valid_returns_201
derm_001.create.invalid_returns_400
derm_001.create.cross_tenant_returns_403
derm_001.update.locked_returns_409
```
