# DevOps Runbook — Derm-001 (DERM-001)
...
### Derm-001-specific runbook

- How to restart just the Derm-001 engine: `pm2 restart nama-medical-erp --name=derm_001`
- How to scale Derm-001: edit `pm2.config.js` → `derm_001: instances=4`
- How to clear Derm-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Derm-001 audit log: `node scripts/replay_audit.js --dept=DERM-001`
