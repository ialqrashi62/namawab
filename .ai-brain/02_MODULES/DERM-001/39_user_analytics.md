# User Analytics — Derm-001 (DERM-001)
...
| Event | Properties |
|---|---|
| `derm_001_create` | tenant_id, user_id, patient_id_hash |
| `derm_001_view` | tenant_id, user_id, duration_ms |
| `derm_001_update` | tenant_id, user_id, fields_changed |
| `derm_001_delete` | tenant_id, user_id, reason |
| `derm_001_print` | tenant_id, user_id, format |
| `derm_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Derm-001 primary workflow
- step 1: open Derm-001 page
