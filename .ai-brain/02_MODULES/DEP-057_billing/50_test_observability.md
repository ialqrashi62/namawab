# Test Observability — Billing (DEP-057)
...
- Overall: > 80%
- Billing engine: > 90%
- Billing critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_057.<area>.<action>.<expectation>

e.g.
dep_057.create.valid_returns_201
dep_057.create.invalid_returns_400
dep_057.create.cross_tenant_returns_403
dep_057.update.locked_returns_409
```
