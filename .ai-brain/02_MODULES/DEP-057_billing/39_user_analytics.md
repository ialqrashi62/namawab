# User Analytics — Billing (DEP-057)
...
| Event | Properties |
|---|---|
| `dep_057_create` | tenant_id, user_id, patient_id_hash |
| `dep_057_view` | tenant_id, user_id, duration_ms |
| `dep_057_update` | tenant_id, user_id, fields_changed |
| `dep_057_delete` | tenant_id, user_id, reason |
| `dep_057_print` | tenant_id, user_id, format |
| `dep_057_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Billing primary workflow
