# DevOps Runbook — Billing (DEP-057)
...
### Billing-specific runbook

- How to restart just the Billing engine: `pm2 restart nama-medical-erp --name=dep_057`
- How to scale Billing: edit `pm2.config.js` → `dep_057: instances=4`
- How to clear Billing cache: `redis-cli -n 1 FLUSHDB`
- How to replay Billing audit log: `node scripts/replay_audit.js --dept=DEP-057`
