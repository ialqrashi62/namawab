# UX/UI Stitch Design — Billing_Coding (DEP-057)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الفوترة والترميز | Billing_Coding] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/billing` — main (2-col)
2. `/station/billing/orders` — full-width list
3. `/station/billing/results` — 2-col with chart
4. `/station/billing/notes` — editor + sign
