// filepath: 02_MODULES/DEP-057/23_frontend_components.tsx
// Stitch components for Billing_Coding (DEP-057)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.BillingAPI : null;
