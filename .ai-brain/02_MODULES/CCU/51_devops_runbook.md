...
### Ccu-specific runbook

- How to restart just the Ccu engine: `pm2 restart nama-medical-erp --name=ccu`
- How to scale Ccu: edit `pm2.config.js` → `ccu: instances=4`
- How to clear Ccu cache: `redis-cli -n 1 FLUSHDB`
- How to replay Ccu audit log: `node scripts/replay_audit.js --dept=CCU`
