...
- Overall: > 80%
- Ccu engine: > 90%
- Ccu critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
ccu.<area>.<action>.<expectation>

e.g.
ccu.create.valid_returns_201
ccu.create.invalid_returns_400
ccu.create.cross_tenant_returns_403
ccu.update.locked_returns_409
```
