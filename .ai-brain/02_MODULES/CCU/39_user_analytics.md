...
| Event | Properties |
|---|---|
| `ccu_create` | tenant_id, user_id, patient_id_hash |
| `ccu_view` | tenant_id, user_id, duration_ms |
| `ccu_update` | tenant_id, user_id, fields_changed |
| `ccu_delete` | tenant_id, user_id, reason |
| `ccu_print` | tenant_id, user_id, format |
| `ccu_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Ccu primary workflow
- step 1: open Ccu page
