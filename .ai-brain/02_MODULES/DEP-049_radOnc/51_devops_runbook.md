...
### Radonc-specific runbook

- How to restart just the Radonc engine: `pm2 restart nama-medical-erp --name=dep_049`
- How to scale Radonc: edit `pm2.config.js` → `dep_049: instances=4`
- How to clear Radonc cache: `redis-cli -n 1 FLUSHDB`
- How to replay Radonc audit log: `node scripts/replay_audit.js --dept=DEP-049`
