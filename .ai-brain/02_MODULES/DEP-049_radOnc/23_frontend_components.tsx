// filepath: 02_MODULES/DEP-049/23_frontend_components.tsx
// Stitch components for Radiation_Oncology (DEP-049)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.RadoncAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('radOnc');
