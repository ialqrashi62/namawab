# UX/UI Stitch Design — Radiation_Oncology (DEP-049)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: علاج الأورام بالإشعاع | Radiation_Oncology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/radOnc` — main (2-col)
2. `/station/radOnc/orders` — full-width list
3. `/station/radOnc/results` — 2-col with chart
4. `/station/radOnc/notes` — editor + sign
