# Test Observability — Radonc (DEP-049)
...
- Overall: > 80%
- Radonc engine: > 90%
- Radonc critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_049.<area>.<action>.<expectation>

e.g.
dep_049.create.valid_returns_201
dep_049.create.invalid_returns_400
dep_049.create.cross_tenant_returns_403
dep_049.update.locked_returns_409
```
