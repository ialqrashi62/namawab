# دليل المستخدم — علاج الأورام بالإشعاع (DEP-049)

> **الإصدار:** 1.0 · **التاريخ:** 2026-08-08

## 1. مقدمة
هذا الدليل مخصص للأطباء والممرضين في قسم علاج الأورام بالإشعاع.

## 2. تسجيل الدخول
1. افتح المتصفح على `https://jumanasoft.com`
2. أدخل اسم المستخدم وكلمة المرور
3. اختر المنشأة من القائمة
4. اختر "علاج الأورام بالإشعاع" من الشريط الجانبي
