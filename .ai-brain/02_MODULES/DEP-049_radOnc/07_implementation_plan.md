# Implementation Plan — Radiation_Oncology (DEP-049)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh radOnc
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-radOnc-<timestamp>`
