# DevOps Runbook — Surg-011 (SURG-011)
...
### Surg-011-specific runbook

- How to restart just the Surg-011 engine: `pm2 restart nama-medical-erp --name=surg_011`
- How to scale Surg-011: edit `pm2.config.js` → `surg_011: instances=4`
- How to clear Surg-011 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Surg-011 audit log: `node scripts/replay_audit.js --dept=SURG-011`
