# User Analytics — Surg-011 (SURG-011)
...
| Event | Properties |
|---|---|
| `surg_011_create` | tenant_id, user_id, patient_id_hash |
| `surg_011_view` | tenant_id, user_id, duration_ms |
| `surg_011_update` | tenant_id, user_id, fields_changed |
| `surg_011_delete` | tenant_id, user_id, reason |
| `surg_011_print` | tenant_id, user_id, format |
| `surg_011_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Surg-011 primary workflow
- step 1: open Surg-011 page
