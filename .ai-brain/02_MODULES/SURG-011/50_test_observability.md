# Test Observability — Surg-011 (SURG-011)
...
- Overall: > 80%
- Surg-011 engine: > 90%
- Surg-011 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
surg_011.<area>.<action>.<expectation>

e.g.
surg_011.create.valid_returns_201
surg_011.create.invalid_returns_400
surg_011.create.cross_tenant_returns_403
surg_011.update.locked_returns_409
```
