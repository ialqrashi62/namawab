# UX/UI Stitch Design — Pharmacy (DEP-053)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الصيدلية | Pharmacy] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/pharmacy` — main (2-col)
2. `/station/pharmacy/orders` — full-width list
3. `/station/pharmacy/results` — 2-col with chart
4. `/station/pharmacy/notes` — editor + sign
