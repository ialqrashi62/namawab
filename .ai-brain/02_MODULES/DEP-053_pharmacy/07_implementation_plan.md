# Implementation Plan — Pharmacy (DEP-053)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh pharmacy
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-pharmacy-<timestamp>`
