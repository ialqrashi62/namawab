# User Analytics — Pharmacy (DEP-053)
...
| Event | Properties |
|---|---|
| `dep_053_create` | tenant_id, user_id, patient_id_hash |
| `dep_053_view` | tenant_id, user_id, duration_ms |
| `dep_053_update` | tenant_id, user_id, fields_changed |
| `dep_053_delete` | tenant_id, user_id, reason |
| `dep_053_print` | tenant_id, user_id, format |
| `dep_053_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Pharmacy primary workflow
- step 1: open Pharmacy page
