# DevOps Runbook — Pharmacy (DEP-053)
...
### Pharmacy-specific runbook

- How to restart just the Pharmacy engine: `pm2 restart nama-medical-erp --name=dep_053`
- How to scale Pharmacy: edit `pm2.config.js` → `dep_053: instances=4`
- How to clear Pharmacy cache: `redis-cli -n 1 FLUSHDB`
- How to replay Pharmacy audit log: `node scripts/replay_audit.js --dept=DEP-053`
