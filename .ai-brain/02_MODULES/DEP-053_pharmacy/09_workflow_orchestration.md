# Workflow Orchestration — Pharmacy (DEP-053)

## BPMN State Machine
```yaml
workflow:
  id: pharmacy_patient_flow
...
|---|---|
| triage | nurse |
| assessment | pharmacy_specialist |
| plan | pharmacy_specialist |
| intervention | pharmacy_specialist + nurse |
| discharge | pharmacy_specialist |
| followup | scheduler + pharmacy_specialist |