# Test Observability — Pharmacy (DEP-053)
...
- Overall: > 80%
- Pharmacy engine: > 90%
- Pharmacy critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_053.<area>.<action>.<expectation>

e.g.
dep_053.create.valid_returns_201
dep_053.create.invalid_returns_400
dep_053.create.cross_tenant_returns_403
dep_053.update.locked_returns_409
```
