# UX/UI Stitch Design — Physical_Therapy_Rehab (DEP-046)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: العلاج الطبيعي | Physical_Therapy_Rehab] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/pt` — main (2-col)
2. `/station/pt/orders` — full-width list
3. `/station/pt/results` — 2-col with chart
4. `/station/pt/notes` — editor + sign
