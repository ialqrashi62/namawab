...
| Event | Properties |
|---|---|
| `dep_046_create` | tenant_id, user_id, patient_id_hash |
| `dep_046_view` | tenant_id, user_id, duration_ms |
| `dep_046_update` | tenant_id, user_id, fields_changed |
| `dep_046_delete` | tenant_id, user_id, reason |
| `dep_046_print` | tenant_id, user_id, format |
| `dep_046_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Pt primary workflow
- step 1: open Pt page
