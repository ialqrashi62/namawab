# Implementation Plan — Physical_Therapy_Rehab (DEP-046)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh pt
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-pt-<timestamp>`
