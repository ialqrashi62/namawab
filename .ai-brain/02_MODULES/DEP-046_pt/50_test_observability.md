...
- Overall: > 80%
- Pt engine: > 90%
- Pt critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_046.<area>.<action>.<expectation>

e.g.
dep_046.create.valid_returns_201
dep_046.create.invalid_returns_400
dep_046.create.cross_tenant_returns_403
dep_046.update.locked_returns_409
```
