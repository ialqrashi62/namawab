# Workflow Orchestration — Physical_Therapy_Rehab (DEP-046)
...
|---|---|
| triage | nurse |
| assessment | pt_specialist |
| plan | pt_specialist |
| intervention | pt_specialist + nurse |
| discharge | pt_specialist |
| followup | scheduler + pt_specialist |