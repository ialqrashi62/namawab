...
- How to restart just the Pt engine: `pm2 restart nama-medical-erp --name=dep_046`
- How to scale Pt: edit `pm2.config.js` → `dep_046: instances=4`
- How to clear Pt cache: `redis-cli -n 1 FLUSHDB`
- How to replay Pt audit log: `node scripts/replay_audit.js --dept=DEP-046`
