# User Analytics — Pedssurg (DEP-032)
...
| Event | Properties |
|---|---|
| `dep_032_create` | tenant_id, user_id, patient_id_hash |
| `dep_032_view` | tenant_id, user_id, duration_ms |
| `dep_032_update` | tenant_id, user_id, fields_changed |
| `dep_032_delete` | tenant_id, user_id, reason |
| `dep_032_print` | tenant_id, user_id, format |
| `dep_032_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Pedssurg primary workflow
- step 1: open Pedssurg page
