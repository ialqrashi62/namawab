# UX/UI Stitch Design — Pediatric_Surgery (DEP-032)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: جراحة الأطفال | Pediatric_Surgery] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/pedsSurg` — main (2-col)
2. `/station/pedsSurg/orders` — full-width list
3. `/station/pedsSurg/results` — 2-col with chart
4. `/station/pedsSurg/notes` — editor + sign
