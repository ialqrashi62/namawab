# LangChain Chains — Pediatric_Surgery (DEP-032)
...
PROMPT = PromptTemplate(
  ...
  template="""أنت خبير في جراحة الأطفال. أجب بالعربية. اعتمد فقط على السياق.
السياق: {context}
السؤال: {question}
الإجابة:"""
)
...
## Tools
- pedsSurg_guidelines_search
- pedsSurg_drug_search
- icd10_search
- snomed_search