# DevOps Runbook — Pedssurg (DEP-032)
...
### Pedssurg-specific runbook

- How to restart just the Pedssurg engine: `pm2 restart nama-medical-erp --name=dep_032`
- How to scale Pedssurg: edit `pm2.config.js` → `dep_032: instances=4`
- How to clear Pedssurg cache: `redis-cli -n 1 FLUSHDB`
- How to replay Pedssurg audit log: `node scripts/replay_audit.js --dept=DEP-032`
