# Workflow Orchestration — Pediatric_Surgery (DEP-032)

## BPMN State Machine
```yaml
workflow:
  id: pedsSurg_patient_flow
...
|---|---|
| triage | nurse |
| assessment | pedsSurg_specialist |
| plan | pedsSurg_specialist |
| intervention | pedsSurg_specialist + nurse |
| discharge | pedsSurg_specialist |
| followup | scheduler + pedsSurg_specialist |