# Implementation Plan — Pediatric_Surgery (DEP-032)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh pedsSurg
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-pedsSurg-<timestamp>`
