# Test Observability — Pedssurg (DEP-032)
...
- Overall: > 80%
- Pedssurg engine: > 90%
- Pedssurg critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_032.<area>.<action>.<expectation>

e.g.
dep_032.create.valid_returns_201
dep_032.create.invalid_returns_400
dep_032.create.cross_tenant_returns_403
dep_032.update.locked_returns_409
```
