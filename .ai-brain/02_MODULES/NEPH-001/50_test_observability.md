# Test Observability — Neph-001 (NEPH-001)
...
- Overall: > 80%
- Neph-001 engine: > 90%
- Neph-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
neph_001.<area>.<action>.<expectation>

e.g.
neph_001.create.valid_returns_201
neph_001.create.invalid_returns_400
neph_001.create.cross_tenant_returns_403
neph_001.update.locked_returns_409
```
