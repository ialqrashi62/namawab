# User Analytics — Neph-001 (NEPH-001)
...
| Event | Properties |
|---|---|
| `neph_001_create` | tenant_id, user_id, patient_id_hash |
| `neph_001_view` | tenant_id, user_id, duration_ms |
| `neph_001_update` | tenant_id, user_id, fields_changed |
| `neph_001_delete` | tenant_id, user_id, reason |
| `neph_001_print` | tenant_id, user_id, format |
| `neph_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Neph-001 primary workflow
- step 1: open Neph-001 page
