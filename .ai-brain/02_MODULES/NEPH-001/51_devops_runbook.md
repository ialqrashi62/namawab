# DevOps Runbook — Neph-001 (NEPH-001)
...
### Neph-001-specific runbook

- How to restart just the Neph-001 engine: `pm2 restart nama-medical-erp --name=neph_001`
- How to scale Neph-001: edit `pm2.config.js` → `neph_001: instances=4`
- How to clear Neph-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Neph-001 audit log: `node scripts/replay_audit.js --dept=NEPH-001`
