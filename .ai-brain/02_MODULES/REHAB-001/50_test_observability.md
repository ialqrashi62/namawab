# Test Observability — Rehab-001 (REHAB-001)
...
- Overall: > 80%
- Rehab-001 engine: > 90%
- Rehab-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
rehab_001.<area>.<action>.<expectation>

e.g.
rehab_001.create.valid_returns_201
rehab_001.create.invalid_returns_400
rehab_001.create.cross_tenant_returns_403
rehab_001.update.locked_returns_409
```
