# DevOps Runbook — Rehab-001 (REHAB-001)
...
### Rehab-001-specific runbook

- How to restart just the Rehab-001 engine: `pm2 restart nama-medical-erp --name=rehab_001`
- How to scale Rehab-001: edit `pm2.config.js` → `rehab_001: instances=4`
- How to clear Rehab-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Rehab-001 audit log: `node scripts/replay_audit.js --dept=REHAB-001`
