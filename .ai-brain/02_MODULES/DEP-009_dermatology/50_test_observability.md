# Test Observability — Dermatology (DEP-009)
**Last updated:** 2026-08-10

## Tests for Dermatology
...
- Overall: > 80%
- Dermatology engine: > 90%
- Dermatology critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_009.<area>.<action>.<expectation>

e.g.
dep_009.create.valid_returns_201
dep_009.create.invalid_returns_400
dep_009.create.cross_tenant_returns_403
dep_009.update.locked_returns_409
```
