# Workflow Orchestration — Dermatology (DEP-009)

## BPMN State Machine
```yaml
workflow:
  id: dermatology_patient_flow
...
|---|---|
| triage | nurse |
| assessment | dermatology_specialist |
| plan | dermatology_specialist |
| intervention | dermatology_specialist + nurse |
| discharge | dermatology_specialist |
| followup | scheduler + dermatology_specialist |