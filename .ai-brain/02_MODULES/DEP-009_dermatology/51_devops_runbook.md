# DevOps Runbook — Dermatology (DEP-009)
...
### Dermatology-specific runbook

- How to restart just the Dermatology engine: `pm2 restart nama-medical-erp --name=dep_009`
- How to scale Dermatology: edit `pm2.config.js` → `dep_009: instances=4`
- How to clear Dermatology cache: `redis-cli -n 1 FLUSHDB`
- How to replay Dermatology audit log: `node scripts/replay_audit.js --dept=DEP-009`
