# LangChain Chains — Dermatology (DEP-009)
...
PROMPT = PromptTemplate(
  ...
  template="""أنت خبير في الجلدية. أجب بالعربية. اعتمد فقط على السياق.
السياق: {context}
السؤال: {question}
الإجابة:"""
)
...
## Tools
- dermatology_guidelines_search
- dermatology_drug_search
- icd10_search
- snomed_search