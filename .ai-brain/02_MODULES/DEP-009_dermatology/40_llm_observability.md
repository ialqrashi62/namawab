# LLM Observability — Dermatology (DEP-009)
**Last updated:** 2026-08-10

## LLM usage for Dermatology

### Orchestrators

| Orchestrator | Model | Calls/day | Cost/day |
|---|---|---|---|
| Dermatology AI orchestrator | gpt-4o | ? | ? |
| Dermatology summary | gpt-4o-mini | ? | ? |
| Dermatology RAG | gpt-4o | ? | ? |
