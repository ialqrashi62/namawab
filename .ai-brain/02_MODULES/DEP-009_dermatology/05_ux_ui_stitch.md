# UX/UI Stitch Design — Dermatology (DEP-009)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الجلدية | Dermatology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/dermatology` — main (2-col)
2. `/station/dermatology/orders` — full-width list
3. `/station/dermatology/results` — 2-col with chart
4. `/station/dermatology/notes` — editor + sign
