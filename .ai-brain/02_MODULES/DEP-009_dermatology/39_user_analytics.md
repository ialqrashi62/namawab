# User Analytics — Dermatology (DEP-009)
...
| Event | Properties |
|---|---|
| `dep_009_create` | tenant_id, user_id, patient_id_hash |
| `dep_009_view` | tenant_id, user_id, duration_ms |
| `dep_009_update` | tenant_id, user_id, fields_changed |
| `dep_009_delete` | tenant_id, user_id, reason |
| `dep_009_print` | tenant_id, user_id, format |
| `dep_009_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Dermatology primary workflow
- step 1: open Dermatology page
...
### Funnel 2: Dermatology AI assist
