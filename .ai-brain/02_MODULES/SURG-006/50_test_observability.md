# Test Observability — Surg-006 (SURG-006)
...
- Overall: > 80%
- Surg-006 engine: > 90%
- Surg-006 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
surg_006.<area>.<action>.<expectation>

e.g.
surg_006.create.valid_returns_201
surg_006.create.invalid_returns_400
surg_006.create.cross_tenant_returns_403
surg_006.update.locked_returns_409
```
