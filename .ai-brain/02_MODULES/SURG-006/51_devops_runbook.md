# DevOps Runbook — Surg-006 (SURG-006)
...
### Surg-006-specific runbook

- How to restart just the Surg-006 engine: `pm2 restart nama-medical-erp --name=surg_006`
- How to scale Surg-006: edit `pm2.config.js` → `surg_006: instances=4`
- How to clear Surg-006 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Surg-006 audit log: `node scripts/replay_audit.js --dept=SURG-006`
