# Test Observability — Er-002 (ER-002)
...
- Overall: > 80%
- Er-002 engine: > 90%
- Er-002 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
er_002.<area>.<action>.<expectation>

e.g.
er_002.create.valid_returns_201
er_002.create.invalid_returns_400
er_002.create.cross_tenant_returns_403
er_002.update.locked_returns_409
```
