...
### Er-002-specific runbook

- How to restart just the Er-002 engine: `pm2 restart nama-medical-erp --name=er_002`
- How to scale Er-002: edit `pm2.config.js` → `er_002: instances=4`
- How to clear Er-002 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Er-002 audit log: `node scripts/replay_audit.js --dept=ER-002`
