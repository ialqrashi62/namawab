# UX/UI Stitch Design — PICU (DEP-024)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: العناية المركزة للأطفال | PICU] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/picu` — main (2-col)
2. `/station/picu/orders` — full-width list
3. `/station/picu/results` — 2-col with chart
4. `/station/picu/notes` — editor + sign
