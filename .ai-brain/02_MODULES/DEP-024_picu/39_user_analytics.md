...
| Event | Properties |
|---|---|
| `dep_024_create` | tenant_id, user_id, patient_id_hash |
| `dep_024_view` | tenant_id, user_id, duration_ms |
| `dep_024_update` | tenant_id, user_id, fields_changed |
| `dep_024_delete` | tenant_id, user_id, reason |
| `dep_024_print` | tenant_id, user_id, format |
| `dep_024_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Picu primary workflow
- step 1: open Picu page
