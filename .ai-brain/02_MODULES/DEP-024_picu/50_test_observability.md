# Test Observability — Picu (DEP-024)
...
- Overall: > 80%
- Picu engine: > 90%
- Picu critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_024.<area>.<action>.<expectation>

e.g.
dep_024.create.valid_returns_201
dep_024.create.invalid_returns_400
dep_024.create.cross_tenant_returns_403
dep_024.update.locked_returns_409
```
