...
### Picu-specific runbook

- How to restart just the Picu engine: `pm2 restart nama-medical-erp --name=dep_024`
- How to scale Picu: edit `pm2.config.js` → `dep_024: instances=4`
- How to clear Picu cache: `redis-cli -n 1 FLUSHDB`
- How to replay Picu audit log: `node scripts/replay_audit.js --dept=DEP-024`
