...
|---|---|---|---|
| POST /api/dep_024/create | < 200ms | < 0.1% | ? |
| GET /api/dep_024/list | < 100ms | < 0.1% | ? |
| POST /api/dep_024/update | < 200ms | < 0.1% | ? |
