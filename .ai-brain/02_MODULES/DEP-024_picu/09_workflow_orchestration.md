# Workflow Orchestration — PICU (DEP-024)

## BPMN State Machine
```yaml
workflow:
  id: picu_patient_flow
...
|---|---|
| triage | nurse |
| assessment | picu_specialist |
| plan | picu_specialist |
| intervention | picu_specialist + nurse |
| discharge | picu_specialist |
| followup | scheduler + picu_specialist |