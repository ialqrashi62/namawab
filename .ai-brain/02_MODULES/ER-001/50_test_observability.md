# Test Observability — Er-001 (ER-001)
...
- Overall: > 80%
- Er-001 engine: > 90%
- Er-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
er_001.<area>.<action>.<expectation>

e.g.
er_001.create.valid_returns_201
er_001.create.invalid_returns_400
er_001.create.cross_tenant_returns_403
er_001.update.locked_returns_409
```
