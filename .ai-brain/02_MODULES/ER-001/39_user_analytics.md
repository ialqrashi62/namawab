...
| Event | Properties |
|---|---|
| `er_001_create` | tenant_id, user_id, patient_id_hash |
| `er_001_view` | tenant_id, user_id, duration_ms |
| `er_001_update` | tenant_id, user_id, fields_changed |
| `er_001_delete` | tenant_id, user_id, reason |
| `er_001_print` | tenant_id, user_id, format |
| `er_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Er-001 primary workflow
- step 1: open Er-001 page
