...
### Er-001-specific runbook

- How to restart just the Er-001 engine: `pm2 restart nama-medical-erp --name=er_001`
- How to scale Er-001: edit `pm2.config.js` → `er_001: instances=4`
- How to clear Er-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Er-001 audit log: `node scripts/replay_audit.js --dept=ER-001`
