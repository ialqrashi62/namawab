# Test Observability — Path-001 (PATH-001)
...
- Overall: > 80%
- Path-001 engine: > 90%
- Path-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
path_001.<area>.<action>.<expectation>

e.g.
path_001.create.valid_returns_201
path_001.create.invalid_returns_400
path_001.create.cross_tenant_returns_403
path_001.update.locked_returns_409
```
