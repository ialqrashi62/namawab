# DevOps Runbook — Path-001 (PATH-001)
...
### Path-001-specific runbook

- How to restart just the Path-001 engine: `pm2 restart nama-medical-erp --name=path_001`
- How to scale Path-001: edit `pm2.config.js` → `path_001: instances=4`
- How to clear Path-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Path-001 audit log: `node scripts/replay_audit.js --dept=PATH-001`
