# DevOps Runbook — Nephrology (DEP-005)
...
### Nephrology-specific runbook

- How to restart just the Nephrology engine: `pm2 restart nama-medical-erp --name=dep_005`
- How to scale Nephrology: edit `pm2.config.js` → `dep_005: instances=4`
- How to clear Nephrology cache: `redis-cli -n 1 FLUSHDB`
- How to replay Nephrology audit log: `node scripts/replay_audit.js --dept=DEP-005`
