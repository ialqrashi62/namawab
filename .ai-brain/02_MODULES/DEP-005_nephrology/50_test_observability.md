# Test Observability — Nephrology (DEP-005)
**Last updated:** 2026-08-10

## Tests for Nephrology
...
- Overall: > 80%
- Nephrology engine: > 90%
- Nephrology critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_005.<area>.<action>.<expectation>

e.g.
dep_005.create.valid_returns_201
dep_005.create.invalid_returns_400
dep_005.create.cross_tenant_returns_403
dep_005.update.locked_returns_409
```
