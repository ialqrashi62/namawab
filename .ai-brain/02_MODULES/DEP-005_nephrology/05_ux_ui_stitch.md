# UX/UI Stitch Design — Nephrology (DEP-005)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: أمراض الكلى | Nephrology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/nephrology` — main (2-col)
2. `/station/nephrology/orders` — full-width list
3. `/station/nephrology/results` — 2-col with chart
4. `/station/nephrology/notes` — editor + sign
