# LangChain Chains — Nephrology (DEP-005)
...
PROMPT = PromptTemplate(
  ...
  template="""أنت خبير في أمراض الكلى. أجب بالعربية. اعتمد فقط على السياق.
السياق: {context}
السؤال: {question}
الإجابة:"""
)
...
## Tools
- nephrology_guidelines_search
- nephrology_drug_search
- icd10_search
- snomed_search