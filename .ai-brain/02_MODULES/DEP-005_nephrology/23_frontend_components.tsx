// filepath: 02_MODULES/DEP-005/23_frontend_components.tsx
// Stitch components for Nephrology (DEP-005)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.NephrologyAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('nephrology');
