# Workflow Orchestration — Nephrology (DEP-005)

## BPMN State Machine
```yaml
workflow:
  id: nephrology_patient_flow
...
|---|---|
| triage | nurse |
| assessment | nephrology_specialist |
| plan | nephrology_specialist |
| intervention | nephrology_specialist + nurse |
| discharge | nephrology_specialist |
| followup | scheduler + nephrology_specialist |