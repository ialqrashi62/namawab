# User Analytics — Nephrology (DEP-005)
...
| Event | Properties |
|---|---|
| `dep_005_create` | tenant_id, user_id, patient_id_hash |
| `dep_005_view` | tenant_id, user_id, duration_ms |
| `dep_005_update` | tenant_id, user_id, fields_changed |
| `dep_005_delete` | tenant_id, user_id, reason |
| `dep_005_print` | tenant_id, user_id, format |
| `dep_005_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Nephrology primary workflow
- step 1: open Nephrology page
