# LLM Observability — Nephrology (DEP-005)
**Last updated:** 2026-08-10

## LLM usage for Nephrology

### Orchestrators

| Orchestrator | Model | Calls/day | Cost/day |
|---|---|---|---|
| Nephrology AI orchestrator | gpt-4o | ? | ? |
| Nephrology summary | gpt-4o-mini | ? | ? |
| Nephrology RAG | gpt-4o | ? | ? |
