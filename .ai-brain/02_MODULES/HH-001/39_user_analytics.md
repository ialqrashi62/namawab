...
| Event | Properties |
|---|---|
| `hh_001_create` | tenant_id, user_id, patient_id_hash |
| `hh_001_view` | tenant_id, user_id, duration_ms |
| `hh_001_update` | tenant_id, user_id, fields_changed |
| `hh_001_delete` | tenant_id, user_id, reason |
| `hh_001_print` | tenant_id, user_id, format |
| `hh_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Hh-001 primary workflow
- step 1: open Hh-001 page
