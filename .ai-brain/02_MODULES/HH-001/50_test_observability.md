# Test Observability — Hh-001 (HH-001)
...
- Overall: > 80%
- Hh-001 engine: > 90%
- Hh-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
hh_001.<area>.<action>.<expectation>

e.g.
hh_001.create.valid_returns_201
hh_001.create.invalid_returns_400
hh_001.create.cross_tenant_returns_403
hh_001.update.locked_returns_409
```
