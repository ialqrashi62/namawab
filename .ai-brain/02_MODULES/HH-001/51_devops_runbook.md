...
### Hh-001-specific runbook

- How to restart just the Hh-001 engine: `pm2 restart nama-medical-erp --name=hh_001`
- How to scale Hh-001: edit `pm2.config.js` → `hh_001: instances=4`
- How to clear Hh-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Hh-001 audit log: `node scripts/replay_audit.js --dept=HH-001`
