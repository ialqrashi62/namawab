# DevOps Runbook — Surg-008 (SURG-008)
...
### Surg-008-specific runbook

- How to restart just the Surg-008 engine: `pm2 restart nama-medical-erp --name=surg_008`
- How to scale Surg-008: edit `pm2.config.js` → `surg_008: instances=4`
- How to clear Surg-008 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Surg-008 audit log: `node scripts/replay_audit.js --dept=SURG-008`
