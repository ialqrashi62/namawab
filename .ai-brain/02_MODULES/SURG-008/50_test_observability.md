# Test Observability — Surg-008 (SURG-008)
...
- Overall: > 80%
- Surg-008 engine: > 90%
- Surg-008 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
surg_008.<area>.<action>.<expectation>

e.g.
surg_008.create.valid_returns_201
surg_008.create.invalid_returns_400
surg_008.create.cross_tenant_returns_403
surg_008.update.locked_returns_409
```
