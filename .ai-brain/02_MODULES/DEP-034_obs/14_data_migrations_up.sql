-- Migration UP for Obstetrics (DEP-034)
...
CREATE POLICY obs_enc_iso ON obs_encounters
...
ALTER TABLE obs_audit ENABLE ROW LEVEL SECURITY;
ALTER TABLE obs_audit FORCE ROW LEVEL SECURITY;
CREATE POLICY obs_audit_iso ON obs_audit
  USING (tenant_id = current_setting('app.tenant_id', true)::BIGINT);
