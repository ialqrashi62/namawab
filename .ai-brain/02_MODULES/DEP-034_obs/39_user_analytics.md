...
| Event | Properties |
|---|---|
| `dep_034_create` | tenant_id, user_id, patient_id_hash |
| `dep_034_view` | tenant_id, user_id, duration_ms |
| `dep_034_update` | tenant_id, user_id, fields_changed |
| `dep_034_delete` | tenant_id, user_id, reason |
| `dep_034_print` | tenant_id, user_id, format |
| `dep_034_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Obs primary workflow
- step 1: open Obs page
