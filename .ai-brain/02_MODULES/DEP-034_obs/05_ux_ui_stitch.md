# UX/UI Stitch Design — Obstetrics (DEP-034)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الولادة | Obstetrics] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/obs` — main (2-col)
2. `/station/obs/orders` — full-width list
3. `/station/obs/results` — 2-col with chart
4. `/station/obs/notes` — editor + sign
