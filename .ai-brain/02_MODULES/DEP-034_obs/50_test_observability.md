# Test Observability — Obs (DEP-034)
...
- Overall: > 80%
- Obs engine: > 90%
- Obs critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_034.<area>.<action>.<expectation>

e.g.
dep_034.create.valid_returns_201
dep_034.create.invalid_returns_400
dep_034.create.cross_tenant_returns_403
dep_034.update.locked_returns_409
```
