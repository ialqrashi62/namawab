# Workflow Orchestration — Obstetrics (DEP-034)
...
|---|---|
| triage | nurse |
| assessment | obs_specialist |
| plan | obs_specialist |
| intervention | obs_specialist + nurse |
| discharge | obs_specialist |
| followup | scheduler + obs_specialist |