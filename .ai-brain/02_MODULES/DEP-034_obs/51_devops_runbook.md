...
### Obs-specific runbook

- How to restart just the Obs engine: `pm2 restart nama-medical-erp --name=dep_034`
- How to scale Obs: edit `pm2.config.js` → `dep_034: instances=4`
- How to clear Obs cache: `redis-cli -n 1 FLUSHDB`
- How to replay Obs audit log: `node scripts/replay_audit.js --dept=DEP-034`
