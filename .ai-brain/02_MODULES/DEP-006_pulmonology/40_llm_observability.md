# LLM Observability — Pulmonology (DEP-006)
**Last updated:** 2026-08-10

## LLM usage for Pulmonology

### Orchestrators

| Orchestrator | Model | Calls/day | Cost/day |
|---|---|---|---|
| Pulmonology AI orchestrator | gpt-4o | ? | ? |
| Pulmonology summary | gpt-4o-mini | ? | ? |
| Pulmonology RAG | gpt-4o | ? | ? |
