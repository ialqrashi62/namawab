# DevOps Runbook — Pulmonology (DEP-006)
...
### Pulmonology-specific runbook

- How to restart just the Pulmonology engine: `pm2 restart nama-medical-erp --name=dep_006`
- How to scale Pulmonology: edit `pm2.config.js` → `dep_006: instances=4`
- How to clear Pulmonology cache: `redis-cli -n 1 FLUSHDB`
- How to replay Pulmonology audit log: `node scripts/replay_audit.js --dept=DEP-006`
