# Test Observability — Pulmonology (DEP-006)
**Last updated:** 2026-08-10

## Tests for Pulmonology
...
- Overall: > 80%
- Pulmonology engine: > 90%
- Pulmonology critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_006.<area>.<action>.<expectation>

e.g.
dep_006.create.valid_returns_201
dep_006.create.invalid_returns_400
dep_006.create.cross_tenant_returns_403
dep_006.update.locked_returns_409
```
