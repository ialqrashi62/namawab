# User Analytics — Pulmonology (DEP-006)
...
| Event | Properties |
|---|---|
| `dep_006_create` | tenant_id, user_id, patient_id_hash |
| `dep_006_view` | tenant_id, user_id, duration_ms |
| `dep_006_update` | tenant_id, user_id, fields_changed |
| `dep_006_delete` | tenant_id, user_id, reason |
| `dep_006_print` | tenant_id, user_id, format |
| `dep_006_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Pulmonology primary workflow
- step 1: open Pulmonology page
...
### Funnel 2: Pulmonology AI assist
