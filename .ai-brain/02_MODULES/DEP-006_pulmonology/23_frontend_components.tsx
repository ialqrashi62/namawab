// filepath: 02_MODULES/DEP-006/23_frontend_components.tsx
// Stitch components for Pulmonology (DEP-006)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.PulmonologyAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('pulmonology');
