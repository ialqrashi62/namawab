# LangChain Chains — Pulmonology (DEP-006)
...
PROMPT = PromptTemplate(
  ...
  template="""أنت خبير في أمراض الصدرية. أجب بالعربية. اعتمد فقط على السياق.
السياق: {context}
السؤال: {question}
الإجابة:"""
)
...
## Tools
- pulmonology_guidelines_search
- pulmonology_drug_search
- icd10_search
- snomed_search