# UX/UI Stitch Design — Pulmonology (DEP-006)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: أمراض الصدرية | Pulmonology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/pulmonology` — main (2-col)
2. `/station/pulmonology/orders` — full-width list
3. `/station/pulmonology/results` — 2-col with chart
4. `/station/pulmonology/notes` — editor + sign
