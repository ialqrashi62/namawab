# Workflow Orchestration — Pulmonology (DEP-006)

## BPMN State Machine
```yaml
workflow:
  id: pulmonology_patient_flow
...
|---|---|
| triage | nurse |
| assessment | pulmonology_specialist |
| plan | pulmonology_specialist |
| intervention | pulmonology_specialist + nurse |
| discharge | pulmonology_specialist |
| followup | scheduler + pulmonology_specialist |