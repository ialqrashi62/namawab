# Test Observability — Cardioth (DEP-014)
...
- Overall: > 80%
- Cardioth engine: > 90%
- Cardioth critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_014.<area>.<action>.<expectation>

e.g.
dep_014.create.valid_returns_201
dep_014.create.invalid_returns_400
dep_014.create.cross_tenant_returns_403
dep_014.update.locked_returns_409
```
