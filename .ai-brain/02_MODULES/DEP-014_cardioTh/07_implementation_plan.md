# Implementation Plan — Cardiothoracic_Surgery (DEP-014)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh cardioTh
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-cardioTh-<timestamp>`
