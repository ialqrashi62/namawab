# Workflow Orchestration — Cardiothoracic_Surgery (DEP-014)

## BPMN State Machine
```yaml
workflow:
  id: cardioTh_patient_flow
...
|---|---|
| triage | nurse |
| assessment | cardioTh_specialist |
| plan | cardioTh_specialist |
| intervention | cardioTh_specialist + nurse |
| discharge | cardioTh_specialist |
| followup | scheduler + cardioTh_specialist |