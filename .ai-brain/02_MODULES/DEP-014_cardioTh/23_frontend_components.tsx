// filepath: 02_MODULES/DEP-014/23_frontend_components.tsx
// Stitch components for Cardiothoracic_Surgery (DEP-014)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.CardiothAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('cardioTh');
