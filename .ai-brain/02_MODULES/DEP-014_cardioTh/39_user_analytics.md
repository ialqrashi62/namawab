# User Analytics — Cardioth (DEP-014)
...
| Event | Properties |
|---|---|
| `dep_014_create` | tenant_id, user_id, patient_id_hash |
| `dep_014_view` | tenant_id, user_id, duration_ms |
| `dep_014_update` | tenant_id, user_id, fields_changed |
| `dep_014_delete` | tenant_id, user_id, reason |
| `dep_014_print` | tenant_id, user_id, format |
| `dep_014_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Cardioth primary workflow
- step 1: open Cardioth page
