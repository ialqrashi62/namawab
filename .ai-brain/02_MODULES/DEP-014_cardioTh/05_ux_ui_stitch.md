# UX/UI Stitch Design — Cardiothoracic_Surgery (DEP-014)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: جراحة القلب والصدر | Cardiothoracic_Surgery] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/cardioTh` — main (2-col)
2. `/station/cardioTh/orders` — full-width list
3. `/station/cardioTh/results` — 2-col with chart
4. `/station/cardioTh/notes` — editor + sign
