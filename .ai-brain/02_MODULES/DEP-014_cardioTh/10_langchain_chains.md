# LangChain Chains — Cardiothoracic_Surgery (DEP-014)
...
PROMPT = PromptTemplate(
  ...
  template="""أنت خبير في جراحة القلب والصدر. أجب بالعربية. اعتمد فقط على السياق.
السياق: {context}
السؤال: {question}
الإجابة:"""
)
...
## Tools
- cardioTh_guidelines_search
- cardioTh_drug_search
- icd10_search
- snomed_search