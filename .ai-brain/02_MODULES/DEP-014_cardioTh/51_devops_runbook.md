# DevOps Runbook — Cardioth (DEP-014)
...
### Cardioth-specific runbook

- How to restart just the Cardioth engine: `pm2 restart nama-medical-erp --name=dep_014`
- How to scale Cardioth: edit `pm2.config.js` → `dep_014: instances=4`
- How to clear Cardioth cache: `redis-cli -n 1 FLUSHDB`
- How to replay Cardioth audit log: `node scripts/replay_audit.js --dept=DEP-014`
