...
- Overall: > 80%
- Ot engine: > 90%
- Ot critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_047.<area>.<action>.<expectation>

e.g.
dep_047.create.valid_returns_201
dep_047.create.invalid_returns_400
dep_047.create.cross_tenant_returns_403
dep_047.update.locked_returns_409
```
