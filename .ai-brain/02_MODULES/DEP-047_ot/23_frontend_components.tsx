// filepath: 02_MODULES/DEP-047/23_frontend_components.tsx
// Stitch components for Occupational_Therapy (DEP-047)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.OtAPI : null;
