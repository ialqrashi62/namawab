# Implementation Plan — Occupational_Therapy (DEP-047)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh ot
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-ot-<timestamp>`
