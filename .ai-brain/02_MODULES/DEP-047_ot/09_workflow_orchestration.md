# Workflow Orchestration — Occupational_Therapy (DEP-047)
...
|---|---|
| triage | nurse |
| assessment | ot_specialist |
| plan | ot_specialist |
| intervention | ot_specialist + nurse |
| discharge | ot_specialist |
| followup | scheduler + ot_specialist |