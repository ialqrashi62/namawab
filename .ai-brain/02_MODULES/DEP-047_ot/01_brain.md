# Occupational_Therapy (DEP-047) — Brain Summary
...
| English | Occupational_Therapy |
| Group | rehabilitation |
| Facility Types | medical_city, tertiary_hospital, general_hospital, rehabilitation_center, polyclinic, mental_health_center |
...
1. developmental_delay_ot
2. autism_spectrum_ot
3. sensory_processing_disorder
4. stroke_rehab_ot
5. traumatic_brain_injury_ot
6. dementia_ot
7. hand_injury_rehab
8. learning_disabilities_ot
9. work_injury_rehab
10. burn_rehab_ot
...
1. ADL_training
2. fine_motor_skills_training
3. sensory_integration_therapy
4. hand_therapy_exercise
5. splinting
6. adaptive_equipment_assessment
7. wheelchair_assessment
8. cognitive_rehabilitation
9. perceptual_training
10. visual_perceptual_training
11. environmental_modifications
12. assistive_technology_training


## Red Flags
- ⚠️ severe_developmental_regression
- ⚠️ suicidal_ideation_ot_session
- ⚠️ severe_sensory_overload
- ⚠️ aspiration_risk_during_feeding
- ⚠️ fall_risk_high_ot
