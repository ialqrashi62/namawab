...
| Event | Properties |
|---|---|
| `dep_047_create` | tenant_id, user_id, patient_id_hash |
| `dep_047_view` | tenant_id, user_id, duration_ms |
| `dep_047_update` | tenant_id, user_id, fields_changed |
| `dep_047_delete` | tenant_id, user_id, reason |
| `dep_047_print` | tenant_id, user_id, format |
| `dep_047_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Ot primary workflow
- step 1: open Ot page
