# UX/UI Stitch Design — Occupational_Therapy (DEP-047)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: العلاج الوظيفي | Occupational_Therapy] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/ot` — main (2-col)
2. `/station/ot/orders` — full-width list
3. `/station/ot/results` — 2-col with chart
4. `/station/ot/notes` — editor + sign
