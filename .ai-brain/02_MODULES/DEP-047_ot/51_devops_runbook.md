...
- How to restart just the Ot engine: `pm2 restart nama-medical-erp --name=dep_047`
- How to scale Ot: edit `pm2.config.js` → `dep_047: instances=4`
- How to clear Ot cache: `redis-cli -n 1 FLUSHDB`
- How to replay Ot audit log: `node scripts/replay_audit.js --dept=DEP-047`
