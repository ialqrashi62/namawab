# Test Observability — Peds (DEP-026)
...
- Overall: > 80%
- Peds engine: > 90%
- Peds critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_026.<area>.<action>.<expectation>

e.g.
dep_026.create.valid_returns_201
dep_026.create.invalid_returns_400
dep_026.create.cross_tenant_returns_403
dep_026.update.locked_returns_409
```
