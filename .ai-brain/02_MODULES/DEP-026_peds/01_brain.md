# General_Pediatrics (DEP-026) — Brain Summary
...
| Code | DEP-026 |
| Arabic | طب الأطفال |
| English | General_Pediatrics |
| Group | pediatrics |
| Facility Types | general_hospital, polyclinic, phc, specialty_center |
...
4. pneumonia
5. asthma
6. fever_undetermined
7. eczema
8. obesity
9. developmental_delay
10. failure_to_thrive
...
6. circumcision
7. ear_piercing
8. foreign_body_removal
9. nebulizer
10. pediatric_phlebotomy


## Red Flags
- ⚠️ neonatal_sepsis
- ⚠️ meningitis_pediatric
- ⚠️ severe_dehydration
- ⚠️ intussusception
- ⚠️ appendicitis_pediatric
