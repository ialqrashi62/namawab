// filepath: 02_MODULES/DEP-026/23_frontend_components.tsx
// Stitch components for General_Pediatrics (DEP-026)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.PedsAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('peds');
