...
### Peds-specific runbook

- How to restart just the Peds engine: `pm2 restart nama-medical-erp --name=dep_026`
- How to scale Peds: edit `pm2.config.js` → `dep_026: instances=4`
- How to clear Peds cache: `redis-cli -n 1 FLUSHDB`
- How to replay Peds audit log: `node scripts/replay_audit.js --dept=DEP-026`
