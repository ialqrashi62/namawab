# UX/UI Stitch Design — General_Pediatrics (DEP-026)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: طب الأطفال | General_Pediatrics] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/peds` — main (2-col)
2. `/station/peds/orders` — full-width list
3. `/station/peds/results` — 2-col with chart
4. `/station/peds/notes` — editor + sign
