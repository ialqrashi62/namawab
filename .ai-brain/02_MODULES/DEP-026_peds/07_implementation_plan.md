# Implementation Plan — General_Pediatrics (DEP-026)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh peds
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-peds-<timestamp>`
