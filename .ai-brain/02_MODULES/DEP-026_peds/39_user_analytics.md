...
| Event | Properties |
|---|---|
| `dep_026_create` | tenant_id, user_id, patient_id_hash |
| `dep_026_view` | tenant_id, user_id, duration_ms |
| `dep_026_update` | tenant_id, user_id, fields_changed |
| `dep_026_delete` | tenant_id, user_id, reason |
| `dep_026_print` | tenant_id, user_id, format |
| `dep_026_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Peds primary workflow
- step 1: open Peds page
