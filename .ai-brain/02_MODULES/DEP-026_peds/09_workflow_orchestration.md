# Workflow Orchestration — General_Pediatrics (DEP-026)

## BPMN State Machine
```yaml
workflow:
  id: peds_patient_flow
...
|---|---|
| triage | nurse |
| assessment | peds_specialist |
| plan | peds_specialist |
| intervention | peds_specialist + nurse |
| discharge | peds_specialist |
| followup | scheduler + peds_specialist |