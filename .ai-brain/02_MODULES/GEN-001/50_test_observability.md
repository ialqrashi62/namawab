# Test Observability — Gen-001 (GEN-001)
...
- Overall: > 80%
- Gen-001 engine: > 90%
- Gen-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
gen_001.<area>.<action>.<expectation>

e.g.
gen_001.create.valid_returns_201
gen_001.create.invalid_returns_400
gen_001.create.cross_tenant_returns_403
gen_001.update.locked_returns_409
```
