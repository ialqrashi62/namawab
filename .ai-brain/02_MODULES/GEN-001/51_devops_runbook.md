# DevOps Runbook — Gen-001 (GEN-001)
...
### Gen-001-specific runbook

- How to restart just the Gen-001 engine: `pm2 restart nama-medical-erp --name=gen_001`
- How to scale Gen-001: edit `pm2.config.js` → `gen_001: instances=4`
- How to clear Gen-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Gen-001 audit log: `node scripts/replay_audit.js --dept=GEN-001`
