# User Analytics — Plast-001 (PLAST-001)
...
| Event | Properties |
|---|---|
| `plast_001_create` | tenant_id, user_id, patient_id_hash |
| `plast_001_view` | tenant_id, user_id, duration_ms |
| `plast_001_update` | tenant_id, user_id, fields_changed |
| `plast_001_delete` | tenant_id, user_id, reason |
| `plast_001_print` | tenant_id, user_id, format |
| `plast_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Plast-001 primary workflow
- step 1: open Plast-001 page
