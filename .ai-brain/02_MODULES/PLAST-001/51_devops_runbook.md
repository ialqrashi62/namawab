# DevOps Runbook — Plast-001 (PLAST-001)
...
### Plast-001-specific runbook

- How to restart just the Plast-001 engine: `pm2 restart nama-medical-erp --name=plast_001`
- How to scale Plast-001: edit `pm2.config.js` → `plast_001: instances=4`
- How to clear Plast-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Plast-001 audit log: `node scripts/replay_audit.js --dept=PLAST-001`
