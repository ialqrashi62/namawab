# Test Observability — Plast-001 (PLAST-001)
...
- Overall: > 80%
- Plast-001 engine: > 90%
- Plast-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
plast_001.<area>.<action>.<expectation>

e.g.
plast_001.create.valid_returns_201
plast_001.create.invalid_returns_400
plast_001.create.cross_tenant_returns_403
plast_001.update.locked_returns_409
```
