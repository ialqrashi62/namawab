# Test Observability — Allergy (DEP-010)
...
- Overall: > 80%
- Allergy engine: > 90%
- Allergy critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_010.<area>.<action>.<expectation>

e.g.
dep_010.create.valid_returns_201
dep_010.create.invalid_returns_400
dep_010.create.cross_tenant_returns_403
dep_010.update.locked_returns_409
```
