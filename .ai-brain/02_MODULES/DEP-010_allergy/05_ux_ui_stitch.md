# UX/UI Stitch Design — Allergy_Immunology (DEP-010)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الحساسية والمناعة | Allergy_Immunology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/allergy` — main (2-col)
2. `/station/allergy/orders` — full-width list
3. `/station/allergy/results` — 2-col with chart
4. `/station/allergy/notes` — editor + sign
