# Workflow Orchestration — Allergy_Immunology (DEP-010)

## BPMN State Machine
```yaml
workflow:
  id: allergy_patient_flow
...
|---|---|
| triage | nurse |
| assessment | allergy_specialist |
| plan | allergy_specialist |
| intervention | allergy_specialist + nurse |
| discharge | allergy_specialist |
| followup | scheduler + allergy_specialist |