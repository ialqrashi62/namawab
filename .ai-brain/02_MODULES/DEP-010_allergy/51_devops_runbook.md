# DevOps Runbook — Allergy (DEP-010)
...
### Allergy-specific runbook

- How to restart just the Allergy engine: `pm2 restart nama-medical-erp --name=dep_010`
- How to scale Allergy: edit `pm2.config.js` → `dep_010: instances=4`
- How to clear Allergy cache: `redis-cli -n 1 FLUSHDB`
- How to replay Allergy audit log: `node scripts/replay_audit.js --dept=DEP-010`
