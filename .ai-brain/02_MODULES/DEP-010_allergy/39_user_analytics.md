# User Analytics — Allergy (DEP-010)
...
| Event | Properties |
|---|---|
| `dep_010_create` | tenant_id, user_id, patient_id_hash |
| `dep_010_view` | tenant_id, user_id, duration_ms |
| `dep_010_update` | tenant_id, user_id, fields_changed |
| `dep_010_delete` | tenant_id, user_id, reason |
| `dep_010_print` | tenant_id, user_id, format |
| `dep_010_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Allergy primary workflow
- step 1: open Allergy page
