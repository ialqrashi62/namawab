// filepath: 02_MODULES/DEP-010/23_frontend_components.tsx
// Stitch components for Allergy_Immunology (DEP-010)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.AllergyAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('allergy');
