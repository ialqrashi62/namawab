// filepath: 02_MODULES/DEP-002/23_frontend_components.tsx
// Stitch components for Endocrinology (DEP-002)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.EndocrinologyAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('endocrinology');
