# LangChain Chains — Endocrinology (DEP-002)
...
PROMPT = PromptTemplate(
  ...
  template="""أنت خبير في الغدد الصماء. أجب بالعربية. اعتمد فقط على السياق.
السياق: {context}
السؤال: {question}
الإجابة:"""
)
...
## Tools
- endocrinology_guidelines_search
- endocrinology_drug_search
- icd10_search
- snomed_search