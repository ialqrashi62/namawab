# UX/UI Stitch Design — Endocrinology (DEP-002)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الغدد الصماء | Endocrinology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/endocrinology` — main (2-col)
2. `/station/endocrinology/orders` — full-width list
3. `/station/endocrinology/results` — 2-col with chart
4. `/station/endocrinology/notes` — editor + sign
