# filepath: 02_MODULES/DEP-002/18_backend_models.py
# SQLAlchemy models for Endocrinology (DEP-002)
...
class EndocrinologyEncounter(Base):
    __tablename__ = "endocrinology_encounters"
...
class EndocrinologyOrder(Base):
    __tablename__ = "endocrinology_orders"
    id = Column(BigInteger, primary_key=True)
    tenant_id = Column(BigInteger, nullable=False, index=True)
    patient_id = Column(BigInteger, ForeignKey("patients.id"), nullable=False, index=True)
    encounter_id = Column(BigInteger, ForeignKey("endocrinology_encounters.id"))
...
class EndocrinologyResult(Base):
    __tablename__ = "endocrinology_results"
    id = Column(BigInteger, primary_key=True)
    tenant_id = Column(BigInteger, nullable=False, index=True)
    patient_id = Column(BigInteger, ForeignKey("patients.id"), nullable=False, index=True)
    encounter_id = Column(BigInteger, ForeignKey("endocrinology_encounters.id"))
    order_id = Column(BigInteger, ForeignKey("endocrinology_orders.id"))
...
class EndocrinologyNote(Base):
    __tablename__ = "endocrinology_notes"
    id = Column(BigInteger, primary_key=True)
    tenant_id = Column(BigInteger, nullable=False, index=True)
    patient_id = Column(BigInteger, ForeignKey("patients.id"), nullable=False, index=True)
    encounter_id = Column(BigInteger, ForeignKey("endocrinology_encounters.id"))
