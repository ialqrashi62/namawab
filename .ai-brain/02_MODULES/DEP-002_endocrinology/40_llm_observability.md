# LLM Observability — Endocrinology (DEP-002)
**Last updated:** 2026-08-10

## LLM usage for Endocrinology

### Orchestrators

| Orchestrator | Model | Calls/day | Cost/day |
|---|---|---|---|
| Endocrinology AI orchestrator | gpt-4o | ? | ? |
| Endocrinology summary | gpt-4o-mini | ? | ? |
| Endocrinology RAG | gpt-4o | ? | ? |
