# DevOps Runbook — Endocrinology (DEP-002)
...
### Endocrinology-specific runbook

- How to restart just the Endocrinology engine: `pm2 restart nama-medical-erp --name=dep_002`
- How to scale Endocrinology: edit `pm2.config.js` → `dep_002: instances=4`
- How to clear Endocrinology cache: `redis-cli -n 1 FLUSHDB`
- How to replay Endocrinology audit log: `node scripts/replay_audit.js --dept=DEP-002`
