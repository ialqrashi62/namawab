# Test Observability — Endocrinology (DEP-002)
**Last updated:** 2026-08-10

## Tests for Endocrinology
...
- Overall: > 80%
- Endocrinology engine: > 90%
- Endocrinology critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_002.<area>.<action>.<expectation>

e.g.
dep_002.create.valid_returns_201
dep_002.create.invalid_returns_400
dep_002.create.cross_tenant_returns_403
dep_002.update.locked_returns_409
```
