# Test Observability — Gi-001 (GI-001)
...
- Overall: > 80%
- Gi-001 engine: > 90%
- Gi-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
gi_001.<area>.<action>.<expectation>

e.g.
gi_001.create.valid_returns_201
gi_001.create.invalid_returns_400
gi_001.create.cross_tenant_returns_403
gi_001.update.locked_returns_409
```
