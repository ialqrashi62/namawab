...
| Event | Properties |
|---|---|
| `gi_001_create` | tenant_id, user_id, patient_id_hash |
| `gi_001_view` | tenant_id, user_id, duration_ms |
| `gi_001_update` | tenant_id, user_id, fields_changed |
| `gi_001_delete` | tenant_id, user_id, reason |
| `gi_001_print` | tenant_id, user_id, format |
| `gi_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Gi-001 primary workflow
- step 1: open Gi-001 page
