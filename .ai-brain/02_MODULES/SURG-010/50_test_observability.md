# Test Observability — Surg-010 (SURG-010)
...
- Overall: > 80%
- Surg-010 engine: > 90%
- Surg-010 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
surg_010.<area>.<action>.<expectation>

e.g.
surg_010.create.valid_returns_201
surg_010.create.invalid_returns_400
surg_010.create.cross_tenant_returns_403
surg_010.update.locked_returns_409
```
