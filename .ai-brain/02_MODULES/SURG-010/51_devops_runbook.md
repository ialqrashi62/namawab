# DevOps Runbook — Surg-010 (SURG-010)
...
### Surg-010-specific runbook

- How to restart just the Surg-010 engine: `pm2 restart nama-medical-erp --name=surg_010`
- How to scale Surg-010: edit `pm2.config.js` → `surg_010: instances=4`
- How to clear Surg-010 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Surg-010 audit log: `node scripts/replay_audit.js --dept=SURG-010`
