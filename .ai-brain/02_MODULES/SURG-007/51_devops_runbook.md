# DevOps Runbook — Surg-007 (SURG-007)
...
### Surg-007-specific runbook

- How to restart just the Surg-007 engine: `pm2 restart nama-medical-erp --name=surg_007`
- How to scale Surg-007: edit `pm2.config.js` → `surg_007: instances=4`
- How to clear Surg-007 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Surg-007 audit log: `node scripts/replay_audit.js --dept=SURG-007`
