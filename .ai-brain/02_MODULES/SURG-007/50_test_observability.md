# Test Observability — Surg-007 (SURG-007)
...
- Overall: > 80%
- Surg-007 engine: > 90%
- Surg-007 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
surg_007.<area>.<action>.<expectation>

e.g.
surg_007.create.valid_returns_201
surg_007.create.invalid_returns_400
surg_007.create.cross_tenant_returns_403
surg_007.update.locked_returns_409
```
