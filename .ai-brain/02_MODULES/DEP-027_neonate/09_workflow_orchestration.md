# Workflow Orchestration — Neonatology (DEP-027)

## BPMN State Machine
```yaml
workflow:
  id: neonate_patient_flow
...
|---|---|
| triage | nurse |
| assessment | neonate_specialist |
| plan | neonate_specialist |
| intervention | neonate_specialist + nurse |
| discharge | neonate_specialist |
| followup | scheduler + neonate_specialist |