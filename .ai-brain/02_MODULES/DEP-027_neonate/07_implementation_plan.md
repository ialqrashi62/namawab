# Implementation Plan — Neonatology (DEP-027)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh neonate
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-neonate-<timestamp>`
