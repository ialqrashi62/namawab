# DevOps Runbook — Neonate (DEP-027)
...
### Neonate-specific runbook

- How to restart just the Neonate engine: `pm2 restart nama-medical-erp --name=dep_027`
- How to scale Neonate: edit `pm2.config.js` → `dep_027: instances=4`
- How to clear Neonate cache: `redis-cli -n 1 FLUSHDB`
- How to replay Neonate audit log: `node scripts/replay_audit.js --dept=DEP-027`
