// filepath: 02_MODULES/DEP-027/23_frontend_components.tsx
// Stitch components for Neonatology (DEP-027)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.NeonateAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('neonate');
