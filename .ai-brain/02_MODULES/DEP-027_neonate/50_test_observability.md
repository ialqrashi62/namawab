# Test Observability — Neonate (DEP-027)
...
- Overall: > 80%
- Neonate engine: > 90%
- Neonate critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_027.<area>.<action>.<expectation>

e.g.
dep_027.create.valid_returns_201
dep_027.create.invalid_returns_400
dep_027.create.cross_tenant_returns_403
dep_027.update.locked_returns_409
```
