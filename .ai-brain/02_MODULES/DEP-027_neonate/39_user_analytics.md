# User Analytics — Neonate (DEP-027)
...
| Event | Properties |
|---|---|
| `dep_027_create` | tenant_id, user_id, patient_id_hash |
| `dep_027_view` | tenant_id, user_id, duration_ms |
| `dep_027_update` | tenant_id, user_id, fields_changed |
| `dep_027_delete` | tenant_id, user_id, reason |
| `dep_027_print` | tenant_id, user_id, format |
| `dep_027_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Neonate primary workflow
- step 1: open Neonate page
