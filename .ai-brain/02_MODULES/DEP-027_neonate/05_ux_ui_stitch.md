# UX/UI Stitch Design — Neonatology (DEP-027)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: حديثي الولادة | Neonatology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/neonate` — main (2-col)
2. `/station/neonate/orders` — full-width list
3. `/station/neonate/results` — 2-col with chart
4. `/station/neonate/notes` — editor + sign
