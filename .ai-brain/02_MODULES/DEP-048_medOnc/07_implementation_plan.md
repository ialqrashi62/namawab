# Implementation Plan — Medical_Oncology (DEP-048)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh medOnc
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-medOnc-<timestamp>`
