...
| Event | Properties |
|---|---|
| `dep_048_create` | tenant_id, user_id, patient_id_hash |
| `dep_048_view` | tenant_id, user_id, duration_ms |
| `dep_048_update` | tenant_id, user_id, fields_changed |
| `dep_048_delete` | tenant_id, user_id, reason |
| `dep_048_print` | tenant_id, user_id, format |
| `dep_048_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Medonc primary workflow
- step 1: open Medonc page
