# Workflow Orchestration — Medical_Oncology (DEP-048)

## BPMN State Machine
```yaml
workflow:
  id: medOnc_patient_flow
...
|---|---|
| triage | nurse |
| assessment | medOnc_specialist |
| plan | medOnc_specialist |
| intervention | medOnc_specialist + nurse |
| discharge | medOnc_specialist |
| followup | scheduler + medOnc_specialist |