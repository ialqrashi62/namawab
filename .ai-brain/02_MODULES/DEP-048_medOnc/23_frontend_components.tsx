// filepath: 02_MODULES/DEP-048/23_frontend_components.tsx
// Stitch components for Medical_Oncology (DEP-048)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.MedoncAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('medOnc');
