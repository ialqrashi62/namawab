# UX/UI Stitch Design — Medical_Oncology (DEP-048)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الأورام الطبية | Medical_Oncology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/medOnc` — main (2-col)
2. `/station/medOnc/orders` — full-width list
3. `/station/medOnc/results` — 2-col with chart
4. `/station/medOnc/notes` — editor + sign
