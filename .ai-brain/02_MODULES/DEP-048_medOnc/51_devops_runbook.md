...
### Medonc-specific runbook

- How to restart just the Medonc engine: `pm2 restart nama-medical-erp --name=dep_048`
- How to scale Medonc: edit `pm2.config.js` → `dep_048: instances=4`
- How to clear Medonc cache: `redis-cli -n 1 FLUSHDB`
- How to replay Medonc audit log: `node scripts/replay_audit.js --dept=DEP-048`
