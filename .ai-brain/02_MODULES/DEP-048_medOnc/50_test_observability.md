# Test Observability — Medonc (DEP-048)
...
- Overall: > 80%
- Medonc engine: > 90%
- Medonc critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_048.<area>.<action>.<expectation>

e.g.
dep_048.create.valid_returns_201
dep_048.create.invalid_returns_400
dep_048.create.cross_tenant_returns_403
dep_048.update.locked_returns_409
```
