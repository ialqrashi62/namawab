# DevOps Runbook — Algy-001 (ALGY-001)
...
### Algy-001-specific runbook

- How to restart just the Algy-001 engine: `pm2 restart nama-medical-erp --name=algy_001`
- How to scale Algy-001: edit `pm2.config.js` → `algy_001: instances=4`
- How to clear Algy-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Algy-001 audit log: `node scripts/replay_audit.js --dept=ALGY-001`
