# Test Observability — Algy-001 (ALGY-001)
...
- Overall: > 80%
- Algy-001 engine: > 90%
- Algy-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
algy_001.<area>.<action>.<expectation>

e.g.
algy_001.create.valid_returns_201
algy_001.create.invalid_returns_400
algy_001.create.cross_tenant_returns_403
algy_001.update.locked_returns_409
```
