# Test Observability — Pain (DEP-052)
...
- Overall: > 80%
- Pain engine: > 90%
- Pain critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_052.<area>.<action>.<expectation>

e.g.
dep_052.create.valid_returns_201
dep_052.create.invalid_returns_400
dep_052.create.cross_tenant_returns_403
dep_052.update.locked_returns_409
```
