...
| Event | Properties |
|---|---|
| `dep_052_create` | tenant_id, user_id, patient_id_hash |
| `dep_052_view` | tenant_id, user_id, duration_ms |
| `dep_052_update` | tenant_id, user_id, fields_changed |
| `dep_052_delete` | tenant_id, user_id, reason |
| `dep_052_print` | tenant_id, user_id, format |
| `dep_052_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Pain primary workflow
- step 1: open Pain page
