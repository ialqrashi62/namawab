# UX/UI Stitch Design — Pain_Management (DEP-052)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: علاج الألم | Pain_Management] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/pain` — main (2-col)
2. `/station/pain/orders` — full-width list
3. `/station/pain/results` — 2-col with chart
4. `/station/pain/notes` — editor + sign
