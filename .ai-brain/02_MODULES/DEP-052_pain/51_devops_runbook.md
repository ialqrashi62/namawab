...
### Pain-specific runbook

- How to restart just the Pain engine: `pm2 restart nama-medical-erp --name=dep_052`
- How to scale Pain: edit `pm2.config.js` → `dep_052: instances=4`
- How to clear Pain cache: `redis-cli -n 1 FLUSHDB`
- How to replay Pain audit log: `node scripts/replay_audit.js --dept=DEP-052`
