// filepath: 02_MODULES/DEP-052/23_frontend_components.tsx
// Stitch components for Pain_Management (DEP-052)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.PainAPI : null;
