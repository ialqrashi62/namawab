# Test Observability — Psych (DEP-044)
...
- Overall: > 80%
- Psych engine: > 90%
- Psych critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_044.<area>.<action>.<expectation>

e.g.
dep_044.create.valid_returns_201
dep_044.create.invalid_returns_400
dep_044.create.cross_tenant_returns_403
dep_044.update.locked_returns_409
```
