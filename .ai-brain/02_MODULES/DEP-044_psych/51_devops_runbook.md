...
### Psych-specific runbook

- How to restart just the Psych engine: `pm2 restart nama-medical-erp --name=dep_044`
- How to scale Psych: edit `pm2.config.js` → `dep_044: instances=4`
- How to clear Psych cache: `redis-cli -n 1 FLUSHDB`
- How to replay Psych audit log: `node scripts/replay_audit.js --dept=DEP-044`
