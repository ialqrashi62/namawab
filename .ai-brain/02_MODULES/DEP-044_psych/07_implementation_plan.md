# Implementation Plan — Psychiatry (DEP-044)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh psych
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-psych-<timestamp>`
