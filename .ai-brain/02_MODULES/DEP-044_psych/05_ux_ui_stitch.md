# UX/UI Stitch Design — Psychiatry (DEP-044)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الطب النفسي | Psychiatry] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/psych` — main (2-col)
2. `/station/psych/orders` — full-width list
3. `/station/psych/results` — 2-col with chart
4. `/station/psych/notes` — editor + sign
