// filepath: 02_MODULES/DEP-044/23_frontend_components.tsx
// Stitch components for Psychiatry (DEP-044)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.PsychAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('psych');
