...
| Event | Properties |
|---|---|
| `dep_044_create` | tenant_id, user_id, patient_id_hash |
| `dep_044_view` | tenant_id, user_id, duration_ms |
| `dep_044_update` | tenant_id, user_id, fields_changed |
| `dep_044_delete` | tenant_id, user_id, reason |
| `dep_044_print` | tenant_id, user_id, format |
| `dep_044_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Psych primary workflow
- step 1: open Psych page
