...
### Nnicu-specific runbook

- How to restart just the Nnicu engine: `pm2 restart nama-medical-erp --name=nnicu`
- How to scale Nnicu: edit `pm2.config.js` → `nnicu: instances=4`
- How to clear Nnicu cache: `redis-cli -n 1 FLUSHDB`
- How to replay Nnicu audit log: `node scripts/replay_audit.js --dept=NNICU`
