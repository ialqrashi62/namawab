# Test Observability — Nnicu (NNICU)
...
- Overall: > 80%
- Nnicu engine: > 90%
- Nnicu critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
nnicu.<area>.<action>.<expectation>

e.g.
nnicu.create.valid_returns_201
nnicu.create.invalid_returns_400
nnicu.create.cross_tenant_returns_403
nnicu.update.locked_returns_409
```
