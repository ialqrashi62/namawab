...
| Event | Properties |
|---|---|
| `nnicu_create` | tenant_id, user_id, patient_id_hash |
| `nnicu_view` | tenant_id, user_id, duration_ms |
| `nnicu_update` | tenant_id, user_id, fields_changed |
| `nnicu_delete` | tenant_id, user_id, reason |
| `nnicu_print` | tenant_id, user_id, format |
| `nnicu_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Nnicu primary workflow
- step 1: open Nnicu page
