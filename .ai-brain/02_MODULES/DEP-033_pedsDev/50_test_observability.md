# Test Observability — Pedsdev (DEP-033)
...
- Overall: > 80%
- Pedsdev engine: > 90%
- Pedsdev critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_033.<area>.<action>.<expectation>

e.g.
dep_033.create.valid_returns_201
dep_033.create.invalid_returns_400
dep_033.create.cross_tenant_returns_403
dep_033.update.locked_returns_409
```
