# Implementation Plan — Pediatric_Development_Rehab (DEP-033)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh pedsDev
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-pedsDev-<timestamp>`
