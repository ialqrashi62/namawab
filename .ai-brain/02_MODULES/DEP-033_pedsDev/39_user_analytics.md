# User Analytics — Pedsdev (DEP-033)
...
| Event | Properties |
|---|---|
| `dep_033_create` | tenant_id, user_id, patient_id_hash |
| `dep_033_view` | tenant_id, user_id, duration_ms |
| `dep_033_update` | tenant_id, user_id, fields_changed |
| `dep_033_delete` | tenant_id, user_id, reason |
| `dep_033_print` | tenant_id, user_id, format |
| `dep_033_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Pedsdev primary workflow
- step 1: open Pedsdev page
