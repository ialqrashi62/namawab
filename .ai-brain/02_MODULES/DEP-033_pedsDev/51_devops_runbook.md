# DevOps Runbook — Pedsdev (DEP-033)
...
### Pedsdev-specific runbook

- How to restart just the Pedsdev engine: `pm2 restart nama-medical-erp --name=dep_033`
- How to scale Pedsdev: edit `pm2.config.js` → `dep_033: instances=4`
- How to clear Pedsdev cache: `redis-cli -n 1 FLUSHDB`
- How to replay Pedsdev audit log: `node scripts/replay_audit.js --dept=DEP-033`
