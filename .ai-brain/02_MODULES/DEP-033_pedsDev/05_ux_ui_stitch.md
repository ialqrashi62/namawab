# UX/UI Stitch Design — Pediatric_Development_Rehab (DEP-033)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: تطور وإعادة تأهيل الأطفال | Pediatric_Development_Rehab] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/pedsDev` — main (2-col)
2. `/station/pedsDev/orders` — full-width list
3. `/station/pedsDev/results` — 2-col with chart
4. `/station/pedsDev/notes` — editor + sign
