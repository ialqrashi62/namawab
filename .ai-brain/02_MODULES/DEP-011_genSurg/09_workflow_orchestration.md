# Workflow Orchestration — General_Surgery (DEP-011)

## BPMN State Machine
```yaml
workflow:
  id: genSurg_patient_flow
...
|---|---|
| triage | nurse |
| assessment | genSurg_specialist |
| plan | genSurg_specialist |
| intervention | genSurg_specialist + nurse |
| discharge | genSurg_specialist |
| followup | scheduler + genSurg_specialist |