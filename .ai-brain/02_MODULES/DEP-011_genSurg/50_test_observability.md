# Test Observability — Gensurg (DEP-011)
...
- Overall: > 80%
- Gensurg engine: > 90%
- Gensurg critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_011.<area>.<action>.<expectation>

e.g.
dep_011.create.valid_returns_201
dep_011.create.invalid_returns_400
dep_011.create.cross_tenant_returns_403
dep_011.update.locked_returns_409
```
