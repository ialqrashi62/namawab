# DevOps Runbook — Gensurg (DEP-011)
...
### Gensurg-specific runbook

- How to restart just the Gensurg engine: `pm2 restart nama-medical-erp --name=dep_011`
- How to scale Gensurg: edit `pm2.config.js` → `dep_011: instances=4`
- How to clear Gensurg cache: `redis-cli -n 1 FLUSHDB`
- How to replay Gensurg audit log: `node scripts/replay_audit.js --dept=DEP-011`
