# Implementation Plan — General_Surgery (DEP-011)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh genSurg
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-genSurg-<timestamp>`
