# UX/UI Stitch Design — General_Surgery (DEP-011)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الجراحة العامة | General_Surgery] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/genSurg` — main (2-col)
2. `/station/genSurg/orders` — full-width list
3. `/station/genSurg/results` — 2-col with chart
4. `/station/genSurg/notes` — editor + sign
