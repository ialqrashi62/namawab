# User Analytics — Gensurg (DEP-011)
...
| Event | Properties |
|---|---|
| `dep_011_create` | tenant_id, user_id, patient_id_hash |
| `dep_011_view` | tenant_id, user_id, duration_ms |
| `dep_011_update` | tenant_id, user_id, fields_changed |
| `dep_011_delete` | tenant_id, user_id, reason |
| `dep_011_print` | tenant_id, user_id, format |
| `dep_011_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Gensurg primary workflow
- step 1: open Gensurg page
