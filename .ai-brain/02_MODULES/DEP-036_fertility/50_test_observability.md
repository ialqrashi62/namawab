# Test Observability — Fertility (DEP-036)
...
- Overall: > 80%
- Fertility engine: > 90%
- Fertility critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_036.<area>.<action>.<expectation>

e.g.
dep_036.create.valid_returns_201
dep_036.create.invalid_returns_400
dep_036.create.cross_tenant_returns_403
dep_036.update.locked_returns_409
```
