# Workflow Orchestration — Reproductive_Medicine_IVF (DEP-036)

## BPMN State Machine
```yaml
workflow:
  id: fertility_patient_flow
...
|---|---|
| triage | nurse |
| assessment | fertility_specialist |
| plan | fertility_specialist |
| intervention | fertility_specialist + nurse |
| discharge | fertility_specialist |
| followup | scheduler + fertility_specialist |