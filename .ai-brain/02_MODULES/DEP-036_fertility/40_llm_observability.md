# LLM Observability — Fertility (DEP-036)
**Last updated:** 2026-08-10

## LLM usage for Fertility

### Orchestrators

| Orchestrator | Model | Calls/day | Cost/day |
|---|---|---|---|
| Fertility AI orchestrator | gpt-4o | ? | ? |
| Fertility summary | gpt-4o-mini | ? | ? |
| Fertility RAG | gpt-4o | ? | ? |
