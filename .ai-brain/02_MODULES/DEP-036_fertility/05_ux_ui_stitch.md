# UX/UI Stitch Design — Reproductive_Medicine_IVF (DEP-036)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الإخصاب | Reproductive_Medicine_IVF] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/fertility` — main (2-col)
2. `/station/fertility/orders` — full-width list
3. `/station/fertility/results` — 2-col with chart
4. `/station/fertility/notes` — editor + sign
