# DevOps Runbook — Fertility (DEP-036)
...
### Fertility-specific runbook

- How to restart just the Fertility engine: `pm2 restart nama-medical-erp --name=dep_036`
- How to scale Fertility: edit `pm2.config.js` → `dep_036: instances=4`
- How to clear Fertility cache: `redis-cli -n 1 FLUSHDB`
- How to replay Fertility audit log: `node scripts/replay_audit.js --dept=DEP-036`
