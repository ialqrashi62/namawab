# User Analytics — Fertility (DEP-036)
...
| Event | Properties |
|---|---|
| `dep_036_create` | tenant_id, user_id, patient_id_hash |
| `dep_036_view` | tenant_id, user_id, duration_ms |
| `dep_036_update` | tenant_id, user_id, fields_changed |
| `dep_036_delete` | tenant_id, user_id, reason |
| `dep_036_print` | tenant_id, user_id, format |
| `dep_036_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Fertility primary workflow
- step 1: open Fertility page
