// filepath: 02_MODULES/DEP-036/23_frontend_components.tsx
// Stitch components for Reproductive_Medicine_IVF (DEP-036)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.FertilityAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('fertility');
