...
| Event | Properties |
|---|---|
| `dep_015_create` | tenant_id, user_id, patient_id_hash |
| `dep_015_view` | tenant_id, user_id, duration_ms |
| `dep_015_update` | tenant_id, user_id, fields_changed |
| `dep_015_delete` | tenant_id, user_id, reason |
| `dep_015_print` | tenant_id, user_id, format |
| `dep_015_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Ent primary workflow
- step 1: open Ent page
