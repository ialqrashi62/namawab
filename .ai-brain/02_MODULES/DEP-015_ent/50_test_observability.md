# Test Observability — Ent (DEP-015)
...
- Overall: > 80%
- Ent engine: > 90%
- Ent critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_015.<area>.<action>.<expectation>

e.g.
dep_015.create.valid_returns_201
dep_015.create.invalid_returns_400
dep_015.create.cross_tenant_returns_403
dep_015.update.locked_returns_409
```
