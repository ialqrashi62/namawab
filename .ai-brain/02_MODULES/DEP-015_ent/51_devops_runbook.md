...
### Ent-specific runbook

- How to restart just the Ent engine: `pm2 restart nama-medical-erp --name=dep_015`
- How to scale Ent: edit `pm2.config.js` → `dep_015: instances=4`
- How to clear Ent cache: `redis-cli -n 1 FLUSHDB`
- How to replay Ent audit log: `node scripts/replay_audit.js --dept=DEP-015`
