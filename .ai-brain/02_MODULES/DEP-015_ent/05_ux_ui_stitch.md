# UX/UI Stitch Design — ENT (DEP-015)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الأنف والأذن والحنجرة | ENT] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/ent` — main (2-col)
2. `/station/ent/orders` — full-width list
3. `/station/ent/results` — 2-col with chart
4. `/station/ent/notes` — editor + sign
