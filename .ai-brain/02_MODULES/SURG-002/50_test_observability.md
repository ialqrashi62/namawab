# Test Observability — Surg-002 (SURG-002)
...
- Overall: > 80%
- Surg-002 engine: > 90%
- Surg-002 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
surg_002.<area>.<action>.<expectation>

e.g.
surg_002.create.valid_returns_201
surg_002.create.invalid_returns_400
surg_002.create.cross_tenant_returns_403
surg_002.update.locked_returns_409
```
