# User Analytics — Surg-002 (SURG-002)
...
| Event | Properties |
|---|---|
| `surg_002_create` | tenant_id, user_id, patient_id_hash |
| `surg_002_view` | tenant_id, user_id, duration_ms |
| `surg_002_update` | tenant_id, user_id, fields_changed |
| `surg_002_delete` | tenant_id, user_id, reason |
| `surg_002_print` | tenant_id, user_id, format |
| `surg_002_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Surg-002 primary workflow
- step 1: open Surg-002 page
