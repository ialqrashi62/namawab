# DevOps Runbook — Surg-002 (SURG-002)
...
### Surg-002-specific runbook

- How to restart just the Surg-002 engine: `pm2 restart nama-medical-erp --name=surg_002`
- How to scale Surg-002: edit `pm2.config.js` → `surg_002: instances=4`
- How to clear Surg-002 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Surg-002 audit log: `node scripts/replay_audit.js --dept=SURG-002`
