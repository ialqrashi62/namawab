# UX/UI Stitch Design — Insurance_Claims_NPHIES (DEP-058)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: التأمين والمطالبات | Insurance_Claims_NPHIES] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/insurance` — main (2-col)
2. `/station/insurance/orders` — full-width list
3. `/station/insurance/results` — 2-col with chart
4. `/station/insurance/notes` — editor + sign
