// filepath: 02_MODULES/DEP-058/23_frontend_components.tsx
// Stitch components for Insurance_Claims_NPHIES (DEP-058)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.InsuranceAPI : null;
