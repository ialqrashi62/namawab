# LLM Observability — Insurance (DEP-058)
**Last updated:** 2026-08-10

## LLM usage for Insurance

### Orchestrators

| Orchestrator | Model | Calls/day | Cost/day |
|---|---|---|---|
| Insurance AI orchestrator | gpt-4o | ? | ? |
| Insurance summary | gpt-4o-mini | ? | ? |
| Insurance RAG | gpt-4o | ? | ? |
