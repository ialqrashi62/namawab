# Test Observability — Insurance (DEP-058)
...
- Overall: > 80%
- Insurance engine: > 90%
- Insurance critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_058.<area>.<action>.<expectation>

e.g.
dep_058.create.valid_returns_201
dep_058.create.invalid_returns_400
dep_058.create.cross_tenant_returns_403
dep_058.update.locked_returns_409
```
