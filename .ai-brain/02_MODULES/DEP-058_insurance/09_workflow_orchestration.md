# Workflow Orchestration — Insurance_Claims_NPHIES (DEP-058)

## BPMN State Machine
```yaml
workflow:
  id: insurance_patient_flow
...
|---|---|
| triage | nurse |
| assessment | insurance_specialist |
| plan | insurance_specialist |
| intervention | insurance_specialist + nurse |
| discharge | insurance_specialist |
| followup | scheduler + insurance_specialist |