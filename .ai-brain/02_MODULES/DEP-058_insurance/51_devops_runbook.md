# DevOps Runbook — Insurance (DEP-058)
...
### Insurance-specific runbook

- How to restart just the Insurance engine: `pm2 restart nama-medical-erp --name=dep_058`
- How to scale Insurance: edit `pm2.config.js` → `dep_058: instances=4`
- How to clear Insurance cache: `redis-cli -n 1 FLUSHDB`
- How to replay Insurance audit log: `node scripts/replay_audit.js --dept=DEP-058`
