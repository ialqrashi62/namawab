# LangChain Chains — Insurance_Claims_NPHIES (DEP-058)
...
PROMPT = PromptTemplate(
  ...
  template="""أنت خبير في التأمين والمطالبات. أجب بالعربية. اعتمد فقط على السياق.
السياق: {context}
السؤال: {question}
الإجابة:"""
)
...
## Tools
- insurance_guidelines_search
- insurance_drug_search
- icd10_search
- snomed_search