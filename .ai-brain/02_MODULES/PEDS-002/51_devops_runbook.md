# DevOps Runbook — Peds-002 (PEDS-002)
...
### Peds-002-specific runbook

- How to restart just the Peds-002 engine: `pm2 restart nama-medical-erp --name=peds_002`
- How to scale Peds-002: edit `pm2.config.js` → `peds_002: instances=4`
- How to clear Peds-002 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Peds-002 audit log: `node scripts/replay_audit.js --dept=PEDS-002`
