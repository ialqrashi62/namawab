# Test Observability — Peds-002 (PEDS-002)
...
- Overall: > 80%
- Peds-002 engine: > 90%
- Peds-002 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
peds_002.<area>.<action>.<expectation>

e.g.
peds_002.create.valid_returns_201
peds_002.create.invalid_returns_400
peds_002.create.cross_tenant_returns_403
peds_002.update.locked_returns_409
```
