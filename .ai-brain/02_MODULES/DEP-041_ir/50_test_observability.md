...
- Overall: > 80%
- Ir engine: > 90%
- Ir critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_041.<area>.<action>.<expectation>

e.g.
dep_041.create.valid_returns_201
dep_041.create.invalid_returns_400
dep_041.create.cross_tenant_returns_403
dep_041.update.locked_returns_409
```
