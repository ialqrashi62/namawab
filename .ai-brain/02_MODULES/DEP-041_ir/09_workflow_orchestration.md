# Workflow Orchestration — Interventional_Radiology (DEP-041)
...
|---|---|
| triage | nurse |
| assessment | ir_specialist |
| plan | ir_specialist |
| intervention | ir_specialist + nurse |
| discharge | ir_specialist |
| followup | scheduler + ir_specialist |