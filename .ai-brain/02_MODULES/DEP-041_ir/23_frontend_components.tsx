// filepath: 02_MODULES/DEP-041/23_frontend_components.tsx
// Stitch components for Interventional_Radiology (DEP-041)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.IrAPI : null;
