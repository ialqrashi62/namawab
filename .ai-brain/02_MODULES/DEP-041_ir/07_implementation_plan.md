# Implementation Plan — Interventional_Radiology (DEP-041)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh ir
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-ir-<timestamp>`
