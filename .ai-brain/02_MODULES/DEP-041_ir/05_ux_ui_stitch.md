# UX/UI Stitch Design — Interventional_Radiology (DEP-041)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الأشعة التداخلية | Interventional_Radiology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/ir` — main (2-col)
2. `/station/ir/orders` — full-width list
3. `/station/ir/results` — 2-col with chart
4. `/station/ir/notes` — editor + sign
