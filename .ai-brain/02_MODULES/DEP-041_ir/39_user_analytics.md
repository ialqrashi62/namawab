...
| Event | Properties |
|---|---|
| `dep_041_create` | tenant_id, user_id, patient_id_hash |
| `dep_041_view` | tenant_id, user_id, duration_ms |
| `dep_041_update` | tenant_id, user_id, fields_changed |
| `dep_041_delete` | tenant_id, user_id, reason |
| `dep_041_print` | tenant_id, user_id, format |
| `dep_041_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Ir primary workflow
- step 1: open Ir page
