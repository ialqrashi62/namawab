...
- How to restart just the Ir engine: `pm2 restart nama-medical-erp --name=dep_041`
- How to scale Ir: edit `pm2.config.js` → `dep_041: instances=4`
- How to clear Ir cache: `redis-cli -n 1 FLUSHDB`
- How to replay Ir audit log: `node scripts/replay_audit.js --dept=DEP-041`
