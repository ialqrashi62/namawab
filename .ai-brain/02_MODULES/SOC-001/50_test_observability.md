# Test Observability — Soc-001 (SOC-001)
...
- Overall: > 80%
- Soc-001 engine: > 90%
- Soc-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
soc_001.<area>.<action>.<expectation>

e.g.
soc_001.create.valid_returns_201
soc_001.create.invalid_returns_400
soc_001.create.cross_tenant_returns_403
soc_001.update.locked_returns_409
```
