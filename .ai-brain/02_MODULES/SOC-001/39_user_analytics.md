# User Analytics — Soc-001 (SOC-001)
...
| Event | Properties |
|---|---|
| `soc_001_create` | tenant_id, user_id, patient_id_hash |
| `soc_001_view` | tenant_id, user_id, duration_ms |
| `soc_001_update` | tenant_id, user_id, fields_changed |
| `soc_001_delete` | tenant_id, user_id, reason |
| `soc_001_print` | tenant_id, user_id, format |
| `soc_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Soc-001 primary workflow
- step 1: open Soc-001 page
