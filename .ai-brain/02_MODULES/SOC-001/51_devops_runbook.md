# DevOps Runbook — Soc-001 (SOC-001)
...
### Soc-001-specific runbook

- How to restart just the Soc-001 engine: `pm2 restart nama-medical-erp --name=soc_001`
- How to scale Soc-001: edit `pm2.config.js` → `soc_001: instances=4`
- How to clear Soc-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Soc-001 audit log: `node scripts/replay_audit.js --dept=SOC-001`
