# DevOps Runbook — Surg-001 (SURG-001)
...
### Surg-001-specific runbook

- How to restart just the Surg-001 engine: `pm2 restart nama-medical-erp --name=surg_001`
- How to scale Surg-001: edit `pm2.config.js` → `surg_001: instances=4`
- How to clear Surg-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Surg-001 audit log: `node scripts/replay_audit.js --dept=SURG-001`
