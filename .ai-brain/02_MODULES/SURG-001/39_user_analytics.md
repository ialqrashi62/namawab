# User Analytics — Surg-001 (SURG-001)
...
| Event | Properties |
|---|---|
| `surg_001_create` | tenant_id, user_id, patient_id_hash |
| `surg_001_view` | tenant_id, user_id, duration_ms |
| `surg_001_update` | tenant_id, user_id, fields_changed |
| `surg_001_delete` | tenant_id, user_id, reason |
| `surg_001_print` | tenant_id, user_id, format |
| `surg_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Surg-001 primary workflow
- step 1: open Surg-001 page
