# Test Observability — Surg-001 (SURG-001)
...
- Overall: > 80%
- Surg-001 engine: > 90%
- Surg-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
surg_001.<area>.<action>.<expectation>

e.g.
surg_001.create.valid_returns_201
surg_001.create.invalid_returns_400
surg_001.create.cross_tenant_returns_403
surg_001.update.locked_returns_409
```
