# DevOps Runbook — Spm-001 (SPM-001)
...
### Spm-001-specific runbook

- How to restart just the Spm-001 engine: `pm2 restart nama-medical-erp --name=spm_001`
- How to scale Spm-001: edit `pm2.config.js` → `spm_001: instances=4`
- How to clear Spm-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Spm-001 audit log: `node scripts/replay_audit.js --dept=SPM-001`
