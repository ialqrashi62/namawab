# Test Observability — Spm-001 (SPM-001)
...
- Overall: > 80%
- Spm-001 engine: > 90%
- Spm-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
spm_001.<area>.<action>.<expectation>

e.g.
spm_001.create.valid_returns_201
spm_001.create.invalid_returns_400
spm_001.create.cross_tenant_returns_403
spm_001.update.locked_returns_409
```
