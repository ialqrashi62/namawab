# User Analytics — Spm-001 (SPM-001)
...
| Event | Properties |
|---|---|
| `spm_001_create` | tenant_id, user_id, patient_id_hash |
| `spm_001_view` | tenant_id, user_id, duration_ms |
| `spm_001_update` | tenant_id, user_id, fields_changed |
| `spm_001_delete` | tenant_id, user_id, reason |
| `spm_001_print` | tenant_id, user_id, format |
| `spm_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Spm-001 primary workflow
- step 1: open Spm-001 page
