# Implementation Plan — Orthopedics (DEP-012)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh ortho
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-ortho-<timestamp>`
