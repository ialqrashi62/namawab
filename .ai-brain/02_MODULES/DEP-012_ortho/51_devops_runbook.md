...
### Ortho-specific runbook

- How to restart just the Ortho engine: `pm2 restart nama-medical-erp --name=dep_012`
- How to scale Ortho: edit `pm2.config.js` → `dep_012: instances=4`
- How to clear Ortho cache: `redis-cli -n 1 FLUSHDB`
- How to replay Ortho audit log: `node scripts/replay_audit.js --dept=DEP-012`
