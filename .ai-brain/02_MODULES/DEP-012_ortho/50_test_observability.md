# Test Observability — Ortho (DEP-012)
...
- Overall: > 80%
- Ortho engine: > 90%
- Ortho critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_012.<area>.<action>.<expectation>

e.g.
dep_012.create.valid_returns_201
dep_012.create.invalid_returns_400
dep_012.create.cross_tenant_returns_403
dep_012.update.locked_returns_409
```
