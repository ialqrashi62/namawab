# Workflow Orchestration — Orthopedics (DEP-012)

## BPMN State Machine
```yaml
workflow:
  id: ortho_patient_flow
...
|---|---|
| triage | nurse |
| assessment | ortho_specialist |
| plan | ortho_specialist |
| intervention | ortho_specialist + nurse |
| discharge | ortho_specialist |
| followup | scheduler + ortho_specialist |