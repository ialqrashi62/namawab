# UX/UI Stitch Design — Orthopedics (DEP-012)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: العظام | Orthopedics] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/ortho` — main (2-col)
2. `/station/ortho/orders` — full-width list
3. `/station/ortho/results` — 2-col with chart
4. `/station/ortho/notes` — editor + sign
