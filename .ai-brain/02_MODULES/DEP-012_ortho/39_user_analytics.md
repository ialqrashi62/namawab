...
| Event | Properties |
|---|---|
| `dep_012_create` | tenant_id, user_id, patient_id_hash |
| `dep_012_view` | tenant_id, user_id, duration_ms |
| `dep_012_update` | tenant_id, user_id, fields_changed |
| `dep_012_delete` | tenant_id, user_id, reason |
| `dep_012_print` | tenant_id, user_id, format |
| `dep_012_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Ortho primary workflow
- step 1: open Ortho page
