# Test Observability — Er-003 (ER-003)
...
- Overall: > 80%
- Er-003 engine: > 90%
- Er-003 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
er_003.<area>.<action>.<expectation>

e.g.
er_003.create.valid_returns_201
er_003.create.invalid_returns_400
er_003.create.cross_tenant_returns_403
er_003.update.locked_returns_409
```
