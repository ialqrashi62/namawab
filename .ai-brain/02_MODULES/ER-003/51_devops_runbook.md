...
### Er-003-specific runbook

- How to restart just the Er-003 engine: `pm2 restart nama-medical-erp --name=er_003`
- How to scale Er-003: edit `pm2.config.js` → `er_003: instances=4`
- How to clear Er-003 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Er-003 audit log: `node scripts/replay_audit.js --dept=ER-003`
