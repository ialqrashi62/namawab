# Implementation Plan — Maternal_Fetal_Medicine (DEP-037)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh mfm
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-mfm-<timestamp>`
