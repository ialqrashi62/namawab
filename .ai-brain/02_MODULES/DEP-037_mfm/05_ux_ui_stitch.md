# UX/UI Stitch Design — Maternal_Fetal_Medicine (DEP-037)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: طب الأم والجنين | Maternal_Fetal_Medicine] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/mfm` — main (2-col)
2. `/station/mfm/orders` — full-width list
3. `/station/mfm/results` — 2-col with chart
4. `/station/mfm/notes` — editor + sign
