...
### Mfm-specific runbook

- How to restart just the Mfm engine: `pm2 restart nama-medical-erp --name=dep_037`
- How to scale Mfm: edit `pm2.config.js` → `dep_037: instances=4`
- How to clear Mfm cache: `redis-cli -n 1 FLUSHDB`
- How to replay Mfm audit log: `node scripts/replay_audit.js --dept=DEP-037`
