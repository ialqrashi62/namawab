# Workflow Orchestration — Maternal_Fetal_Medicine (DEP-037)
...
|---|---|
| triage | nurse |
| assessment | mfm_specialist |
| plan | mfm_specialist |
| intervention | mfm_specialist + nurse |
| discharge | mfm_specialist |
| followup | scheduler + mfm_specialist |