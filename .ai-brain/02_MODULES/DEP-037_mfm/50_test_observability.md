# Test Observability — Mfm (DEP-037)
...
- Overall: > 80%
- Mfm engine: > 90%
- Mfm critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_037.<area>.<action>.<expectation>

e.g.
dep_037.create.valid_returns_201
dep_037.create.invalid_returns_400
dep_037.create.cross_tenant_returns_403
dep_037.update.locked_returns_409
```
