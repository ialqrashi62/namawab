# User Analytics — Pedsneph (DEP-030)
...
| Event | Properties |
|---|---|
| `dep_030_create` | tenant_id, user_id, patient_id_hash |
| `dep_030_view` | tenant_id, user_id, duration_ms |
| `dep_030_update` | tenant_id, user_id, fields_changed |
| `dep_030_delete` | tenant_id, user_id, reason |
| `dep_030_print` | tenant_id, user_id, format |
| `dep_030_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Pedsneph primary workflow
- step 1: open Pedsneph page
