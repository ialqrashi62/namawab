# Workflow Orchestration — Pediatric_Nephrology (DEP-030)

## BPMN State Machine
```yaml
workflow:
  id: pedsNeph_patient_flow
...
|---|---|
| triage | nurse |
| assessment | pedsNeph_specialist |
| plan | pedsNeph_specialist |
| intervention | pedsNeph_specialist + nurse |
| discharge | pedsNeph_specialist |
| followup | scheduler + pedsNeph_specialist |