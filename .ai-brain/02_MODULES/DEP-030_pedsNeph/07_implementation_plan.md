# Implementation Plan — Pediatric_Nephrology (DEP-030)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh pedsNeph
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-pedsNeph-<timestamp>`
