# Test Observability — Pedsneph (DEP-030)
...
- Overall: > 80%
- Pedsneph engine: > 90%
- Pedsneph critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_030.<area>.<action>.<expectation>

e.g.
dep_030.create.valid_returns_201
dep_030.create.invalid_returns_400
dep_030.create.cross_tenant_returns_403
dep_030.update.locked_returns_409
```
