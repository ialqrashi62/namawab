# DevOps Runbook — Pedsneph (DEP-030)
...
### Pedsneph-specific runbook

- How to restart just the Pedsneph engine: `pm2 restart nama-medical-erp --name=dep_030`
- How to scale Pedsneph: edit `pm2.config.js` → `dep_030: instances=4`
- How to clear Pedsneph cache: `redis-cli -n 1 FLUSHDB`
- How to replay Pedsneph audit log: `node scripts/replay_audit.js --dept=DEP-030`
