// filepath: 02_MODULES/DEP-030/23_frontend_components.tsx
// Stitch components for Pediatric_Nephrology (DEP-030)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.PedsnephAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('pedsNeph');
