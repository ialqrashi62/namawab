# LangChain Chains — Pediatric_Nephrology (DEP-030)
...
PROMPT = PromptTemplate(
  ...
  template="""أنت خبير في كلى الأطفال. أجب بالعربية. اعتمد فقط على السياق.
السياق: {context}
السؤال: {question}
الإجابة:"""
)
...
## Tools
- pedsNeph_guidelines_search
- pedsNeph_drug_search
- icd10_search
- snomed_search