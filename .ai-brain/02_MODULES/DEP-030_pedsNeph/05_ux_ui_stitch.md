# UX/UI Stitch Design — Pediatric_Nephrology (DEP-030)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: كلى الأطفال | Pediatric_Nephrology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/pedsNeph` — main (2-col)
2. `/station/pedsNeph/orders` — full-width list
3. `/station/pedsNeph/results` — 2-col with chart
4. `/station/pedsNeph/notes` — editor + sign
