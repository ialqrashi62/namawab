# Training Video Script — Pediatric_Nephrology (DEP-030)

> **Duration:** 15 minutes · **Generated:** 2026-08-08

## Scene 1: Introduction (2 min)
[Visual: Hospital logo + narrator]
Narrator: "Welcome to NamaMedical ERP. In this video, we cover Pediatric_Nephrology workflow."

## Scene 2: Login & Navigation (2 min)
[Visual: Screen recording]
- Open https://jumanasoft.com
- Login as pedsNeph_specialist
- Select Pediatric_Nephrology from sidebar
