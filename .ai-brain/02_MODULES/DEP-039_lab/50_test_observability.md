# Test Observability — Lab (DEP-039)
...
- Overall: > 80%
- Lab engine: > 90%
- Lab critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_039.<area>.<action>.<expectation>

e.g.
dep_039.create.valid_returns_201
dep_039.create.invalid_returns_400
dep_039.create.cross_tenant_returns_403
dep_039.update.locked_returns_409
```
