...
### Lab-specific runbook

- How to restart just the Lab engine: `pm2 restart nama-medical-erp --name=dep_039`
- How to scale Lab: edit `pm2.config.js` → `dep_039: instances=4`
- How to clear Lab cache: `redis-cli -n 1 FLUSHDB`
- How to replay Lab audit log: `node scripts/replay_audit.js --dept=DEP-039`
