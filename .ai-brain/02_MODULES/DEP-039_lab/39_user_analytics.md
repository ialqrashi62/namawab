...
| Event | Properties |
|---|---|
| `dep_039_create` | tenant_id, user_id, patient_id_hash |
| `dep_039_view` | tenant_id, user_id, duration_ms |
| `dep_039_update` | tenant_id, user_id, fields_changed |
| `dep_039_delete` | tenant_id, user_id, reason |
| `dep_039_print` | tenant_id, user_id, format |
| `dep_039_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Lab primary workflow
- step 1: open Lab page
