# LangChain Chains — Neurosurgery (DEP-013)
...
PROMPT = PromptTemplate(
  ...
  template="""أنت خبير في جراحة المخ والأعصاب. أجب بالعربية. اعتمد فقط على السياق.
السياق: {context}
السؤال: {question}
الإجابة:"""
)
...
## Tools
- neuroSurg_guidelines_search
- neuroSurg_drug_search
- icd10_search
- snomed_search