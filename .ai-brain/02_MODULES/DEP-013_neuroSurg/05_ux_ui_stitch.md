# UX/UI Stitch Design — Neurosurgery (DEP-013)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: جراحة المخ والأعصاب | Neurosurgery] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/neuroSurg` — main (2-col)
2. `/station/neuroSurg/orders` — full-width list
3. `/station/neuroSurg/results` — 2-col with chart
4. `/station/neuroSurg/notes` — editor + sign
