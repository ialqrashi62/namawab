# User Analytics — Neurosurg (DEP-013)
...
| Event | Properties |
|---|---|
| `dep_013_create` | tenant_id, user_id, patient_id_hash |
| `dep_013_view` | tenant_id, user_id, duration_ms |
| `dep_013_update` | tenant_id, user_id, fields_changed |
| `dep_013_delete` | tenant_id, user_id, reason |
| `dep_013_print` | tenant_id, user_id, format |
| `dep_013_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Neurosurg primary workflow
- step 1: open Neurosurg page
