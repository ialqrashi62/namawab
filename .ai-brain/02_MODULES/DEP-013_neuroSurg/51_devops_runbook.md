# DevOps Runbook — Neurosurg (DEP-013)
...
### Neurosurg-specific runbook

- How to restart just the Neurosurg engine: `pm2 restart nama-medical-erp --name=dep_013`
- How to scale Neurosurg: edit `pm2.config.js` → `dep_013: instances=4`
- How to clear Neurosurg cache: `redis-cli -n 1 FLUSHDB`
- How to replay Neurosurg audit log: `node scripts/replay_audit.js --dept=DEP-013`
