# Test Observability — Neurosurg (DEP-013)
...
- Overall: > 80%
- Neurosurg engine: > 90%
- Neurosurg critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_013.<area>.<action>.<expectation>

e.g.
dep_013.create.valid_returns_201
dep_013.create.invalid_returns_400
dep_013.create.cross_tenant_returns_403
dep_013.update.locked_returns_409
```
