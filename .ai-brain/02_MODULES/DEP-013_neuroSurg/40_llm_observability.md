# LLM Observability — Neurosurg (DEP-013)
**Last updated:** 2026-08-10

## LLM usage for Neurosurg

### Orchestrators

| Orchestrator | Model | Calls/day | Cost/day |
|---|---|---|---|
| Neurosurg AI orchestrator | gpt-4o | ? | ? |
| Neurosurg summary | gpt-4o-mini | ? | ? |
| Neurosurg RAG | gpt-4o | ? | ? |
