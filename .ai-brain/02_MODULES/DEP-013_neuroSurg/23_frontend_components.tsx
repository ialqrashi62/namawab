// filepath: 02_MODULES/DEP-013/23_frontend_components.tsx
// Stitch components for Neurosurgery (DEP-013)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.NeurosurgAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('neuroSurg');
