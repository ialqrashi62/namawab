# Workflow Orchestration — Neurosurgery (DEP-013)

## BPMN State Machine
```yaml
workflow:
  id: neuroSurg_patient_flow
...
|---|---|
| triage | nurse |
| assessment | neuroSurg_specialist |
| plan | neuroSurg_specialist |
| intervention | neuroSurg_specialist + nurse |
| discharge | neuroSurg_specialist |
| followup | scheduler + neuroSurg_specialist |