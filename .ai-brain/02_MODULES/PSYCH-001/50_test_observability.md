# Test Observability — Psych-001 (PSYCH-001)
...
- Overall: > 80%
- Psych-001 engine: > 90%
- Psych-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
psych_001.<area>.<action>.<expectation>

e.g.
psych_001.create.valid_returns_201
psych_001.create.invalid_returns_400
psych_001.create.cross_tenant_returns_403
psych_001.update.locked_returns_409
```
