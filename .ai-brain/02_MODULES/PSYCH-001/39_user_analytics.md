# User Analytics — Psych-001 (PSYCH-001)
...
| Event | Properties |
|---|---|
| `psych_001_create` | tenant_id, user_id, patient_id_hash |
| `psych_001_view` | tenant_id, user_id, duration_ms |
| `psych_001_update` | tenant_id, user_id, fields_changed |
| `psych_001_delete` | tenant_id, user_id, reason |
| `psych_001_print` | tenant_id, user_id, format |
| `psych_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Psych-001 primary workflow
- step 1: open Psych-001 page
