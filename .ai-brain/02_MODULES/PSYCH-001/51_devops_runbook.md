# DevOps Runbook — Psych-001 (PSYCH-001)
...
### Psych-001-specific runbook

- How to restart just the Psych-001 engine: `pm2 restart nama-medical-erp --name=psych_001`
- How to scale Psych-001: edit `pm2.config.js` → `psych_001: instances=4`
- How to clear Psych-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Psych-001 audit log: `node scripts/replay_audit.js --dept=PSYCH-001`
