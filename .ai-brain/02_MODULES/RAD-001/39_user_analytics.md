# User Analytics — Rad-001 (RAD-001)
...
| Event | Properties |
|---|---|
| `rad_001_create` | tenant_id, user_id, patient_id_hash |
| `rad_001_view` | tenant_id, user_id, duration_ms |
| `rad_001_update` | tenant_id, user_id, fields_changed |
| `rad_001_delete` | tenant_id, user_id, reason |
| `rad_001_print` | tenant_id, user_id, format |
| `rad_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Rad-001 primary workflow
- step 1: open Rad-001 page
