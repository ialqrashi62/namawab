# DevOps Runbook — Rad-001 (RAD-001)
...
### Rad-001-specific runbook

- How to restart just the Rad-001 engine: `pm2 restart nama-medical-erp --name=rad_001`
- How to scale Rad-001: edit `pm2.config.js` → `rad_001: instances=4`
- How to clear Rad-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Rad-001 audit log: `node scripts/replay_audit.js --dept=RAD-001`
