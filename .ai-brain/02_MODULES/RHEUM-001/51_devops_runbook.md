# DevOps Runbook — Rheum-001 (RHEUM-001)
...
### Rheum-001-specific runbook

- How to restart just the Rheum-001 engine: `pm2 restart nama-medical-erp --name=rheum_001`
- How to scale Rheum-001: edit `pm2.config.js` → `rheum_001: instances=4`
- How to clear Rheum-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Rheum-001 audit log: `node scripts/replay_audit.js --dept=RHEUM-001`
