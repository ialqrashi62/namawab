# User Analytics — Rheum-001 (RHEUM-001)
...
| Event | Properties |
|---|---|
| `rheum_001_create` | tenant_id, user_id, patient_id_hash |
| `rheum_001_view` | tenant_id, user_id, duration_ms |
| `rheum_001_update` | tenant_id, user_id, fields_changed |
| `rheum_001_delete` | tenant_id, user_id, reason |
| `rheum_001_print` | tenant_id, user_id, format |
| `rheum_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Rheum-001 primary workflow
- step 1: open Rheum-001 page
