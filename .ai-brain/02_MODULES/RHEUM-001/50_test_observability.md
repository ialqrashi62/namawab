# Test Observability — Rheum-001 (RHEUM-001)
...
- Overall: > 80%
- Rheum-001 engine: > 90%
- Rheum-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
rheum_001.<area>.<action>.<expectation>

e.g.
rheum_001.create.valid_returns_201
rheum_001.create.invalid_returns_400
rheum_001.create.cross_tenant_returns_403
rheum_001.update.locked_returns_409
```
