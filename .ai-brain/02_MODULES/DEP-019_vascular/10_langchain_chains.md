# LangChain Chains — Vascular_Surgery (DEP-019)
...
PROMPT = PromptTemplate(
  ...
  template="""أنت خبير في جراحة الأوعية. أجب بالعربية. اعتمد فقط على السياق.
السياق: {context}
السؤال: {question}
الإجابة:"""
)
...
## Tools
- vascular_guidelines_search
- vascular_drug_search
- icd10_search
- snomed_search