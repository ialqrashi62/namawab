# DevOps Runbook — Vascular (DEP-019)
...
### Vascular-specific runbook

- How to restart just the Vascular engine: `pm2 restart nama-medical-erp --name=dep_019`
- How to scale Vascular: edit `pm2.config.js` → `dep_019: instances=4`
- How to clear Vascular cache: `redis-cli -n 1 FLUSHDB`
- How to replay Vascular audit log: `node scripts/replay_audit.js --dept=DEP-019`
