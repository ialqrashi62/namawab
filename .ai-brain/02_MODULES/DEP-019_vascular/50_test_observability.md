# Test Observability — Vascular (DEP-019)
...
- Overall: > 80%
- Vascular engine: > 90%
- Vascular critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_019.<area>.<action>.<expectation>

e.g.
dep_019.create.valid_returns_201
dep_019.create.invalid_returns_400
dep_019.create.cross_tenant_returns_403
dep_019.update.locked_returns_409
```
