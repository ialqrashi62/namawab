// filepath: 02_MODULES/DEP-019/23_frontend_components.tsx
// Stitch components for Vascular_Surgery (DEP-019)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.VascularAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('vascular');
