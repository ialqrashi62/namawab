# UX/UI Stitch Design — Vascular_Surgery (DEP-019)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: جراحة الأوعية | Vascular_Surgery] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/vascular` — main (2-col)
2. `/station/vascular/orders` — full-width list
3. `/station/vascular/results` — 2-col with chart
4. `/station/vascular/notes` — editor + sign
