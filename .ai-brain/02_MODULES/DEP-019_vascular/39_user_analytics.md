# User Analytics — Vascular (DEP-019)
...
| Event | Properties |
|---|---|
| `dep_019_create` | tenant_id, user_id, patient_id_hash |
| `dep_019_view` | tenant_id, user_id, duration_ms |
| `dep_019_update` | tenant_id, user_id, fields_changed |
| `dep_019_delete` | tenant_id, user_id, reason |
| `dep_019_print` | tenant_id, user_id, format |
| `dep_019_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Vascular primary workflow
- step 1: open Vascular page
