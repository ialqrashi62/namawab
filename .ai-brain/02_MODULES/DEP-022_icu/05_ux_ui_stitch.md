# UX/UI Stitch Design — ICU_Adult (DEP-022)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: العناية المركزة | ICU_Adult] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/icu` — main (2-col)
2. `/station/icu/orders` — full-width list
3. `/station/icu/results` — 2-col with chart
4. `/station/icu/notes` — editor + sign
