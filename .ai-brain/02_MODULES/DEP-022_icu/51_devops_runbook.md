...
### Icu-specific runbook

- How to restart just the Icu engine: `pm2 restart nama-medical-erp --name=dep_022`
- How to scale Icu: edit `pm2.config.js` → `dep_022: instances=4`
- How to clear Icu cache: `redis-cli -n 1 FLUSHDB`
- How to replay Icu audit log: `node scripts/replay_audit.js --dept=DEP-022`
