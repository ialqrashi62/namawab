# Test Observability — Icu (DEP-022)
...
- Overall: > 80%
- Icu engine: > 90%
- Icu critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_022.<area>.<action>.<expectation>

e.g.
dep_022.create.valid_returns_201
dep_022.create.invalid_returns_400
dep_022.create.cross_tenant_returns_403
dep_022.update.locked_returns_409
```
