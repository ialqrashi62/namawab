# Workflow Orchestration — ICU_Adult (DEP-022)
...
|---|---|
| triage | nurse |
| assessment | icu_specialist |
| plan | icu_specialist |
| intervention | icu_specialist + nurse |
| discharge | icu_specialist |
| followup | scheduler + icu_specialist |