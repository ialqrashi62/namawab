...
| Event | Properties |
|---|---|
| `dep_022_create` | tenant_id, user_id, patient_id_hash |
| `dep_022_view` | tenant_id, user_id, duration_ms |
| `dep_022_update` | tenant_id, user_id, fields_changed |
| `dep_022_delete` | tenant_id, user_id, reason |
| `dep_022_print` | tenant_id, user_id, format |
| `dep_022_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Icu primary workflow
- step 1: open Icu page
