...
```
pacu.<area>.<action>.<expectation>

e.g.
pacu.create.valid_returns_201
pacu.create.invalid_returns_400
pacu.create.cross_tenant_returns_403
pacu.update.locked_returns_409
```
