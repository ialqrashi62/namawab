...
- How to restart just the Pacu engine: `pm2 restart nama-medical-erp --name=pacu`
- How to scale Pacu: edit `pm2.config.js` → `pacu: instances=4`
- How to clear Pacu cache: `redis-cli -n 1 FLUSHDB`
- How to replay Pacu audit log: `node scripts/replay_audit.js --dept=PACU`
