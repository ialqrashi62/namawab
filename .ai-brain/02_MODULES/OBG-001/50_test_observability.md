# Test Observability — Obg-001 (OBG-001)
...
- Overall: > 80%
- Obg-001 engine: > 90%
- Obg-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
obg_001.<area>.<action>.<expectation>

e.g.
obg_001.create.valid_returns_201
obg_001.create.invalid_returns_400
obg_001.create.cross_tenant_returns_403
obg_001.update.locked_returns_409
```
