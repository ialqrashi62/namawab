# User Analytics — Obg-001 (OBG-001)
...
| Event | Properties |
|---|---|
| `obg_001_create` | tenant_id, user_id, patient_id_hash |
| `obg_001_view` | tenant_id, user_id, duration_ms |
| `obg_001_update` | tenant_id, user_id, fields_changed |
| `obg_001_delete` | tenant_id, user_id, reason |
| `obg_001_print` | tenant_id, user_id, format |
| `obg_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Obg-001 primary workflow
- step 1: open Obg-001 page
