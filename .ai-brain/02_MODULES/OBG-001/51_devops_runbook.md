# DevOps Runbook — Obg-001 (OBG-001)
...
### Obg-001-specific runbook

- How to restart just the Obg-001 engine: `pm2 restart nama-medical-erp --name=obg_001`
- How to scale Obg-001: edit `pm2.config.js` → `obg_001: instances=4`
- How to clear Obg-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Obg-001 audit log: `node scripts/replay_audit.js --dept=OBG-001`
