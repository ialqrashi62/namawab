# DevOps Runbook — Anes-001 (ANES-001)
...
### Anes-001-specific runbook

- How to restart just the Anes-001 engine: `pm2 restart nama-medical-erp --name=anes_001`
- How to scale Anes-001: edit `pm2.config.js` → `anes_001: instances=4`
- How to clear Anes-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Anes-001 audit log: `node scripts/replay_audit.js --dept=ANES-001`
