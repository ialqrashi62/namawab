# Test Observability — Anes-001 (ANES-001)
...
- Overall: > 80%
- Anes-001 engine: > 90%
- Anes-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
anes_001.<area>.<action>.<expectation>

e.g.
anes_001.create.valid_returns_201
anes_001.create.invalid_returns_400
anes_001.create.cross_tenant_returns_403
anes_001.update.locked_returns_409
```
