# User Analytics — Anes-001 (ANES-001)
...
| Event | Properties |
|---|---|
| `anes_001_create` | tenant_id, user_id, patient_id_hash |
| `anes_001_view` | tenant_id, user_id, duration_ms |
| `anes_001_update` | tenant_id, user_id, fields_changed |
| `anes_001_delete` | tenant_id, user_id, reason |
| `anes_001_print` | tenant_id, user_id, format |
| `anes_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Anes-001 primary workflow
- step 1: open Anes-001 page
