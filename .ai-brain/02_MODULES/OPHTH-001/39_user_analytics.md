# User Analytics — Ophth-001 (OPHTH-001)
...
| Event | Properties |
|---|---|
| `ophth_001_create` | tenant_id, user_id, patient_id_hash |
| `ophth_001_view` | tenant_id, user_id, duration_ms |
| `ophth_001_update` | tenant_id, user_id, fields_changed |
| `ophth_001_delete` | tenant_id, user_id, reason |
| `ophth_001_print` | tenant_id, user_id, format |
| `ophth_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Ophth-001 primary workflow
- step 1: open Ophth-001 page
