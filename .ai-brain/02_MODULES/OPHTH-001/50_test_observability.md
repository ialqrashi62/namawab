# Test Observability — Ophth-001 (OPHTH-001)
...
- Overall: > 80%
- Ophth-001 engine: > 90%
- Ophth-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
ophth_001.<area>.<action>.<expectation>

e.g.
ophth_001.create.valid_returns_201
ophth_001.create.invalid_returns_400
ophth_001.create.cross_tenant_returns_403
ophth_001.update.locked_returns_409
```
