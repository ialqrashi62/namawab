# DevOps Runbook — Pedshemonc (DEP-031)
...
### Pedshemonc-specific runbook

- How to restart just the Pedshemonc engine: `pm2 restart nama-medical-erp --name=dep_031`
- How to scale Pedshemonc: edit `pm2.config.js` → `dep_031: instances=4`
- How to clear Pedshemonc cache: `redis-cli -n 1 FLUSHDB`
- How to replay Pedshemonc audit log: `node scripts/replay_audit.js --dept=DEP-031`
