# LangChain Chains — Pediatric_HemOnc (DEP-031)
...
PROMPT = PromptTemplate(
  ...
  template="""أنت خبير في دم وأورام الأطفال. أجب بالعربية. اعتمد فقط على السياق.
السياق: {context}
السؤال: {question}
الإجابة:"""
)
...
## Tools
- pedsHemOnc_guidelines_search
- pedsHemOnc_drug_search
- icd10_search
- snomed_search