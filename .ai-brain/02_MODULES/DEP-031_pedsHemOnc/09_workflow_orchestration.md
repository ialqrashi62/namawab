# Workflow Orchestration — Pediatric_HemOnc (DEP-031)

## BPMN State Machine
```yaml
workflow:
  id: pedsHemOnc_patient_flow
...
|---|---|
| triage | nurse |
| assessment | pedsHemOnc_specialist |
| plan | pedsHemOnc_specialist |
| intervention | pedsHemOnc_specialist + nurse |
| discharge | pedsHemOnc_specialist |
| followup | scheduler + pedsHemOnc_specialist |