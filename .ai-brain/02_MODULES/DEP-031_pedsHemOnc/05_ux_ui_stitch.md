# UX/UI Stitch Design — Pediatric_HemOnc (DEP-031)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: دم وأورام الأطفال | Pediatric_HemOnc] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/pedsHemOnc` — main (2-col)
2. `/station/pedsHemOnc/orders` — full-width list
3. `/station/pedsHemOnc/results` — 2-col with chart
4. `/station/pedsHemOnc/notes` — editor + sign
