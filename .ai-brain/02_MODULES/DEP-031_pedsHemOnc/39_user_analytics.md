# User Analytics — Pedshemonc (DEP-031)
...
| Event | Properties |
|---|---|
| `dep_031_create` | tenant_id, user_id, patient_id_hash |
| `dep_031_view` | tenant_id, user_id, duration_ms |
| `dep_031_update` | tenant_id, user_id, fields_changed |
| `dep_031_delete` | tenant_id, user_id, reason |
| `dep_031_print` | tenant_id, user_id, format |
| `dep_031_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Pedshemonc primary workflow
- step 1: open Pedshemonc page
