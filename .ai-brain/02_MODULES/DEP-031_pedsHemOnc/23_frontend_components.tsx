// filepath: 02_MODULES/DEP-031/23_frontend_components.tsx
// Stitch components for Pediatric_HemOnc (DEP-031)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.PedshemoncAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('pedsHemOnc');
