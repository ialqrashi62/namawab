# Pediatric_HemOnc (DEP-031) — Brain Summary

## Quick Facts
| Field | Value |
|---|---|
| Code | DEP-031 |
| Arabic | دم وأورام الأطفال |
| English | Pediatric_HemOnc |
| Group | pediatrics |
...
- general
- leukemia_pediatric
- solid_tumor_pediatric
- BMT_pediatric
- sickle_cell_pediatric
...
3. neuroblastoma
4. wilms_tumor
5. lymphoma_pediatric
6. brain_tumor_pediatric
7. sickle_cell_disease
8. thalassemia_pediatric
9. ITP_pediatric
10. hemophilia_pediatric


## Top 20 Procedures (SNOMED-CT)
1. bone_marrow_aspiration_pediatric
2. lumbar_puncture_intrathecal_pediatric
3. chemotherapy_pediatric
4. blood_transfusion_pediatric
5. platelet_transfusion_pediatric
6. BMT_pediatric
7. port_placement_pediatric
8. central_line_pediatric
9. tumor_resection_pediatric
10. radiotherapy_pediatric


## Red Flags
- ⚠️ neutropenic_fever_pediatric
- ⚠️ tumor_lysis_pediatric
- ⚠️ spinal_cord_compression_pediatric
- ⚠️ SVCS_pediatric
- ⚠️ DIC_pediatric
