# Test Observability — Pedshemonc (DEP-031)
**Last updated:** 2026-08-10

## Tests for Pedshemonc
...
- Overall: > 80%
- Pedshemonc engine: > 90%
- Pedshemonc critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_031.<area>.<action>.<expectation>

e.g.
dep_031.create.valid_returns_201
dep_031.create.invalid_returns_400
dep_031.create.cross_tenant_returns_403
dep_031.update.locked_returns_409
```
