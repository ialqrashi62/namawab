# LLM Observability — Pedshemonc (DEP-031)
**Last updated:** 2026-08-10

## LLM usage for Pedshemonc

### Orchestrators

| Orchestrator | Model | Calls/day | Cost/day |
|---|---|---|---|
| Pedshemonc AI orchestrator | gpt-4o | ? | ? |
| Pedshemonc summary | gpt-4o-mini | ? | ? |
| Pedshemonc RAG | gpt-4o | ? | ? |
