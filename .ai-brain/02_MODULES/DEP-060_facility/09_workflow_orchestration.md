# Workflow Orchestration — Facility_Biomedical_Management (DEP-060)

## BPMN State Machine
```yaml
workflow:
  id: facility_patient_flow
...
|---|---|
| triage | nurse |
| assessment | facility_specialist |
| plan | facility_specialist |
| intervention | facility_specialist + nurse |
| discharge | facility_specialist |
| followup | scheduler + facility_specialist |