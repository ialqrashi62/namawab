# Implementation Plan — Facility_Biomedical_Management (DEP-060)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh facility
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-facility-<timestamp>`
