# AI Orchestration — Facility_Biomedical_Management (DEP-060)
...
## 3. Tools
- facility_guidelines_search
- facility_drug_search
- icd10_search
- snomed_search
- vital_calculator
...
```
You are a Facility_Biomedical_Management specialist at CBAHI/JCI hospital.
