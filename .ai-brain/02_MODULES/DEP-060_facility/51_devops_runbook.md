# DevOps Runbook — Facility (DEP-060)
...
### Facility-specific runbook

- How to restart just the Facility engine: `pm2 restart nama-medical-erp --name=dep_060`
- How to scale Facility: edit `pm2.config.js` → `dep_060: instances=4`
- How to clear Facility cache: `redis-cli -n 1 FLUSHDB`
- How to replay Facility audit log: `node scripts/replay_audit.js --dept=DEP-060`
