# Test Observability — Facility (DEP-060)
...
- Overall: > 80%
- Facility engine: > 90%
- Facility critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_060.<area>.<action>.<expectation>

e.g.
dep_060.create.valid_returns_201
dep_060.create.invalid_returns_400
dep_060.create.cross_tenant_returns_403
dep_060.update.locked_returns_409
```
