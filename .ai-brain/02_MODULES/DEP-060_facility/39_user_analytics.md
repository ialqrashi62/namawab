# User Analytics — Facility (DEP-060)
...
| Event | Properties |
|---|---|
| `dep_060_create` | tenant_id, user_id, patient_id_hash |
| `dep_060_view` | tenant_id, user_id, duration_ms |
| `dep_060_update` | tenant_id, user_id, fields_changed |
| `dep_060_delete` | tenant_id, user_id, reason |
| `dep_060_print` | tenant_id, user_id, format |
| `dep_060_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Facility primary workflow
- step 1: open Facility page
