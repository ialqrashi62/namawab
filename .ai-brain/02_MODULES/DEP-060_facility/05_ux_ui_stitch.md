# UX/UI Stitch Design — Facility_Biomedical_Management (DEP-060)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: إدارة المنشأة | Facility_Biomedical_Management] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/facility` — main (2-col)
2. `/station/facility/orders` — full-width list
3. `/station/facility/results` — 2-col with chart
4. `/station/facility/notes` — editor + sign
