// filepath: 02_MODULES/DEP-060/23_frontend_components.tsx
// Stitch components for Facility_Biomedical_Management (DEP-060)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.FacilityAPI : null;
