# DevOps Runbook — Surg-004 (SURG-004)
...
### Surg-004-specific runbook

- How to restart just the Surg-004 engine: `pm2 restart nama-medical-erp --name=surg_004`
- How to scale Surg-004: edit `pm2.config.js` → `surg_004: instances=4`
- How to clear Surg-004 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Surg-004 audit log: `node scripts/replay_audit.js --dept=SURG-004`
