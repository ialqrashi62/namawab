# Test Observability — Surg-004 (SURG-004)
...
- Overall: > 80%
- Surg-004 engine: > 90%
- Surg-004 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
surg_004.<area>.<action>.<expectation>

e.g.
surg_004.create.valid_returns_201
surg_004.create.invalid_returns_400
surg_004.create.cross_tenant_returns_403
surg_004.update.locked_returns_409
```
