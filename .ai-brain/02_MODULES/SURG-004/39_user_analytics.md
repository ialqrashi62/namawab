# User Analytics — Surg-004 (SURG-004)
...
| Event | Properties |
|---|---|
| `surg_004_create` | tenant_id, user_id, patient_id_hash |
| `surg_004_view` | tenant_id, user_id, duration_ms |
| `surg_004_update` | tenant_id, user_id, fields_changed |
| `surg_004_delete` | tenant_id, user_id, reason |
| `surg_004_print` | tenant_id, user_id, format |
| `surg_004_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Surg-004 primary workflow
- step 1: open Surg-004 page
