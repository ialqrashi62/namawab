# User Analytics — Pedsneuro (DEP-029)
...
| Event | Properties |
|---|---|
| `dep_029_create` | tenant_id, user_id, patient_id_hash |
| `dep_029_view` | tenant_id, user_id, duration_ms |
| `dep_029_update` | tenant_id, user_id, fields_changed |
| `dep_029_delete` | tenant_id, user_id, reason |
| `dep_029_print` | tenant_id, user_id, format |
| `dep_029_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Pedsneuro primary workflow
- step 1: open Pedsneuro page
