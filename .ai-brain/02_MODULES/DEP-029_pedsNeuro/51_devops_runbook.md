# DevOps Runbook — Pedsneuro (DEP-029)
...
### Pedsneuro-specific runbook

- How to restart just the Pedsneuro engine: `pm2 restart nama-medical-erp --name=dep_029`
- How to scale Pedsneuro: edit `pm2.config.js` → `dep_029: instances=4`
- How to clear Pedsneuro cache: `redis-cli -n 1 FLUSHDB`
- How to replay Pedsneuro audit log: `node scripts/replay_audit.js --dept=DEP-029`
