# UX/UI Stitch Design — Pediatric_Neurology (DEP-029)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: أعصاب الأطفال | Pediatric_Neurology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/pedsNeuro` — main (2-col)
2. `/station/pedsNeuro/orders` — full-width list
3. `/station/pedsNeuro/results` — 2-col with chart
4. `/station/pedsNeuro/notes` — editor + sign
