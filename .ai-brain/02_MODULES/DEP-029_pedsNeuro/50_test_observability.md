# Test Observability — Pedsneuro (DEP-029)
...
- Overall: > 80%
- Pedsneuro engine: > 90%
- Pedsneuro critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_029.<area>.<action>.<expectation>

e.g.
dep_029.create.valid_returns_201
dep_029.create.invalid_returns_400
dep_029.create.cross_tenant_returns_403
dep_029.update.locked_returns_409
```
