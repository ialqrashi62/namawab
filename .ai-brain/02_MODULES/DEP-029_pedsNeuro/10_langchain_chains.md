# LangChain Chains — Pediatric_Neurology (DEP-029)
...
PROMPT = PromptTemplate(
  ...
  template="""أنت خبير في أعصاب الأطفال. أجب بالعربية. اعتمد فقط على السياق.
السياق: {context}
السؤال: {question}
الإجابة:"""
)
...
## Tools
- pedsNeuro_guidelines_search
- pedsNeuro_drug_search
- icd10_search
- snomed_search