# Test Observability — Vas-001 (VAS-001)
...
- Overall: > 80%
- Vas-001 engine: > 90%
- Vas-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
vas_001.<area>.<action>.<expectation>

e.g.
vas_001.create.valid_returns_201
vas_001.create.invalid_returns_400
vas_001.create.cross_tenant_returns_403
vas_001.update.locked_returns_409
```
