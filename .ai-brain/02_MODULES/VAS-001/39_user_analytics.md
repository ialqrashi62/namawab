# User Analytics — Vas-001 (VAS-001)
...
| Event | Properties |
|---|---|
| `vas_001_create` | tenant_id, user_id, patient_id_hash |
| `vas_001_view` | tenant_id, user_id, duration_ms |
| `vas_001_update` | tenant_id, user_id, fields_changed |
| `vas_001_delete` | tenant_id, user_id, reason |
| `vas_001_print` | tenant_id, user_id, format |
| `vas_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Vas-001 primary workflow
- step 1: open Vas-001 page
