# DevOps Runbook — Vas-001 (VAS-001)
...
### Vas-001-specific runbook

- How to restart just the Vas-001 engine: `pm2 restart nama-medical-erp --name=vas_001`
- How to scale Vas-001: edit `pm2.config.js` → `vas_001: instances=4`
- How to clear Vas-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Vas-001 audit log: `node scripts/replay_audit.js --dept=VAS-001`
