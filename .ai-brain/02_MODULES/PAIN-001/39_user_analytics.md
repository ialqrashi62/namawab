# User Analytics — Pain-001 (PAIN-001)
...
| Event | Properties |
|---|---|
| `pain_001_create` | tenant_id, user_id, patient_id_hash |
| `pain_001_view` | tenant_id, user_id, duration_ms |
| `pain_001_update` | tenant_id, user_id, fields_changed |
| `pain_001_delete` | tenant_id, user_id, reason |
| `pain_001_print` | tenant_id, user_id, format |
| `pain_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Pain-001 primary workflow
- step 1: open Pain-001 page
