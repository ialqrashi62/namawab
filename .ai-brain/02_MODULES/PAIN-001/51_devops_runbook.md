# DevOps Runbook — Pain-001 (PAIN-001)
...
### Pain-001-specific runbook

- How to restart just the Pain-001 engine: `pm2 restart nama-medical-erp --name=pain_001`
- How to scale Pain-001: edit `pm2.config.js` → `pain_001: instances=4`
- How to clear Pain-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Pain-001 audit log: `node scripts/replay_audit.js --dept=PAIN-001`
