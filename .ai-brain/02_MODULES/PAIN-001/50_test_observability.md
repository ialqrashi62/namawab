# Test Observability — Pain-001 (PAIN-001)
...
- Overall: > 80%
- Pain-001 engine: > 90%
- Pain-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
pain_001.<area>.<action>.<expectation>

e.g.
pain_001.create.valid_returns_201
pain_001.create.invalid_returns_400
pain_001.create.cross_tenant_returns_403
pain_001.update.locked_returns_409
```
