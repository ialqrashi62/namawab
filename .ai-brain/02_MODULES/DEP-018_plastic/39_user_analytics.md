# User Analytics — Plastic (DEP-018)
...
| Event | Properties |
|---|---|
| `dep_018_create` | tenant_id, user_id, patient_id_hash |
| `dep_018_view` | tenant_id, user_id, duration_ms |
| `dep_018_update` | tenant_id, user_id, fields_changed |
| `dep_018_delete` | tenant_id, user_id, reason |
| `dep_018_print` | tenant_id, user_id, format |
| `dep_018_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Plastic primary workflow
- step 1: open Plastic page
