# DevOps Runbook — Plastic (DEP-018)
...
### Plastic-specific runbook

- How to restart just the Plastic engine: `pm2 restart nama-medical-erp --name=dep_018`
- How to scale Plastic: edit `pm2.config.js` → `dep_018: instances=4`
- How to clear Plastic cache: `redis-cli -n 1 FLUSHDB`
- How to replay Plastic audit log: `node scripts/replay_audit.js --dept=DEP-018`
