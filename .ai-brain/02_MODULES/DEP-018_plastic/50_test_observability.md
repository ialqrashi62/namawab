# Test Observability — Plastic (DEP-018)
...
- Overall: > 80%
- Plastic engine: > 90%
- Plastic critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_018.<area>.<action>.<expectation>

e.g.
dep_018.create.valid_returns_201
dep_018.create.invalid_returns_400
dep_018.create.cross_tenant_returns_403
dep_018.update.locked_returns_409
```
