// filepath: 02_MODULES/DEP-018/23_frontend_components.tsx
// Stitch components for Plastic_Burns (DEP-018)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.PlasticAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('plastic');
