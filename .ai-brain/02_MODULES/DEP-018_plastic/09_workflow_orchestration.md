# Workflow Orchestration — Plastic_Burns (DEP-018)

## BPMN State Machine
```yaml
workflow:
  id: plastic_patient_flow
...
|---|---|
| triage | nurse |
| assessment | plastic_specialist |
| plan | plastic_specialist |
| intervention | plastic_specialist + nurse |
| discharge | plastic_specialist |
| followup | scheduler + plastic_specialist |