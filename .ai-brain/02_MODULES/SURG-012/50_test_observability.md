# Test Observability — Surg-012 (SURG-012)
...
- Overall: > 80%
- Surg-012 engine: > 90%
- Surg-012 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
surg_012.<area>.<action>.<expectation>

e.g.
surg_012.create.valid_returns_201
surg_012.create.invalid_returns_400
surg_012.create.cross_tenant_returns_403
surg_012.update.locked_returns_409
```
