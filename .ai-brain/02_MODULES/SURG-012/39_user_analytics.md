# User Analytics — Surg-012 (SURG-012)
...
| Event | Properties |
|---|---|
| `surg_012_create` | tenant_id, user_id, patient_id_hash |
| `surg_012_view` | tenant_id, user_id, duration_ms |
| `surg_012_update` | tenant_id, user_id, fields_changed |
| `surg_012_delete` | tenant_id, user_id, reason |
| `surg_012_print` | tenant_id, user_id, format |
| `surg_012_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Surg-012 primary workflow
- step 1: open Surg-012 page
