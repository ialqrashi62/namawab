# DevOps Runbook — Surg-012 (SURG-012)
...
### Surg-012-specific runbook

- How to restart just the Surg-012 engine: `pm2 restart nama-medical-erp --name=surg_012`
- How to scale Surg-012: edit `pm2.config.js` → `surg_012: instances=4`
- How to clear Surg-012 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Surg-012 audit log: `node scripts/replay_audit.js --dept=SURG-012`
