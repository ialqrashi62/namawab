# Test Observability — Nicu (DEP-023)
...
- Overall: > 80%
- Nicu engine: > 90%
- Nicu critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_023.<area>.<action>.<expectation>

e.g.
dep_023.create.valid_returns_201
dep_023.create.invalid_returns_400
dep_023.create.cross_tenant_returns_403
dep_023.update.locked_returns_409
```
