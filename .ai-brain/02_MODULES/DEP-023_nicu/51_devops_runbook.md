...
### Nicu-specific runbook

- How to restart just the Nicu engine: `pm2 restart nama-medical-erp --name=dep_023`
- How to scale Nicu: edit `pm2.config.js` → `dep_023: instances=4`
- How to clear Nicu cache: `redis-cli -n 1 FLUSHDB`
- How to replay Nicu audit log: `node scripts/replay_audit.js --dept=DEP-023`
