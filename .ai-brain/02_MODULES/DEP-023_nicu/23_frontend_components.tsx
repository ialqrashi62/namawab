// filepath: 02_MODULES/DEP-023/23_frontend_components.tsx
// Stitch components for NICU (DEP-023)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.NicuAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('nicu');
