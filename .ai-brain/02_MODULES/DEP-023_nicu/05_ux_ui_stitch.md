# UX/UI Stitch Design — NICU (DEP-023)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: العناية المركزة لحديثي الولادة | NICU] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/nicu` — main (2-col)
2. `/station/nicu/orders` — full-width list
3. `/station/nicu/results` — 2-col with chart
4. `/station/nicu/notes` — editor + sign
