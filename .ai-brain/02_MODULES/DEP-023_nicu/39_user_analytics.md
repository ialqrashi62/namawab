...
| Event | Properties |
|---|---|
| `dep_023_create` | tenant_id, user_id, patient_id_hash |
| `dep_023_view` | tenant_id, user_id, duration_ms |
| `dep_023_update` | tenant_id, user_id, fields_changed |
| `dep_023_delete` | tenant_id, user_id, reason |
| `dep_023_print` | tenant_id, user_id, format |
| `dep_023_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Nicu primary workflow
- step 1: open Nicu page
