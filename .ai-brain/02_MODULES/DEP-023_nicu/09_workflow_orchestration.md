# Workflow Orchestration — NICU (DEP-023)

## BPMN State Machine
```yaml
workflow:
  id: nicu_patient_flow
...
|---|---|
| triage | nurse |
| assessment | nicu_specialist |
| plan | nicu_specialist |
| intervention | nicu_specialist + nurse |
| discharge | nicu_specialist |
| followup | scheduler + nicu_specialist |