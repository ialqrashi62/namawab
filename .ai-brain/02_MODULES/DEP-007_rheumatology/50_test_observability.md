# Test Observability — Rheumatology (DEP-007)
**Last updated:** 2026-08-10

## Tests for Rheumatology
...
- Overall: > 80%
- Rheumatology engine: > 90%
- Rheumatology critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_007.<area>.<action>.<expectation>

e.g.
dep_007.create.valid_returns_201
dep_007.create.invalid_returns_400
dep_007.create.cross_tenant_returns_403
dep_007.update.locked_returns_409
```
