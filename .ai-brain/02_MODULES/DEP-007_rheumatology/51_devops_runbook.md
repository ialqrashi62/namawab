# DevOps Runbook — Rheumatology (DEP-007)
...
### Rheumatology-specific runbook

- How to restart just the Rheumatology engine: `pm2 restart nama-medical-erp --name=dep_007`
- How to scale Rheumatology: edit `pm2.config.js` → `dep_007: instances=4`
- How to clear Rheumatology cache: `redis-cli -n 1 FLUSHDB`
- How to replay Rheumatology audit log: `node scripts/replay_audit.js --dept=DEP-007`
