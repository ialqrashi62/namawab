# Workflow Orchestration — Rheumatology (DEP-007)

## BPMN State Machine
```yaml
workflow:
  id: rheumatology_patient_flow
...
|---|---|
| triage | nurse |
| assessment | rheumatology_specialist |
| plan | rheumatology_specialist |
| intervention | rheumatology_specialist + nurse |
| discharge | rheumatology_specialist |
| followup | scheduler + rheumatology_specialist |