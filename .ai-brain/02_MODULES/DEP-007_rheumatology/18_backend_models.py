# filepath: 02_MODULES/DEP-007/18_backend_models.py
# SQLAlchemy models for Rheumatology (DEP-007)
...
class RheumatologyEncounter(Base):
    __tablename__ = "rheumatology_encounters"
...
class RheumatologyOrder(Base):
    __tablename__ = "rheumatology_orders"
    id = Column(BigInteger, primary_key=True)
    tenant_id = Column(BigInteger, nullable=False, index=True)
    patient_id = Column(BigInteger, ForeignKey("patients.id"), nullable=False, index=True)
    encounter_id = Column(BigInteger, ForeignKey("rheumatology_encounters.id"))
...
class RheumatologyResult(Base):
    __tablename__ = "rheumatology_results"
    id = Column(BigInteger, primary_key=True)
    tenant_id = Column(BigInteger, nullable=False, index=True)
    patient_id = Column(BigInteger, ForeignKey("patients.id"), nullable=False, index=True)
    encounter_id = Column(BigInteger, ForeignKey("rheumatology_encounters.id"))
    order_id = Column(BigInteger, ForeignKey("rheumatology_orders.id"))
...
class RheumatologyNote(Base):
    __tablename__ = "rheumatology_notes"
    id = Column(BigInteger, primary_key=True)
    tenant_id = Column(BigInteger, nullable=False, index=True)
    patient_id = Column(BigInteger, ForeignKey("patients.id"), nullable=False, index=True)
    encounter_id = Column(BigInteger, ForeignKey("rheumatology_encounters.id"))
