# LLM Observability — Rheumatology (DEP-007)
**Last updated:** 2026-08-10

## LLM usage for Rheumatology

### Orchestrators

| Orchestrator | Model | Calls/day | Cost/day |
|---|---|---|---|
| Rheumatology AI orchestrator | gpt-4o | ? | ? |
| Rheumatology summary | gpt-4o-mini | ? | ? |
| Rheumatology RAG | gpt-4o | ? | ? |
