# UX/UI Stitch Design — Rheumatology (DEP-007)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الروماتيزم | Rheumatology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/rheumatology` — main (2-col)
2. `/station/rheumatology/orders` — full-width list
3. `/station/rheumatology/results` — 2-col with chart
4. `/station/rheumatology/notes` — editor + sign
