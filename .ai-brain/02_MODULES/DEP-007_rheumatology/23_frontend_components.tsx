// filepath: 02_MODULES/DEP-007/23_frontend_components.tsx
// Stitch components for Rheumatology (DEP-007)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.RheumatologyAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('rheumatology');
