# User Analytics — Rheumatology (DEP-007)
...
| Event | Properties |
|---|---|
| `dep_007_create` | tenant_id, user_id, patient_id_hash |
| `dep_007_view` | tenant_id, user_id, duration_ms |
| `dep_007_update` | tenant_id, user_id, fields_changed |
| `dep_007_delete` | tenant_id, user_id, reason |
| `dep_007_print` | tenant_id, user_id, format |
| `dep_007_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Rheumatology primary workflow
- step 1: open Rheumatology page
...
### Funnel 2: Rheumatology AI assist
