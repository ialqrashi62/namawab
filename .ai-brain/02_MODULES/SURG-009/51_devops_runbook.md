# DevOps Runbook — Surg-009 (SURG-009)
...
### Surg-009-specific runbook

- How to restart just the Surg-009 engine: `pm2 restart nama-medical-erp --name=surg_009`
- How to scale Surg-009: edit `pm2.config.js` → `surg_009: instances=4`
- How to clear Surg-009 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Surg-009 audit log: `node scripts/replay_audit.js --dept=SURG-009`
