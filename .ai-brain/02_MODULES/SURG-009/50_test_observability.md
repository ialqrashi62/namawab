# Test Observability — Surg-009 (SURG-009)
...
- Overall: > 80%
- Surg-009 engine: > 90%
- Surg-009 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
surg_009.<area>.<action>.<expectation>

e.g.
surg_009.create.valid_returns_201
surg_009.create.invalid_returns_400
surg_009.create.cross_tenant_returns_403
surg_009.update.locked_returns_409
```
