# User Analytics — Surg-009 (SURG-009)
...
| Event | Properties |
|---|---|
| `surg_009_create` | tenant_id, user_id, patient_id_hash |
| `surg_009_view` | tenant_id, user_id, duration_ms |
| `surg_009_update` | tenant_id, user_id, fields_changed |
| `surg_009_delete` | tenant_id, user_id, reason |
| `surg_009_print` | tenant_id, user_id, format |
| `surg_009_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Surg-009 primary workflow
- step 1: open Surg-009 page
