...
### Gyn-specific runbook

- How to restart just the Gyn engine: `pm2 restart nama-medical-erp --name=dep_035`
- How to scale Gyn: edit `pm2.config.js` → `dep_035: instances=4`
- How to clear Gyn cache: `redis-cli -n 1 FLUSHDB`
- How to replay Gyn audit log: `node scripts/replay_audit.js --dept=DEP-035`
