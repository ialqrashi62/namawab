# UX/UI Stitch Design — Gynecology (DEP-035)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: أمراض النساء | Gynecology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/gyn` — main (2-col)
2. `/station/gyn/orders` — full-width list
3. `/station/gyn/results` — 2-col with chart
4. `/station/gyn/notes` — editor + sign
