# Workflow Orchestration — Gynecology (DEP-035)
...
|---|---|
| triage | nurse |
| assessment | gyn_specialist |
| plan | gyn_specialist |
| intervention | gyn_specialist + nurse |
| discharge | gyn_specialist |
| followup | scheduler + gyn_specialist |