# Test Observability — Gyn (DEP-035)
...
- Overall: > 80%
- Gyn engine: > 90%
- Gyn critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_035.<area>.<action>.<expectation>

e.g.
dep_035.create.valid_returns_201
dep_035.create.invalid_returns_400
dep_035.create.cross_tenant_returns_403
dep_035.update.locked_returns_409
```
