...
| Event | Properties |
|---|---|
| `dep_035_create` | tenant_id, user_id, patient_id_hash |
| `dep_035_view` | tenant_id, user_id, duration_ms |
| `dep_035_update` | tenant_id, user_id, fields_changed |
| `dep_035_delete` | tenant_id, user_id, reason |
| `dep_035_print` | tenant_id, user_id, format |
| `dep_035_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Gyn primary workflow
- step 1: open Gyn page
