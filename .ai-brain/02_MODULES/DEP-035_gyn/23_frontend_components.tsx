// filepath: 02_MODULES/DEP-035/23_frontend_components.tsx
// Stitch components for Gynecology (DEP-035)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.GynAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('gyn');
