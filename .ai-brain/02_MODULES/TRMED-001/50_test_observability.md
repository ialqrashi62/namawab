# Test Observability — Trmed-001 (TRMED-001)
...
- Overall: > 80%
- Trmed-001 engine: > 90%
- Trmed-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
trmed_001.<area>.<action>.<expectation>

e.g.
trmed_001.create.valid_returns_201
trmed_001.create.invalid_returns_400
trmed_001.create.cross_tenant_returns_403
trmed_001.update.locked_returns_409
```
