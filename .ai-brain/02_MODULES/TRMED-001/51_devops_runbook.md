# DevOps Runbook — Trmed-001 (TRMED-001)
...
### Trmed-001-specific runbook

- How to restart just the Trmed-001 engine: `pm2 restart nama-medical-erp --name=trmed_001`
- How to scale Trmed-001: edit `pm2.config.js` → `trmed_001: instances=4`
- How to clear Trmed-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Trmed-001 audit log: `node scripts/replay_audit.js --dept=TRMED-001`
