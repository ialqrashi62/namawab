# Implementation Plan — Hematology_Oncology (DEP-004)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh hemOnc
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-hemOnc-<timestamp>`
