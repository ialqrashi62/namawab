// filepath: 02_MODULES/DEP-004/23_frontend_components.tsx
// Stitch components for Hematology_Oncology (DEP-004)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.HemoncAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('hemOnc');
