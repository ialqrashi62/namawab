...
| Event | Properties |
|---|---|
| `dep_004_create` | tenant_id, user_id, patient_id_hash |
| `dep_004_view` | tenant_id, user_id, duration_ms |
| `dep_004_update` | tenant_id, user_id, fields_changed |
| `dep_004_delete` | tenant_id, user_id, reason |
| `dep_004_print` | tenant_id, user_id, format |
| `dep_004_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Hemonc primary workflow
- step 1: open Hemonc page
