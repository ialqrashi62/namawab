# UX/UI Stitch Design — Hematology_Oncology (DEP-004)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: أمراض الدم والأورام | Hematology_Oncology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/hemOnc` — main (2-col)
2. `/station/hemOnc/orders` — full-width list
3. `/station/hemOnc/results` — 2-col with chart
4. `/station/hemOnc/notes` — editor + sign
