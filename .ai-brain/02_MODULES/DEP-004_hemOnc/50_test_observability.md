# Test Observability — Hemonc (DEP-004)
...
- Overall: > 80%
- Hemonc engine: > 90%
- Hemonc critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_004.<area>.<action>.<expectation>

e.g.
dep_004.create.valid_returns_201
dep_004.create.invalid_returns_400
dep_004.create.cross_tenant_returns_403
dep_004.update.locked_returns_409
```
