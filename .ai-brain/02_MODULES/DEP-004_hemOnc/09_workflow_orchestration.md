# Workflow Orchestration — Hematology_Oncology (DEP-004)

## BPMN State Machine
```yaml
workflow:
  id: hemOnc_patient_flow
...
|---|---|
| triage | nurse |
| assessment | hemOnc_specialist |
| plan | hemOnc_specialist |
| intervention | hemOnc_specialist + nurse |
| discharge | hemOnc_specialist |
| followup | scheduler + hemOnc_specialist |