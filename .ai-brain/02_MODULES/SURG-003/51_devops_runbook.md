# DevOps Runbook — Surg-003 (SURG-003)
...
### Surg-003-specific runbook

- How to restart just the Surg-003 engine: `pm2 restart nama-medical-erp --name=surg_003`
- How to scale Surg-003: edit `pm2.config.js` → `surg_003: instances=4`
- How to clear Surg-003 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Surg-003 audit log: `node scripts/replay_audit.js --dept=SURG-003`
