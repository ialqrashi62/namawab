# Test Observability — Surg-003 (SURG-003)
...
- Overall: > 80%
- Surg-003 engine: > 90%
- Surg-003 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
surg_003.<area>.<action>.<expectation>

e.g.
surg_003.create.valid_returns_201
surg_003.create.invalid_returns_400
surg_003.create.cross_tenant_returns_403
surg_003.update.locked_returns_409
```
