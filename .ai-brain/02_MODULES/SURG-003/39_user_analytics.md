# User Analytics — Surg-003 (SURG-003)
...
| Event | Properties |
|---|---|
| `surg_003_create` | tenant_id, user_id, patient_id_hash |
| `surg_003_view` | tenant_id, user_id, duration_ms |
| `surg_003_update` | tenant_id, user_id, fields_changed |
| `surg_003_delete` | tenant_id, user_id, reason |
| `surg_003_print` | tenant_id, user_id, format |
| `surg_003_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Surg-003 primary workflow
- step 1: open Surg-003 page
