...
| Event | Properties |
|---|---|
| `sicu_create` | tenant_id, user_id, patient_id_hash |
| `sicu_view` | tenant_id, user_id, duration_ms |
| `sicu_update` | tenant_id, user_id, fields_changed |
| `sicu_delete` | tenant_id, user_id, reason |
| `sicu_print` | tenant_id, user_id, format |
| `sicu_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Sicu primary workflow
- step 1: open Sicu page
