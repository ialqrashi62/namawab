...
- Overall: > 80%
- Sicu engine: > 90%
- Sicu critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
sicu.<area>.<action>.<expectation>

e.g.
sicu.create.valid_returns_201
sicu.create.invalid_returns_400
sicu.create.cross_tenant_returns_403
sicu.update.locked_returns_409
```
