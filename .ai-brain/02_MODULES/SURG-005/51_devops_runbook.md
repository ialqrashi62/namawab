# DevOps Runbook — Surg-005 (SURG-005)
...
### Surg-005-specific runbook

- How to restart just the Surg-005 engine: `pm2 restart nama-medical-erp --name=surg_005`
- How to scale Surg-005: edit `pm2.config.js` → `surg_005: instances=4`
- How to clear Surg-005 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Surg-005 audit log: `node scripts/replay_audit.js --dept=SURG-005`
