# Test Observability — Surg-005 (SURG-005)
...
- Overall: > 80%
- Surg-005 engine: > 90%
- Surg-005 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
surg_005.<area>.<action>.<expectation>

e.g.
surg_005.create.valid_returns_201
surg_005.create.invalid_returns_400
surg_005.create.cross_tenant_returns_403
surg_005.update.locked_returns_409
```
