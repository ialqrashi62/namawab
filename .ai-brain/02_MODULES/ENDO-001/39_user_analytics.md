# User Analytics — Endo-001 (ENDO-001)
...
| Event | Properties |
|---|---|
| `endo_001_create` | tenant_id, user_id, patient_id_hash |
| `endo_001_view` | tenant_id, user_id, duration_ms |
| `endo_001_update` | tenant_id, user_id, fields_changed |
| `endo_001_delete` | tenant_id, user_id, reason |
| `endo_001_print` | tenant_id, user_id, format |
| `endo_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Endo-001 primary workflow
- step 1: open Endo-001 page
