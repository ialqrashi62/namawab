# Test Observability — Endo-001 (ENDO-001)
...
- Overall: > 80%
- Endo-001 engine: > 90%
- Endo-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
endo_001.<area>.<action>.<expectation>

e.g.
endo_001.create.valid_returns_201
endo_001.create.invalid_returns_400
endo_001.create.cross_tenant_returns_403
endo_001.update.locked_returns_409
```
