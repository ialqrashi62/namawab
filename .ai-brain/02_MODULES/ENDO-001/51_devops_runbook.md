# DevOps Runbook — Endo-001 (ENDO-001)
...
### Endo-001-specific runbook

- How to restart just the Endo-001 engine: `pm2 restart nama-medical-erp --name=endo_001`
- How to scale Endo-001: edit `pm2.config.js` → `endo_001: instances=4`
- How to clear Endo-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Endo-001 audit log: `node scripts/replay_audit.js --dept=ENDO-001`
