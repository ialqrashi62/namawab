...
| Event | Properties |
|---|---|
| `picu_create` | tenant_id, user_id, patient_id_hash |
| `picu_view` | tenant_id, user_id, duration_ms |
| `picu_update` | tenant_id, user_id, fields_changed |
| `picu_delete` | tenant_id, user_id, reason |
| `picu_print` | tenant_id, user_id, format |
| `picu_export` | tenant_id, user_id, format, rows |
