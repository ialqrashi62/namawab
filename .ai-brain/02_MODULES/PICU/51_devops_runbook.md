...
- How to restart just the Picu engine: `pm2 restart nama-medical-erp --name=picu`
- How to scale Picu: edit `pm2.config.js` → `picu: instances=4`
- How to clear Picu cache: `redis-cli -n 1 FLUSHDB`
- How to replay Picu audit log: `node scripts/replay_audit.js --dept=PICU`
