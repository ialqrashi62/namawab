...
```
picu.<area>.<action>.<expectation>

e.g.
picu.create.valid_returns_201
picu.create.invalid_returns_400
picu.create.cross_tenant_returns_403
picu.update.locked_returns_409
```
