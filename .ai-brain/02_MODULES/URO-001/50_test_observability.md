# Test Observability — Uro-001 (URO-001)
...
- Overall: > 80%
- Uro-001 engine: > 90%
- Uro-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
uro_001.<area>.<action>.<expectation>

e.g.
uro_001.create.valid_returns_201
uro_001.create.invalid_returns_400
uro_001.create.cross_tenant_returns_403
uro_001.update.locked_returns_409
```
