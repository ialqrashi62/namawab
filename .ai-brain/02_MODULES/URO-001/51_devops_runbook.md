# DevOps Runbook — Uro-001 (URO-001)
...
### Uro-001-specific runbook

- How to restart just the Uro-001 engine: `pm2 restart nama-medical-erp --name=uro_001`
- How to scale Uro-001: edit `pm2.config.js` → `uro_001: instances=4`
- How to clear Uro-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Uro-001 audit log: `node scripts/replay_audit.js --dept=URO-001`
