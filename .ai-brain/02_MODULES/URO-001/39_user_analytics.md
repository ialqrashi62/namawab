# User Analytics — Uro-001 (URO-001)
...
| Event | Properties |
|---|---|
| `uro_001_create` | tenant_id, user_id, patient_id_hash |
| `uro_001_view` | tenant_id, user_id, duration_ms |
| `uro_001_update` | tenant_id, user_id, fields_changed |
| `uro_001_delete` | tenant_id, user_id, reason |
| `uro_001_print` | tenant_id, user_id, format |
| `uro_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Uro-001 primary workflow
- step 1: open Uro-001 page
