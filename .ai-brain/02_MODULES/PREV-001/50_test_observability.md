# Test Observability — Prev-001 (PREV-001)
...
- Overall: > 80%
- Prev-001 engine: > 90%
- Prev-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
prev_001.<area>.<action>.<expectation>

e.g.
prev_001.create.valid_returns_201
prev_001.create.invalid_returns_400
prev_001.create.cross_tenant_returns_403
prev_001.update.locked_returns_409
```
