# DevOps Runbook — Prev-001 (PREV-001)
...
### Prev-001-specific runbook

- How to restart just the Prev-001 engine: `pm2 restart nama-medical-erp --name=prev_001`
- How to scale Prev-001: edit `pm2.config.js` → `prev_001: instances=4`
- How to clear Prev-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Prev-001 audit log: `node scripts/replay_audit.js --dept=PREV-001`
