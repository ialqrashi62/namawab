# User Analytics — Prev-001 (PREV-001)
...
| Event | Properties |
|---|---|
| `prev_001_create` | tenant_id, user_id, patient_id_hash |
| `prev_001_view` | tenant_id, user_id, duration_ms |
| `prev_001_update` | tenant_id, user_id, fields_changed |
| `prev_001_delete` | tenant_id, user_id, reason |
| `prev_001_print` | tenant_id, user_id, format |
| `prev_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Prev-001 primary workflow
- step 1: open Prev-001 page
