# User Analytics — Lab-001 (LAB-001)
...
| Event | Properties |
|---|---|
| `lab_001_create` | tenant_id, user_id, patient_id_hash |
| `lab_001_view` | tenant_id, user_id, duration_ms |
| `lab_001_update` | tenant_id, user_id, fields_changed |
| `lab_001_delete` | tenant_id, user_id, reason |
| `lab_001_print` | tenant_id, user_id, format |
| `lab_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Lab-001 primary workflow
- step 1: open Lab-001 page
