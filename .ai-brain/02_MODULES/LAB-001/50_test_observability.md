# Test Observability — Lab-001 (LAB-001)
...
- Overall: > 80%
- Lab-001 engine: > 90%
- Lab-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
lab_001.<area>.<action>.<expectation>

e.g.
lab_001.create.valid_returns_201
lab_001.create.invalid_returns_400
lab_001.create.cross_tenant_returns_403
lab_001.update.locked_returns_409
```
