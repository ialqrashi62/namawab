# DevOps Runbook — Lab-001 (LAB-001)
...
### Lab-001-specific runbook

- How to restart just the Lab-001 engine: `pm2 restart nama-medical-erp --name=lab_001`
- How to scale Lab-001: edit `pm2.config.js` → `lab_001: instances=4`
- How to clear Lab-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Lab-001 audit log: `node scripts/replay_audit.js --dept=LAB-001`
