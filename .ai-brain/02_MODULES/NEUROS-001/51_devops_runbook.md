# DevOps Runbook — Neuros-001 (NEUROS-001)
...
### Neuros-001-specific runbook

- How to restart just the Neuros-001 engine: `pm2 restart nama-medical-erp --name=neuros_001`
- How to scale Neuros-001: edit `pm2.config.js` → `neuros_001: instances=4`
- How to clear Neuros-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Neuros-001 audit log: `node scripts/replay_audit.js --dept=NEUROS-001`
