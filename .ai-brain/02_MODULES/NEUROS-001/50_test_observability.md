# Test Observability — Neuros-001 (NEUROS-001)
**Last updated:** 2026-08-10

## Tests for Neuros-001
...
- Overall: > 80%
- Neuros-001 engine: > 90%
- Neuros-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
neuros_001.<area>.<action>.<expectation>

e.g.
neuros_001.create.valid_returns_201
neuros_001.create.invalid_returns_400
neuros_001.create.cross_tenant_returns_403
neuros_001.update.locked_returns_409
```
