# User Analytics — Emergency (DEP-021)
...
| Event | Properties |
|---|---|
| `dep_021_create` | tenant_id, user_id, patient_id_hash |
| `dep_021_view` | tenant_id, user_id, duration_ms |
| `dep_021_update` | tenant_id, user_id, fields_changed |
| `dep_021_delete` | tenant_id, user_id, reason |
| `dep_021_print` | tenant_id, user_id, format |
| `dep_021_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Emergency primary workflow
