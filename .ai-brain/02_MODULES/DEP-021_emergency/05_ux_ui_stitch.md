# UX/UI Stitch Design — Emergency (DEP-021)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الطوارئ | Emergency] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/emergency` — main (2-col)
2. `/station/emergency/orders` — full-width list
3. `/station/emergency/results` — 2-col with chart
4. `/station/emergency/notes` — editor + sign
