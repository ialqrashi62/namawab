# Test Observability — Emergency (DEP-021)
...
- Overall: > 80%
- Emergency engine: > 90%
- Emergency critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_021.<area>.<action>.<expectation>

e.g.
dep_021.create.valid_returns_201
dep_021.create.invalid_returns_400
dep_021.create.cross_tenant_returns_403
dep_021.update.locked_returns_409
```
