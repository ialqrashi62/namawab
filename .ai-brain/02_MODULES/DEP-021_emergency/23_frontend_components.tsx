// filepath: 02_MODULES/DEP-021/23_frontend_components.tsx
// Stitch components for Emergency (DEP-021)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.EmergencyAPI : null;
