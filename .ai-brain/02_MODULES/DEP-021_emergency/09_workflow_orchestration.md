# Workflow Orchestration — Emergency (DEP-021)

## BPMN State Machine
```yaml
workflow:
  id: emergency_patient_flow
...
|---|---|
| triage | nurse |
| assessment | emergency_specialist |
| plan | emergency_specialist |
| intervention | emergency_specialist + nurse |
| discharge | emergency_specialist |
| followup | scheduler + emergency_specialist |