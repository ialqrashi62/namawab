# DevOps Runbook — Emergency (DEP-021)
...
### Emergency-specific runbook

- How to restart just the Emergency engine: `pm2 restart nama-medical-erp --name=dep_021`
- How to scale Emergency: edit `pm2.config.js` → `dep_021: instances=4`
- How to clear Emergency cache: `redis-cli -n 1 FLUSHDB`
- How to replay Emergency audit log: `node scripts/replay_audit.js --dept=DEP-021`
