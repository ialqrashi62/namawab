# LLM Observability — Emergency (DEP-021)
**Last updated:** 2026-08-10

## LLM usage for Emergency

### Orchestrators

| Orchestrator | Model | Calls/day | Cost/day |
|---|---|---|---|
| Emergency AI orchestrator | gpt-4o | ? | ? |
| Emergency summary | gpt-4o-mini | ? | ? |
| Emergency RAG | gpt-4o | ? | ? |
