# LangChain Chains — Cardiology (DEP-001)
...
PROMPT = PromptTemplate(
  ...
  template="""أنت خبير في أمراض القلب. أجب بالعربية. اعتمد فقط على السياق.
السياق: {context}
السؤال: {question}
الإجابة:"""
)
...
## Tools
- cardiology_guidelines_search
- cardiology_drug_search
- icd10_search
- snomed_search