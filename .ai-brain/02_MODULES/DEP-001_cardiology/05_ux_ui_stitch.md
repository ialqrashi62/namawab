# UX/UI Stitch Design — Cardiology (DEP-001)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: أمراض القلب | Cardiology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/cardiology` — main (2-col)
2. `/station/cardiology/orders` — full-width list
3. `/station/cardiology/results` — 2-col with chart
4. `/station/cardiology/notes` — editor + sign
