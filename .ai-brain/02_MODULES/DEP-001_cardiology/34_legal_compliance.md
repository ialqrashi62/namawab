# Legal & Compliance — Cardiology (DEP-001)
...
- CARE-1: see compliance matrix

- EM-1: see compliance matrix

- MM-1: see compliance matrix

- PR-1: see compliance matrix

- RC-1: see compliance matrix

- SS-1: see compliance matrix


## 6. JCI Standards

- ACC-1: see compliance matrix

- ACC-2: see compliance matrix

- MMU-1: see compliance matrix

- MMU-2: see compliance matrix

- IPSG-1: see compliance matrix

- IPSG-2: see compliance matrix

- IPSG-3: see compliance matrix

- IPSG-4: see compliance matrix

- IPSG-5: see compliance matrix

- QPS-1: see compliance matrix

- QPS-2: see compliance matrix

- PFR-1: see compliance matrix
