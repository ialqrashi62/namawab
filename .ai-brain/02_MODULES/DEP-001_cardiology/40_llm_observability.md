# LLM Observability — Cardiology (DEP-001)
**Last updated:** 2026-08-10

## LLM usage for Cardiology

### Orchestrators

| Orchestrator | Model | Calls/day | Cost/day |
|---|---|---|---|
| Cardiology AI orchestrator | gpt-4o | ? | ? |
| Cardiology summary | gpt-4o-mini | ? | ? |
| Cardiology RAG | gpt-4o | ? | ? |
