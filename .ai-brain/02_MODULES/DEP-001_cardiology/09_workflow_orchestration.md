# Workflow Orchestration — Cardiology (DEP-001)

## BPMN State Machine
```yaml
workflow:
  id: cardiology_patient_flow
...
|---|---|
| triage | nurse |
| assessment | cardiology_specialist |
| plan | cardiology_specialist |
| intervention | cardiology_specialist + nurse |
| discharge | cardiology_specialist |
| followup | scheduler + cardiology_specialist |