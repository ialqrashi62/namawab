# DevOps Runbook — Cardiology (DEP-001)
...
### Cardiology-specific runbook

- How to restart just the Cardiology engine: `pm2 restart nama-medical-erp --name=dep_001`
- How to scale Cardiology: edit `pm2.config.js` → `dep_001: instances=4`
- How to clear Cardiology cache: `redis-cli -n 1 FLUSHDB`
- How to replay Cardiology audit log: `node scripts/replay_audit.js --dept=DEP-001`
