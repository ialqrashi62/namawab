// filepath: 02_MODULES/DEP-001/23_frontend_components.tsx
// Stitch components for Cardiology (DEP-001)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.CardiologyAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('cardiology');
