# Test Observability — Cardiology (DEP-001)
...
- Overall: > 80%
- Cardiology engine: > 90%
- Cardiology critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_001.<area>.<action>.<expectation>

e.g.
dep_001.create.valid_returns_201
dep_001.create.invalid_returns_400
dep_001.create.cross_tenant_returns_403
dep_001.update.locked_returns_409
```
