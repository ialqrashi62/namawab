# Workflow Orchestration — Inventory_Supply_Chain (DEP-054)

## BPMN State Machine
```yaml
workflow:
  id: inventory_patient_flow
...
|---|---|
| triage | nurse |
| assessment | inventory_specialist |
| plan | inventory_specialist |
| intervention | inventory_specialist + nurse |
| discharge | inventory_specialist |
| followup | scheduler + inventory_specialist |