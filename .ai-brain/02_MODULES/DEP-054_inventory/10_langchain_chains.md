# LangChain Chains — Inventory_Supply_Chain (DEP-054)
...
PROMPT = PromptTemplate(
  ...
  template="""أنت خبير في المخزون وسلسلة الإمداد. أجب بالعربية. اعتمد فقط على السياق.
السياق: {context}
السؤال: {question}
الإجابة:"""
)
...
## Tools
- inventory_guidelines_search
- inventory_drug_search
- icd10_search
- snomed_search