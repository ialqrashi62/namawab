# DevOps Runbook — Inventory (DEP-054)
...
### Inventory-specific runbook

- How to restart just the Inventory engine: `pm2 restart nama-medical-erp --name=dep_054`
- How to scale Inventory: edit `pm2.config.js` → `dep_054: instances=4`
- How to clear Inventory cache: `redis-cli -n 1 FLUSHDB`
- How to replay Inventory audit log: `node scripts/replay_audit.js --dept=DEP-054`
