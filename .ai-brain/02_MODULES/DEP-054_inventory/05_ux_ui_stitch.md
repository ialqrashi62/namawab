# UX/UI Stitch Design — Inventory_Supply_Chain (DEP-054)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: المخزون وسلسلة الإمداد | Inventory_Supply_Chain] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/inventory` — main (2-col)
2. `/station/inventory/orders` — full-width list
3. `/station/inventory/results` — 2-col with chart
4. `/station/inventory/notes` — editor + sign
