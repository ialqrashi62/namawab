# LLM Observability — Inventory (DEP-054)
**Last updated:** 2026-08-10

## LLM usage for Inventory

### Orchestrators

| Orchestrator | Model | Calls/day | Cost/day |
|---|---|---|---|
| Inventory AI orchestrator | gpt-4o | ? | ? |
| Inventory summary | gpt-4o-mini | ? | ? |
| Inventory RAG | gpt-4o | ? | ? |
