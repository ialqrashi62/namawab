...
| Event | Properties |
|---|---|
| `dep_056_create` | tenant_id, user_id, patient_id_hash |
| `dep_056_view` | tenant_id, user_id, duration_ms |
| `dep_056_update` | tenant_id, user_id, fields_changed |
| `dep_056_delete` | tenant_id, user_id, reason |
| `dep_056_print` | tenant_id, user_id, format |
| `dep_056_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Hr primary workflow
- step 1: open Hr page
