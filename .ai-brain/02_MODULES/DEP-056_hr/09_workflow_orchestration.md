# Workflow Orchestration — HR_Staffing (DEP-056)
...
|---|---|
| triage | nurse |
| assessment | hr_specialist |
| plan | hr_specialist |
| intervention | hr_specialist + nurse |
| discharge | hr_specialist |
| followup | scheduler + hr_specialist |