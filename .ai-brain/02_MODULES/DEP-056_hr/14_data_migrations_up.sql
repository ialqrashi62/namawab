-- Migration UP for HR_Staffing (DEP-056)
...
CREATE POLICY hr_enc_iso ON hr_encounters
...
ALTER TABLE hr_audit FORCE ROW LEVEL SECURITY;
CREATE POLICY hr_audit_iso ON hr_audit
  USING (tenant_id = current_setting('app.tenant_id', true)::BIGINT);
