...
- How to restart just the Hr engine: `pm2 restart nama-medical-erp --name=dep_056`
- How to scale Hr: edit `pm2.config.js` → `dep_056: instances=4`
- How to clear Hr cache: `redis-cli -n 1 FLUSHDB`
- How to replay Hr audit log: `node scripts/replay_audit.js --dept=DEP-056`
