...
- Overall: > 80%
- Hr engine: > 90%
- Hr critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_056.<area>.<action>.<expectation>

e.g.
dep_056.create.valid_returns_201
dep_056.create.invalid_returns_400
dep_056.create.cross_tenant_returns_403
dep_056.update.locked_returns_409
```
