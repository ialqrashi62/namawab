# UX/UI Stitch Design — HR_Staffing (DEP-056)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الموارد البشرية | HR_Staffing] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/hr` — main (2-col)
2. `/station/hr/orders` — full-width list
3. `/station/hr/results` — 2-col with chart
4. `/station/hr/notes` — editor + sign
