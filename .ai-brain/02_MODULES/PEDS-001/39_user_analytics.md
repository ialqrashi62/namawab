# User Analytics — Peds-001 (PEDS-001)
...
| Event | Properties |
|---|---|
| `peds_001_create` | tenant_id, user_id, patient_id_hash |
| `peds_001_view` | tenant_id, user_id, duration_ms |
| `peds_001_update` | tenant_id, user_id, fields_changed |
| `peds_001_delete` | tenant_id, user_id, reason |
| `peds_001_print` | tenant_id, user_id, format |
| `peds_001_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Peds-001 primary workflow
- step 1: open Peds-001 page
