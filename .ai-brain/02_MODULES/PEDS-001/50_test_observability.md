# Test Observability — Peds-001 (PEDS-001)
...
- Overall: > 80%
- Peds-001 engine: > 90%
- Peds-001 critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
peds_001.<area>.<action>.<expectation>

e.g.
peds_001.create.valid_returns_201
peds_001.create.invalid_returns_400
peds_001.create.cross_tenant_returns_403
peds_001.update.locked_returns_409
```
