# DevOps Runbook — Peds-001 (PEDS-001)
...
### Peds-001-specific runbook

- How to restart just the Peds-001 engine: `pm2 restart nama-medical-erp --name=peds_001`
- How to scale Peds-001: edit `pm2.config.js` → `peds_001: instances=4`
- How to clear Peds-001 cache: `redis-cli -n 1 FLUSHDB`
- How to replay Peds-001 audit log: `node scripts/replay_audit.js --dept=PEDS-001`
