# DevOps Runbook — Quality (DEP-059)
...
### Quality-specific runbook

- How to restart just the Quality engine: `pm2 restart nama-medical-erp --name=dep_059`
- How to scale Quality: edit `pm2.config.js` → `dep_059: instances=4`
- How to clear Quality cache: `redis-cli -n 1 FLUSHDB`
- How to replay Quality audit log: `node scripts/replay_audit.js --dept=DEP-059`
