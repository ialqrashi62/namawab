// filepath: 02_MODULES/DEP-059/23_frontend_components.tsx
// Stitch components for Quality_Safety (DEP-059)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.QualityAPI : null;
