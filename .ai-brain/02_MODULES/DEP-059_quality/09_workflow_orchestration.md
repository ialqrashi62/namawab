# Workflow Orchestration — Quality_Safety (DEP-059)

## BPMN State Machine
```yaml
workflow:
  id: quality_patient_flow
...
|---|---|
| triage | nurse |
| assessment | quality_specialist |
| plan | quality_specialist |
| intervention | quality_specialist + nurse |
| discharge | quality_specialist |
| followup | scheduler + quality_specialist |