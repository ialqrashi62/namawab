# UX/UI Stitch Design — Quality_Safety (DEP-059)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الجودة وسلامة المرضى | Quality_Safety] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/quality` — main (2-col)
2. `/station/quality/orders` — full-width list
3. `/station/quality/results` — 2-col with chart
4. `/station/quality/notes` — editor + sign
