# Workflow Orchestration — Finance_Accounting (DEP-055)

## BPMN State Machine
```yaml
workflow:
  id: finance_patient_flow
...
|---|---|
| triage | nurse |
| assessment | finance_specialist |
| plan | finance_specialist |
| intervention | finance_specialist + nurse |
| discharge | finance_specialist |
| followup | scheduler + finance_specialist |