# Test Observability — Finance (DEP-055)
...
- Overall: > 80%
- Finance engine: > 90%
- Finance critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_055.<area>.<action>.<expectation>

e.g.
dep_055.create.valid_returns_201
dep_055.create.invalid_returns_400
dep_055.create.cross_tenant_returns_403
dep_055.update.locked_returns_409
```
