# UX/UI Stitch Design — Finance_Accounting (DEP-055)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: المالية والمحاسبة | Finance_Accounting] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/finance` — main (2-col)
2. `/station/finance/orders` — full-width list
3. `/station/finance/results` — 2-col with chart
4. `/station/finance/notes` — editor + sign
