# DevOps Runbook — Finance (DEP-055)
...
### Finance-specific runbook

- How to restart just the Finance engine: `pm2 restart nama-medical-erp --name=dep_055`
- How to scale Finance: edit `pm2.config.js` → `dep_055: instances=4`
- How to clear Finance cache: `redis-cli -n 1 FLUSHDB`
- How to replay Finance audit log: `node scripts/replay_audit.js --dept=DEP-055`
