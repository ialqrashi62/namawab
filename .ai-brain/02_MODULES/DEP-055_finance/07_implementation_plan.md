# Implementation Plan — Finance_Accounting (DEP-055)
...
jobs:
  ...
  deploy-staging:
    ...
    runs-on: ubuntu-latest
    steps:
      - run: ./scripts/deploy_staging.sh finance
```

## 3. Rollback Plan
1. Tag current production: `git tag prod-finance-<timestamp>`
