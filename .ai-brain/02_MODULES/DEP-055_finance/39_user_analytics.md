# User Analytics — Finance (DEP-055)
...
| Event | Properties |
|---|---|
| `dep_055_create` | tenant_id, user_id, patient_id_hash |
| `dep_055_view` | tenant_id, user_id, duration_ms |
| `dep_055_update` | tenant_id, user_id, fields_changed |
| `dep_055_delete` | tenant_id, user_id, reason |
| `dep_055_print` | tenant_id, user_id, format |
| `dep_055_export` | tenant_id, user_id, format, rows |

## Funnels

### Funnel 1: Finance primary workflow
