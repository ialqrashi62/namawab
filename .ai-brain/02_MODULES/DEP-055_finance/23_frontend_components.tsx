// filepath: 02_MODULES/DEP-055/23_frontend_components.tsx
// Stitch components for Finance_Accounting (DEP-055)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.FinanceAPI : null;
