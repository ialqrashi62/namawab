# LLM Observability — Radiology (DEP-040)
**Last updated:** 2026-08-10

## LLM usage for Radiology

### Orchestrators

| Orchestrator | Model | Calls/day | Cost/day |
|---|---|---|---|
| Radiology AI orchestrator | gpt-4o | ? | ? |
| Radiology summary | gpt-4o-mini | ? | ? |
| Radiology RAG | gpt-4o | ? | ? |
