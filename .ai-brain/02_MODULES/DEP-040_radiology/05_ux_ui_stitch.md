# UX/UI Stitch Design — Radiology (DEP-040)
...
```
┌──────────────────────────────────────────────────────────────┐
│ [Header: الأشعة | Radiology] [Lang AR/EN]   │
├──────────────────────────────────────────────────────────────┤
...
## 3. Pages
1. `/station/radiology` — main (2-col)
2. `/station/radiology/orders` — full-width list
3. `/station/radiology/results` — 2-col with chart
4. `/station/radiology/notes` — editor + sign
