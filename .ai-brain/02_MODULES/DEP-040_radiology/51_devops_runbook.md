# DevOps Runbook — Radiology (DEP-040)
...
### Radiology-specific runbook

- How to restart just the Radiology engine: `pm2 restart nama-medical-erp --name=dep_040`
- How to scale Radiology: edit `pm2.config.js` → `dep_040: instances=4`
- How to clear Radiology cache: `redis-cli -n 1 FLUSHDB`
- How to replay Radiology audit log: `node scripts/replay_audit.js --dept=DEP-040`
