// filepath: 02_MODULES/DEP-040/23_frontend_components.tsx
// Stitch components for Radiology (DEP-040)

import React from 'react';
import { useTranslation } from 'next-i18next';

const API = (typeof window !== 'undefined') ? window.RadiologyAPI : null;

// ============ ResultCard ============
export function ResultCard({ result }: { result: any }) {
  const { t, i18n } = useTranslation('radiology');
