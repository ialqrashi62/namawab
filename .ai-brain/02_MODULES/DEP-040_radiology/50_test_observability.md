# Test Observability — Radiology (DEP-040)
...
- Overall: > 80%
- Radiology engine: > 90%
- Radiology critical paths: 100% (admit, discharge, sign, lock)

### Test naming convention

```
dep_040.<area>.<action>.<expectation>

e.g.
dep_040.create.valid_returns_201
dep_040.create.invalid_returns_400
dep_040.create.cross_tenant_returns_403
dep_040.update.locked_returns_409
```
