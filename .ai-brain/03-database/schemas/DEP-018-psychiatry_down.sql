...
-- =====================================================================
-- File:        DEP-018-psychiatry_down.sql
-- Department:  DEP-018 — Psychiatry & Mental Health
...
-- Drop trigger first
DROP TRIGGER IF EXISTS psych_assessment_set_updated_at_utc ON blueprint_v2.psych_assessment;

-- Drop policy
DROP POLICY IF EXISTS psych_assessment_tenant_isolation ON blueprint_v2.psych_assessment;
...
DROP TABLE IF EXISTS blueprint_v2.psych_assessment CASCADE;
