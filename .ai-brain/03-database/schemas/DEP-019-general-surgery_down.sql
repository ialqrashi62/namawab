...
-- =====================================================================
-- File:        DEP-019-general-surgery_down.sql
-- Department:  DEP-019 — General Surgery
...
-- Drop trigger first
DROP TRIGGER IF EXISTS surgical_case_set_updated_at_utc ON blueprint_v2.surgical_case;

-- Drop policy
DROP POLICY IF EXISTS surgical_case_tenant_isolation ON blueprint_v2.surgical_case;
...
DROP TABLE IF EXISTS blueprint_v2.surgical_case CASCADE;
