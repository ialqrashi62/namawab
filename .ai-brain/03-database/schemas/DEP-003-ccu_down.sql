...
-- =====================================================================
-- File:        DEP-003-ccu_down.sql
-- Department:  DEP-003 — Coronary Care Unit (CCU)
...
-- Drop trigger first
DROP TRIGGER IF EXISTS ccu_admission_set_updated_at_utc ON blueprint_v2.ccu_admission;

-- Drop policy
DROP POLICY IF EXISTS ccu_admission_tenant_isolation ON blueprint_v2.ccu_admission;
...
DROP TABLE IF EXISTS blueprint_v2.ccu_admission CASCADE;
