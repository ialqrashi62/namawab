...
-- =====================================================================
-- File:        DEP-006-burn-unit_down.sql
-- Department:  DEP-006 — Burn Unit
...
-- Drop trigger first
DROP TRIGGER IF EXISTS burn_assessment_set_updated_at_utc ON blueprint_v2.burn_assessment;

-- Drop policy
DROP POLICY IF EXISTS burn_assessment_tenant_isolation ON blueprint_v2.burn_assessment;
...
DROP TABLE IF EXISTS blueprint_v2.burn_assessment CASCADE;
