...
-- =====================================================================
-- File:        DEP-027-plastic-reconstructive_down.sql
-- Department:  DEP-027 — Plastic & Reconstructive Surgery
...
-- Drop trigger first
DROP TRIGGER IF EXISTS plastic_surgery_case_set_updated_at_utc ON blueprint_v2.plastic_surgery_case;

-- Drop policy
DROP POLICY IF EXISTS plastic_surgery_case_tenant_isolation ON blueprint_v2.plastic_surgery_case;
...
DROP TABLE IF EXISTS blueprint_v2.plastic_surgery_case CASCADE;
