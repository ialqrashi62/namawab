...
-- =====================================================================
-- File:        DEP-030-pediatrics_down.sql
-- Department:  DEP-030 — Pediatrics & General
...
-- Drop trigger first
DROP TRIGGER IF EXISTS peds_visit_set_updated_at_utc ON blueprint_v2.peds_visit;

-- Drop policy
DROP POLICY IF EXISTS peds_visit_tenant_isolation ON blueprint_v2.peds_visit;
...
DROP TABLE IF EXISTS blueprint_v2.peds_visit CASCADE;
