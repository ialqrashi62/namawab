...
-- =====================================================================
-- File:        DEP-010-nephrology-dialysis_down.sql
-- Department:  DEP-010 — Nephrology & Dialysis
...
-- Drop trigger first
DROP TRIGGER IF EXISTS dialysis_session_set_updated_at_utc ON blueprint_v2.dialysis_session;

-- Drop policy
DROP POLICY IF EXISTS dialysis_session_tenant_isolation ON blueprint_v2.dialysis_session;
...
DROP TABLE IF EXISTS blueprint_v2.dialysis_session CASCADE;
