...
-- =====================================================================
-- File:        DEP-038-him-medical-records_down.sql
-- Department:  DEP-038 — Health Information Management (HIM) / Medical Records
...
-- Drop trigger first
DROP TRIGGER IF EXISTS medical_record_request_set_updated_at_utc ON blueprint_v2.medical_record_request;

-- Drop policy
DROP POLICY IF EXISTS medical_record_request_tenant_isolation ON blueprint_v2.medical_record_request;
...
DROP TABLE IF EXISTS blueprint_v2.medical_record_request CASCADE;
