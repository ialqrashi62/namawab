...
-- =====================================================================
-- File:        DEP-002-icu-adult_down.sql
-- Department:  DEP-002 — Adult Intensive Care Unit (ICU)
...
-- Drop trigger first
DROP TRIGGER IF EXISTS icu_admission_set_updated_at_utc ON blueprint_v2.icu_admission;

-- Drop policy
DROP POLICY IF EXISTS icu_admission_tenant_isolation ON blueprint_v2.icu_admission;
...
DROP TABLE IF EXISTS blueprint_v2.icu_admission CASCADE;
