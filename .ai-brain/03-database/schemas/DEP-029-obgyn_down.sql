...
-- =====================================================================
-- File:        DEP-029-obgyn_down.sql
-- Department:  DEP-029 — Obstetrics & Gynecology (OB/GYN)
...
-- Drop trigger first
DROP TRIGGER IF EXISTS obgyn_visit_set_updated_at_utc ON blueprint_v2.obgyn_visit;

-- Drop policy
DROP POLICY IF EXISTS obgyn_visit_tenant_isolation ON blueprint_v2.obgyn_visit;
...
DROP TABLE IF EXISTS blueprint_v2.obgyn_visit CASCADE;
