...
-- =====================================================================
-- File:        DEP-021-neurosurgery_down.sql
-- Department:  DEP-021 — Neurosurgery
...
-- Drop trigger first
DROP TRIGGER IF EXISTS neurosurg_case_set_updated_at_utc ON blueprint_v2.neurosurg_case;

-- Drop policy
DROP POLICY IF EXISTS neurosurg_case_tenant_isolation ON blueprint_v2.neurosurg_case;
...
DROP TABLE IF EXISTS blueprint_v2.neurosurg_case CASCADE;
