...
-- =====================================================================
-- File:        DEP-020-orthopedics-trauma_down.sql
-- Department:  DEP-020 — Orthopedics & Trauma
...
-- Drop trigger first
DROP TRIGGER IF EXISTS ortho_fracture_set_updated_at_utc ON blueprint_v2.ortho_fracture;

-- Drop policy
DROP POLICY IF EXISTS ortho_fracture_tenant_isolation ON blueprint_v2.ortho_fracture;
...
DROP TABLE IF EXISTS blueprint_v2.ortho_fracture CASCADE;
