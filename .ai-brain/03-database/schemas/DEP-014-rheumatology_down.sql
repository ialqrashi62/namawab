...
-- =====================================================================
-- File:        DEP-014-rheumatology_down.sql
-- Department:  DEP-014 — Rheumatology
...
-- Drop trigger first
DROP TRIGGER IF EXISTS rheum_assessment_set_updated_at_utc ON blueprint_v2.rheum_assessment;

-- Drop policy
DROP POLICY IF EXISTS rheum_assessment_tenant_isolation ON blueprint_v2.rheum_assessment;
...
DROP TABLE IF EXISTS blueprint_v2.rheum_assessment CASCADE;
