...
-- =====================================================================
-- File:        DEP-013-oncology_down.sql
-- Department:  DEP-013 — Oncology & Medical Oncology
...
-- Drop trigger first
DROP TRIGGER IF EXISTS oncology_treatment_plan_set_updated_at_utc ON blueprint_v2.oncology_treatment_plan;

-- Drop policy
DROP POLICY IF EXISTS oncology_treatment_plan_tenant_isolation ON blueprint_v2.oncology_treatment_plan;
...
DROP TABLE IF EXISTS blueprint_v2.oncology_treatment_plan CASCADE;
