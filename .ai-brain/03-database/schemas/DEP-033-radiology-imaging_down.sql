...
-- =====================================================================
-- File:        DEP-033-radiology-imaging_down.sql
-- Department:  DEP-033 — Radiology & Medical Imaging
...
-- Drop trigger first
DROP TRIGGER IF EXISTS imaging_study_set_updated_at_utc ON blueprint_v2.imaging_study;

-- Drop policy
DROP POLICY IF EXISTS imaging_study_tenant_isolation ON blueprint_v2.imaging_study;
...
DROP TABLE IF EXISTS blueprint_v2.imaging_study CASCADE;
