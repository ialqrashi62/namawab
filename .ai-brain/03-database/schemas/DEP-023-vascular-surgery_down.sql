...
-- =====================================================================
-- File:        DEP-023-vascular-surgery_down.sql
-- Department:  DEP-023 — Vascular Surgery
...
-- Drop trigger first
DROP TRIGGER IF EXISTS vascular_case_set_updated_at_utc ON blueprint_v2.vascular_case;

-- Drop policy
DROP POLICY IF EXISTS vascular_case_tenant_isolation ON blueprint_v2.vascular_case;
...
DROP TABLE IF EXISTS blueprint_v2.vascular_case CASCADE;
