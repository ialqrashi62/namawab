...
-- =====================================================================
-- File:        DEP-037-cssd_down.sql
-- Department:  DEP-037 — Central Sterile Services Department (CSSD)
...
-- Drop trigger first
DROP TRIGGER IF EXISTS cssd_sterilization_cycle_set_updated_at_utc ON blueprint_v2.cssd_sterilization_cycle;

-- Drop policy
DROP POLICY IF EXISTS cssd_sterilization_cycle_tenant_isolation ON blueprint_v2.cssd_sterilization_cycle;
...
DROP TABLE IF EXISTS blueprint_v2.cssd_sterilization_cycle CASCADE;
