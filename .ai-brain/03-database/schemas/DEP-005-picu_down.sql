...
-- =====================================================================
-- File:        DEP-005-picu_down.sql
-- Department:  DEP-005 — Pediatric Intensive Care Unit (PICU)
...
-- Drop trigger first
DROP TRIGGER IF EXISTS picu_admission_set_updated_at_utc ON blueprint_v2.picu_admission;

-- Drop policy
DROP POLICY IF EXISTS picu_admission_tenant_isolation ON blueprint_v2.picu_admission;
...
DROP TABLE IF EXISTS blueprint_v2.picu_admission CASCADE;
