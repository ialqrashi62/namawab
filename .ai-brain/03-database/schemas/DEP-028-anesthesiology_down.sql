...
-- =====================================================================
-- File:        DEP-028-anesthesiology_down.sql
-- Department:  DEP-028 — Anesthesiology & Pain Management
...
-- Drop trigger first
DROP TRIGGER IF EXISTS anesthesia_record_set_updated_at_utc ON blueprint_v2.anesthesia_record;

-- Drop policy
DROP POLICY IF EXISTS anesthesia_record_tenant_isolation ON blueprint_v2.anesthesia_record;
...
DROP TABLE IF EXISTS blueprint_v2.anesthesia_record CASCADE;
