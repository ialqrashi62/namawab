...
-- =====================================================================
-- File:        DEP-022-cardiothoracic-surgery_down.sql
-- Department:  DEP-022 — Cardiothoracic Surgery
...
-- Drop trigger first
DROP TRIGGER IF EXISTS cts_case_set_updated_at_utc ON blueprint_v2.cts_case;

-- Drop policy
DROP POLICY IF EXISTS cts_case_tenant_isolation ON blueprint_v2.cts_case;
...
DROP TABLE IF EXISTS blueprint_v2.cts_case CASCADE;
