...
-- =====================================================================
-- File:        DEP-004-nicu_down.sql
-- Department:  DEP-004 — Neonatal Intensive Care Unit (NICU)
...
-- Drop trigger first
DROP TRIGGER IF EXISTS nicu_admission_set_updated_at_utc ON blueprint_v2.nicu_admission;

-- Drop policy
DROP POLICY IF EXISTS nicu_admission_tenant_isolation ON blueprint_v2.nicu_admission;
...
DROP TABLE IF EXISTS blueprint_v2.nicu_admission CASCADE;
