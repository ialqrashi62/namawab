...
-- =====================================================================
-- File:        DEP-034-laboratory-pathology_down.sql
-- Department:  DEP-034 — Laboratory & Pathology
...
-- Drop trigger first
DROP TRIGGER IF EXISTS lab_result_set_updated_at_utc ON blueprint_v2.lab_result;

-- Drop policy
DROP POLICY IF EXISTS lab_result_tenant_isolation ON blueprint_v2.lab_result;
...
DROP TABLE IF EXISTS blueprint_v2.lab_result CASCADE;
