...
-- =====================================================================
-- File:        DEP-011-endocrinology_down.sql
-- Department:  DEP-011 — Endocrinology & Diabetes
...
-- Drop trigger first
DROP TRIGGER IF EXISTS endocrine_visit_set_updated_at_utc ON blueprint_v2.endocrine_visit;

-- Drop policy
DROP POLICY IF EXISTS endocrine_visit_tenant_isolation ON blueprint_v2.endocrine_visit;
...
DROP TABLE IF EXISTS blueprint_v2.endocrine_visit CASCADE;
