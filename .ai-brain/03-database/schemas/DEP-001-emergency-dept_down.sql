...
-- =====================================================================
-- File:        DEP-001-emergency-dept_down.sql
-- Department:  DEP-001 — Emergency Department
...
-- Drop trigger first
DROP TRIGGER IF EXISTS ed_encounter_set_updated_at_utc ON blueprint_v2.ed_encounter;

-- Drop policy
DROP POLICY IF EXISTS ed_encounter_tenant_isolation ON blueprint_v2.ed_encounter;
...
DROP TABLE IF EXISTS blueprint_v2.ed_encounter CASCADE;
