...
-- =====================================================================
-- File:        DEP-017-neurology_down.sql
-- Department:  DEP-017 — Neurology
...
-- Drop trigger first
DROP TRIGGER IF EXISTS neuro_exam_set_updated_at_utc ON blueprint_v2.neuro_exam;

-- Drop policy
DROP POLICY IF EXISTS neuro_exam_tenant_isolation ON blueprint_v2.neuro_exam;
...
DROP TABLE IF EXISTS blueprint_v2.neuro_exam CASCADE;
