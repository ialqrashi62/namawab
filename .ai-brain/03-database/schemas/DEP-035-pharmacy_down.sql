...
-- =====================================================================
-- File:        DEP-035-pharmacy_down.sql
-- Department:  DEP-035 — Pharmacy & Therapeutics
...
-- Drop trigger first
DROP TRIGGER IF EXISTS medication_dispense_set_updated_at_utc ON blueprint_v2.medication_dispense;

-- Drop policy
DROP POLICY IF EXISTS medication_dispense_tenant_isolation ON blueprint_v2.medication_dispense;
...
DROP TABLE IF EXISTS blueprint_v2.medication_dispense CASCADE;
