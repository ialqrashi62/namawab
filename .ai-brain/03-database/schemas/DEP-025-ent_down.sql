...
-- =====================================================================
-- File:        DEP-025-ent_down.sql
-- Department:  DEP-025 — Otorhinolaryngology (ENT)
...
-- Drop trigger first
DROP TRIGGER IF EXISTS ent_exam_set_updated_at_utc ON blueprint_v2.ent_exam;

-- Drop policy
DROP POLICY IF EXISTS ent_exam_tenant_isolation ON blueprint_v2.ent_exam;
...
DROP TABLE IF EXISTS blueprint_v2.ent_exam CASCADE;
