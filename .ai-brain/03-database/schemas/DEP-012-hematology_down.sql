...
-- =====================================================================
-- File:        DEP-012-hematology_down.sql
-- Department:  DEP-012 — Hematology
...
-- Drop trigger first
DROP TRIGGER IF EXISTS hematology_panel_set_updated_at_utc ON blueprint_v2.hematology_panel;

-- Drop policy
DROP POLICY IF EXISTS hematology_panel_tenant_isolation ON blueprint_v2.hematology_panel;
...
DROP TABLE IF EXISTS blueprint_v2.hematology_panel CASCADE;
