...
-- =====================================================================
-- File:        DEP-024-urology_down.sql
-- Department:  DEP-024 — Urology
...
-- Drop trigger first
DROP TRIGGER IF EXISTS urology_procedure_set_updated_at_utc ON blueprint_v2.urology_procedure;

-- Drop policy
DROP POLICY IF EXISTS urology_procedure_tenant_isolation ON blueprint_v2.urology_procedure;
...
DROP TABLE IF EXISTS blueprint_v2.urology_procedure CASCADE;
