...
-- =====================================================================
-- File:        DEP-009-gastroenterology_down.sql
-- Department:  DEP-009 — Gastroenterology
...
-- Drop trigger first
DROP TRIGGER IF EXISTS gi_endoscopy_set_updated_at_utc ON blueprint_v2.gi_endoscopy;

-- Drop policy
DROP POLICY IF EXISTS gi_endoscopy_tenant_isolation ON blueprint_v2.gi_endoscopy;
...
DROP TABLE IF EXISTS blueprint_v2.gi_endoscopy CASCADE;
