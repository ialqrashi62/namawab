...
-- =====================================================================
-- File:        DEP-008-pulmonology_down.sql
-- Department:  DEP-008 — Pulmonology
...
-- Drop trigger first
DROP TRIGGER IF EXISTS pulmonary_function_test_set_updated_at_utc ON blueprint_v2.pulmonary_function_test;

-- Drop policy
DROP POLICY IF EXISTS pulmonary_function_test_tenant_isolation ON blueprint_v2.pulmonary_function_test;
...
DROP TABLE IF EXISTS blueprint_v2.pulmonary_function_test CASCADE;
