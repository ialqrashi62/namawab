...
-- =====================================================================
-- File:        DEP-036-physiotherapy-rehab_down.sql
-- Department:  DEP-036 — Physiotherapy & Rehabilitation
...
-- Drop trigger first
DROP TRIGGER IF EXISTS rehab_session_set_updated_at_utc ON blueprint_v2.rehab_session;

-- Drop policy
DROP POLICY IF EXISTS rehab_session_tenant_isolation ON blueprint_v2.rehab_session;
...
DROP TABLE IF EXISTS blueprint_v2.rehab_session CASCADE;
