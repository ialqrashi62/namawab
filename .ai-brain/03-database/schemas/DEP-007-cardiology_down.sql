...
-- =====================================================================
-- File:        DEP-007-cardiology_down.sql
-- Department:  DEP-007 — Cardiology
...
-- Drop trigger first
DROP TRIGGER IF EXISTS cardiology_consult_set_updated_at_utc ON blueprint_v2.cardiology_consult;

-- Drop policy
DROP POLICY IF EXISTS cardiology_consult_tenant_isolation ON blueprint_v2.cardiology_consult;
...
DROP TABLE IF EXISTS blueprint_v2.cardiology_consult CASCADE;
