...
-- =====================================================================
-- File:        DEP-026-ophthalmology_down.sql
-- Department:  DEP-026 — Ophthalmology
...
-- Drop trigger first
DROP TRIGGER IF EXISTS ophth_exam_set_updated_at_utc ON blueprint_v2.ophth_exam;

-- Drop policy
DROP POLICY IF EXISTS ophth_exam_tenant_isolation ON blueprint_v2.ophth_exam;
...
DROP TABLE IF EXISTS blueprint_v2.ophth_exam CASCADE;
