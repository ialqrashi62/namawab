...
const r = spawnSync('ssh', [
  ...
  'root@204.168.144.74',
  `bash -c '
for path in "fhir/metadata" "fhir/Patient" "fhir/Patient/123" "fhir/Observation?patient=123" "fhir/MedicationRequest?patient=123" "api/v4/hl7/" "api/v4/dicomweb/" "api/v4/dicomweb/qido/studies" "api/v4/dicomweb/ohif/config" "api/v4/portal2/me" ; do
