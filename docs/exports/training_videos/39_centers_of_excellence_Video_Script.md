# سيناريو التدريب - Centers Of Excellence

## المشهد 1: مقدمة (0:00 - 0:30)
**الصوت (Voiceover):** "مرحباً بكم في دليل استخدام نظام Nama Medical ERP الخاص بقسم Centers Of Excellence. سنتعلم اليوم كيفية إدارة الطلبات الطبية وقراءة النتائج بشكل آمن."
**الشاشة:** عرض لوحة تحكم Centers Of Excellence مع التركيز على الشريط الجانبي.
...
**الشاشة:** تسجيل شاشة تفاعلي يوضح اختيار مريض من القاعدة وإرسال طلب `POST /api/v1/centers_of_excellence/orders`.
