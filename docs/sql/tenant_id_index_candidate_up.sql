-- tenant_id_index_candidate_up.sql
-- OPTIONAL (future scale): add tenant_id index to 88 small/empty FORCE-RLS tables.
-- NOT EXECUTED. Run as table owner. CONCURRENTLY = no long lock (run outside a txn block).
