...
* **التراجع التلقائي (Automatic Rollback)**: متوفر بالكامل عبر السكربت [tenant_id_backfill_controlled_migration_down.sql](file:///c:/Users/ice/Desktop/NamaMedical/docs/sql/tenant_id_backfill_controlled_migration_down.sql)
