...
const engineSrc = fs.readFileSync(path.join(__dirname, 'internal_medicine_wave1_engine_batch4.js'), 'utf8');
const serverSrc = fs.readFileSync(path.join(__dirname, 'server.js'), 'utf8');

const ROUTES = [
  {
    "path": "/lupus-nephritis/risk",
    "fn": "checkLupusNephritisRisk"
  },
  {
    "path": "/tropical/severe-malaria",
    "fn": "checkSevereMalariaCriteria"
  },
  {
    "path": "/travel/vaccine-contraindication",
    "fn": "checkVaccinationContraindication"
  },
  {
    "path": "/nutrition/refeeding-syndrome",
    "fn": "checkRefeedingSyndromeRisk"
  }
];
...
function runTests() {
    for (const r of ROUTES) {
        assert.ok(
            ...
            'internal_medicine_wave1_engine_batch4.js must export ' + r.fn
        );
    }
    assert.ok(
    ...
    console.log('internal_medicine_wave1_engine_batch4_routes_static_test: all ' + ROUTES.length + ' routes verified');
}
