# Short AutoPilot Prompt for Antigravity
...
1. Create/update shared design system tokens and reusable UI components.
...
4. Apply the new RTL premium app shell: sidebar, topbar, page container, cards, tables, buttons, and status chips.
