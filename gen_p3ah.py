#!/usr/bin/env python3
"""P3-AH generator: SQL + routes + integration for rehab_ext, sports_med, forensic_med."""
import os, textwrap

MODULES = [
    ('rehab_ext', 'rehab_ext_engine', [
        'FIMScore', 'BarthelIndex', 'RanchoLosAmigos', 'ASIAImpairmentScale',
        'FuglMeyerStroke', 'CardiacRehabRiskStratification', 'ModifiedAshworth',
        'BradenScale', 'DysphagiaSeverity', 'WheelchairSeatingAssessment'
    ]),
    ('sports_med', 'sports_med_engine', [
        'ConcussionSCAT5', 'ReturnToPlayStage', 'ACLIKDCGrade', 'HeatIllness',
        'ExertionalCompartmentSyndrome', 'SuddenCardiacDeathAthlete', 'MeniscusMcMurray',
        'HamstringStrainGrade', 'TennisElbowNirschl', 'ExercisePrescriptionFITT'
    ]),
    ('forensic_med', 'forensic_med_engine', [
        'MannerOfDeath', 'TimeSinceDeath', 'MechanismOfDeath', 'GunshotWoundRange',
        'StrangulationClassification', 'DrowningDiagnosis', 'DrugRelatedDeath',
        'SkeletalAgeEstimation', 'SexualAssaultInjury', 'BluntForceTrauma'
    ])
]
...
print('P3-AH generation complete.')
