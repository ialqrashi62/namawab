#!/usr/bin/env python3
"""P3-DO generator: 3 modules = engines + tests + integration tests + routes + SQL."""
import os
...
os.chdir(ROOT)
MODULES = [
    ('pcc_gastroenterology_advanced', 'PCC Gastroenterology Advanced', 'gia'),
    ('pcc_hepatology_advanced', 'PCC Hepatology Advanced', 'hea'),
    ('pcc_endoscopy_advanced', 'PCC Endoscopy Advanced', 'end'),
]
PKG = 'p3do_'
COLUMNS = [
    ('encounter_id', 'TEXT'),
...
ENGINE_FUNCS = {
    'pcc_gastroenterology_advanced': ['ChronicDiarrheaWorkup', 'ConstipationRefractory', 'IBDFlareManagement', 'IBSRefractory', 'CeliacDisease', 'Gastroparesis', 'EosinophilicEsophagitis', 'GIBleedAdvanced', 'PancreatitisChronic', 'SmallIntestinalBacterialOvergrowth'],
    'pcc_hepatology_advanced': ['AscitesRefractory', 'HepaticEncephalopathyRecurrent', 'HepatorenalSyndrome', 'HepatopulmonarySyndrome', 'PortopulmonaryHypertension', 'AcuteLiverFailure', 'AutoimmuneHepatitis', 'PrimaryBiliaryCholangitis', 'PrimarySclerosingCholangitis', 'LiverTransplantEvaluation'],
    'pcc_endoscopy_advanced': ['ColonoscopyScreeningAdvanced', 'PolypectomyRisk', 'ERCPIndication', 'EUSIndication', 'EndoscopicHemostasis', 'PEGPlacement', 'EndoscopicDilation', 'EndoscopicResection', 'CapsuleEndoscopy', 'EndoscopySedationRisk'],
}
