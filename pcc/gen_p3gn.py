#!/usr/bin/env python3
"""P3-GN generator v3.156.0 — pcc_neuro_ext57, pcc_pediatric_neuro_ext46, pcc_pediatric_surg_ext46"""
import os
...
MODULES = [
    ('pcc_neuro_ext57', 'PCC Neuro Ext57', 'pcc-neuro-ext57'),
    ('pcc_pediatric_neuro_ext46', 'PCC Pediatric Neuro Ext46', 'pcc-pediatric-neuro-ext46'),
    ('pcc_pediatric_surg_ext46', 'PCC Pediatric Surg Ext46', 'pcc-pediatric-surg-ext46'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext57': [
        'ToxicEncephalopathyExt', 'HeavyMetalEncephalopathyExt',
        'MercuryPoisoningExt', 'LeadPoisoningExt',
        'ArsenicPoisoningExt', 'ManganesePoisoningExt',
        'CarbonMonoxidePoisoningExt', 'OrganophosphatePoisoningExt',
        'MethamphetamineToxicityExt', 'MDMAPosthallucinogenExt',
    ],
    'pcc_pediatric_neuro_ext46': [
        'PediatricToxicEncephalopathyExt', 'PediatricLeadPoisoningExt',
        'PediatricMercuryToxicityExt', 'PediatricIronOverloadExt',
        'PediatricFetalAlcoholSyndromeExt', 'PediatricAlcoholSpectrumExt',
        'PediatricDrugInducedMovementExt', 'PediatricSerotoninSyndromeExt',
        'PediatricMalignantHyperthermiaExt', 'PediatricNeurolepticMalignantExt',
    ],
    'pcc_pediatric_surg_ext46': [
        'PediatricNeurosurgeryOncologyExt', 'PediatricSpinalTumorExt',
        'PediatricPosteriorFossaTumorExt', 'PediatricBrainstemTumorExt',
        'PediatricSuprasellarTumorExt', 'PediatricPituitaryTumorExt',
        'PediatricPinealRegionTumorExt', 'PediatricSpinalCordTumorExt',
        'PediatricPeripheralNerveTumorExt', 'PediatricSkullBaseTumorExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext57,pediatric_neuro_ext46,pediatric_surg_ext46');\n"
