// P3-BN routes: gastro_ext (Gastro-Ext)
...
router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'gastro_ext', label: 'Gastro-Ext', functions: fns.length, version: '3.26.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'gastro_ext', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
