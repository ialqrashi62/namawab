#!/usr/bin/env python3
"""P3-FY generator v3.141.0 — pcc_neuro_ext42, pcc_pediatric_neuro_ext31, pcc_pediatric_surg_ext31"""
import os
...
MODULES = [
    ('pcc_neuro_ext42', 'PCC Neuro Ext42', 'pcc-neuro-ext42'),
    ('pcc_pediatric_neuro_ext31', 'PCC Pediatric Neuro Ext31', 'pcc-pediatric-neuro-ext31'),
    ('pcc_pediatric_surg_ext31', 'PCC Pediatric Surg Ext31', 'pcc-pediatric-surg-ext31'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext42': [
        'CharcotMarieToothExt', 'HereditaryNeuropathyExt',
        'GuillainBarreSyndromeExt', 'CIDPExt',
        'VasculiticNeuropathyExt', 'DiabeticNeuropathyExt',
        'AlcoholicNeuropathyExt', 'SmallFiberNeuropathyExt',
        'AutonomicNeuropathyExt', 'IdiopathicNeuropathyExt',
    ],
    'pcc_pediatric_neuro_ext31': [
        'PediatricAutismSpectrumExt2', 'PediatricAspergerExt',
        'PediatricPDDNOSExt', 'PediatricCDDDisorderExt',
        'PediatricADHDCombinedExt', 'PediatricADHDInattentiveExt',
        'PediatricADHDHyperactiveExt', 'PediatricODDExt',
        'PediatricConductDisorderExt', 'PediatricOppositionalDefiantExt',
    ],
    'pcc_pediatric_surg_ext31': [
        'PediatricCardiothoracicExt', 'PediatricVSDRepairExt',
        'PediatricASDRepairExt', 'PediatricAVCanalRepair',
        'PediatricTOFRrepairExt', 'PediatricCoarctationRepair',
        'PediatricBTShuntExt', 'PediatricGlennProcedureExt',
        'PediatricFontanProcedureExt', 'PediatricHeartTransplantPedExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext42,pediatric_neuro_ext31,pediatric_surg_ext31');\n"
