#!/usr/bin/env python3
"""P3-FU generator v3.137.0 — pcc_neuro_ext38, pcc_pediatric_neuro_ext27, pcc_pediatric_surg_ext27"""
import os
...
MODULES = [
    ('pcc_neuro_ext38', 'PCC Neuro Ext38', 'pcc-neuro-ext38'),
    ('pcc_pediatric_neuro_ext27', 'PCC Pediatric Neuro Ext27', 'pcc-pediatric-neuro-ext27'),
    ('pcc_pediatric_surg_ext27', 'PCC Pediatric Surg Ext27', 'pcc-pediatric-surg-ext27'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext38': [
        'TrigeminalNeuralgiaExt', 'GlossopharyngealNeuralgia',
        'OccipitalNeuralgiaExt', 'PostherpeticNeuralgiaExt',
        'TrigeminalNeuropathyExt', 'TrigeminalTrophicSyndrome',
        'BurningMouthSyndromeExt', 'AtypicalOdontalgiaExt',
        'ClusterTicSyndromeExt', 'SUNCTDisorderExt',
    ],
    'pcc_pediatric_neuro_ext27': [
        'PediatricEpilepsyExt3', 'PediatricFebrileSeizureExt',
        'PediatricChildhoodAbsence', 'PediatricJuvenileMyoclonic',
        'PediatricLennoxGastautExt', 'PediatricWestSyndromeExt',
        'PediatricDravetSyndromeExt', 'PediatricLandauKleffnerExt',
        'PediatricCSWSyndromeExt', 'PediatricMyoclonicAstatic',
    ],
    'pcc_pediatric_surg_ext27': [
        'PediatricAsthmaSurgeryExt', 'PediatricCysticFibrosisExt',
        'PediatricBronchiectasisSurg', 'PediatricLungResectionExt',
        'PediatricPneumothoraxExt', 'PediatricChylothoraxExt',
        'PediatricEmpyemaExt', 'PediatricLungBiopsyExt',
        'PediatricTrachealReconstruction', 'PediatricAirwayStent',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext38,pediatric_neuro_ext27,pediatric_surg_ext27');\n"
