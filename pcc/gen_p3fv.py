#!/usr/bin/env python3
"""P3-FV generator v3.138.0 — pcc_neuro_ext39, pcc_pediatric_neuro_ext28, pcc_pediatric_surg_ext28"""
import os
...
MODULES = [
    ('pcc_neuro_ext39', 'PCC Neuro Ext39', 'pcc-neuro-ext39'),
    ('pcc_pediatric_neuro_ext28', 'PCC Pediatric Neuro Ext28', 'pcc-pediatric-neuro-ext28'),
    ('pcc_pediatric_surg_ext28', 'PCC Pediatric Surg Ext28', 'pcc-pediatric-surg-ext28'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext39': [
        'MyastheniaGravisExt', 'LambertEatonMyasthenicExt',
        'CongenitalMyasthenicExt', 'BotulismExt2',
        'TetanusExt2', 'NeurolepticMalignantExt',
        'MalignantHyperthermiaExt', 'SerotoninSyndromeExt',
        'AnticholinergicToxicityExt', 'CholinergicCrisisExt',
    ],
    'pcc_pediatric_neuro_ext28': [
        'PediatricMeningitisExt3', 'PediatricEncephalitisExt',
        'PediatricBrainAbscessExt', 'PediatricSubduralEmpyema',
        'PediatricEpiduralAbscessExt', 'PediatricCerebritisExt',
        'PediatricADEMExt', 'PediatricAcuteFlaccidMyelitisExt',
        'PediatricAntiNMDAReceptorExt', 'PediatricAutoimmuneEncephalitis',
    ],
    'pcc_pediatric_surg_ext28': [
        'PediatricBurnSurgeryExt', 'PediatricScarRevisionExt',
        'PediatricContractureRelease', 'PediatricSkinGraftExt',
        'PediatricFlapSurgeryExt', 'PediatricTissueExpansionExt',
        'PediatricVACTherapyExt', 'PediatricWoundDebridementExt',
        'PediatricDermalMatrixExt', 'PediatricCulturedEpidermis',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext39,pediatric_neuro_ext28,pediatric_surg_ext28');\n"
