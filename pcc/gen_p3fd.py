#!/usr/bin/env python3
"""P3-FD generator v3.120.0 — pcc_neuro_ext21, pcc_pediatric_neuro_ext10, pcc_pediatric_surg_ext10"""
import os
...
MODULES = [
    ('pcc_neuro_ext21', 'PCC Neuro Ext21', 'pcc-neuro-ext21'),
    ('pcc_pediatric_neuro_ext10', 'PCC Pediatric Neuro Ext10', 'pcc-pediatric-neuro-ext10'),
    ('pcc_pediatric_surg_ext10', 'PCC Pediatric Surg Ext10', 'pcc-pediatric-surg-ext10'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext21': [
        'MovementDisorderExt2', 'AtaxiaTelangiectasia',
        'FriedreichAtaxiaExt', 'SpinocerebellarDegeneration',
        'HereditarySpasticParaplegia', 'ProgressiveSupranuclearPalsyExt',
        'CorticobasalSyndrome', 'MultipleSystemAtrophyExt',
        'LewyBodyDementia', 'FrontotemporalDementia',
    ],
    'pcc_pediatric_neuro_ext10': [
        'PediatricLanguageDisorder', 'PediatricSpeechDelay',
        'PediatricArticulationDisorder', 'PediatricPhonologicalDisorder',
        'PediatricStuttering', 'PediatricApraxia',
        'PediatricDysarthria', 'PediatricVoiceDisorder',
        'PediatricDyslexia', 'PediatricDysgraphia',
    ],
    'pcc_pediatric_surg_ext10': [
        'PediatricCardiothoracicSurgery', 'PediatricVSDClosure',
        'PediatricASDClosure', 'PediatricTOFCorrection',
        'PediatricAVCanalRepair', 'PediatricTruncusArteriosus',
        'PediatricNorwoodProcedure', 'PediatricFontanProcedure',
        'PediatricGlennShunt', 'PediatricPulmonaryAtresia',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext21,pediatric_neuro_ext10,pediatric_surg_ext10');\n"
