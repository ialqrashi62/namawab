#!/usr/bin/env python3
"""P3-FH generator v3.124.0 — pcc_neuro_ext25, pcc_pediatric_neuro_ext14, pcc_pediatric_surg_ext14"""
import os
...
MODULES = [
    ('pcc_neuro_ext25', 'PCC Neuro Ext25', 'pcc-neuro-ext25'),
    ('pcc_pediatric_neuro_ext14', 'PCC Pediatric Neuro Ext14', 'pcc-pediatric-neuro-ext14'),
    ('pcc_pediatric_surg_ext14', 'PCC Pediatric Surg Ext14', 'pcc-pediatric-surg-ext14'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext25': [
        'CerebellarDisorderExt', 'CerebellarDegeneration',
        'ParaneoplasticCerebellar', 'ToxicCerebellarSyndrome',
        'AlcoholicCerebellar', 'CerebellarStroke',
        'CerebellarTumorExt', 'FlocculonodularSyndrome',
        'CerebellarCognitiveAffective', 'MachadoJosephDisease',
    ],
    'pcc_pediatric_neuro_ext14': [
        'PediatricSpinalCordDisorder', 'PediatricSpinalCordTumorExt',
        'PediatricSpinalCordInjury', 'PediatricMyelitis',
        'PediatricTransverseMyelitis', 'PediatricSpinalMuscularAtrophy',
        'PediatricPolyradiculopathy', 'PediatricCaudaEquina',
        'PediatricSyringomyeliaExt', 'PediatricTetheredCordExt',
    ],
    'pcc_pediatric_surg_ext14': [
        'PediatricENTExt2', 'PediatricAdenoidectomyExt',
        'PediatricTonsillectomyExt', 'PediatricMyringotomy',
        'PediatricTympanostomyExt', 'PediatricSeptoplasty',
        'PediatricRhinoplasty', 'PediatricSinusSurgery',
        'PediatricTracheostomy', 'PediatricLaryngoscopy',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext25,pediatric_neuro_ext14,pediatric_surg_ext14');\n"
