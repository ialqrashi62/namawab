#!/usr/bin/env python3
"""P3-FL generator v3.128.0 — pcc_neuro_ext29, pcc_pediatric_neuro_ext18, pcc_pediatric_surg_ext18"""
import os
...
MODULES = [
    ('pcc_neuro_ext29', 'PCC Neuro Ext29', 'pcc-neuro-ext29'),
    ('pcc_pediatric_neuro_ext18', 'PCC Pediatric Neuro Ext18', 'pcc-pediatric-neuro-ext18'),
    ('pcc_pediatric_surg_ext18', 'PCC Pediatric Surg Ext18', 'pcc-pediatric-surg-ext18'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext29': [
        'CognitiveDisorderExt', 'MildCognitiveImpairment',
        'VascularCognitiveImpairment', 'FrontotemporalDementiaExt',
        'PrimaryProgressiveAphasia', 'PosteriorCorticalAtrophy',
        'DementiaWithLewyBodiesExt', 'AlzheimersDisease',
        'CreutzfeldtJakobDisease', 'NormalPressureHydrocephalus',
    ],
    'pcc_pediatric_neuro_ext18': [
        'PediatricNeuropsychiatricEval', 'PediatricCognitiveAssessment',
        'PediatricIntelligenceTest', 'PediatricAdaptiveFunction',
        'PediatricLearningDisorder', 'PediatricIntellectualDisability',
        'PediatricGlobalDevelopmentalDelay', 'PediatricSpecificLearningDisorder',
        'PediatricMotorSkillsDisorder', 'PediatricCommunicationDisorder',
    ],
    'pcc_pediatric_surg_ext18': [
        'PediatricCardiothoracicExt', 'PediatricECMOInitiation',
        'PediatricVADPlacement', 'PediatricHeartTransplantEval',
        'PediatricLungTransplantEval', 'PediatricThoracicSurgeryExt',
        'PediatricVATS', 'PediatricChestWallReconstruction',
        'PediatricPectusExcavatum', 'PediatricPectusCarinatum',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext29,pediatric_neuro_ext18,pediatric_surg_ext18');\n"
