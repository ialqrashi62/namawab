...
MODS = [('burn_center', 'bc'), ('ecmo_service', 'ec'), ('trauma_center', 'tc')]
...
TPL_INT = """// P3-AQ integration: __MOD__
...
def main():
    sql_path = BASE / 'migrations' / 'p3aq_up.sql'
    ...
    audit = BASE.parent / 'scratch' / 'p3aq_audit.txt'
