// P3-BA routes: chronic_pain_rehab (Chronic-Pain-Rehab)
...
router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'chronic_pain_rehab', label: 'Chronic-Pain-Rehab', functions: fns.length, version: '3.13.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'chronic_pain_rehab', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
