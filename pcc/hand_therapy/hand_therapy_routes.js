// P3-AV routes: hand_therapy (Hand-Therapy)
...
router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'hand_therapy', label: 'Hand-Therapy', functions: fns.length, version: '3.8.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'hand_therapy', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
