#!/usr/bin/env python3
"""P3-FK generator v3.127.0 — pcc_neuro_ext28, pcc_pediatric_neuro_ext17, pcc_pediatric_surg_ext17"""
import os
...
MODULES = [
    ('pcc_neuro_ext28', 'PCC Neuro Ext28', 'pcc-neuro-ext28'),
    ('pcc_pediatric_neuro_ext17', 'PCC Pediatric Neuro Ext17', 'pcc-pediatric-neuro-ext17'),
    ('pcc_pediatric_surg_ext17', 'PCC Pediatric Surg Ext17', 'pcc-pediatric-surg-ext17'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext28': [
        'AutonomicDisorderExt', 'AutonomicNeuropathy',
        'PureAutonomicFailure', 'MultipleSystemAtrophyAutonomic',
        'OrthostaticHypotension', 'PosturalTachycardiaSyndrome',
        'NeurocardiogenicSyncope', 'CarotidSinusHypersensitivity',
        'AutonomicDysreflexia', 'BaroreflexFailure',
    ],
    'pcc_pediatric_neuro_ext17': [
        'PediatricAcuteFlaccidMyelitis', 'PediatricAFM',
        'PediatricEnterovirusD68', 'PediatricPolioLikeIllness',
        'PediatricAcuteMyelitis', 'PediatricLimbWeakness',
        'PediatricCranialNervePalsy', 'PediatricBrainstemEncephalitis',
        'PediatricRhombencephalitis', 'PediatricBickerstaff',
    ],
    'pcc_pediatric_surg_ext17': [
        'PediatricOncologySurgeryExt', 'PediatricWilmsTumor',
        'PediatricNeuroblastomaResection', 'PediatricHepatoblastoma',
        'PediatricRetinoblastomaSurgeryExt', 'PediatricRhabdomyosarcoma',
        'PediatricOsteosarcomaResection', 'PediatricEwingsSarcoma',
        'PediatricLymphomaBiopsy', 'PediatricGermCellTumor',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext28,pediatric_neuro_ext17,pediatric_surg_ext17');\n"
