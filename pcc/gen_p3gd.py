#!/usr/bin/env python3
"""P3-GD generator v3.146.0 — pcc_neuro_ext47, pcc_pediatric_neuro_ext36, pcc_pediatric_surg_ext36"""
import os
...
MODULES = [
    ('pcc_neuro_ext47', 'PCC Neuro Ext47', 'pcc-neuro-ext47'),
    ('pcc_pediatric_neuro_ext36', 'PCC Pediatric Neuro Ext36', 'pcc-pediatric-neuro-ext36'),
    ('pcc_pediatric_surg_ext36', 'PCC Pediatric Surg Ext36', 'pcc-pediatric-surg-ext36'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext47': [
        'VertebrobasilarInsufficiencyExt', 'BasilarArteryThrombosisExt',
        'PosteriorFossaStrokeExt', 'CerebellarStrokeExt',
        'LateralMedullarySyndromeExt', 'MedialMedullarySyndromeExt',
        'LateralPonsSyndromeExt', 'LockedInSyndromeExt',
        'TopOfBasilarSyndromeExt', 'SubclavianStealSyndromeExt',
    ],
    'pcc_pediatric_neuro_ext36': [
        'PediatricNeurocutaneousExt', 'PediatricNeurofibromatosisType1Ext',
        'PediatricNeurofibromatosisType2Ext', 'PediatricTuberousSclerosisExt',
        'PediatricSturgeWeberExt', 'PediatricVonHippelLindauExt',
        'PediatricAtaxiaTelangiectasiaExt', 'PediatricGorlinSyndromeExt',
        'PediatricHypomelanosisOfItoExt', 'PediatricIncontinentiaPigmentiExt',
    ],
    'pcc_pediatric_surg_ext36': [
        'PediatricThoracicSurgeryExt', 'PediatricPectusRepairExt',
        'PediatricNussProcedureExt', 'PediatricRavitchProcedureExt',
        'PediatricEsophagealAtresiaExt', 'PediatricTEFistulaExt',
        'PediatricDiaphragmaticHerniaExt', 'PediatricCDHRepairExt',
        'PediatricEventrationExt', 'PediatricPhrenicNervePalsyExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext47,pediatric_neuro_ext36,pediatric_surg_ext36');\n"
