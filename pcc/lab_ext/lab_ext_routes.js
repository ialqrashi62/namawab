...
router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'lab_ext', label: 'Lab-Ext', functions: fns.length, version: '3.21.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'lab_ext', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
