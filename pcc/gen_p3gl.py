#!/usr/bin/env python3
"""P3-GL generator v3.154.0 — pcc_neuro_ext55, pcc_pediatric_neuro_ext44, pcc_pediatric_surg_ext44"""
import os
...
MODULES = [
    ('pcc_neuro_ext55', 'PCC Neuro Ext55', 'pcc-neuro-ext55'),
    ('pcc_pediatric_neuro_ext44', 'PCC Pediatric Neuro Ext44', 'pcc-pediatric-neuro-ext44'),
    ('pcc_pediatric_surg_ext44', 'PCC Pediatric Surg Ext44', 'pcc-pediatric-surg-ext44'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext55': [
        'CreutzfeldtJakobDiseaseExt', 'VariantCJDExt',
        'GerstmannStrausslerScheinkerExt', 'KuruExt',
        'BovineSpongiformEncephalopathyExt', 'FatalFamilialInsomniaExt',
        'SporadicFatalInsomniaExt', 'VariablyProteaseSensitivePrionopathyExt',
        'PrionProteinCerebralAmyloidAngiopathyExt', 'PrionDiseaseDiagnosisExt',
    ],
    'pcc_pediatric_neuro_ext44': [
        'PediatricNeurometabolicExt3', 'PediatricLeukodystrophyExt',
        'PediatricMetachromaticLeukodystrophyExt', 'PediatricKrabbeDiseaseExt',
        'PediatricAdrenoleukodystrophyExt', 'PediatricCanavanDiseaseExt',
        'PediatricAlexanderDiseaseExt', 'PediatricPelizaeusMerzbacherExt',
        'PediatricCerebralCholesterolinosisExt', 'PediatricVanishingWhiteMatterExt',
    ],
    'pcc_pediatric_surg_ext44': [
        'PediatricENTReconstructionExt', 'PediatricTrachealResectionExt',
        'PediatricLaryngotrachealReconstructionExt', 'PediatricCricotrachealResectionExt',
        'PediatricLaryngoplastyExt', 'PediatricPhonosurgeryExt',
        'PediatricBronchoscopyTherapeuticExt', 'PediatricEsophagealDilatationExt',
        'PediatricEsophagealReplacementExt', 'PediatricPharyngealReconstructionExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext55,pediatric_neuro_ext44,pediatric_surg_ext44');\n"
