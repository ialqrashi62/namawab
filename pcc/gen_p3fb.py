#!/usr/bin/env python3
"""P3-FB generator v3.118.0 — pcc_neuro_ext19, pcc_pediatric_neuro_ext8, pcc_pediatric_surg_ext8"""
import os
...
MODULES = [
    ('pcc_neuro_ext19', 'PCC Neuro Ext19', 'pcc-neuro-ext19'),
    ('pcc_pediatric_neuro_ext8', 'PCC Pediatric Neuro Ext8', 'pcc-pediatric-neuro-ext8'),
    ('pcc_pediatric_surg_ext8', 'PCC Pediatric Surg Ext8', 'pcc-pediatric-surg-ext8'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext19': [
        'SpinalCordInjuryExt', 'CervicalSpinalCordInjury',
        'ThoracicSpinalCordInjury', 'LumbarSpinalCordInjury',
        'CaudaEquinaSyndrome', 'ConusMedullarisSyndrome',
        'SpinalCordCompression', 'SpinalEpiduralAbscess',
        'SpinalCordTumorExt', 'SyringomyeliaExt',
    ],
    'pcc_pediatric_neuro_ext8': [
        'PediatricAutismSpectrum', 'PediatricAspergerSyndrome',
        'PediatricPervasiveDevelopmental', 'PediatricRettSyndrome',
        'PediatricChildhoodDisintegrative', 'PediatricADHD',
        'PediatricTouretteSyndrome', 'PediatricOCD',
        'PediatricAnxietyDisorder', 'PediatricConductDisorder',
    ],
    'pcc_pediatric_surg_ext8': [
        'PediatricCleftPalateRepair', 'PediatricCleftLipRepair',
        'PediatricAlveolarBoneGraft', 'PediatricPharyngoplasty',
        'PediatricTympanoplasty', 'PediatricMastoidectomy',
        'PediatricCochlearImplant', 'PediatricBAHAImplant',
        'PediatricBoneAnchoredHearing', 'PediatricMiddleEarSurgery',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext19,pediatric_neuro_ext8,pediatric_surg_ext8');\n"
