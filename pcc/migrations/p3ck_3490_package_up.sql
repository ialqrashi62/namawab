...
CREATE TABLE IF NOT EXISTS p3ck_pcc_neonatal_ext2 (
    id BIGSERIAL PRIMARY KEY,
    encounter_id TEXT,
    tenant_id TEXT NOT NULL,
    input JSONB,
...
CREATE INDEX IF NOT EXISTS idx_p3ck_pcc_neonatal_ext2_tenant ON p3ck_pcc_neonatal_ext2(tenant_id);

CREATE INDEX IF NOT EXISTS idx_p3ck_pcc_neonatal_ext2_encounter ON p3ck_pcc_neonatal_ext2(encounter_id);
