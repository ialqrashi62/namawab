#!/usr/bin/env python3
"""P3-DR generator: 3 modules = engines + tests + integration tests + routes + SQL."""
import os
...
os.chdir(ROOT)
MODULES = [
    ('pcc_obstetrics_advanced', 'PCC Obstetrics Advanced', 'oba'),
    ('pcc_gynecology_advanced', 'PCC Gynecology Advanced', 'gya'),
    ('pcc_maternal_fetal_advanced', 'PCC Maternal Fetal Advanced', 'mfa'),
]
PKG = 'p3dr_'
COLUMNS = [
    ('encounter_id', 'TEXT'),
...
ENGINE_FUNCS = {
    'pcc_obstetrics_advanced': ['PreeclampsiaSevere', 'EclampsiaManagement', 'HELLPSyndrome', 'PlacentalAbruption', 'PlacentaPreviaAdvanced', 'PostpartumHemorrhage', 'AmnioticFluidEmbolism', 'UterineRupture', 'ObstetricSepsis', 'PeripartumCardiomyopathy'],
    'pcc_gynecology_advanced': ['OvarianCancerAdvanced', 'EndometrialCancer', 'CervicalCancerAdvanced', 'UterineFibroidsRefractory', 'EndometriosisAdvanced', 'PCOSRefractory', 'PelvicInflammatoryDisease', 'VulvodyniaAdvanced', 'GynecologicSurgeryRisk', 'FertilityPreservation'],
    'pcc_maternal_fetal_advanced': ['FetalGrowthRestriction', 'TwinTwinTransfusion', 'FetalAnemia', 'FetalArrhythmia', 'CongenitalInfections', 'RedCellAlloimmunization', 'PretermLaborTocolysis', 'CervicalInsufficiency', 'MaternalCardiacDisease', 'MaternalRenalDisease'],
}
