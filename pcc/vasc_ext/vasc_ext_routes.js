// P3-BP routes: vasc_ext (Vasc-Ext)
...
router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'vasc_ext', label: 'Vasc-Ext', functions: fns.length, version: '3.28.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'vasc_ext', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
