// P3-BO routes: endocrine_ext (Endocrine-Ext)
...
router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'endocrine_ext', label: 'Endocrine-Ext', functions: fns.length, version: '3.27.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'endocrine_ext', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
