...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.119.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.119.0: modules wired, P3-FC neuro_ext20/pediatric_neuro_ext9/pediatric_surg_ext9)`);
  // eslint-disable-next-line no-console
