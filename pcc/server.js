...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.164.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.164.0: modules wired, P3-GV neuro_ext65/pediatric_neuro_ext54/pediatric_surg_ext54)`);
  // eslint-disable-next-line no-console
