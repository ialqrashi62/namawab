...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.126.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.126.0: modules wired, P3-FJ neuro_ext27/pediatric_neuro_ext16/pediatric_surg_ext16)`);
  // eslint-disable-next-line no-console
