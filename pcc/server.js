...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.148.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.148.0: modules wired, P3-GF neuro_ext49/pediatric_neuro_ext38/pediatric_surg_ext38)`);
  // eslint-disable-next-line no-console
