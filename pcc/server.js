...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.161.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.161.0: modules wired, P3-GS neuro_ext62/pediatric_neuro_ext51/pediatric_surg_ext51)`);
  // eslint-disable-next-line no-console
