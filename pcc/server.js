...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.100.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.100.0: modules wired, P3-EJ spine_surgery_ext/pediatric_infectious/pediatric_derm_ext)`);
  // eslint-disable-next-line no-console
