...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.153.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.153.0: modules wired, P3-GK neuro_ext54/pediatric_neuro_ext43/pediatric_surg_ext43)`);
  // eslint-disable-next-line no-console
