...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.111.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.111.0: modules wired, P3-EU neuro_ext12/pediatric_psych_ext2/pediatric_derm_ext2)`);
  // eslint-disable-next-line no-console
