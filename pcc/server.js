...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.109.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.109.0: modules wired, P3-ES neuro_ext10/pediatric_cardio_ext2/pediatric_oncology_ext)`);
  // eslint-disable-next-line no-console
