...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.120.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.120.0: modules wired, P3-FD neuro_ext21/pediatric_neuro_ext10/pediatric_surg_ext10)`);
  // eslint-disable-next-line no-console
