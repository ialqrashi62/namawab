...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.102.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.102.0: modules wired, P3-EL neuro_ext3/pediatric_behavior/pediatric_imaging)`);
  // eslint-disable-next-line no-console
