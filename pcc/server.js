...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.116.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.116.0: modules wired, P3-EZ neuro_ext17/pediatric_neuro_ext6/pediatric_surg_ext6)`);
  // eslint-disable-next-line no-console
