...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.130.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.130.0: modules wired, P3-FN neuro_ext31/pediatric_neuro_ext20/pediatric_surg_ext20)`);
  // eslint-disable-next-line no-console
