...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.108.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.108.0: modules wired, P3-ER neuro_ext9/pediatric_gi_ext2/pediatric_neuro_ext)`);
  // eslint-disable-next-line no-console
