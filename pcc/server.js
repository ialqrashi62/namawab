...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.129.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.129.0: modules wired, P3-FM neuro_ext30/pediatric_neuro_ext19/pediatric_surg_ext19)`);
  // eslint-disable-next-line no-console
