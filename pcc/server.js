...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.163.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.163.0: modules wired, P3-GU neuro_ext64/pediatric_neuro_ext53/pediatric_surg_ext53)`);
  // eslint-disable-next-line no-console
