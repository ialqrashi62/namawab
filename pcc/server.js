...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.138.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.138.0: modules wired, P3-FV neuro_ext39/pediatric_neuro_ext28/pediatric_surg_ext28)`);
  // eslint-disable-next-line no-console
