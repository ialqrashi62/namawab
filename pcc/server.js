...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.114.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.114.0: modules wired, P3-EX neuro_ext15/pediatric_neuro_ext4/pediatric_surg_ext4)`);
  // eslint-disable-next-line no-console
