...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.134.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.134.0: modules wired, P3-FR neuro_ext35/pediatric_neuro_ext24/pediatric_surg_ext24)`);
  // eslint-disable-next-line no-console
