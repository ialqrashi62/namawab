...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.142.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.142.0: modules wired, P3-FZ neuro_ext43/pediatric_neuro_ext32/pediatric_surg_ext32)`);
  // eslint-disable-next-line no-console
