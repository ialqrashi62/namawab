...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.115.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.115.0: modules wired, P3-EY neuro_ext16/pediatric_neuro_ext5/pediatric_surg_ext5)`);
  // eslint-disable-next-line no-console
