...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.149.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.149.0: modules wired, P3-GG neuro_ext50/pediatric_neuro_ext39/pediatric_surg_ext39)`);
  // eslint-disable-next-line no-console
