...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.132.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.132.0: modules wired, P3-FP neuro_ext33/pediatric_neuro_ext22/pediatric_surg_ext22)`);
  // eslint-disable-next-line no-console
