...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.122.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.122.0: modules wired, P3-FF neuro_ext23/pediatric_neuro_ext12/pediatric_surg_ext12)`);
  // eslint-disable-next-line no-console
