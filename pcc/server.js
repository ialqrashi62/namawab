...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.107.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.107.0: modules wired, P3-EQ neuro_ext8/pediatric_renal_ext/pediatric_pulm_ext)`);
  // eslint-disable-next-line no-console
