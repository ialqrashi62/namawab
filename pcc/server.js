...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.151.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.151.0: modules wired, P3-GI neuro_ext52/pediatric_neuro_ext41/pediatric_surg_ext41)`);
  // eslint-disable-next-line no-console
