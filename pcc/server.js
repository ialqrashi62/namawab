...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.103.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.103.0: modules wired, P3-EM neuro_ext4/pediatric_surg_ext/pediatric_rehab)`);
  // eslint-disable-next-line no-console
