...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.123.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.123.0: modules wired, P3-FG neuro_ext24/pediatric_neuro_ext13/pediatric_surg_ext13)`);
  // eslint-disable-next-line no-console
