...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.147.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.147.0: modules wired, P3-GE neuro_ext48/pediatric_neuro_ext37/pediatric_surg_ext37)`);
  // eslint-disable-next-line no-console
