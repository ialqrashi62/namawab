...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.125.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.125.0: modules wired, P3-FI neuro_ext26/pediatric_neuro_ext15/pediatric_surg_ext15)`);
  // eslint-disable-next-line no-console
