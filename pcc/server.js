...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.155.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.155.0: modules wired, P3-GM neuro_ext56/pediatric_neuro_ext45/pediatric_surg_ext45)`);
  // eslint-disable-next-line no-console
