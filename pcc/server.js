...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.139.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.139.0: modules wired, P3-FW neuro_ext40/pediatric_neuro_ext29/pediatric_surg_ext29)`);
  // eslint-disable-next-line no-console
