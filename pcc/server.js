...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.112.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.112.0: modules wired, P3-EV neuro_ext13/pediatric_neuro_ext2/pediatric_surg_ext2)`);
  // eslint-disable-next-line no-console
