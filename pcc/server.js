...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.113.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.113.0: modules wired, P3-EW neuro_ext14/pediatric_surg_ext3/pediatric_neuro_ext3)`);
  // eslint-disable-next-line no-console
