...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.104.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.104.0: modules wired, P3-EN neuro_ext5/pediatric_icu_ext/pediatric_er_ext)`);
  // eslint-disable-next-line no-console
