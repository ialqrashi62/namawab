...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.110.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.110.0: modules wired, P3-ET neuro_ext11/pediatric_neuro_surg_ext/pediatric_endo_ext2)`);
  // eslint-disable-next-line no-console
