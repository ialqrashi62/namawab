...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.128.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.128.0: modules wired, P3-FL neuro_ext29/pediatric_neuro_ext18/pediatric_surg_ext18)`);
  // eslint-disable-next-line no-console
