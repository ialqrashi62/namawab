...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.121.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.121.0: modules wired, P3-FE neuro_ext22/pediatric_neuro_ext11/pediatric_surg_ext11)`);
  // eslint-disable-next-line no-console
