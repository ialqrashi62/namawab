...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.162.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.162.0: modules wired, P3-GT neuro_ext63/pediatric_neuro_ext52/pediatric_surg_ext52)`);
  // eslint-disable-next-line no-console
