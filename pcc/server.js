...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.137.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.137.0: modules wired, P3-FU neuro_ext38/pediatric_neuro_ext27/pediatric_surg_ext27)`);
  // eslint-disable-next-line no-console
