...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.131.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.131.0: modules wired, P3-FO neuro_ext32/pediatric_neuro_ext21/pediatric_surg_ext21)`);
  // eslint-disable-next-line no-console
