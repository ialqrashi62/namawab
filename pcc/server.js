...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.136.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.136.0: modules wired, P3-FT neuro_ext37/pediatric_neuro_ext26/pediatric_surg_ext26)`);
  // eslint-disable-next-line no-console
