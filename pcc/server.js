...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.143.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.143.0: modules wired, P3-GA neuro_ext44/pediatric_neuro_ext33/pediatric_surg_ext33)`);
  // eslint-disable-next-line no-console
