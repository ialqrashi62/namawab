...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.101.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.101.0: modules wired, P3-EK ortho_ext/pediatric_sleep/pediatric_surg_subspec)`);
  // eslint-disable-next-line no-console
