...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.118.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.118.0: modules wired, P3-FB neuro_ext19/pediatric_neuro_ext8/pediatric_surg_ext8)`);
  // eslint-disable-next-line no-console
