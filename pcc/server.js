...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.145.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.145.0: modules wired, P3-GC neuro_ext46/pediatric_neuro_ext35/pediatric_surg_ext35)`);
  // eslint-disable-next-line no-console
