...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.117.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.117.0: modules wired, P3-FA neuro_ext18/pediatric_neuro_ext7/pediatric_surg_ext7)`);
  // eslint-disable-next-line no-console
