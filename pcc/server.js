...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.127.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.127.0: modules wired, P3-FK neuro_ext28/pediatric_neuro_ext17/pediatric_surg_ext17)`);
  // eslint-disable-next-line no-console
