...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.157.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.157.0: modules wired, P3-GO neuro_ext58/pediatric_neuro_ext47/pediatric_surg_ext47)`);
  // eslint-disable-next-line no-console
