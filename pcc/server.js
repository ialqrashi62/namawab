...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.135.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.135.0: modules wired, P3-FS neuro_ext36/pediatric_neuro_ext25/pediatric_surg_ext25)`);
  // eslint-disable-next-line no-console
