...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.154.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.154.0: modules wired, P3-GL neuro_ext55/pediatric_neuro_ext44/pediatric_surg_ext44)`);
  // eslint-disable-next-line no-console
