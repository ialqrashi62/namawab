...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.146.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.146.0: modules wired, P3-GD neuro_ext47/pediatric_neuro_ext36/pediatric_surg_ext36)`);
  // eslint-disable-next-line no-console
