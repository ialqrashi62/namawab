...
app.get('/health', (_req, res) => res.json({
  status: 'ok', service: 'pcc-sandbox', version: ('3.165.0'),
...
const server = app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`PCC sandbox listening on port ${PORT} (v3.165.0: modules wired, P3-GW neuro_ext66/pediatric_neuro_ext55/pediatric_surg_ext55)`);
  // eslint-disable-next-line no-console
