#!/usr/bin/env python3
"""P3-DL generator: 3 modules = engines + tests + integration tests + routes + SQL."""
import os
...
os.chdir(ROOT)
MODULES = [
    ('pcc_critical_care_advanced', 'PCC Critical Care Advanced', 'cca'),
    ('pcc_nutrition_support', 'PCC Nutrition Support', 'nut'),
    ('pcc_sedation_analgesia', 'PCC Sedation Analgesia', 'sed'),
]
PKG = 'p3dl_'
COLUMNS = [
    ('encounter_id', 'TEXT'),
...
ENGINE_FUNCS = {
    'pcc_critical_care_advanced': ['ShockIndex', 'LactateClearance', 'Scvo2Monitoring', 'Microcirculation', 'CuffPressure', 'PronePositioning', 'ECMOIndication', 'CRRTDosing', 'NeuromuscularBlock', 'DeliriumPrevention'],
    'pcc_nutrition_support': ['CaloricTarget', 'ProteinRequirement', 'EnteralAccess', 'ParenteralIndication', 'RefeedingRisk', 'GlycemicControlNutrition', 'Immunonutrition', 'FluidBalance', 'MicronutrientRepletion', 'NutritionOutcome'],
    'pcc_sedation_analgesia': ['SedationScale', 'AnalgesiaScore', 'DailySedationInterruption', 'Analgosedation', 'WithdrawalAssessment', 'RegionalAnalgesia', 'OpioidSparing', 'AgitationProtocol', 'ProceduralSedation', 'SedationWeaning'],
}
