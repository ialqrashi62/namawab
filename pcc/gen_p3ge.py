#!/usr/bin/env python3
"""P3-GE generator v3.147.0 — pcc_neuro_ext48, pcc_pediatric_neuro_ext37, pcc_pediatric_surg_ext37"""
import os
...
MODULES = [
    ('pcc_neuro_ext48', 'PCC Neuro Ext48', 'pcc-neuro-ext48'),
    ('pcc_pediatric_neuro_ext37', 'PCC Pediatric Neuro Ext37', 'pcc-pediatric-neuro-ext37'),
    ('pcc_pediatric_surg_ext37', 'PCC Pediatric Surg Ext37', 'pcc-pediatric-surg-ext37'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext48': [
        'MotorNeuronDiseaseExt', 'AmyotrophicLateralSclerosisExt',
        'PrimaryLateralSclerosisExt', 'ProgressiveBulbarPalsyExt',
        'ProgressiveMuscularAtrophyExt', 'FlailArmSyndromeExt',
        'FlailLegSyndromeExt', 'KennedyDiseaseExt',
        'SpinalMuscularAtrophyAdultExt', 'MultifocalMotorNeuropathyExt',
    ],
    'pcc_pediatric_neuro_ext37': [
        'PediatricHeadacheDisorderExt', 'PediatricMigraineWithAuraExt',
        'PediatricMigraineWithoutAuraExt', 'PediatricHemiplegicMigraineExt',
        'PediatricBasilarMigraineExt', 'PediatricConfusionalMigraineExt',
        'PediatricOphthalmoplegicMigraineExt', 'PediatricVestibularMigraineExt',
        'PediatricAbdominalMigraineExt', 'PediatricCyclicVomitingExt',
    ],
    'pcc_pediatric_surg_ext37': [
        'PediatricAbdominalWallExt', 'PediatricGastroschisisExt',
        'PediatricOmphaloceleExt', 'PediatricHerniaRepairExt',
        'PediatricInguinalHerniaExt', 'PediatricUmbilicalHerniaExt',
        'PediatricFemoralHerniaExt', 'PediatricDiaphragmaticHerniaRecurrExt',
        'PediatricEventrationRepairExt', 'PediatricAbdominalReconstructionExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext48,pediatric_neuro_ext37,pediatric_surg_ext37');\n"
