#!/usr/bin/env python3
"""P3-DQ generator: 3 modules = engines + tests + integration tests + routes + SQL."""
import os
...
os.chdir(ROOT)
MODULES = [
    ('pcc_dermatology_advanced', 'PCC Dermatology Advanced', 'dea'),
    ('pcc_pediatrics_advanced', 'PCC Pediatrics Advanced', 'pea'),
    ('pcc_neonatology_advanced', 'PCC Neonatology Advanced', 'nea'),
]
PKG = 'p3dq_'
COLUMNS = [
    ('encounter_id', 'TEXT'),
...
ENGINE_FUNCS = {
    'pcc_dermatology_advanced': ['PsoriasisAdvanced', 'AtopicDermatitisSevere', 'AcneRefractory', 'RosaceaAdvanced', 'HidradenitisSuppurativa', 'CutaneousLymphoma', 'AutoimmuneBlistering', 'MelanomaAdvanced', 'DermatomyositisSkin', 'VascularAnomalies'],
    'pcc_pediatrics_advanced': ['PediatricSepsisAdvanced', 'DiabeticKetoacidosisPedi', 'StatusEpilepticusPedi', 'BronchiolitisSevere', 'PediatricAsthmaSevere', 'CongenitalHeartDisease', 'PediatricOncologyEmergencies', 'InbornErrorsMetabolism', 'PediatricNeurocritical', 'PediatricToxicology'],
    'pcc_neonatology_advanced': ['NeonatalResuscitationAdvanced', 'NeonatalSepsisAdvanced', 'NeonatalHypoglycemia', 'NeonatalJaundiceAdvanced', 'NeonatalRespiratoryDistress', 'NeonatalSeizures', 'NeonatalHypoxicIschemic', 'NeonatalNecrotizingEnterocolitis', 'NeonatalPatentDuctusArteriosus', 'NeonatalRetinopathyPrematurity'],
}
