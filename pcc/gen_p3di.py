#!/usr/bin/env python3
"""P3-DI generator: 3 modules = engines + tests + integration tests + routes + SQL."""
import os
...
os.chdir(ROOT)
MODULES = [
    ('pcc_cardiovascular_optimization', 'PCC Cardiovascular Optimization', 'cvo'),
    ('pcc_vascular_health', 'PCC Vascular Health', 'vhl'),
    ('pcc_heart_failure_advanced', 'PCC Heart Failure Advanced', 'hfa'),
]
PKG = 'p3di_'
COLUMNS = [
    ('encounter_id', 'TEXT'),
...
ENGINE_FUNCS = {
    'pcc_cardiovascular_optimization': ['EndothelialFunction', 'LipidOptimization', 'BloodPressurePattern', 'HeartRateVariability', 'CardiacRehabAdvanced', 'VascularStiffness', 'CoronaryRisk', 'StrokePrevention', 'CardiacNutrition', 'ExercisePrescription'],
    'pcc_vascular_health': ['VenousInsufficiency', 'PeripheralArtery', 'AorticHealth', 'Microcirculation', 'VascularInflammation', 'EndothelialRepair', 'CompressionTherapy', 'VascularScreening', 'ClotRisk', 'VascularSurgeryPrep'],
    'pcc_heart_failure_advanced': ['NYHAStaging', 'BNPTrend', 'EjectionFraction', 'FluidStatus', 'CardiacDevice', 'HeartTransplantEval', 'PalliativeHF', 'AcuteDecompensation', 'DiureticStrategy', 'SelfManagement'],
}
