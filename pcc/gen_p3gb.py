#!/usr/bin/env python3
"""P3-GB generator v3.144.0 — pcc_neuro_ext45, pcc_pediatric_neuro_ext34, pcc_pediatric_surg_ext34"""
import os
...
MODULES = [
    ('pcc_neuro_ext45', 'PCC Neuro Ext45', 'pcc-neuro-ext45'),
    ('pcc_pediatric_neuro_ext34', 'PCC Pediatric Neuro Ext34', 'pcc-pediatric-neuro-ext34'),
    ('pcc_pediatric_surg_ext34', 'PCC Pediatric Surg Ext34', 'pcc-pediatric-surg-ext34'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext45': [
        'CranialNerveIPalsyExt', 'CranialNerveIIPalsyExt',
        'CranialNerveIIIPalsyExt', 'CranialNerveIVPalsyExt',
        'CranialNerveVPalsyExt', 'CranialNerveVIPalsyExt',
        'CranialNerveVIIPalsyExt', 'CranialNerveVIIIPalsyExt',
        'CranialNerveIXPalsyExt', 'CranialNerveXPalsyExt',
    ],
    'pcc_pediatric_neuro_ext34': [
        'PediatricFeedingDisorderExt3', 'PediatricAvoidantRestrictiveFoodExt',
        'PediatricAnorexiaExt', 'PediatricBulimiaExt',
        'PediatricBingeEatingExt', 'PediatricPicaExt',
        'PediatricRuminationExt', 'PediatricFoodRefusalExt',
        'PediatricSelectiveEatingExt', 'PediatricFailureToThriveExt',
    ],
    'pcc_pediatric_surg_ext34': [
        'PediatricTraumaSurgeryExt', 'PediatricSplenectomyExt',
        'PediatricHepatectomyExt', 'PediatricPancreatectomyExt',
        'PediatricNephrectomyTraumaExt', 'PediatricBowelResectionTraumaExt',
        'PediatricDamageControlExt', 'PediatricVascularTraumaRepairExt',
        'PediatricNerveRepairTraumaExt', 'PediatricTendonRepairTraumaExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext45,pediatric_neuro_ext34,pediatric_surg_ext34');\n"
