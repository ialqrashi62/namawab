// P3-BG routes: transplant_immunology (Transplant-Immunology)
...
router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'transplant_immunology', label: 'Transplant-Immunology', functions: fns.length, version: '3.19.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'transplant_immunology', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
