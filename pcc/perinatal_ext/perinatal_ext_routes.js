// P3-BE routes: perinatal_ext (Perinatal-Ext)
...
router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'perinatal_ext', label: 'Perinatal-Ext', functions: fns.length, version: '3.17.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'perinatal_ext', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
