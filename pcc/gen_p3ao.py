...
MODS = [('hospice', 'h'), ('pharmacy_clinical', 'pc'), ('clinical_pharm', 'cp')]
...
TPL_INT = """// P3-AO integration: __MOD__
...
def main():
    sql_path = BASE / 'migrations' / 'p3ao_up.sql'
    ...
    audit = BASE.parent / 'scratch' / 'p3ao_audit.txt'
