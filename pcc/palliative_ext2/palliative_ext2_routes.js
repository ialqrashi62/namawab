// P3-BG routes: palliative_ext2 (Palliative-Ext-2)
...
router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'palliative_ext2', label: 'Palliative-Ext-2', functions: fns.length, version: '3.19.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'palliative_ext2', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
