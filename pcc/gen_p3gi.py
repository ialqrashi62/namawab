#!/usr/bin/env python3
"""P3-GI generator v3.151.0 — pcc_neuro_ext52, pcc_pediatric_neuro_ext41, pcc_pediatric_surg_ext41"""
import os
...
MODULES = [
    ('pcc_neuro_ext52', 'PCC Neuro Ext52', 'pcc-neuro-ext52'),
    ('pcc_pediatric_neuro_ext41', 'PCC Pediatric Neuro Ext41', 'pcc-pediatric-neuro-ext41'),
    ('pcc_pediatric_surg_ext41', 'PCC Pediatric Surg Ext41', 'pcc-pediatric-surg-ext41'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext52': [
        'SubduralHematomaExt', 'EpiduralHematomaExt',
        'SubarachnoidHemorrhageExt', 'IntracerebralHemorrhageExt',
        'IntraventricularHemorrhageExt', 'CerebralMicrobleedsExt',
        'ChronicSubduralHematomaExt', 'AcuteSubduralHematomaExt',
        'TraumaticSAHExt', 'BerryAneurysmRuptureExt',
    ],
    'pcc_pediatric_neuro_ext41': [
        'PediatricDemyelinatingExt', 'PediatricMSAdultLikeExt',
        'PediatricMOGADExt', 'PediatricNMOSDExt',
        'PediatricADEMEpiExt', 'PediatricOpticNeuritisExt',
        'PediatricTransverseMyelitisExt', 'PediatricClinicallyIsolatedSyndromeExt',
        'PediatricRadiologicallyIsolatedExt', 'PediatricMyelinOligodendrocyteExt',
    ],
    'pcc_pediatric_surg_ext41': [
        'PediatricBariatricSurgeryExt', 'PediatricSleeveGastrectomyExt',
        'PediatricGastricBypassExt', 'PediatricAdjustableBandExt',
        'PediatricBiliopancreaticDiversionExt', 'PediatricDuodenalSwitchExt',
        'PediatricRevisionalBariatricExt', 'PediatricCholecystectomyExt',
        'PediatricSplenectomyHematologicExt', 'PediatricLiverResectionExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext52,pediatric_neuro_ext41,pediatric_surg_ext41');\n"
