// P3-BD routes: transplant_extended (Transplant-Extended)
...
router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'transplant_extended', label: 'Transplant-Extended', functions: fns.length, version: '3.16.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'transplant_extended', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
