#!/usr/bin/env python3
"""P3-DS generator: convert 3 P3-B blueprints to real PCC code."""
import os
...
os.chdir(ROOT)
MODULES = [
    ('pcc_cath_lab_specialized', 'PCC Cath Lab Specialized', 'cls'),
    ('pcc_dialysis', 'PCC Dialysis', 'dial'),
    ('pcc_stroke_unit', 'PCC Stroke Unit', 'strk'),
]
PKG = 'p3ds_'
COLUMNS = [
    ('encounter_id', 'TEXT'),
...
ENGINE_FUNCS = {
    'pcc_cath_lab_specialized': ['CTOScoreJCTO', 'SyntaxScore', 'CalciumScoreIVUS', 'FFRiFRAnalysis', 'BifurcationMedina', 'PerforationEllis', 'RotablationBurr', 'IVLDelivery', 'NoReflowPredict', 'CoronaryDissectionType'],
    'pcc_dialysis': ['DialysisInitiation', 'HDAdequacyKtV', 'PDAdequacyKtV', 'CRRTDose', 'VascularAccess', 'DialysisHypotension', 'DialysisDisequilibrium', 'HyperkalemiaDialysis', 'ContrastNephropathyProphylaxis', 'TransplantWaitlist'],
    'pcc_stroke_unit': ['NIHSS', 'DoorToNeedle', 'tPAContraindications', 'ICHScore', 'ASPECTS', 'ABCD2', 'HASBLED', 'StrokeSepsisBundle', 'DysphagiaScreen', 'SecondaryPrevention'],
}
