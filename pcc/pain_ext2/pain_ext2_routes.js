// P3-BK routes: pain_ext2 (Pain-Ext-2)
...
router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'pain_ext2', label: 'Pain-Ext-2', functions: fns.length, version: '3.23.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'pain_ext2', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
