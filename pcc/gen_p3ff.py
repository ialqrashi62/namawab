#!/usr/bin/env python3
"""P3-FF generator v3.122.0 — pcc_neuro_ext23, pcc_pediatric_neuro_ext12, pcc_pediatric_surg_ext12"""
import os
...
MODULES = [
    ('pcc_neuro_ext23', 'PCC Neuro Ext23', 'pcc-neuro-ext23'),
    ('pcc_pediatric_neuro_ext12', 'PCC Pediatric Neuro Ext12', 'pcc-pediatric-neuro-ext12'),
    ('pcc_pediatric_surg_ext12', 'PCC Pediatric Surg Ext12', 'pcc-pediatric-surg-ext12'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext23': [
        'CranialNerveDisorderExt', 'OlfactoryNerveDisorder',
        'OpticNeuritisExt2', 'OculomotorNervePalsy',
        'TrochlearNervePalsy', 'AbducensNervePalsy',
        'TrigeminalNeuropathy', 'FacialNervePalsy',
        'VestibulocochlearNerveDisorder', 'GlossopharyngealNeuralgiaExt',
    ],
    'pcc_pediatric_neuro_ext12': [
        'PediatricCerebralPalsy', 'PediatricSpasticity',
        'PediatricDyskinesia', 'PediatricAtaxia',
        'PediatricHypotonia', 'PediatricHypertonia',
        'PediatricDystonia', 'PediatricChorea',
        'PediatricTremor', 'PediatricMyoclonus',
    ],
    'pcc_pediatric_surg_ext12': [
        'PediatricPlasticSurgeryExt', 'PediatricCleftHandRepair',
        'PediatricSyndactylyRelease', 'PediatricPolydactylyRepair',
        'PediatricBurnReconstruction', 'PediatricScarRevision',
        'PediatricTissueExpansion', 'PediatricSkinFlap',
        'PediatricFreeFlap', 'PediatricReplantation',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext23,pediatric_neuro_ext12,pediatric_surg_ext12');\n"
