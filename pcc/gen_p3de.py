#!/usr/bin/env python3
"""P3-DE generator: 3 modules = engines + tests + integration tests + routes + SQL."""
import os
...
os.chdir(ROOT)
MODULES = [
    ('pcc_nutritional_medicine', 'PCC Nutritional Medicine', 'nut'),
    ('pcc_gut_microbiome', 'PCC Gut Microbiome', 'gut'),
    ('pcc_metabolic_health', 'PCC Metabolic Health', 'mth'),
]
PKG = 'p3de_'
COLUMNS = [
    ('encounter_id', 'TEXT'),
...
ENGINE_FUNCS = {
    'pcc_nutritional_medicine': ['MacronutrientBalance', 'MicronutrientStatus', 'TherapeuticDiet', 'EnteralNutrition', 'ParenteralNutrition', 'MalnutritionScreen', 'FoodAllergy', 'EatingDisorder', 'SportsNutrition', 'CancerNutrition'],
    'pcc_gut_microbiome': ['DysbiosisAssessment', 'Probiotics', 'Prebiotics', 'FecalTransplant', 'SIBO', 'LeakyGut', 'GutBrainAxis', 'MicrobiomeTesting', 'DietaryFiber', 'PostbioticTherapy'],
    'pcc_metabolic_health': ['InsulinResistance', 'GlucoseVariability', 'MetabolicSyndrome', 'LipidProfile', 'FattyLiver', 'KetogenicTherapy', 'TimeRestrictedEating', 'ContinuousGlucose', 'ThyroidMetabolism', 'WeightSetPoint'],
}
