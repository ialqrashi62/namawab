#!/usr/bin/env python3
"""P3-DG generator: 3 modules = engines + tests + integration tests + routes + SQL."""
import os
...
os.chdir(ROOT)
MODULES = [
    ('pcc_hormone_optimization', 'PCC Hormone Optimization', 'hor'),
    ('pcc_thyroid_advanced', 'PCC Thyroid Advanced', 'thy'),
    ('pcc_adrenal_health', 'PCC Adrenal Health', 'adr'),
]
PKG = 'p3dg_'
COLUMNS = [
    ('encounter_id', 'TEXT'),
...
ENGINE_FUNCS = {
    'pcc_hormone_optimization': ['TestosteroneBalance', 'EstrogenMetabolism', 'ProgesteroneSupport', 'CortisolRhythm', 'GrowthHormone', 'DHEAOptimization', 'Pregnenolone', 'MelatoninRhythm', 'ThyroidHormone', 'HormoneSafety'],
    'pcc_thyroid_advanced': ['TSHPattern', 'FreeT3T4', 'ReverseT3', 'ThyroidAntibodies', 'IodineStatus', 'SeleniumSupport', 'Hashimotos', 'Graves', 'ThyroidNodule', 'PostpartumThyroid'],
    'pcc_adrenal_health': ['CortisolCurve', 'DHEASLevel', 'AdrenalFatigue', 'StressResponse', 'HPAAxis', 'AldosteroneBalance', 'SaltCraving', 'MorningCortisol', 'ACTHStimulation', 'AdrenalCrisis'],
}
