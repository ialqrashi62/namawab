#!/usr/bin/env python3
"""P3-GA generator v3.143.0 — pcc_neuro_ext44, pcc_pediatric_neuro_ext33, pcc_pediatric_surg_ext33"""
import os
...
MODULES = [
    ('pcc_neuro_ext44', 'PCC Neuro Ext44', 'pcc-neuro-ext44'),
    ('pcc_pediatric_neuro_ext33', 'PCC Pediatric Neuro Ext33', 'pcc-pediatric-neuro-ext33'),
    ('pcc_pediatric_surg_ext33', 'PCC Pediatric Surg Ext33', 'pcc-pediatric-surg-ext33'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext44': [
        'SpinocerebellarAtaxiaExt', 'FriedreichAtaxiaExt',
        'AtaxiaTelangiectasiaExt', 'EpisodicAtaxiaExt',
        'CerebellarDegenerationExt', 'OlivopontocerebellarAtrophyExt',
        'DentatorubralPallidoluysianExt', 'MachadoJosephExt',
        'IdiopathicCerebellarAtaxiaExt', 'CerebellitisExt',
    ],
    'pcc_pediatric_neuro_ext33': [
        'PediatricLearningDisorderExt3', 'PediatricDyslexiaExt',
        'PediatricDyscalculiaExt', 'PediatricDysgraphiaExt',
        'PediatricAuditoryProcessingExt', 'PediatricVisualProcessingExt',
        'PediatricLanguageDisorderExt', 'PediatricSpeechSoundDisorderExt',
        'PediatricChildhoodFluencyExt', 'PediatricSocialCommunicationExt',
    ],
    'pcc_pediatric_surg_ext33': [
        'PediatricOrthopedicExt2', 'PediatricScoliosisSurgeryExt',
        'PediatricSpinalFusionExt', 'PediatricGrowingRodsExt',
        'PediatricMAGECRodsExt', 'PediatricVEPTRExt',
        'PediatricTetheredCordExt', 'PediatricSpondylolisthesisExt',
        'PediatricKyphosisSurgeryExt', 'PediatricLordosisCorrectionExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext44,pediatric_neuro_ext33,pediatric_surg_ext33');\n"
