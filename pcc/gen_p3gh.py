#!/usr/bin/env python3
"""P3-GH generator v3.150.0 — pcc_neuro_ext51, pcc_pediatric_neuro_ext40, pcc_pediatric_surg_ext40"""
import os
...
MODULES = [
    ('pcc_neuro_ext51', 'PCC Neuro Ext51', 'pcc-neuro-ext51'),
    ('pcc_pediatric_neuro_ext40', 'PCC Pediatric Neuro Ext40', 'pcc-pediatric-neuro-ext40'),
    ('pcc_pediatric_surg_ext40', 'PCC Pediatric Surg Ext40', 'pcc-pediatric-surg-ext40'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext51': [
        'SyringomyeliaExt', 'SyringobulbiaExt',
        'ChiariMalformationType1Ext', 'ChiariMalformationType2Ext',
        'ChiariMalformationType3Ext', 'TetheredCordSyndromeExt',
        'OccultSpinalDysraphismExt', 'SpinalLipomaExt',
        'DermalSinusTractExt', 'DiastematomyeliaExt',
    ],
    'pcc_pediatric_neuro_ext40': [
        'PediatricMovementDisorderExt3', 'PediatricSydenhamChoreaExt',
        'PediatricPANDASExt', 'PediatricPANSext',
        'PediatricAutoimmuneEncephalitisExt2', 'PediatricOpsoclonusMyoclonusExt',
        'PediatricParaneoplasticSyndromeExt', 'PediatricAntiGADExt',
        'PediatricAntiLGI1Ext', 'PediatricAntiCASPR2Ext',
    ],
    'pcc_pediatric_surg_ext40': [
        'PediatricColorectalSurgeryExt', 'PediatricHirschsprungExt',
        'PediatricPullThroughExt', 'PediatricSwensonProcedureExt',
        'PediatricSoaveProcedureExt', 'PediatricDuhamelProcedureExt',
        'PediatricAnorectalMalformationExt', 'PediatricImperforateAnusExt',
        'PediatricRectalProlapseExt', 'PediatricFecalIncontinenceExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext51,pediatric_neuro_ext40,pediatric_surg_ext40');\n"
