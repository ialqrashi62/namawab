#!/usr/bin/env python3
"""P3-DN generator: 3 modules = engines + tests + integration tests + routes + SQL."""
import os
...
os.chdir(ROOT)
MODULES = [
    ('pcc_nephrology_advanced', 'PCC Nephrology Advanced', 'npa'),
    ('pcc_dialysis_advanced', 'PCC Dialysis Advanced', 'dia'),
    ('pcc_electrolyte_acid_base', 'PCC Electrolyte Acid Base', 'eab'),
]
PKG = 'p3dn_'
COLUMNS = [
    ('encounter_id', 'TEXT'),
...
ENGINE_FUNCS = {
    'pcc_nephrology_advanced': ['ProteinuriaWorkup', 'HematuriaEvaluation', 'NephroticSyndrome', 'NephriticSyndrome', 'RapidlyProgressiveGN', 'DiabeticNephropathy', 'HypertensiveNephrosclerosis', 'PolycysticKidneyDisease', 'RenalArteryStenosis', 'ChronicKidneyDiseaseProgression'],
    'pcc_dialysis_advanced': ['HemodialysisAccess', 'DialysisAdequacy', 'IntradialyticHypotension', 'DialysisDisequilibrium', 'PeritonealDialysisPrescription', 'PDPeritonitis', 'HomeHemodialysis', 'NocturnalDialysis', 'DialysisNutrition', 'TransplantReadiness'],
    'pcc_electrolyte_acid_base': ['HyponatremiaWorkup', 'HypernatremiaWorkup', 'HypokalemiaWorkup', 'HyperkalemiaWorkup', 'HypocalcemiaWorkup', 'HypercalcemiaWorkup', 'HypomagnesemiaWorkup', 'HypophosphatemiaWorkup', 'MetabolicAcidosis', 'MetabolicAlkalosis'],
}
