#!/usr/bin/env python3
"""P3-FT generator v3.136.0 — pcc_neuro_ext37, pcc_pediatric_neuro_ext26, pcc_pediatric_surg_ext26"""
import os
...
MODULES = [
    ('pcc_neuro_ext37', 'PCC Neuro Ext37', 'pcc-neuro-ext37'),
    ('pcc_pediatric_neuro_ext26', 'PCC Pediatric Neuro Ext26', 'pcc-pediatric-neuro-ext26'),
    ('pcc_pediatric_surg_ext26', 'PCC Pediatric Surg Ext26', 'pcc-pediatric-surg-ext26'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext37': [
        'CataplexyExt', 'SleepOnsetREM',
        'HypnagogicHallucinationsExt', 'HypnopompicHallucinations',
        'SleepParalysisExt2', 'REMIntrusionExt',
        'StatusDissociatusExt', 'SleepRelatedHallucinations',
        'NightmareDisorderExt', 'IsolatedSleepParalysis',
    ],
    'pcc_pediatric_neuro_ext26': [
        'PediatricMigraineExt3', 'PediatricTensionHeadacheExt',
        'PediatricClusterHeadacheExt', 'PediatricChronicDailyHeadache',
        'PediatricMedicationOveruseHeadache', 'PediatricNewDailyPersistentHeadache',
        'PediatricCervicogenicHeadache', 'PediatricPostTraumaticHeadache',
        'PediatricThunderclapHeadache', 'PediatricPrimaryCoughHeadache',
    ],
    'pcc_pediatric_surg_ext26': [
        'PediatricHydrocephalusExt', 'PediatricVPShuntPlacement',
        'PediatricVPShuntRevision', 'PediatricETVExt',
        'PediatricCraniotomyExt', 'PediatricCraniectomyExt',
        'PediatricTumorResectionExt', 'PediatricSpinalCordTumorExt',
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext37,pediatric_neuro_ext26,pediatric_surg_ext26');\n"
