#!/usr/bin/env python3
"""P3-DP generator: 3 modules = engines + tests + integration tests + routes + SQL."""
import os
...
os.chdir(ROOT)
MODULES = [
    ('pcc_rheumatology_advanced', 'PCC Rheumatology Advanced', 'rha'),
    ('pcc_immunology_advanced', 'PCC Immunology Advanced', 'ima'),
    ('pcc_allergy_advanced', 'PCC Allergy Advanced', 'ala'),
]
PKG = 'p3dp_'
COLUMNS = [
    ('encounter_id', 'TEXT'),
...
ENGINE_FUNCS = {
    'pcc_rheumatology_advanced': ['RheumatoidArthritisAdvanced', 'SLEFlareManagement', 'SpondyloarthritisAdvanced', 'GoutRefractory', 'VasculitisWorkup', 'OsteoporosisAdvanced', 'MyositisEvaluation', 'SjogrenAdvanced', 'SystemicSclerosis', 'AutoinflammatoryDisease'],
    'pcc_immunology_advanced': ['PrimaryImmunodeficiency', 'SecondaryImmunodeficiency', 'AutoimmuneLymphoproliferative', 'ImmuneReconstitution', 'CytokineStorm', 'HypersensitivityPneumonitis', 'ImmuneCheckpointToxicity', 'TransplantRejectionImmune', 'VaccineResponseAssessment', 'BiologicMonitoring'],
    'pcc_allergy_advanced': ['AnaphylaxisAdvanced', 'DrugAllergyDelabeling', 'FoodAllergyOralImmunotherapy', 'VenomImmunotherapy', 'AllergicBronchopulmonaryAspergillosis', 'EosinophilicGranulomatosis', 'MastCellActivation', 'ChronicUrticariaRefractory', 'AllergicRhinoconjunctivitisAdvanced', 'ContactDermatitisAdvanced'],
}
