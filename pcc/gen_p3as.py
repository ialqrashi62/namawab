...
MODS = [('radiology_ext', 'rx'), ('pharmacy_compounding', 'pc'), ('lab_specialty', 'ls')]
...
TPL_INT = """// P3-AS integration: __MOD__
...
def main():
    sql_path = BASE / 'migrations' / 'p3as_up.sql'
    ...
    audit = BASE.parent / 'scratch' / 'p3as_audit.txt'
