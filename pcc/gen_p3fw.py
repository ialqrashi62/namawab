#!/usr/bin/env python3
"""P3-FW generator v3.139.0 — pcc_neuro_ext40, pcc_pediatric_neuro_ext29, pcc_pediatric_surg_ext29"""
import os
...
MODULES = [
    ('pcc_neuro_ext40', 'PCC Neuro Ext40', 'pcc-neuro-ext40'),
    ('pcc_pediatric_neuro_ext29', 'PCC Pediatric Neuro Ext29', 'pcc-pediatric-neuro-ext29'),
    ('pcc_pediatric_surg_ext29', 'PCC Pediatric Surg Ext29', 'pcc-pediatric-surg-ext29'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext40': [
        'MultipleSclerosisExt2', 'NeuromyelitisOpticaExt',
        'MOGAntibodyDisorderExt', 'AcuteDisseminatedEncephalomyelitis',
        'ClinicallyIsolatedSyndromeExt', 'RadiologicallyIsolatedSyndrome',
        'ProgressiveMultifocalLeukoencephalopathy', 'ADEMExt2',
        'CerebralVasculitisExt', 'CNSLupusExt',
    ],
    'pcc_pediatric_neuro_ext29': [
        'PediatricCerebralPalsyExt3', 'PediatricSpasticityExt',
        'PediatricDystoniaExt', 'PediatricChoreaExt',
        'PediatricAthetosisExt', 'PediatricAtaxiaExt',
        'PediatricTremorExt', 'PediatricTicDisorderExt',
        'PediatricTouretteExt', 'PediatricStereotypyExt',
    ],
    'pcc_pediatric_surg_ext29': [
        'PediatricLimbReconstructionExt', 'PediatricLimbLengtheningExt',
        'PediatricLimbShorteningExt', 'PediatricDeformityCorrectionExt',
        'PediatricFractureFixationExt', 'PediatricTendonRepairExt',
        'PediatricLigamentReconstructionExt', 'PediatricACLReconstructionExt',
        'PediatricMeniscusRepairExt', 'PediatricHipDysplasiaExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext40,pediatric_neuro_ext29,pediatric_surg_ext29');\n"
