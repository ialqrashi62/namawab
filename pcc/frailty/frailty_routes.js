...
router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'frailty', label: 'Frailty', functions: fns.length, version: '3.14.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'frailty', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
