// P3-AY routes: aquatic_therapy (Aquatic-Therapy)
...
router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'aquatic_therapy', label: 'Aquatic-Therapy', functions: fns.length, version: '3.11.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'aquatic_therapy', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
