// P3-BK routes: psych_ext (Psych-Ext)
...
router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'psych_ext', label: 'Psych-Ext', functions: fns.length, version: '3.23.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'psych_ext', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
