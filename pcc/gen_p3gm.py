#!/usr/bin/env python3
"""P3-GM generator v3.155.0 — pcc_neuro_ext56, pcc_pediatric_neuro_ext45, pcc_pediatric_surg_ext45"""
import os
...
MODULES = [
    ('pcc_neuro_ext56', 'PCC Neuro Ext56', 'pcc-neuro-ext56'),
    ('pcc_pediatric_neuro_ext45', 'PCC Pediatric Neuro Ext45', 'pcc-pediatric-neuro-ext45'),
    ('pcc_pediatric_surg_ext45', 'PCC Pediatric Surg Ext45', 'pcc-pediatric-surg-ext45'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext56': [
        'WernickeEncephalopathyExt', 'KorsakoffSyndromeExt',
        'WernickeKorsakoffExt', 'AlcoholicCerebellarDegenerationExt',
        'MarchiafavaBignamiExt', 'AlcoholRelatedDementiaExt',
        'CentralPontineMyelinolysisExt', 'OsmoticDemyelinationExt',
        'CobalaminDeficiencyExt', 'FolateDeficiencyExt',
    ],
    'pcc_pediatric_neuro_ext45': [
        'PediatricNutritionalDeficiencyExt', 'PediatricVitaminB12DeficiencyExt',
        'PediatricFolateDeficiencyExt', 'PediatricThiamineDeficiencyExt',
        'PediatricNiacinDeficiencyExt', 'PediatricPyridoxineDeficiencyExt',
        'PediatricVitaminDDeficiencyExt', 'PediatricVitaminKDeficiencyExt',
        'PediatricIronDeficiencyExt', 'PediatricIodineDeficiencyExt',
    ],
    'pcc_pediatric_surg_ext45': [
        'PediatricVascularSurgeryExt', 'PediatricArteriovenousMalformationExt',
        'PediatricVascularAnomalyExt', 'PediatricLymphaticMalformationExt',
        'PediatricVenousMalformationExt', 'PediatricCapillaryMalformationExt',
        'PediatricKlippelTrenaunayExt', 'PediatricParkesWeberExt',
        'PediatricSturgeWeberSurgExt', 'PediatricKasabachMerrittExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext56,pediatric_neuro_ext45,pediatric_surg_ext45');\n"
