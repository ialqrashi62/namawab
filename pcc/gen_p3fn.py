#!/usr/bin/env python3
"""P3-FN generator v3.130.0 — pcc_neuro_ext31, pcc_pediatric_neuro_ext20, pcc_pediatric_surg_ext20"""
import os
...
MODULES = [
    ('pcc_neuro_ext31', 'PCC Neuro Ext31', 'pcc-neuro-ext31'),
    ('pcc_pediatric_neuro_ext20', 'PCC Pediatric Neuro Ext20', 'pcc-pediatric-neuro-ext20'),
    ('pcc_pediatric_surg_ext20', 'PCC Pediatric Surg Ext20', 'pcc-pediatric-surg-ext20'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext31': [
        'MovementDisorderAdvanced', 'DystoniaSyndrome',
        'ChoreaAdvanced', 'AthetosisSyndrome',
        'TicDisorderAdvanced', 'MyoclonusAdvanced',
        'TremorSyndrome', 'AtaxiaSyndrome',
        'GaitDisorder', 'HypokineticMovement',
    ],
    'pcc_pediatric_neuro_ext20': [
        'PediatricDemyelinatingDisorder', 'PediatricMultipleSclerosis',
        'PediatricNMOSpectrum', 'PediatricMOGDisease',
        'PediatricAcuteDemyelinating', 'PediatricOpticNeuritis',
        'PediatricTransverseMyelitisExt', 'PediatricADEMExt',
        'PediatricAutoimmuneEncephalitis', 'PediatricHashimoto',
    ],
    'pcc_pediatric_surg_ext20': [
        'PediatricSpineSurgeryExt', 'PediatricScoliosisCorrection',
        'PediatricSpinalFusion', 'PediatricVertebralTethering',
        'PediatricMagneticallyControlledGrowingRod', 'PediatricGrowingRod',
        'PediatricSpinalDeformity', 'PediatricKyphosisCorrection',
        'PediatricLordosisCorrection', 'PediatricSpondylolisthesis',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext31,pediatric_neuro_ext20,pediatric_surg_ext20');\n"
