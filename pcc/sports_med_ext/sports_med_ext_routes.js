// P3-BK routes: sports_med_ext (Sports-Med-Ext)
...
router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'sports_med_ext', label: 'Sports-Med-Ext', functions: fns.length, version: '3.23.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'sports_med_ext', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
