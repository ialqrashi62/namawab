#!/usr/bin/env python3
"""P3-GS generator v3.161.0 — pcc_neuro_ext62, pcc_pediatric_neuro_ext51, pcc_pediatric_surg_ext51"""
import os
...
MODULES = [
    ('pcc_neuro_ext62', 'PCC Neuro Ext62', 'pcc-neuro-ext62'),
    ('pcc_pediatric_neuro_ext51', 'PCC Pediatric Neuro Ext51', 'pcc-pediatric-neuro-ext51'),
    ('pcc_pediatric_surg_ext51', 'PCC Pediatric Surg Ext51', 'pcc-pediatric-surg-ext51'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext62': [
        'IdiopathicIntracranialHypertensionExt2', 'PseudotumorCerebriSyndromeExt',
        'EmptySellaSyndromeExt', 'CSFPressureDisorderExt',
        'CSFLeakPositionalExt', 'CSFVenousFistulaTreatmentExt',
        'CSFShuntObstructionExt', 'CSFShuntInfectionExt',
        'CerebralVenousThrombosisTreatmentExt', 'ReversibleCerebralVasoconstrictionExt',
    ],
    'pcc_pediatric_neuro_ext51': [
        'PediatricPseudotumorCerebriExt', 'PediatricIIHExt',
        'PediatricEmptySellaExt', 'PediatricCSFPressureDisorderExt',
        'PediatricCSFLeakExt', 'PediatricCSFVenousFistulaExt',
        'PediatricShuntMalfunctionExt', 'PediatricShuntInfectionExt',
        'PediatricVentriculomegalyExt', 'PediatricArachnoidCystExt',
    ],
    'pcc_pediatric_surg_ext51': [
        'PediatricNeurosurgeryCSFExt', 'PediatricVPShuntInsertionExt',
        'PediatricVPShuntRevisionExt', 'PediatricVA shuntInsertionExt',
        'PediatricLumboperitonealShuntExt', 'PediatricVentriculoatrialShuntExt',
        'PediatricSubgalealShuntExt', 'PediatricExternalDrainageExt',
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext62,pediatric_neuro_ext51,pediatric_surg_ext51');\n"
