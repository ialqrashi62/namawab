#!/usr/bin/env python3
"""P3-FS generator v3.135.0 — pcc_neuro_ext36, pcc_pediatric_neuro_ext25, pcc_pediatric_surg_ext25"""
import os
...
MODULES = [
    ('pcc_neuro_ext36', 'PCC Neuro Ext36', 'pcc-neuro-ext36'),
    ('pcc_pediatric_neuro_ext25', 'PCC Pediatric Neuro Ext25', 'pcc-pediatric-neuro-ext25'),
    ('pcc_pediatric_surg_ext25', 'PCC Pediatric Surg Ext25', 'pcc-pediatric-surg-ext25'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext36': [
        'SleepWalkingExt2', 'SleepEatingDisorder',
        'SleepTextingDisorder', 'SleepDrinkingDisorder',
        'ExplodingHeadSyndromeExt', 'HypnicJerksExt',
        'SleepBruxismExt', 'NocturnalLegCramps',
        'RestlessLegSyndromeExt', 'PeriodicLimbMovementsExt2',
    ],
    'pcc_pediatric_neuro_ext25': [
        'PediatricNightTerrorsExt', 'PediatricSleepwalkingExt',
        'PediatricSleepBruxism', 'PediatricRestlessLegsExt',
        'PediatricNarcolepsyExt', 'PediatricKleineLevin',
        'PediatricIdiopathicHypersomniaExt', 'PediatricDelayedSleepPhase',
        'PediatricAdvancedSleepPhase', 'PediatricIrregularSleepWake',
    ],
    'pcc_pediatric_surg_ext25': [
        'PediatricCleftLipExt3', 'PediatricCleftPalateExt',
        'PediatricCraniosynostosisExt', 'PediatricPlagiocephalyExt',
        'PediatricSyndactylyExt', 'PediatricPolydactylyExt',
        'PediatricBrachialPlexusExt', 'PediatricCongenitalHandExt',
        'PediatricPectusExcavatumExt', 'PediatricPectusCarinatumExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext36,pediatric_neuro_ext25,pediatric_surg_ext25');\n"
