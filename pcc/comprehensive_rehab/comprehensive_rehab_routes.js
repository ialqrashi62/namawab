// P3-BD routes: comprehensive_rehab (Comprehensive-Rehab)
...
router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'comprehensive_rehab', label: 'Comprehensive-Rehab', functions: fns.length, version: '3.16.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'comprehensive_rehab', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
