#!/usr/bin/env python3
"""P3-FA generator v3.117.0 — pcc_neuro_ext18, pcc_pediatric_neuro_ext7, pcc_pediatric_surg_ext7"""
import os
...
MODULES = [
    ('pcc_neuro_ext18', 'PCC Neuro Ext18', 'pcc-neuro-ext18'),
    ('pcc_pediatric_neuro_ext7', 'PCC Pediatric Neuro Ext7', 'pcc-pediatric-neuro-ext7'),
    ('pcc_pediatric_surg_ext7', 'PCC Pediatric Surg Ext7', 'pcc-pediatric-surg-ext7'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext18': [
        'BrainTumorExt', 'GlioblastomaMultiformeExt', 'MeningiomaExt',
        'PituitaryAdenomaExt', 'AcousticNeuromaExt',
        'MetastaticBrainTumor', 'PrimaryCNSLymphoma',
        'MedulloblastomaAdult', 'EpendymomaAdult', 'OligodendrogliomaExt',
    ],
    'pcc_pediatric_neuro_ext7': [
        'PediatricHeadacheEvaluation', 'PediatricMigraineAcute',
        'PediatricMigraineProphylaxis', 'PediatricTensionType',
        'PediatricChronicDailyHeadache', 'PediatricPostTraumatic',
        'PediatricSinusitisHeadache', 'PediatricIntracranialHypertension',
        'PediatricChiariHeadache', 'PediatricMedicationOveruse',
    ],
    'pcc_pediatric_surg_ext7': [
        'PediatricSoftTissueSurgery', 'PediatricSkinLesionExcision',
        'PediatricBurnWoundCare', 'PediatricWoundDebridement',
        'PediatricSkinGraft', 'PediatricFlapReconstruction',
        'PediatricScarRevision', 'PediatricCystExcision',
        'PediatricLymphNodeBiopsy', 'PediatricTissueBiopsy',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext18,pediatric_neuro_ext7,pediatric_surg_ext7');\n"
