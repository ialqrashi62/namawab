#!/usr/bin/env python3
"""P3-GQ generator v3.159.0 — pcc_neuro_ext60, pcc_pediatric_neuro_ext49, pcc_pediatric_surg_ext49"""
import os
...
MODULES = [
    ('pcc_neuro_ext60', 'PCC Neuro Ext60', 'pcc-neuro-ext60'),
    ('pcc_pediatric_neuro_ext49', 'PCC Pediatric Neuro Ext49', 'pcc-pediatric-neuro-ext49'),
    ('pcc_pediatric_surg_ext49', 'PCC Pediatric Surg Ext49', 'pcc-pediatric-surg-ext49'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext60': [
        'HydrocephalusNormalPressureExt', 'HydrocephalusCommunicatingExt',
        'HydrocephalusNonCommunicatingExt', 'ArrestedHydrocephalusExt',
        'LongstandingOvertVenticulomegalyExt', 'ExternalHydrocephalusExt',
        'HydrocephalusExVacuoExt', 'BenignExternalHydrocephalusExt',
        'IdiopathicIntracranialHypertensionExt', 'CSFLeakSyndromeExt',
    ],
    'pcc_pediatric_neuro_ext49': [
        'PediatricSeizureDisorderExt3', 'PediatricFebrileStatusEpilepticusExt',
        'PediatricRefractoryEpilepsyExt', 'PediatricEpilepsySurgeryEvalExt',
        'PediatricVagusNerveStimulationExt', 'PediatricKetogenicDietExt',
        'PediatricEpilepsyGeneticExt', 'PediatricEpilepsyMetabolicExt',
        'PediatricEpilepsyAutoimmuneExt', 'PediatricSUDEPExt',
    ],
    'pcc_pediatric_surg_ext49': [
        'PediatricEpilepsySurgeryExt', 'PediatricTemporalLobectomyExt',
        'PediatricHemispherectomyExt', 'PediatricCorpusCallosotomyExt',
        'PediatricLesionectomyExt', 'PediatricVagusNerveStimulatorExt',
        'PediatricResponsiveNeurostimulatorExt', 'PediatricStereotacticEEGExt',
        'PediatricLaserAblationExt', 'PediatricMRIguidedLITTSExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext60,pediatric_neuro_ext49,pediatric_surg_ext49');\n"
