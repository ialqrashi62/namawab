#!/usr/bin/env python3
"""P3-DM generator: 3 modules = engines + tests + integration tests + routes + SQL."""
import os
...
os.chdir(ROOT)
MODULES = [
    ('pcc_infectious_disease_advanced', 'PCC Infectious Disease Advanced', 'ida'),
    ('pcc_antimicrobial_stewardship', 'PCC Antimicrobial Stewardship', 'ams'),
    ('pcc_sepsis_advanced', 'PCC Sepsis Advanced', 'sep'),
]
PKG = 'p3dm_'
COLUMNS = [
    ('encounter_id', 'TEXT'),
...
ENGINE_FUNCS = {
    'pcc_infectious_disease_advanced': ['FeverOfUnknownOrigin', 'TravelRelatedInfection', 'ImmunocompromisedHost', 'HealthcareAssociatedInfection', 'ZoonoticDisease', 'VectorBorneDisease', 'FungalInfectionWorkup', 'MycobacterialDisease', 'ViralHepatitisAdvanced', 'HIVOpportunisticInfection'],
    'pcc_antimicrobial_stewardship': ['EmpiricAntibioticChoice', 'DeEscalationReview', 'TherapeuticDrugMonitoring', 'AllergyCrossReactivity', 'RenalDoseAdjustment', 'HepaticDoseAdjustment', 'DrugInteractionCheck', 'CultureFollowUp', 'AntibioticSpectrum', 'StewardshipMetrics'],
    'pcc_sepsis_advanced': ['SepsisRecognition', 'LactateGuidedResuscitation', 'FluidResponsiveness', 'VasopressorSelection', 'CorticosteroidSepsis', 'SourceControlPlan', 'EndOrganPerfusion', 'SepsisBundleCompliance', 'PostSepsisFollowUp', 'SepsisReadmissionRisk'],
}
