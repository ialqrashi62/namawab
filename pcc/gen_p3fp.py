#!/usr/bin/env python3
"""P3-FP generator v3.132.0 — pcc_neuro_ext33, pcc_pediatric_neuro_ext22, pcc_pediatric_surg_ext22"""
import os
...
MODULES = [
    ('pcc_neuro_ext33', 'PCC Neuro Ext33', 'pcc-neuro-ext33'),
    ('pcc_pediatric_neuro_ext22', 'PCC Pediatric Neuro Ext22', 'pcc-pediatric-neuro-ext22'),
    ('pcc_pediatric_surg_ext22', 'PCC Pediatric Surg Ext22', 'pcc-pediatric-surg-ext22'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext33': [
        'NeuroRehabilitationExt', 'StrokeRehab',
        'TraumaticBrainInjuryRehab', 'SpinalCordInjuryRehab',
        'MultipleSclerosisRehab', 'ParkinsonDiseaseRehab',
        'NeuropathyRehab', 'MyopathyRehab',
        'BalanceRehab', 'GaitRehab',
    ],
    'pcc_pediatric_neuro_ext22': [
        'PediatricNeuroRehab', 'PediatricStrokeRehab',
        'PediatricTBIRehab', 'PediatricBrainTumorRehab',
        'PediatricCerebralPalsyRehab', 'PediatricSpinaBifidaRehab',
        'PediatricBrachialPlexusRehab', 'PediatricMuscularDystrophyRehab',
        'PediatricSpinalCordInjuryRehab', 'PediatricAcquiredBrainInjury',
    ],
    'pcc_pediatric_surg_ext22': [
        'PediatricTransplantSurgery', 'PediatricKidneyTransplant',
        'PediatricLiverTransplant', 'PediatricHeartTransplant',
        'PediatricLungTransplant', 'PediatricBoneMarrowTransplant',
        'PediatricStemCellTransplant', 'PediatricPancreasTransplant',
        'PediatricSmallBowelTransplant', 'PediatricMultiVisceralTransplant',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext33,pediatric_neuro_ext22,pediatric_surg_ext22');\n"
