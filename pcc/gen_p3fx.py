#!/usr/bin/env python3
"""P3-FX generator v3.140.0 — pcc_neuro_ext41, pcc_pediatric_neuro_ext30, pcc_pediatric_surg_ext30"""
import os
...
MODULES = [
    ('pcc_neuro_ext41', 'PCC Neuro Ext41', 'pcc-neuro-ext41'),
    ('pcc_pediatric_neuro_ext30', 'PCC Pediatric Neuro Ext30', 'pcc-pediatric-neuro-ext30'),
    ('pcc_pediatric_surg_ext30', 'PCC Pediatric Surg Ext30', 'pcc-pediatric-surg-ext30'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext41': [
        'ParkinsonDiseaseExt3', 'MultipleSystemAtrophyExt',
        'ProgressiveSupranuclearPalsy', 'CorticobasalDegeneration',
        'LewyBodyDementiaExt', 'ParkinsonismDementiaComplex',
        'VascularParkinsonismExt', 'DrugInducedParkinsonism',
        'EssentialTremorExt2', 'DystonicTremorExt',
    ],
    'pcc_pediatric_neuro_ext30': [
        'PediatricSpinalMuscularAtrophyExt', 'PediatricDuchenneMuscularDystrophy',
        'PediatricBeckerMuscularDystrophy', 'PediatricMyotonicDystrophyExt',
        'PediatricFacioscapulohumeralExt', 'PediatricLimbGirdleExt',
        'PediatricCongenitalMyopathyExt', 'PediatricMitochondrialMyopathy',
        'PediatricInflammatoryMyopathyExt', 'PediatricDermatomyositisExt',
    ],
    'pcc_pediatric_surg_ext30': [
        'PediatricOncologySurgeryExt', 'PediatricNeuroblastomaExt',
        'PediatricWilmsTumorExt', 'PediatricHepatoblastomaExt',
        'PediatricRhabdomyosarcomaExt', 'PediatricOsteosarcomaExt',
        'PediatricEwingSarcomaExt', 'PediatricRetinoblastomaExt',
        'PediatricBrainTumorExt', 'PediatricLymphomaSurgeryExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext41,pediatric_neuro_ext30,pediatric_surg_ext30');\n"
