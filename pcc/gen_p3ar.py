...
MODS = [('critical_care_ext', 'cc'), ('stroke_ext', 'sx'), ('cardiology_ext2', 'ce2')]
...
TPL_INT = """// P3-AR integration: __MOD__
...
def main():
    sql_path = BASE / 'migrations' / 'p3ar_up.sql'
    ...
    audit = BASE.parent / 'scratch' / 'p3ar_audit.txt'
