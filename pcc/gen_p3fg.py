#!/usr/bin/env python3
"""P3-FG generator v3.123.0 — pcc_neuro_ext24, pcc_pediatric_neuro_ext13, pcc_pediatric_surg_ext13"""
import os
...
MODULES = [
    ('pcc_neuro_ext24', 'PCC Neuro Ext24', 'pcc-neuro-ext24'),
    ('pcc_pediatric_neuro_ext13', 'PCC Pediatric Neuro Ext13', 'pcc-pediatric-neuro-ext13'),
    ('pcc_pediatric_surg_ext13', 'PCC Pediatric Surg Ext13', 'pcc-pediatric-surg-ext13'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext24': [
        'NeuromuscularDisorderExt', 'MyastheniaGravisExt2',
        'LambertEatonSyndrome', 'CongenitalMyasthenicSyndrome',
        'PolymyositisExt', 'Dermatomyositis',
        'InclusionBodyMyositis', 'MyotonicDisorder',
        'PeriodicParalysis', 'MitochondrialMyopathy',
    ],
    'pcc_pediatric_neuro_ext13': [
        'PediatricBrainMalformation', 'PediatricHoloprosencephaly',
        'PediatricLissencephaly', 'PediatricPolymicrogyria',
        'PediatricSchizencephaly', 'PediatricPorencephaly',
        'PediatricHydrocephalusExt2', 'PediatricDandyWalker',
        'PediatricArnoldChiari', 'PediatricSyringomyelia',
    ],
    'pcc_pediatric_surg_ext13': [
        'PediatricTraumaSurgery', 'PediatricSplenectomyTrauma',
        'PediatricLiverLaceration', 'PediatricKidneyLaceration',
        'PediatricBowelInjury', 'PediatricPancreaticInjury',
        'PediatricVascularInjury', 'PediatricThoracicTrauma',
        'PediatricHeadTrauma', 'PediatricSpinalTrauma',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext24,pediatric_neuro_ext13,pediatric_surg_ext13');\n"
