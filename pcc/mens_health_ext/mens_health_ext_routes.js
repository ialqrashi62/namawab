// P3-BG routes: mens_health_ext (Mens-Health-Ext)
...
router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'mens_health_ext', label: 'Mens-Health-Ext', functions: fns.length, version: '3.19.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'mens_health_ext', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
