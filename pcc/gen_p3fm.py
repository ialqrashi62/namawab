#!/usr/bin/env python3
"""P3-FM generator v3.129.0 — pcc_neuro_ext30, pcc_pediatric_neuro_ext19, pcc_pediatric_surg_ext19"""
import os
...
MODULES = [
    ('pcc_neuro_ext30', 'PCC Neuro Ext30', 'pcc-neuro-ext30'),
    ('pcc_pediatric_neuro_ext19', 'PCC Pediatric Neuro Ext19', 'pcc-pediatric-neuro-ext19'),
    ('pcc_pediatric_surg_ext19', 'PCC Pediatric Surg Ext19', 'pcc-pediatric-surg-ext19'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext30': [
        'HeadacheDisorderExt2', 'MigraineWithoutAura',
        'MigraineWithAura', 'ChronicMigraine',
        'TensionTypeHeadache', 'ClusterHeadacheExt2',
        'HemicraniaContinua', 'SUNCTHeadache',
        'HypnicHeadache', 'ThunderclapHeadache',
    ],
    'pcc_pediatric_neuro_ext19': [
        'PediatricEpilepsySyndromesExt', 'PediatricFebrileSeizureExt',
        'PediatricInfantileSpasm', 'PediatricLennoxGastautExt',
        'PediatricDooseSyndrome', 'PediatricLandauKleffnerExt',
        'PediatricCSWSSyndrome', 'PediatricSevereMyoclonicEpilepsy',
        'PediatricPanayiotopoulos', 'PediatricEpilepsyOfInfancy',
    ],
    'pcc_pediatric_surg_ext19': [
        'PediatricNeurosurgeryTumor', 'PediatricPilocyticAstrocytoma',
        'PediatricMedulloblastomaExt', 'PediatricEpendymomaSurgery',
        'PediatricCraniopharyngiomaExt', 'PediatricBrainstemGlioma',
        'PediatricOpticPathwayGlioma', 'PediatricChoroidPlexusTumor',
        'PediatricATRTCase', 'PediatricDIPGTumor',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext30,pediatric_neuro_ext19,pediatric_surg_ext19');\n"
