// P3-BM routes: onco_ext2 (Onco-Ext-2)
...
router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'onco_ext2', label: 'Onco-Ext-2', functions: fns.length, version: '3.25.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'onco_ext2', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
