#!/usr/bin/env python3
"""P3-GC generator v3.145.0 — pcc_neuro_ext46, pcc_pediatric_neuro_ext35, pcc_pediatric_surg_ext35"""
import os
...
MODULES = [
    ('pcc_neuro_ext46', 'PCC Neuro Ext46', 'pcc-neuro-ext46'),
    ('pcc_pediatric_neuro_ext35', 'PCC Pediatric Neuro Ext35', 'pcc-pediatric-neuro-ext35'),
    ('pcc_pediatric_surg_ext35', 'PCC Pediatric Surg Ext35', 'pcc-pediatric-surg-ext35'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext46': [
        'BellPalsyExt2', 'RamsayHuntSyndromeExt',
        'MelkerssonRosenthalExt', 'HeerfordtSyndromeExt',
        'HemifacialSpasmExt', 'FacialMyokymiaExt',
        'FacialSynkinesisExt', 'TrigeminalMotorNeuropathyExt',
        'AbducensNervePalsyExt', 'TrochlearNervePalsyExt',
    ],
    'pcc_pediatric_neuro_ext35': [
        'PediatricEliminationDisorderExt', 'PediatricEnuresisExt',
        'PediatricEncopresisExt', 'PediatricFunctionalUrinaryRetention',
        'PediatricFunctionalConstipationExt', 'PediatricToiletRefusal',
        'PediatricStoolWithholdingExt', 'PediatricNightmaresExt',
        'PediatricNightTerrorsExt', 'PediatricSleepwalkingExt',
    ],
    'pcc_pediatric_surg_ext35': [
        'PediatricENTTumorExt', 'PediatricThyroidectomyExt',
        'PediatricParathyroidectomyExt', 'PediatricSalivaryGlandExt',
        'PediatricCervicalLymphNodeExt', 'PediatricBranchialCleftExt',
        'PediatricThyroglossalDuctExt', 'PediatricCysticHygromaExt',
        'PediatricDermoidCystExt', 'PediatricLingualThyroidExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext46,pediatric_neuro_ext35,pediatric_surg_ext35');\n"
