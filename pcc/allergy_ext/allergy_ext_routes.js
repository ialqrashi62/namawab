// P3-BO routes: allergy_ext (Allergy-Ext)
...
router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'allergy_ext', label: 'Allergy-Ext', functions: fns.length, version: '3.27.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'allergy_ext', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
