#!/usr/bin/env python3
"""P3-FO generator v3.131.0 — pcc_neuro_ext32, pcc_pediatric_neuro_ext21, pcc_pediatric_surg_ext21"""
import os
...
MODULES = [
    ('pcc_neuro_ext32', 'PCC Neuro Ext32', 'pcc-neuro-ext32'),
    ('pcc_pediatric_neuro_ext21', 'PCC Pediatric Neuro Ext21', 'pcc-pediatric-neuro-ext21'),
    ('pcc_pediatric_surg_ext21', 'PCC Pediatric Surg Ext21', 'pcc-pediatric-surg-ext21'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext32': [
        'NeuroInflammatoryExt', 'Neurosarcoidosis',
        'NeuroLupus', 'NeuroBehcet',
        'NeuroSarcoidosis', 'NeuroWhipple',
        'NeuroLymeDisease', 'Neurosyphilis',
        'NeuroHIV', 'NeuroBrucellosis',
    ],
    'pcc_pediatric_neuro_ext21': [
        'PediatricNeuroinflammatory', 'PediatricADEMRecurrent',
        'PediatricMultipleSclerosisRelapse', 'PediatricVasculitis',
        'PediatricSystemicLupus', 'PediatricBehcetDisease',
        'PediatricWegeners', 'PediatricTakayasu',
        'PediatricKawasakiNeurologic', 'PediatricNeuroVasculitis',
    ],
    'pcc_pediatric_surg_ext21': [
        'PediatricGeneralSurgeryExt', 'PediatricAppendectomyExt',
        'PediatricCholecystectomyExt', 'PediatricSplenectomyExt',
        'PediatricHerniaRepairExt', 'PediatricHydroceleRepair',
        'PediatricUndescendedTestis', 'PediatricVaricoceleRepair',
        'PediatricIntestinalResection', 'PediatricBowelAnastomosis',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext32,pediatric_neuro_ext21,pediatric_surg_ext21');\n"
