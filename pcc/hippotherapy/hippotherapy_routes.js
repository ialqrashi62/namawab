// P3-AY routes: hippotherapy (Hippotherapy)
...
const fns = [
  ...
  'HorseSelection',
  'GaitOnHorse',
  'PediatricHippotherapy',
  'AdultHippotherapy',
  'HippotherapyContra',
  'SessionStructure',
  'ProgressMeasure',
  'SafetyProtocol',
  'HippotherapyDischarge'
];

router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'hippotherapy', label: 'Hippotherapy', functions: fns.length, version: '3.11.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'hippotherapy', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
