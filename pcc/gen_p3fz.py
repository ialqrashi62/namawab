#!/usr/bin/env python3
"""P3-FZ generator v3.142.0 — pcc_neuro_ext43, pcc_pediatric_neuro_ext32, pcc_pediatric_surg_ext32"""
import os
...
MODULES = [
    ('pcc_neuro_ext43', 'PCC Neuro Ext43', 'pcc-neuro-ext43'),
    ('pcc_pediatric_neuro_ext32', 'PCC Pediatric Neuro Ext32', 'pcc-pediatric-neuro-ext32'),
    ('pcc_pediatric_surg_ext32', 'PCC Pediatric Surg Ext32', 'pcc-pediatric-surg-ext32'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext43': [
        'AdultHydrocephalusExt', 'NormalPressureHydrocephalusExt',
        'CommunicatingHydrocephalusExt', 'NonCommunicatingHydrocephalusExt',
        'ArrestedHydrocephalusExt', 'ExVacuoDilatationExt',
        'CSFLeakExt', 'IntracranialHypotensionExt',
        'PseudotumorCerebriExt2', 'CSFVenousFistulaExt',
    ],
    'pcc_pediatric_neuro_ext32': [
        'PediatricStrokeExt3', 'PediatricArterialIschemicStrokeExt',
        'PediatricCerebralVenousThrombosisExt', 'PediatricHemorrhagicStrokeExt',
        'PediatricNeonatalStrokeExt', 'PediatricPerinatalStrokeExt',
        'PediatricMoyamoyaExt', 'PediatricArteriopathyExt',
        'PediatricCerebralPalsyStrokeExt', 'PediatricVasculopathyExt',
    ],
    'pcc_pediatric_surg_ext32': [
        'PediatricUrologyExt3', 'PediatricPyeloplastyExt',
        'PediatricUreteralReimplantExt', 'PediatricHypospadiasRepairExt',
        'PediatricEpispadiasRepairExt', 'PediatricBladderExstrophyExt',
        'PediatricCloacalExstrophyExt', 'PediatricPosteriorUrethralValvesExt',
        'PediatricNephrectomyExt', 'PediatricPartialNephrectomyExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext43,pediatric_neuro_ext32,pediatric_surg_ext32');\n"
