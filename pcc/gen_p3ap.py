...
MODS = [('transplant_heart', 'th'), ('transplant_liver', 'tl'), ('transfusion_med', 'tm')]
...
TPL_INT = """// P3-AP integration: __MOD__
...
def main():
    sql_path = BASE / 'migrations' / 'p3ap_up.sql'
    ...
    audit = BASE.parent / 'scratch' / 'p3ap_audit.txt'
