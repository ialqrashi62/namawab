#!/usr/bin/env python3
"""P3-EZ generator v3.116.0 — pcc_neuro_ext17, pcc_pediatric_neuro_ext6, pcc_pediatric_surg_ext6"""
import os
...
MODULES = [
    ('pcc_neuro_ext17', 'PCC Neuro Ext17', 'pcc-neuro-ext17'),
    ('pcc_pediatric_neuro_ext6', 'PCC Pediatric Neuro Ext6', 'pcc-pediatric-neuro-ext6'),
    ('pcc_pediatric_surg_ext6', 'PCC Pediatric Surg Ext6', 'pcc-pediatric-surg-ext6'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext17': [
        'SleepWakeDisordersExt', 'CircadianRhythmDisorder',
        'NarcolepsyExt', 'IdiopathicHypersomnia',
        'KleineLevinSyndrome', 'RestlessLegsSyndromeExt',
        'PeriodicLimbMovement', 'REMBehaviorDisorder',
        'SleepApneaExt', 'Parasomnias',
    ],
    'pcc_pediatric_neuro_ext6': [
        'PediatricSeizureEvaluation', 'PediatricFirstNonFebrileSeizure',
        'PediatricNewOnsetRefractory', 'PediatricKetogenicDiet',
        'PediatricVagalNerveStimulation', 'PediatricEpilepsyMonitoring',
        'PediatricEEG', 'PediatricVideoEEG',
        'PediatricSleepStudy', 'PediatricPolysomnography',
    ],
    'pcc_pediatric_surg_ext6': [
        'PediatricLaparoscopicSurgery', 'PediatricRoboticSurgery',
        'PediatricThoracoscopicSurgery', 'PediatricBronchoscopy',
        'PediatricEsophagoscopy', 'PediatricGastroscopy',
        'PediatricColonoscopy', 'PediatricCystoscopy',
        'PediatricLaparoscopy', 'PediatricEndoscopy',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext17,pediatric_neuro_ext6,pediatric_surg_ext6');\n"
