#!/usr/bin/env python3
"""P3-FC generator v3.119.0 — pcc_neuro_ext20, pcc_pediatric_neuro_ext9, pcc_pediatric_surg_ext9"""
import os
...
MODULES = [
    ('pcc_neuro_ext20', 'PCC Neuro Ext20', 'pcc-neuro-ext20'),
    ('pcc_pediatric_neuro_ext9', 'PCC Pediatric Neuro Ext9', 'pcc-pediatric-neuro-ext9'),
    ('pcc_pediatric_surg_ext9', 'PCC Pediatric Surg Ext9', 'pcc-pediatric-surg-ext9'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext20': [
        'CerebrovascularDiseaseExt', 'IntracranialAneurysmExt',
        'ArteriovenousMalformation', 'CavernousMalformation',
        'MoyamoyaDisease', 'SubarachnoidHemorrhageExt',
        'IntracerebralHemorrhage', 'SubduralHematomaExt',
        'EpiduralHematomaExt', 'VenousSinusThrombosis',
    ],
    'pcc_pediatric_neuro_ext9': [
        'PediatricDownSyndrome', 'PediatricFragileXSyndrome',
        'PediatricWilliamsSyndrome', 'PediatricPraderWilliSyndrome',
        'PediatricAngelmanSyndrome', 'PediatricTurnerSyndrome',
        'PediatricNoonanSyndrome', 'PediatricMarfanSyndrome',
        'PediatricMuscularDystrophy', 'PediatricSpinalMuscularAtrophy',
    ],
    'pcc_pediatric_surg_ext9': [
        'PediatricNeonatalSurgery', 'PediatricCongenitalDiaphragmaticHernia',
        'PediatricTracheoesophagealFistula', 'PediatricIntestinalAtresia',
        'PediatricAnorectalMalformation', 'PediatricHirschsprungDisease',
        'PediatricBiliaryAtresia', 'PediatricCholedochalCyst',
        'PediatricPancreaticSurgery', 'PediatricHepaticResection',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext20,pediatric_neuro_ext9,pediatric_surg_ext9');\n"
