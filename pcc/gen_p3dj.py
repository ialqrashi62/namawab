#!/usr/bin/env python3
"""P3-DJ generator: 3 modules = engines + tests + integration tests + routes + SQL."""
import os
...
os.chdir(ROOT)
MODULES = [
    ('pcc_pulmonary_advanced', 'PCC Pulmonary Advanced', 'pul'),
    ('pcc_sleep_disorders', 'PCC Sleep Disorders', 'slp'),
    ('pcc_allergy_environmental', 'PCC Allergy Environmental', 'ale'),
]
PKG = 'p3dj_'
COLUMNS = [
    ('encounter_id', 'TEXT'),
...
ENGINE_FUNCS = {
    'pcc_pulmonary_advanced': ['SpirometryPattern', 'DiffusionCapacity', 'Bronchoprovocation', 'EosinophilicAsthma', 'COPDExacerbation', 'InterstitialLung', 'PulmonaryRehab', 'OxygenTherapy', 'VentilatorySupport', 'LungTransplant'],
    'pcc_sleep_disorders': ['SleepApnea', 'InsomniaCBT', 'CircadianRhythm', 'RestlessLegs', 'Narcolepsy', 'Parasomnias', 'Hypersomnia', 'SleepHygieneAdvanced', 'CPAPTitration', 'SleepSurgery'],
    'pcc_allergy_environmental': ['PollenForecast', 'MoldExposure', 'DustMite', 'PetDander', 'Cockroach', 'RodentAllergen', 'IndoorAirQuality', 'SeasonalStrategy', 'EnvironmentalControl', 'AllergenImmunotherapy'],
}
