...
MODS = [('imaging_molecular', 'im'), ('aerospace', 'as'), ('bmt2', 'b2')]
...
TPL_INT = """// P3-AT integration: __MOD__
...
def main():
    sql_path = BASE / 'migrations' / 'p3at_up.sql'
    ...
    audit = BASE.parent / 'scratch' / 'p3at_audit.txt'
