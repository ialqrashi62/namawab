#!/usr/bin/env python3
"""P3-GK generator v3.153.0 — pcc_neuro_ext54, pcc_pediatric_neuro_ext43, pcc_pediatric_surg_ext43"""
import os
...
MODULES = [
    ('pcc_neuro_ext54', 'PCC Neuro Ext54', 'pcc-neuro-ext54'),
    ('pcc_pediatric_neuro_ext43', 'PCC Pediatric Neuro Ext43', 'pcc-pediatric-neuro-ext43'),
    ('pcc_pediatric_surg_ext43', 'PCC Pediatric Surg Ext43', 'pcc-pediatric-surg-ext43'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext54': [
        'NeuroacanthocytosisExt', 'ChoreaAcanthocytosisExt',
        'McLeodSyndromeExt', 'HuntingtonDiseaseLike2Ext',
        'HDL3Ext', 'HDL4Ext',
        'SenileChoreaExt', 'BenignHereditaryChoreaExt',
        'InheritedCreutzfeldtJakobExt', 'FatalFamilialInsomniaExt',
    ],
    'pcc_pediatric_neuro_ext43': [
        'PediatricTicDisorderExt3', 'PediatricTransientTicExt',
        'PediatricChronicMotorTicExt', 'PediatricChronicVocalTicExt',
        'PediatricTouretteSyndromeExt', 'PediatricTouretteComorbidityExt',
        'PediatricTicRelatedOCDExt', 'PediatricTicRelatedADHDExt',
        'PediatricTicRelatedAnxietyExt', 'PediatricTicPharmacologyExt',
    ],
    'pcc_pediatric_surg_ext43': [
        'PediatricRoboticSurgeryExt', 'PediatricRoboticPyeloplastyExt',
        'PediatricRoboticNephrectomyExt', 'PediatricRoboticUreteralExt',
        'PediatricRoboticHysterectomyExt', 'PediatricRoboticSplenectomyExt',
        'PediatricRoboticHepatojejunostomyExt', 'PediatricRoboticCholecystectomyExt',
        'PediatricRoboticAdrenalectomyExt', 'PediatricRoboticPancreaticExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext54,pediatric_neuro_ext43,pediatric_surg_ext43');\n"
