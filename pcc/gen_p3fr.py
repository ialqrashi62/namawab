#!/usr/bin/env python3
"""P3-FR generator v3.134.0 — pcc_neuro_ext35, pcc_pediatric_neuro_ext24, pcc_pediatric_surg_ext24"""
import os
...
MODULES = [
    ('pcc_neuro_ext35', 'PCC Neuro Ext35', 'pcc-neuro-ext35'),
    ('pcc_pediatric_neuro_ext24', 'PCC Pediatric Neuro Ext24', 'pcc-pediatric-neuro-ext24'),
    ('pcc_pediatric_surg_ext24', 'PCC Pediatric Surg Ext24', 'pcc-pediatric-surg-ext24'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext35': [
        'SleepDisorderExt3', 'ObstructiveSleepApnea',
        'CentralSleepApnea', 'MixedSleepApnea',
        'SleepHypoventilation', 'ObesityHypoventilation',
        'PeriodicLimbMovementExt', 'REMBehaviorDisorderExt',
        'SleepParalysis', 'SleepTalking',
    ],
    'pcc_pediatric_neuro_ext24': [
        'PediatricSleepDisorder', 'PediatricObstructiveSleepApnea',
        'PediatricCentralSleepApnea', 'PediatricSleepApneaEval',
        'PediatricPolysomnographyExt', 'PediatricSleepStudy',
        'PediatricCPAPInitiation', 'PediatricBiPAPInitiation',
        'PediatricSleepHygiene', 'PediatricCircadianRhythmDisorder',
    ],
    'pcc_pediatric_surg_ext24': [
        'PediatricENTExt3', 'PediatricTonsillectomyEval',
        'PediatricAdenoidectomyEval', 'PediatricAdenotonsillectomy',
        'PediatricMyringotomyEval', 'PediatricTympanostomyExt',
        'PediatricCochlearImplantEval', 'PediatricBAHAImplantEval',
        'PediatricSeptoplastyExt', 'PediatricTracheostomyExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext35,pediatric_neuro_ext24,pediatric_surg_ext24');\n"
