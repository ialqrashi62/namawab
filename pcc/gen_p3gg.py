#!/usr/bin/env python3
"""P3-GG generator v3.149.0 — pcc_neuro_ext50, pcc_pediatric_neuro_ext39, pcc_pediatric_surg_ext39"""
import os
...
MODULES = [
    ('pcc_neuro_ext50', 'PCC Neuro Ext50', 'pcc-neuro-ext50'),
    ('pcc_pediatric_neuro_ext39', 'PCC Pediatric Neuro Ext39', 'pcc-pediatric-neuro-ext39'),
    ('pcc_pediatric_surg_ext39', 'PCC Pediatric Surg Ext39', 'pcc-pediatric-surg-ext39'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext50': [
        'MeningiomaExt', 'AnaplasticMeningiomaExt',
        'HemangioblastomaExt', 'HemangiopericytomaExt',
        'PrimaryCNSLymphomaExt', 'CNSLymphomaExt',
        'GermCellTumorExt', 'PineoblastomaExt',
        'PituitaryAdenomaExt', 'PituitaryApoplexyExt',
    ],
    'pcc_pediatric_neuro_ext39': [
        'PediatricMetabolicDisorderExt3', 'PediatricMitochondrialDiseaseExt',
        'PediatricLysosomalStorageExt', 'PediatricPeroxisomalDisorderExt',
        'PediatricAminoAcidDisorderExt', 'PediatricOrganicAcidemiaExt',
        'PediatricUreaCycleDisorderExt', 'PediatricFattyAcidOxidationExt',
        'PediatricGlycogenStorageExt', 'PediatricPurineDisorderExt',
    ],
    'pcc_pediatric_surg_ext39': [
        'PediatricOrthopedicTraumaExt', 'PediatricSupracondylarFractureExt',
        'PediatricLateralCondyleFractureExt', 'PediatricMedialEpicondyleExt',
        'PediatricForearmFractureExt', 'PediatricFemurFractureExt',
        'PediatricTibiaFractureExt', 'PediatricAnkleFractureExt',
        'PediatricSpineFractureExt', 'PediatricPelvicFractureExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext50,pediatric_neuro_ext39,pediatric_surg_ext39');\n"
