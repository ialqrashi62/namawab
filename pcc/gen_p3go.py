#!/usr/bin/env python3
"""P3-GO generator v3.157.0 — pcc_neuro_ext58, pcc_pediatric_neuro_ext47, pcc_pediatric_surg_ext47"""
import os
...
MODULES = [
    ('pcc_neuro_ext58', 'PCC Neuro Ext58', 'pcc-neuro-ext58'),
    ('pcc_pediatric_neuro_ext47', 'PCC Pediatric Neuro Ext47', 'pcc-pediatric-neuro-ext47'),
    ('pcc_pediatric_surg_ext47', 'PCC Pediatric Surg Ext47', 'pcc-pediatric-surg-ext47'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext58': [
        'CentralNervousSystemLupusExt', 'NeuroBehcetExt',
        'NeuroSarcoidosisExt', 'NeurosyphilisExt',
        'NeuroLymeDiseaseExt', 'NeuroBrucellosisExt',
        'NeuroWhippleDiseaseExt', 'NeuroCysticercosisExt',
        'NeuroToxoplasmosisExt', 'NeuroCysticercosisSurgeryExt',
    ],
    'pcc_pediatric_neuro_ext47': [
        'PediatricVasculitisExt3', 'PediatricKawasakiVasculopathyExt',
        'PediatricHenochSchonleinExt', 'PediatricANCAVasculitisExt',
        'PediatricTakayasuExt', 'PediatricPolyarteritisExt',
        'PediatricMicroscopicPolyangiitisExt', 'PediatricGranulomatosisVasculitisExt',
        'PediatricChurgStraussExt', 'PediatricBehcetExt',
    ],
    'pcc_pediatric_surg_ext47': [
        'PediatricENTCancerExt', 'PediatricLaryngealCancerExt',
        'PediatricThyroidCancerExt', 'PediatricNasopharyngealExt',
        'PediatricSalivaryGlandTumorExt', 'PediatricLymphomaNeckExt',
        'PediatricRhabdomyosarcomaNeckExt', 'PediatricNeuroblastomaNeckExt',
        'PediatricFibromatosisColliExt', 'PediatricBranchogenicCarcinomaExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext58,pediatric_neuro_ext47,pediatric_surg_ext47');\n"
