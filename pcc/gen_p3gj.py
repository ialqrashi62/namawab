#!/usr/bin/env python3
"""P3-GJ generator v3.152.0 — pcc_neuro_ext53, pcc_pediatric_neuro_ext42, pcc_pediatric_surg_ext42"""
import os
...
MODULES = [
    ('pcc_neuro_ext53', 'PCC Neuro Ext53', 'pcc-neuro-ext53'),
    ('pcc_pediatric_neuro_ext42', 'PCC Pediatric Neuro Ext42', 'pcc-pediatric-neuro-ext42'),
    ('pcc_pediatric_surg_ext42', 'PCC Pediatric Surg Ext42', 'pcc-pediatric-surg-ext42'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext53': [
        'CerebralCavernousMalformationExt', 'ArteriovenousMalformationExt',
        'CapillaryTelangiectasiaExt', 'DevelopmentalVenousAnomalyExt',
        'DuralArteriovenousFistulaExt', 'CavernousMalformationExt',
        'MoyamoyaDiseaseExt', 'SickleCellDiseaseStrokeExt',
        'CerebralAmyloidAngiopathyExt', 'CADASILExt',
    ],
    'pcc_pediatric_neuro_ext42': [
        'PediatricCerebrovascularExt3', 'PediatricArteriovenousMalformationExt',
        'PediatricCavernousMalformationExt', 'PediatricMoyamoyaExt2',
        'PediatricVeinOfGalenMalformationExt', 'PediatricDuralSinusMalformationExt',
        'PediatricCapillaryTelangiectasiaExt', 'PediatricDevelopmentalVenousAnomalyExt',
        'PediatricArteriopathyExt2', 'PediatricSickleCellStrokeExt',
    ],
    'pcc_pediatric_surg_ext42': [
        'PediatricTransplantSurgeryExt', 'PediatricRenalTransplantExt',
        'PediatricLiverTransplantExt', 'PediatricHeartTransplantExt',
        'PediatricLungTransplantExt', 'PediatricSmallBowelTransplantExt',
        'PediatricMultivisceralTransplantExt', 'PediatricStemCellTransplantExt',
        'PediatricBoneMarrowTransplantExt', 'PediatricPancreasTransplantExt',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext53,pediatric_neuro_ext42,pediatric_surg_ext42');\n"
