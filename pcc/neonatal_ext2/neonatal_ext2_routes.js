// P3-BI routes: neonatal_ext2 (Neonatal-Ext-2)
...
router.get('/list', authenticate, (req, res) => {
  res.json({ module: 'neonatal_ext2', label: 'Neonatal-Ext-2', functions: fns.length, version: '3.21.0' });
});
...
router.post('/record', authenticate, (req, res) => {
  ...
  res.json({ ok: true, module: 'neonatal_ext2', tenant_id, patient_id, encounter_id: encounter_id || null, payload: payload || {}, createdAt: new Date().toISOString() });
});
