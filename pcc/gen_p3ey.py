#!/usr/bin/env python3
"""P3-EY generator v3.115.0 — pcc_neuro_ext16, pcc_pediatric_neuro_ext5, pcc_pediatric_surg_ext5"""
import os
...
MODULES = [
    ('pcc_neuro_ext16', 'PCC Neuro Ext16', 'pcc-neuro-ext16'),
    ('pcc_pediatric_neuro_ext5', 'PCC Pediatric Neuro Ext5', 'pcc-pediatric-neuro-ext5'),
    ('pcc_pediatric_surg_ext5', 'PCC Pediatric Surg Ext5', 'pcc-pediatric-surg-ext5'),
]

ENGINE_FUNCS = {
    'pcc_neuro_ext16': [
        'BellsPalsyExt', 'TrigeminalNeuralgiaExt', 'HemifacialSpasm',
        'GlossopharyngealNeuralgia', 'OccipitalNeuralgia',
        'ClusterHeadacheExt', 'MigraineVariants',
        'CervicogenicHeadache', 'TensionHeadacheExt',
        'MedicationOveruseHeadache',
    ],
    'pcc_pediatric_neuro_ext5': [
        'PediatricFebrileIllness', 'PediatricMeningitis',
        'PediatricEncephalitis', 'PediatricBrainAbscess',
        'PediatricCerebritis', 'PediatricADEM',
        'PediatricRasmussenEncephalitis', 'PediatricCASKRelatedDisorders',
        'PediatricPontineTumor', 'PediatricNeurocutaneousSyndromes',
    ],
    'pcc_pediatric_surg_ext5': [
        'PediatricCraniosynostosis', 'PediatricPlagiocephaly',
        'PediatricHydrocephalusExt', 'PediatricVPShunt',
        'PediatricETVChoroidPlexusCauterization', 'PediatricChiariDecompression',
        'PediatricTetheredCordRelease', 'PediatricSyringomyelia',
        'PediatricSpinaBifidaRepair', 'PediatricEncephalocele',
    ],
}
...
def write_package_migration():
    code = f"-- {PHASE} package v{VER}\nINSERT INTO pcc_packages (version, phase, modules) VALUES ('{VER}', '{PHASE}', 'neuro_ext16,pediatric_neuro_ext5,pediatric_surg_ext5');\n"
