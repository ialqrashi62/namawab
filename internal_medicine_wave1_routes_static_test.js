...
const engineSrc = fs.readFileSync(path.join(__dirname, 'internal_medicine_wave1_engine.js'), 'utf8');
const serverSrc = fs.readFileSync(path.join(__dirname, 'server.js'), 'utf8');

const ROUTES = [
  {
    "path": "/heart-failure/risk-score",
    "fn": "checkHeartFailureDecompensation"
  },
  {
    "path": "/vascular/risk-profile",
    "fn": "checkCriticalLimbIschemia"
  },
  {
    "path": "/sleep/hypoxemia-check",
    "fn": "checkNocturnalHypoxemia"
  },
  {
    "path": "/motility/surgical-consult-check",
    "fn": "checkAchalasiaSurgicalConsult"
  },
  {
    "path": "/nuclear/safety-lock",
    "fn": "checkNuclearScanSafetyLock"
  },
  {
    "path": "/preventive/risk-score",
    "fn": "checkPreventiveCardiologyHighRisk"
  },
  {
    "path": "/allergic-pulm/anaphylaxis-check",
    "fn": "checkAnaphylaxisAlert"
  },
  {
    "path": "/respiratory/abg-check",
    "fn": "checkRespiratoryCriticalABG"
  }
];
...
function runTests() {
    for (const r of ROUTES) {
        assert.ok(
            ...
            'internal_medicine_wave1_engine.js must export ' + r.fn
        );
    }
    assert.ok(
    ...
    console.log('internal_medicine_wave1_engine_routes_static_test: all ' + ROUTES.length + ' routes verified');
}
