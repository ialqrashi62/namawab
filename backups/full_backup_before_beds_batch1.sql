...
\restrict Mg8ed2y0rUxXwQ1QAksTevaPGZwSEh2YMdcf5lB6ArfXEVbpkOhaVveY7vB30ud
...
21	1	المدير العام	LOGIN	Auth	0		User logged in as Admin	::1	2026-06-19 05:41:54.259788	\N		
\.
...
SELECT pg_catalog.setval('public.audit_trail_id_seq', 21, true);
...
SELECT pg_catalog.setval('public.cosmetic_procedures_id_seq', 345, true);
...
SELECT pg_catalog.setval('public.system_users_id_seq', 23, true);
...
SELECT pg_catalog.setval('public.tenant_lab_test_overrides_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.tenant_radiology_overrides_id_seq', 7, true);
...
SELECT pg_catalog.setval('public.user_facilities_id_seq', 23, true);
...
SELECT pg_catalog.setval('public.user_tenants_id_seq', 23, true);
...
\unrestrict Mg8ed2y0rUxXwQ1QAksTevaPGZwSEh2YMdcf5lB6ArfXEVbpkOhaVveY7vB30ud
